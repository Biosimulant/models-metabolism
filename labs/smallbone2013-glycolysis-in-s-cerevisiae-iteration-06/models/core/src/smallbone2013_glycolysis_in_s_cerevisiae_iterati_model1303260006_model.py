...
"""Tellurium-backed wrapper for Smallbone2013 - Glycolysis in S.cerevisiae - Iteration 06."""
...
class Smallbone2013GlycolysisInSCerevisiaeIteratiModel1303260006Model(TelluriumSBMLBioModule):
    """Tellurium-backed wrapper for Smallbone2013 - Glycolysis in S.cerevisiae - Iteration 06."""

    _SBML_ID = 'MODEL1303260006'
    _TITLE = 'Smallbone2013 - Glycolysis in S.cerevisiae - Iteration 06'
    ...
    def __init__(self, model_path: str = 'data/MODEL1303260006.xml', integration_step: float = 0.1) -> None:
