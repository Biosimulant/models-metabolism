...
"""Tellurium-backed wrapper for Smallbone2013 - Glycolysis in S.cerevisiae - Iteration 11."""
...
class Smallbone2013GlycolysisInSCerevisiaeIteratiModel1303260011Model(TelluriumSBMLBioModule):
    """Tellurium-backed wrapper for Smallbone2013 - Glycolysis in S.cerevisiae - Iteration 11."""

    _SBML_ID = 'MODEL1303260011'
    _TITLE = 'Smallbone2013 - Glycolysis in S.cerevisiae - Iteration 11'
    ...
    def __init__(self, model_path: str = 'data/MODEL1303260011.xml', integration_step: float = 0.1) -> None:
