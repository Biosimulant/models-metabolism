...
"""Tellurium-backed wrapper for Cloutier2009_EnergyMetabolism_ModelE."""
...
class Cloutier2009EnergymetabolismModeleModel1006230059Model(TelluriumSBMLBioModule):
    """Tellurium-backed wrapper for Cloutier2009_EnergyMetabolism_ModelE."""

    _SBML_ID = 'MODEL1006230059'
    _TITLE = 'Cloutier2009_EnergyMetabolism_ModelE'
    ...
    def __init__(self, model_path: str = 'data/MODEL1006230059.xml', integration_step: float = 0.1) -> None:
