...
"""Tellurium-backed wrapper for Smallbone2013 - Glycolysis in S.cerevisiae - Iteration 03."""
...
class Smallbone2013GlycolysisInSCerevisiaeIteratiModel1303260003Model(TelluriumSBMLBioModule):
    """Tellurium-backed wrapper for Smallbone2013 - Glycolysis in S.cerevisiae - Iteration 03."""

    _SBML_ID = 'MODEL1303260003'
    _TITLE = 'Smallbone2013 - Glycolysis in S.cerevisiae - Iteration 03'
    ...
    def __init__(self, model_path: str = 'data/MODEL1303260003.xml', integration_step: float = 0.1) -> None:
