...
"""Tellurium-backed wrapper for Tiago2010_FeMetabolism_FeDeficient."""
...
class Tiago2010FemetabolismFedeficientBiomd0000000259Model(TelluriumSBMLBioModule):
    """Tellurium-backed wrapper for Tiago2010_FeMetabolism_FeDeficient."""

    _SBML_ID = 'BIOMD0000000259'
    _TITLE = 'Tiago2010_FeMetabolism_FeDeficient'
    ...
    def __init__(self, model_path: str = 'data/BIOMD0000000259.xml', integration_step: float = 0.1) -> None:
