...
"""Tellurium-backed wrapper for Smallbone2013 - Glycolysis in S.cerevisiae - Iteration 07."""
...
class Smallbone2013GlycolysisInSCerevisiaeIteratiModel1303260007Model(TelluriumSBMLBioModule):
    """Tellurium-backed wrapper for Smallbone2013 - Glycolysis in S.cerevisiae - Iteration 07."""

    _SBML_ID = 'MODEL1303260007'
    _TITLE = 'Smallbone2013 - Glycolysis in S.cerevisiae - Iteration 07'
    ...
    def __init__(self, model_path: str = 'data/MODEL1303260007.xml', integration_step: float = 0.1) -> None:
