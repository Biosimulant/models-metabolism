...
"""Tellurium-backed wrapper for Smallbone2013 - Glycolysis in S.cerevisiae - Iteration 01."""
...
class Smallbone2013GlycolysisInSCerevisiaeIteratiModel1303260001Model(TelluriumSBMLBioModule):
    """Tellurium-backed wrapper for Smallbone2013 - Glycolysis in S.cerevisiae - Iteration 01."""

    _SBML_ID = 'MODEL1303260001'
    _TITLE = 'Smallbone2013 - Glycolysis in S.cerevisiae - Iteration 01'
    ...
    def __init__(self, model_path: str = 'data/MODEL1303260001.xml', integration_step: float = 0.1) -> None:
