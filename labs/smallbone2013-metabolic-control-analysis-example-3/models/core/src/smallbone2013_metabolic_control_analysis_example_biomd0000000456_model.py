...
"""Tellurium-backed wrapper for Smallbone2013 - Metabolic Control Analysis - Example 3."""
...
class Smallbone2013MetabolicControlAnalysisExampleBiomd0000000456Model(TelluriumSBMLBioModule):
    """Tellurium-backed wrapper for Smallbone2013 - Metabolic Control Analysis - Example 3."""

    _SBML_ID = 'BIOMD0000000456'
    _TITLE = 'Smallbone2013 - Metabolic Control Analysis - Example 3'
