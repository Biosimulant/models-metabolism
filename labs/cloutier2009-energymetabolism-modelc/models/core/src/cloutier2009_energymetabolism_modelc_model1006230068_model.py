...
"""Tellurium-backed wrapper for Cloutier2009_EnergyMetabolism_ModelC."""
...
class Cloutier2009EnergymetabolismModelcModel1006230068Model(TelluriumSBMLBioModule):
    """Tellurium-backed wrapper for Cloutier2009_EnergyMetabolism_ModelC."""

    _SBML_ID = 'MODEL1006230068'
    _TITLE = 'Cloutier2009_EnergyMetabolism_ModelC'
    ...
    def __init__(self, model_path: str = 'data/MODEL1006230068.xml', integration_step: float = 0.1) -> None:
