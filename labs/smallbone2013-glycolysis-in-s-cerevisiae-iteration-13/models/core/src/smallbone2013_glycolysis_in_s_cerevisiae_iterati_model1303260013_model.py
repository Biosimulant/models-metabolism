...
"""Tellurium-backed wrapper for Smallbone2013 - Glycolysis in S.cerevisiae - Iteration 13."""
...
class Smallbone2013GlycolysisInSCerevisiaeIteratiModel1303260013Model(TelluriumSBMLBioModule):
    """Tellurium-backed wrapper for Smallbone2013 - Glycolysis in S.cerevisiae - Iteration 13."""

    _SBML_ID = 'MODEL1303260013'
    _TITLE = 'Smallbone2013 - Glycolysis in S.cerevisiae - Iteration 13'
    ...
    def __init__(self, model_path: str = 'data/MODEL1303260013.xml', integration_step: float = 0.1) -> None:
