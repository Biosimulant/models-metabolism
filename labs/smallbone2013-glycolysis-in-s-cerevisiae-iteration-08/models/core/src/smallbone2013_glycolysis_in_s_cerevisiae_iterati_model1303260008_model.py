...
"""Tellurium-backed wrapper for Smallbone2013 - Glycolysis in S.cerevisiae - Iteration 08."""
...
class Smallbone2013GlycolysisInSCerevisiaeIteratiModel1303260008Model(TelluriumSBMLBioModule):
    """Tellurium-backed wrapper for Smallbone2013 - Glycolysis in S.cerevisiae - Iteration 08."""

    _SBML_ID = 'MODEL1303260008'
    _TITLE = 'Smallbone2013 - Glycolysis in S.cerevisiae - Iteration 08'
    ...
    def __init__(self, model_path: str = 'data/MODEL1303260008.xml', integration_step: float = 0.1) -> None:
