...
"""Tellurium-backed wrapper for Smallbone2013 - Glycolysis in S.cerevisiae - Iteration 12."""
...
class Smallbone2013GlycolysisInSCerevisiaeIteratiModel1303260012Model(TelluriumSBMLBioModule):
    """Tellurium-backed wrapper for Smallbone2013 - Glycolysis in S.cerevisiae - Iteration 12."""

    _SBML_ID = 'MODEL1303260012'
    _TITLE = 'Smallbone2013 - Glycolysis in S.cerevisiae - Iteration 12'
    ...
    def __init__(self, model_path: str = 'data/MODEL1303260012.xml', integration_step: float = 0.1) -> None:
