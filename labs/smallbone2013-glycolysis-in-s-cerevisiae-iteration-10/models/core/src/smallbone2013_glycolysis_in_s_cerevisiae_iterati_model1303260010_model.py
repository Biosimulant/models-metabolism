...
"""Tellurium-backed wrapper for Smallbone2013 - Glycolysis in S.cerevisiae - Iteration 10."""
...
class Smallbone2013GlycolysisInSCerevisiaeIteratiModel1303260010Model(TelluriumSBMLBioModule):
    """Tellurium-backed wrapper for Smallbone2013 - Glycolysis in S.cerevisiae - Iteration 10."""

    _SBML_ID = 'MODEL1303260010'
    _TITLE = 'Smallbone2013 - Glycolysis in S.cerevisiae - Iteration 10'
    ...
    def __init__(self, model_path: str = 'data/MODEL1303260010.xml', integration_step: float = 0.1) -> None:
