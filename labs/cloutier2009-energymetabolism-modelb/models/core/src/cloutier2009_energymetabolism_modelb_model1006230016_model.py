...
"""Tellurium-backed wrapper for Cloutier2009_EnergyMetabolism_ModelB."""
...
class Cloutier2009EnergymetabolismModelbModel1006230016Model(TelluriumSBMLBioModule):
    """Tellurium-backed wrapper for Cloutier2009_EnergyMetabolism_ModelB."""

    _SBML_ID = 'MODEL1006230016'
    _TITLE = 'Cloutier2009_EnergyMetabolism_ModelB'
    ...
    def __init__(self, model_path: str = 'data/MODEL1006230016.xml', integration_step: float = 0.1) -> None:
