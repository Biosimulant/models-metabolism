...
![Thiaville2016 - Folate pathway model (PanB overexpression) Lab - run interpretation](assets/01-thiaville2016-folate-pathway-model-panb-overexpression-lab-run-interpretation.png)
...
![Thiaville2016 - Folate pathway model (PanB overexpression) observable dynamics](assets/02-thiaville2016-folate-pathway-model-panb-overexpression-observable-dynamics.png)
