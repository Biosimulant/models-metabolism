...
"""Tellurium-backed wrapper for Smallbone2013 - Glycolysis in S.cerevisiae - Iteration 04."""
...
class Smallbone2013GlycolysisInSCerevisiaeIteratiModel1303260004Model(TelluriumSBMLBioModule):
    """Tellurium-backed wrapper for Smallbone2013 - Glycolysis in S.cerevisiae - Iteration 04."""

    _SBML_ID = 'MODEL1303260004'
    _TITLE = 'Smallbone2013 - Glycolysis in S.cerevisiae - Iteration 04'
    ...
    def __init__(self, model_path: str = 'data/MODEL1303260004.xml', integration_step: float = 0.1) -> None:
