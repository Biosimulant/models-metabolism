...
"""Tellurium-backed wrapper for Costa2015 - Central metabolism of E. coli, extended regulated linlog model ( with additional allosteric regulations than the Model1)."""
...
class Costa2015CentralMetabolismOfEColiExtendedModel1504080006Model(TelluriumSBMLBioModule):
    """Tellurium-backed wrapper for Costa2015 - Central metabolism of E. coli, extended regulated linlog model ( with additional allosteric regulations than the Model1)."""

    _SBML_ID = 'MODEL1504080006'
    _TITLE = 'Costa2015 - Central metabolism of E. coli, extended regulated linlog model ( with additional allosteric regulations than the Model1)'
    ...
    def __init__(self, model_path: str = 'data/MODEL1504080006.xml', integration_step: float = 0.1) -> None:
