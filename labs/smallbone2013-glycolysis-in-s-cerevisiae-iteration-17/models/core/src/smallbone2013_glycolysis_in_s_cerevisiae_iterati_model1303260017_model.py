...
"""Tellurium-backed wrapper for Smallbone2013 - Glycolysis in S.cerevisiae - Iteration 17."""
...
class Smallbone2013GlycolysisInSCerevisiaeIteratiModel1303260017Model(TelluriumSBMLBioModule):
    """Tellurium-backed wrapper for Smallbone2013 - Glycolysis in S.cerevisiae - Iteration 17."""

    _SBML_ID = 'MODEL1303260017'
    _TITLE = 'Smallbone2013 - Glycolysis in S.cerevisiae - Iteration 17'
    ...
    def __init__(self, model_path: str = 'data/MODEL1303260017.xml', integration_step: float = 0.1) -> None:
