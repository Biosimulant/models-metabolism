...
"""Tellurium-backed wrapper for Cloutier2009_EnergyMetabolism_ModelD."""
...
class Cloutier2009EnergymetabolismModeldModel1006230095Model(TelluriumSBMLBioModule):
    """Tellurium-backed wrapper for Cloutier2009_EnergyMetabolism_ModelD."""

    _SBML_ID = 'MODEL1006230095'
    _TITLE = 'Cloutier2009_EnergyMetabolism_ModelD'
    ...
    def __init__(self, model_path: str = 'data/MODEL1006230095.xml', integration_step: float = 0.1) -> None:
