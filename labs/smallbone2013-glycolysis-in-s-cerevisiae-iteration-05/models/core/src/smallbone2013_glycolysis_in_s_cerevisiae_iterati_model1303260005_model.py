...
"""Tellurium-backed wrapper for Smallbone2013 - Glycolysis in S.cerevisiae - Iteration 05."""
...
class Smallbone2013GlycolysisInSCerevisiaeIteratiModel1303260005Model(TelluriumSBMLBioModule):
    """Tellurium-backed wrapper for Smallbone2013 - Glycolysis in S.cerevisiae - Iteration 05."""

    _SBML_ID = 'MODEL1303260005'
    _TITLE = 'Smallbone2013 - Glycolysis in S.cerevisiae - Iteration 05'
    ...
    def __init__(self, model_path: str = 'data/MODEL1303260005.xml', integration_step: float = 0.1) -> None:
