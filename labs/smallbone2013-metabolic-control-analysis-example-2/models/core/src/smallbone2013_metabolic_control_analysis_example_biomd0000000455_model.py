...
"""Tellurium-backed wrapper for Smallbone2013 - Metabolic Control Analysis - Example 2."""
...
class Smallbone2013MetabolicControlAnalysisExampleBiomd0000000455Model(TelluriumSBMLBioModule):
    """Tellurium-backed wrapper for Smallbone2013 - Metabolic Control Analysis - Example 2."""

    _SBML_ID = 'BIOMD0000000455'
    _TITLE = 'Smallbone2013 - Metabolic Control Analysis - Example 2'
    ...
    def __init__(self, model_path: str = 'data/BIOMD0000000455.xml', integration_step: float = 0.1) -> None:
