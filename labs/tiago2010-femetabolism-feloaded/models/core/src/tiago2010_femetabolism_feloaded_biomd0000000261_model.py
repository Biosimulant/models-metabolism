...
"""Tellurium-backed wrapper for Tiago2010_FeMetabolism_FeLoaded."""
...
class Tiago2010FemetabolismFeloadedBiomd0000000261Model(TelluriumSBMLBioModule):
    """Tellurium-backed wrapper for Tiago2010_FeMetabolism_FeLoaded."""

    _SBML_ID = 'BIOMD0000000261'
    _TITLE = 'Tiago2010_FeMetabolism_FeLoaded'
    ...
    def __init__(self, model_path: str = 'data/BIOMD0000000261.xml', integration_step: float = 0.1) -> None:
