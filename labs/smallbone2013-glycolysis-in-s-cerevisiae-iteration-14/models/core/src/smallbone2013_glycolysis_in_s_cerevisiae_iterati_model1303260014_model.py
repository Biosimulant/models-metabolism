...
"""Tellurium-backed wrapper for Smallbone2013 - Glycolysis in S.cerevisiae - Iteration 14."""
...
class Smallbone2013GlycolysisInSCerevisiaeIteratiModel1303260014Model(TelluriumSBMLBioModule):
    """Tellurium-backed wrapper for Smallbone2013 - Glycolysis in S.cerevisiae - Iteration 14."""

    _SBML_ID = 'MODEL1303260014'
    _TITLE = 'Smallbone2013 - Glycolysis in S.cerevisiae - Iteration 14'
    ...
    def __init__(self, model_path: str = 'data/MODEL1303260014.xml', integration_step: float = 0.1) -> None:
