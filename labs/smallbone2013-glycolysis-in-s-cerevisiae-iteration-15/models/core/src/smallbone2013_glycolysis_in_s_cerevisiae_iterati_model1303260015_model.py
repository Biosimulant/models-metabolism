...
"""Tellurium-backed wrapper for Smallbone2013 - Glycolysis in S.cerevisiae - Iteration 15."""
...
class Smallbone2013GlycolysisInSCerevisiaeIteratiModel1303260015Model(TelluriumSBMLBioModule):
    """Tellurium-backed wrapper for Smallbone2013 - Glycolysis in S.cerevisiae - Iteration 15."""

    _SBML_ID = 'MODEL1303260015'
    _TITLE = 'Smallbone2013 - Glycolysis in S.cerevisiae - Iteration 15'
    ...
    def __init__(self, model_path: str = 'data/MODEL1303260015.xml', integration_step: float = 0.1) -> None:
