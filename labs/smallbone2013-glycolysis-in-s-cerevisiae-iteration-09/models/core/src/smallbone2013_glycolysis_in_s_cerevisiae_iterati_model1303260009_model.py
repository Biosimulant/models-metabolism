...
"""Tellurium-backed wrapper for Smallbone2013 - Glycolysis in S.cerevisiae - Iteration 09."""
...
class Smallbone2013GlycolysisInSCerevisiaeIteratiModel1303260009Model(TelluriumSBMLBioModule):
    """Tellurium-backed wrapper for Smallbone2013 - Glycolysis in S.cerevisiae - Iteration 09."""

    _SBML_ID = 'MODEL1303260009'
    _TITLE = 'Smallbone2013 - Glycolysis in S.cerevisiae - Iteration 09'
    ...
    def __init__(self, model_path: str = 'data/MODEL1303260009.xml', integration_step: float = 0.1) -> None:
