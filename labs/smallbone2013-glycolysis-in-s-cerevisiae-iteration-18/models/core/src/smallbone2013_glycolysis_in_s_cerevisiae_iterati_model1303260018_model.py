...
"""Tellurium-backed wrapper for Smallbone2013 - Glycolysis in S.cerevisiae - Iteration 18."""
...
class Smallbone2013GlycolysisInSCerevisiaeIteratiModel1303260018Model(TelluriumSBMLBioModule):
    """Tellurium-backed wrapper for Smallbone2013 - Glycolysis in S.cerevisiae - Iteration 18."""

    _SBML_ID = 'MODEL1303260018'
    _TITLE = 'Smallbone2013 - Glycolysis in S.cerevisiae - Iteration 18'
    ...
    def __init__(self, model_path: str = 'data/MODEL1303260018.xml', integration_step: float = 0.1) -> None:
