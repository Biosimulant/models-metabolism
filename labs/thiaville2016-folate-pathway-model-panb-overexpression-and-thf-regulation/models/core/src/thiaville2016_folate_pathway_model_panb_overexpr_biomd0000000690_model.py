...
"""Tellurium-backed wrapper for Thiaville2016 - Folate pathway model (PanB overexpression and THF regulation)."""
...
class Thiaville2016FolatePathwayModelPanbOverexprBiomd0000000690Model(TelluriumSBMLBioModule):
    """Tellurium-backed wrapper for Thiaville2016 - Folate pathway model (PanB overexpression and THF regulation)."""

    _SBML_ID = 'BIOMD0000000690'
    _TITLE = 'Thiaville2016 - Folate pathway model (PanB overexpression and THF regulation)'
    ...
    def __init__(self, model_path: str = 'data/BIOMD0000000690.xml', integration_step: float = 0.1) -> None:
