...
"""Tellurium-backed wrapper for Smallbone2013 - Glycolysis in S.cerevisiae - Iteration 16."""
...
class Smallbone2013GlycolysisInSCerevisiaeIteratiModel1303260016Model(TelluriumSBMLBioModule):
    """Tellurium-backed wrapper for Smallbone2013 - Glycolysis in S.cerevisiae - Iteration 16."""

    _SBML_ID = 'MODEL1303260016'
    _TITLE = 'Smallbone2013 - Glycolysis in S.cerevisiae - Iteration 16'
    ...
    def __init__(self, model_path: str = 'data/MODEL1303260016.xml', integration_step: float = 0.1) -> None:
