...
"""Tellurium-backed wrapper for Costa2015 - Central metabolism of E. coli, non-regulated linlog model (without allosteric regulations)."""
...
class Costa2015CentralMetabolismOfEColiNonRegulModel1504080005Model(TelluriumSBMLBioModule):
    """Tellurium-backed wrapper for Costa2015 - Central metabolism of E. coli, non-regulated linlog model (without allosteric regulations)."""

    _SBML_ID = 'MODEL1504080005'
    _TITLE = 'Costa2015 - Central metabolism of E. coli, non-regulated linlog model (without allosteric regulations)'
    ...
    def __init__(self, model_path: str = 'data/MODEL1504080005.xml', integration_step: float = 0.1) -> None:
