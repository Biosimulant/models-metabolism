...
"""Tellurium-backed wrapper for Smallbone2013 - Glycolysis in S.cerevisiae - Iteration 02."""
...
class Smallbone2013GlycolysisInSCerevisiaeIteratiModel1303260002Model(TelluriumSBMLBioModule):
    """Tellurium-backed wrapper for Smallbone2013 - Glycolysis in S.cerevisiae - Iteration 02."""

    _SBML_ID = 'MODEL1303260002'
    _TITLE = 'Smallbone2013 - Glycolysis in S.cerevisiae - Iteration 02'
    ...
    def __init__(self, model_path: str = 'data/MODEL1303260002.xml', integration_step: float = 0.1) -> None:
