...
"""Auto-generated SBML BioModule wrapper for Pitkanen2014 - Metabolic reconstruction of Coccidioides immitis using CoReCo.

Source: biomodels_ebi:MODEL1302010007
Original: https://www.ebi.ac.uk/biomodels/MODEL1302010007
"""
...
class SbmlPitkanen2014MetabolicReconstructionOfCoccidioides(biosim.BioModule):
    """BioModule wrapper for SBML model: Pitkanen2014 - Metabolic reconstruction of Coccidioides immitis using CoReCo."""

    def __init__(self, model_path: str = "data/MODEL1302010007.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Pitkanen2014MetabolicReconstructionOfCoccidiModel1302010007Model = SbmlPitkanen2014MetabolicReconstructionOfCoccidioides
