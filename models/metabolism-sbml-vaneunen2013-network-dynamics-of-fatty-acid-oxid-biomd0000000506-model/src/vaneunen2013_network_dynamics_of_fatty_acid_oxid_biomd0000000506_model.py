...
"""Auto-generated SBML BioModule wrapper for vanEunen2013 - Network dynamics of fatty acid β-oxidation (time-course model).

Source: biomodels_ebi:BIOMD0000000506
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000506
"""
...
class SbmlVaneunen2013NetworkDynamicsOfFattyAcidOxidationTime(biosim.BioModule):
    """BioModule wrapper for SBML model: vanEunen2013 - Network dynamics of fatty acid β-oxidation (time-course model)."""

    def __init__(self, model_path: str = "data/BIOMD0000000506.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Vaneunen2013NetworkDynamicsOfFattyAcidOxidBiomd0000000506Model = SbmlVaneunen2013NetworkDynamicsOfFattyAcidOxidationTime
