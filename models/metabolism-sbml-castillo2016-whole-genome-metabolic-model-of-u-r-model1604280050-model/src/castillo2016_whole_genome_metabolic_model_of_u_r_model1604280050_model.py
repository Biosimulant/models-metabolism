...
"""Auto-generated SBML BioModule wrapper for Castillo2016 - Whole-genome metabolic model of U.reesii using CoReCo.

Source: biomodels_ebi:MODEL1604280050
Original: https://www.ebi.ac.uk/biomodels/MODEL1604280050
"""
...
class SbmlCastillo2016WholeGenomeMetabolicModelOfUReesiiUsing(biosim.BioModule):
    """BioModule wrapper for SBML model: Castillo2016 - Whole-genome metabolic model of U.reesii using CoReCo."""

    def __init__(self, model_path: str = "data/MODEL1604280050.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Castillo2016WholeGenomeMetabolicModelOfURModel1604280050Model = SbmlCastillo2016WholeGenomeMetabolicModelOfUReesiiUsing
