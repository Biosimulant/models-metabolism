...
"""Auto-generated SBML BioModule wrapper for Cloutier2009_EnergyMetabolism_ModelA.

Source: biomodels_ebi:MODEL1006230010
Original: https://www.ebi.ac.uk/biomodels/MODEL1006230010
"""
...
class SbmlCloutier2009EnergymetabolismModela(biosim.BioModule):
    """BioModule wrapper for SBML model: Cloutier2009_EnergyMetabolism_ModelA."""

    def __init__(self, model_path: str = "data/MODEL1006230010.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Cloutier2009EnergymetabolismModelaModel1006230010Model = SbmlCloutier2009EnergymetabolismModela
