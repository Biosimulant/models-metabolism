...
"""Auto-generated SBML BioModule wrapper for Castillo2016 - Whole-genome metabolic model of A.gossypii using CoReCo.

Source: biomodels_ebi:MODEL1604280044
Original: https://www.ebi.ac.uk/biomodels/MODEL1604280044
"""
...
class SbmlCastillo2016WholeGenomeMetabolicModelOfAGossypii(biosim.BioModule):
    """BioModule wrapper for SBML model: Castillo2016 - Whole-genome metabolic model of A.gossypii using CoReCo."""

    def __init__(self, model_path: str = "data/MODEL1604280044.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Castillo2016WholeGenomeMetabolicModelOfAGModel1604280044Model = SbmlCastillo2016WholeGenomeMetabolicModelOfAGossypii
