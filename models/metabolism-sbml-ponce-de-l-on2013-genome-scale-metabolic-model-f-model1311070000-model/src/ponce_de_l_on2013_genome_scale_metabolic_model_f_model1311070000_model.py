...
"""Auto-generated SBML BioModule wrapper for Ponce-de-Léon2013 - Genome scale metabolic model for Blattabacterium cuenoti (iMP240).

Source: biomodels_ebi:MODEL1311070000
Original: https://www.ebi.ac.uk/biomodels/MODEL1311070000
"""
...
class SbmlPonceDeLeon2013GenomeScaleMetabolicModelFor(biosim.BioModule):
    """BioModule wrapper for SBML model: Ponce-de-Léon2013 - Genome scale metabolic model for Blattabacterium cuenoti (iMP240)."""

    def __init__(self, model_path: str = "data/MODEL1311070000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
PonceDeLOn2013GenomeScaleMetabolicModelFModel1311070000Model = SbmlPonceDeLeon2013GenomeScaleMetabolicModelFor
