...
"""Auto-generated SBML BioModule wrapper for Millard2016 - E. coli central carbon and energy metabolism.

Source: biomodels_ebi:MODEL1505110000
Original: https://www.ebi.ac.uk/biomodels/MODEL1505110000
"""
...
class SbmlMillard2016EColiCentralCarbonAndEnergyMetabolism(biosim.BioModule):
    """BioModule wrapper for SBML model: Millard2016 - E. coli central carbon and energy metabolism."""

    def __init__(self, model_path: str = "data/MODEL1505110000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Millard2016EColiCentralCarbonAndEnergyMetModel1505110000Model = SbmlMillard2016EColiCentralCarbonAndEnergyMetabolism
