...
"""Auto-generated SBML BioModule wrapper for Castillo2016 - Whole-genome metabolic model of N.crassa using CoReCo.

Source: biomodels_ebi:MODEL1604280046
Original: https://www.ebi.ac.uk/biomodels/MODEL1604280046
"""
...
class SbmlCastillo2016WholeGenomeMetabolicModelOfNCrassaUsing(biosim.BioModule):
    """BioModule wrapper for SBML model: Castillo2016 - Whole-genome metabolic model of N.crassa using CoReCo."""

    def __init__(self, model_path: str = "data/MODEL1604280046.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Castillo2016WholeGenomeMetabolicModelOfNCModel1604280046Model = SbmlCastillo2016WholeGenomeMetabolicModelOfNCrassaUsing
