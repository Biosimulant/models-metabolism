...
"""Auto-generated SBML BioModule wrapper for Castillo2016 - Whole-genome metabolic model of T.harzianum using CoReCo.

Source: biomodels_ebi:MODEL1604280000
Original: https://www.ebi.ac.uk/biomodels/MODEL1604280000
"""
...
class SbmlCastillo2016WholeGenomeMetabolicModelOfTHarzianum(biosim.BioModule):
    """BioModule wrapper for SBML model: Castillo2016 - Whole-genome metabolic model of T.harzianum using CoReCo."""

    def __init__(self, model_path: str = "data/MODEL1604280000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Castillo2016WholeGenomeMetabolicModelOfTHModel1604280000Model = SbmlCastillo2016WholeGenomeMetabolicModelOfTHarzianum
