...
"""Auto-generated SBML BioModule wrapper for Pitkanen2014 - Metabolic reconstruction of Pichia stipitis using CoReCo.

Source: biomodels_ebi:MODEL1302010043
Original: https://www.ebi.ac.uk/biomodels/MODEL1302010043
"""
...
class SbmlPitkanen2014MetabolicReconstructionOfPichiaStipitis(biosim.BioModule):
    """BioModule wrapper for SBML model: Pitkanen2014 - Metabolic reconstruction of Pichia stipitis using CoReCo."""

    def __init__(self, model_path: str = "data/MODEL1302010043.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Pitkanen2014MetabolicReconstructionOfPichiaModel1302010043Model = SbmlPitkanen2014MetabolicReconstructionOfPichiaStipitis
