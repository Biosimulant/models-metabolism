...
"""Auto-generated SBML BioModule wrapper for Wolf2000 - Cellular interaction on glycolytic oscillations in yeast.

Source: biomodels_ebi:BIOMD0000000691
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000691
"""
...
class SbmlWolf2000CellularInteractionOnGlycolyticOscillationsIn(biosim.BioModule):
    """BioModule wrapper for SBML model: Wolf2000 - Cellular interaction on glycolytic oscillations in yeast."""

    def __init__(self, model_path: str = "data/BIOMD0000000691.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Wolf2000CellularInteractionOnGlycolyticOsciBiomd0000000691Model = SbmlWolf2000CellularInteractionOnGlycolyticOscillationsIn
