...
"""Auto-generated SBML BioModule wrapper for Vongsangnak2008 - Genome-scale metabolic network of Aspergillus oryzae (iWV1314).

Source: biomodels_ebi:MODEL1507180056
Original: https://www.ebi.ac.uk/biomodels/MODEL1507180056
"""
...
class SbmlVongsangnak2008GenomeScaleMetabolicNetworkOf(biosim.BioModule):
    """BioModule wrapper for SBML model: Vongsangnak2008 - Genome-scale metabolic network of Aspergillus oryzae (iWV1314)."""

    def __init__(self, model_path: str = "data/MODEL1507180056.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Vongsangnak2008GenomeScaleMetabolicNetworkOModel1507180056Model = SbmlVongsangnak2008GenomeScaleMetabolicNetworkOf
