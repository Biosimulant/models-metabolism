...
"""Auto-generated SBML BioModule wrapper for Fatma2018 -  Model of central carbon metabolism of E. coli with additional reactions to investigate potential routes of alkane synthesis.

Source: biomodels_ebi:MODEL1802080001
Original: https://www.ebi.ac.uk/biomodels/MODEL1802080001
"""
...
class SbmlFatma2018ModelOfCentralCarbonMetabolismOfEColiWith(biosim.BioModule):
    """BioModule wrapper for SBML model: Fatma2018 -  Model of central carbon metabolism of E. coli with additional reactions to investigate potential routes of alkane synthesis."""

    def __init__(self, model_path: str = "data/MODEL1802080001.sbml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Fatma2018ModelOfCentralCarbonMetabolismOfModel1802080001Model = SbmlFatma2018ModelOfCentralCarbonMetabolismOfEColiWith
