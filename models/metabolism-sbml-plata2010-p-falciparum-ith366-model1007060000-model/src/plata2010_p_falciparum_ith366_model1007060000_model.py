...
"""Auto-generated SBML BioModule wrapper for Plata2010_P_falciparum_iTH366.

Source: biomodels_ebi:MODEL1007060000
Original: https://www.ebi.ac.uk/biomodels/MODEL1007060000
"""
...
class SbmlPlata2010PFalciparumIth366(biosim.BioModule):
    """BioModule wrapper for SBML model: Plata2010_P_falciparum_iTH366."""

    def __init__(self, model_path: str = "data/MODEL1007060000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Plata2010PFalciparumIth366Model1007060000Model = SbmlPlata2010PFalciparumIth366
