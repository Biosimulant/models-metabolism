...
"""Auto-generated SBML BioModule wrapper for Koch2017 - Petri Net Model of Core Metabolism in Arabidopsis thaliana.

Source: biomodels_ebi:MODEL1801090001
Original: https://www.ebi.ac.uk/biomodels/MODEL1801090001
"""
...
class SbmlKoch2017PetriNetModelOfCoreMetabolismInArabidopsis(biosim.BioModule):
    """BioModule wrapper for SBML model: Koch2017 - Petri Net Model of Core Metabolism in Arabidopsis thaliana."""

    def __init__(self, model_path: str = "data/MODEL1801090001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Koch2017PetriNetModelOfCoreMetabolismInAModel1801090001Model = SbmlKoch2017PetriNetModelOfCoreMetabolismInArabidopsis
