...
"""Auto-generated SBML BioModule wrapper for Castillo2016 - Whole-genome metabolic model of S.pombe using CoReCo.

Source: biomodels_ebi:MODEL1604280041
Original: https://www.ebi.ac.uk/biomodels/MODEL1604280041
"""
...
class SbmlCastillo2016WholeGenomeMetabolicModelOfSPombeUsing(biosim.BioModule):
    """BioModule wrapper for SBML model: Castillo2016 - Whole-genome metabolic model of S.pombe using CoReCo."""

    def __init__(self, model_path: str = "data/MODEL1604280041.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Castillo2016WholeGenomeMetabolicModelOfSPModel1604280041Model = SbmlCastillo2016WholeGenomeMetabolicModelOfSPombeUsing
