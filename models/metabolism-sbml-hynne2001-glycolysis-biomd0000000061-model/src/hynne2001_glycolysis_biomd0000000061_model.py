...
"""Auto-generated SBML BioModule wrapper for Hynne2001_Glycolysis.

Source: biomodels_ebi:BIOMD0000000061
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000061
"""
...
class SbmlHynne2001Glycolysis(biosim.BioModule):
    """BioModule wrapper for SBML model: Hynne2001_Glycolysis."""

    def __init__(self, model_path: str = "data/BIOMD0000000061.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Hynne2001GlycolysisBiomd0000000061Model = SbmlHynne2001Glycolysis
