...
"""Auto-generated SBML BioModule wrapper for Thiele2013 - Salivary gland glandular cells.

Source: biomodels_ebi:MODEL1310110062
Original: https://www.ebi.ac.uk/biomodels/MODEL1310110062
"""
...
class SbmlThiele2013SalivaryGlandGlandularCells(biosim.BioModule):
    """BioModule wrapper for SBML model: Thiele2013 - Salivary gland glandular cells."""

    def __init__(self, model_path: str = "data/MODEL1310110062.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Thiele2013SalivaryGlandGlandularCellsModel1310110062Model = SbmlThiele2013SalivaryGlandGlandularCells
