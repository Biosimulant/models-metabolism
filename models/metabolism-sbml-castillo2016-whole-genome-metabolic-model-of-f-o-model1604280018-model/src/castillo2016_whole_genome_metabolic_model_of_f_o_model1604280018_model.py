...
"""Auto-generated SBML BioModule wrapper for Castillo2016 - Whole-genome metabolic model of F.oxysporum using CoReCo.

Source: biomodels_ebi:MODEL1604280018
Original: https://www.ebi.ac.uk/biomodels/MODEL1604280018
"""
...
class SbmlCastillo2016WholeGenomeMetabolicModelOfFOxysporum(biosim.BioModule):
    """BioModule wrapper for SBML model: Castillo2016 - Whole-genome metabolic model of F.oxysporum using CoReCo."""

    def __init__(self, model_path: str = "data/MODEL1604280018.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Castillo2016WholeGenomeMetabolicModelOfFOModel1604280018Model = SbmlCastillo2016WholeGenomeMetabolicModelOfFOxysporum
