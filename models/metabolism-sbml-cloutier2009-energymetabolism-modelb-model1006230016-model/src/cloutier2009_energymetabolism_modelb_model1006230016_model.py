...
"""Auto-generated SBML BioModule wrapper for Cloutier2009_EnergyMetabolism_ModelB.

Source: biomodels_ebi:MODEL1006230016
Original: https://www.ebi.ac.uk/biomodels/MODEL1006230016
"""
...
class SbmlCloutier2009EnergymetabolismModelb(biosim.BioModule):
    """BioModule wrapper for SBML model: Cloutier2009_EnergyMetabolism_ModelB."""

    def __init__(self, model_path: str = "data/MODEL1006230016.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Cloutier2009EnergymetabolismModelbModel1006230016Model = SbmlCloutier2009EnergymetabolismModelb
