...
"""Auto-generated SBML BioModule wrapper for Kerkhoven2016 - Genome-scale metabolic model of Yarrowia lipolytica.

Source: biomodels_ebi:MODEL1508190002
Original: https://www.ebi.ac.uk/biomodels/MODEL1508190002
"""
...
class SbmlKerkhoven2016GenomeScaleMetabolicModelOfYarrowia(biosim.BioModule):
    """BioModule wrapper for SBML model: Kerkhoven2016 - Genome-scale metabolic model of Yarrowia lipolytica."""

    def __init__(self, model_path: str = "data/MODEL1508190002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Kerkhoven2016GenomeScaleMetabolicModelOfYaModel1508190002Model = SbmlKerkhoven2016GenomeScaleMetabolicModelOfYarrowia
