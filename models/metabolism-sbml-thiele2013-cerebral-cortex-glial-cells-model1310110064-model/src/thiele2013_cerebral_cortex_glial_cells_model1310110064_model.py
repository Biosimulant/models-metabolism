...
"""Auto-generated SBML BioModule wrapper for Thiele2013 - Cerebral cortex glial cells.

Source: biomodels_ebi:MODEL1310110064
Original: https://www.ebi.ac.uk/biomodels/MODEL1310110064
"""
...
class SbmlThiele2013CerebralCortexGlialCells(biosim.BioModule):
    """BioModule wrapper for SBML model: Thiele2013 - Cerebral cortex glial cells."""

    def __init__(self, model_path: str = "data/MODEL1310110064.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Thiele2013CerebralCortexGlialCellsModel1310110064Model = SbmlThiele2013CerebralCortexGlialCells
