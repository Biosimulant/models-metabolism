...
"""Auto-generated SBML BioModule wrapper for Tec-Campos2020 - Azotobacter vinelandii DJ metabolism.

Source: biomodels_ebi:MODEL2204190001
Original: https://www.ebi.ac.uk/biomodels/MODEL2204190001
"""
...
class SbmlTecCampos2020AzotobacterVinelandiiDjMetabolism(biosim.BioModule):
    """BioModule wrapper for SBML model: Tec-Campos2020 - Azotobacter vinelandii DJ metabolism."""

    def __init__(self, model_path: str = "data/MODEL2204190001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
TecCampos2020AzotobacterVinelandiiDjMetabolModel2204190001Model = SbmlTecCampos2020AzotobacterVinelandiiDjMetabolism
