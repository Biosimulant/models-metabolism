...
"""Auto-generated SBML BioModule wrapper for Hong2004 - Genome-scale metabolic network of Mannheimia succiniciproducens (iSH335).

Source: biomodels_ebi:MODEL1507180025
Original: https://www.ebi.ac.uk/biomodels/MODEL1507180025
"""
...
class SbmlHong2004GenomeScaleMetabolicNetworkOfMannheimia(biosim.BioModule):
    """BioModule wrapper for SBML model: Hong2004 - Genome-scale metabolic network of Mannheimia succiniciproducens (iSH335)."""

    def __init__(self, model_path: str = "data/MODEL1507180025.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Hong2004GenomeScaleMetabolicNetworkOfMannhModel1507180025Model = SbmlHong2004GenomeScaleMetabolicNetworkOfMannheimia
