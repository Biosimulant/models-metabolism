...
"""Auto-generated SBML BioModule wrapper for Liu2012 - Genome-scale metabolic network of Scheffersomyces stipitis (iTL885).

Source: biomodels_ebi:MODEL1507180026
Original: https://www.ebi.ac.uk/biomodels/MODEL1507180026
"""
...
class SbmlLiu2012GenomeScaleMetabolicNetworkOfScheffersomyces(biosim.BioModule):
    """BioModule wrapper for SBML model: Liu2012 - Genome-scale metabolic network of Scheffersomyces stipitis (iTL885)."""

    def __init__(self, model_path: str = "data/MODEL1507180026.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Liu2012GenomeScaleMetabolicNetworkOfScheffModel1507180026Model = SbmlLiu2012GenomeScaleMetabolicNetworkOfScheffersomyces
