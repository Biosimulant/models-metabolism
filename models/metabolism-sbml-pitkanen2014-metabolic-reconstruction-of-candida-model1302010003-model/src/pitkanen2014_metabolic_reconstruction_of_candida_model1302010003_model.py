...
"""Auto-generated SBML BioModule wrapper for Pitkanen2014 - Metabolic reconstruction of Candida tropicalis using CoReCo.

Source: biomodels_ebi:MODEL1302010003
Original: https://www.ebi.ac.uk/biomodels/MODEL1302010003
"""
...
class SbmlPitkanen2014MetabolicReconstructionOfCandidaTropicalis(biosim.BioModule):
    """BioModule wrapper for SBML model: Pitkanen2014 - Metabolic reconstruction of Candida tropicalis using CoReCo."""

    def __init__(self, model_path: str = "data/MODEL1302010003.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Pitkanen2014MetabolicReconstructionOfCandidaModel1302010003Model = SbmlPitkanen2014MetabolicReconstructionOfCandidaTropicalis
