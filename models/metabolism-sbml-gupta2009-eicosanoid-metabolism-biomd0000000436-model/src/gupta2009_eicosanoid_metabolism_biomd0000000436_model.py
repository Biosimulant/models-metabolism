...
"""Auto-generated SBML BioModule wrapper for Gupta2009 - Eicosanoid Metabolism.

Source: biomodels_ebi:BIOMD0000000436
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000436
"""
...
class SbmlGupta2009EicosanoidMetabolism(biosim.BioModule):
    """BioModule wrapper for SBML model: Gupta2009 - Eicosanoid Metabolism."""

    def __init__(self, model_path: str = "data/BIOMD0000000436.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Gupta2009EicosanoidMetabolismBiomd0000000436Model = SbmlGupta2009EicosanoidMetabolism
