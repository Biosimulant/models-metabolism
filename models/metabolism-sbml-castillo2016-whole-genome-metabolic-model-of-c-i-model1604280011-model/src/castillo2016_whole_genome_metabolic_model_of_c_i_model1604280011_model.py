...
"""Auto-generated SBML BioModule wrapper for Castillo2016 - Whole-genome metabolic model of C.immitis using CoReCo.

Source: biomodels_ebi:MODEL1604280011
Original: https://www.ebi.ac.uk/biomodels/MODEL1604280011
"""
...
class SbmlCastillo2016WholeGenomeMetabolicModelOfCImmitis(biosim.BioModule):
    """BioModule wrapper for SBML model: Castillo2016 - Whole-genome metabolic model of C.immitis using CoReCo."""

    def __init__(self, model_path: str = "data/MODEL1604280011.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Castillo2016WholeGenomeMetabolicModelOfCIModel1604280011Model = SbmlCastillo2016WholeGenomeMetabolicModelOfCImmitis
