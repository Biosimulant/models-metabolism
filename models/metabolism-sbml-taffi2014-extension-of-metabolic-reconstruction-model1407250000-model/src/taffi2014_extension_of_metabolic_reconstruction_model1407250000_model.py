...
"""Auto-generated SBML BioModule wrapper for Taffi2014 - Extension of metabolic reconstruction of Pseudomonas putida KT2440 with aerobic pathway of PCBs degradation.

Source: biomodels_ebi:MODEL1407250000
Original: https://www.ebi.ac.uk/biomodels/MODEL1407250000
"""
...
class SbmlTaffi2014ExtensionOfMetabolicReconstructionOf(biosim.BioModule):
    """BioModule wrapper for SBML model: Taffi2014 - Extension of metabolic reconstruction of Pseudomonas putida KT2440 with aerobic pathway of PCBs degradation."""

    def __init__(self, model_path: str = "data/MODEL1407250000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Taffi2014ExtensionOfMetabolicReconstructionModel1407250000Model = SbmlTaffi2014ExtensionOfMetabolicReconstructionOf
