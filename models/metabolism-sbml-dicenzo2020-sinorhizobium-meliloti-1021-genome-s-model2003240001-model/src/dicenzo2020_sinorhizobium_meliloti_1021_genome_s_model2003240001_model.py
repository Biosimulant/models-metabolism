...
"""Auto-generated SBML BioModule wrapper for diCenzo2020 - Sinorhizobium meliloti 1021 genome-scale metabolic model.

Source: biomodels_ebi:MODEL2003240001
Original: https://www.ebi.ac.uk/biomodels/MODEL2003240001
"""
...
class SbmlDicenzo2020SinorhizobiumMeliloti1021GenomeScale(biosim.BioModule):
    """BioModule wrapper for SBML model: diCenzo2020 - Sinorhizobium meliloti 1021 genome-scale metabolic model."""

    def __init__(self, model_path: str = "data/MODEL2003240001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Dicenzo2020SinorhizobiumMeliloti1021GenomeSModel2003240001Model = SbmlDicenzo2020SinorhizobiumMeliloti1021GenomeScale
