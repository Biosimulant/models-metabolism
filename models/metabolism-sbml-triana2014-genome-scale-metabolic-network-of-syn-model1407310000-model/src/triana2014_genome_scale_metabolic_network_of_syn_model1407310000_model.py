...
"""Auto-generated SBML BioModule wrapper for Triana2014 - Genome-scale metabolic network of Synechococcus elongatus (iSyf715).

Source: biomodels_ebi:MODEL1407310000
Original: https://www.ebi.ac.uk/biomodels/MODEL1407310000
"""
...
class SbmlTriana2014GenomeScaleMetabolicNetworkOfSynechococcus(biosim.BioModule):
    """BioModule wrapper for SBML model: Triana2014 - Genome-scale metabolic network of Synechococcus elongatus (iSyf715)."""

    def __init__(self, model_path: str = "data/MODEL1407310000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Triana2014GenomeScaleMetabolicNetworkOfSynModel1407310000Model = SbmlTriana2014GenomeScaleMetabolicNetworkOfSynechococcus
