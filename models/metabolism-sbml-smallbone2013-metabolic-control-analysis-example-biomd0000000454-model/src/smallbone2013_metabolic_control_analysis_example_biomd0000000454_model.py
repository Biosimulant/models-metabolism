...
"""Auto-generated SBML BioModule wrapper for Smallbone2013 - Metabolic Control Analysis - Example 1.

Source: biomodels_ebi:BIOMD0000000454
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000454
"""
...
class SbmlSmallbone2013MetabolicControlAnalysisExample1(biosim.BioModule):
    """BioModule wrapper for SBML model: Smallbone2013 - Metabolic Control Analysis - Example 1."""

    def __init__(self, model_path: str = "data/BIOMD0000000454.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Smallbone2013MetabolicControlAnalysisExampleBiomd0000000454Model = SbmlSmallbone2013MetabolicControlAnalysisExample1
