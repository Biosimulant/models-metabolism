...
"""Auto-generated SBML BioModule wrapper for Oh2007 - Genome-scale metabolic network of Bacillus subtilis (iYO844).

Source: biomodels_ebi:MODEL1507180013
Original: https://www.ebi.ac.uk/biomodels/MODEL1507180013
"""
...
class SbmlOh2007GenomeScaleMetabolicNetworkOfBacillusSubtilis(biosim.BioModule):
    """BioModule wrapper for SBML model: Oh2007 - Genome-scale metabolic network of Bacillus subtilis (iYO844)."""

    def __init__(self, model_path: str = "data/MODEL1507180013.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Oh2007GenomeScaleMetabolicNetworkOfBacilluModel1507180013Model = SbmlOh2007GenomeScaleMetabolicNetworkOfBacillusSubtilis
