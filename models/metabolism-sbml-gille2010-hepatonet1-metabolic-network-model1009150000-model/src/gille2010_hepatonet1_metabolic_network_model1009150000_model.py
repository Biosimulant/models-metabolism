...
"""Auto-generated SBML BioModule wrapper for Gille2010_HepatoNet1_Metabolic_Network.

Source: biomodels_ebi:MODEL1009150000
Original: https://www.ebi.ac.uk/biomodels/MODEL1009150000
"""
...
class SbmlGille2010Hepatonet1MetabolicNetwork(biosim.BioModule):
    """BioModule wrapper for SBML model: Gille2010_HepatoNet1_Metabolic_Network."""

    def __init__(self, model_path: str = "data/MODEL1009150000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Gille2010Hepatonet1MetabolicNetworkModel1009150000Model = SbmlGille2010Hepatonet1MetabolicNetwork
