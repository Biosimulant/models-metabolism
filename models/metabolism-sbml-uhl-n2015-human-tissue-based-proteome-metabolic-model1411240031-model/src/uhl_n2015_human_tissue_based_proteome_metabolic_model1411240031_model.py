...
"""Auto-generated SBML BioModule wrapper for Uhlén2015 - Human tissue-based proteome metabolic network - urinary.

Source: biomodels_ebi:MODEL1411240031
Original: https://www.ebi.ac.uk/biomodels/MODEL1411240031
"""
...
class SbmlUhlen2015HumanTissueBasedProteomeMetabolicNetwork26(biosim.BioModule):
    """BioModule wrapper for SBML model: Uhlén2015 - Human tissue-based proteome metabolic network - urinary."""

    def __init__(self, model_path: str = "data/MODEL1411240031.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
UhlN2015HumanTissueBasedProteomeMetabolicModel1411240031Model = SbmlUhlen2015HumanTissueBasedProteomeMetabolicNetwork26
