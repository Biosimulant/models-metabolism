...
"""Auto-generated SBML BioModule wrapper for Castillo2016 - Whole-genome metabolic model of M.graminicola using CoReCo.

Source: biomodels_ebi:MODEL1604280036
Original: https://www.ebi.ac.uk/biomodels/MODEL1604280036
"""
...
class SbmlCastillo2016WholeGenomeMetabolicModelOfMGraminicola(biosim.BioModule):
    """BioModule wrapper for SBML model: Castillo2016 - Whole-genome metabolic model of M.graminicola using CoReCo."""

    def __init__(self, model_path: str = "data/MODEL1604280036.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Castillo2016WholeGenomeMetabolicModelOfMGModel1604280036Model = SbmlCastillo2016WholeGenomeMetabolicModelOfMGraminicola
