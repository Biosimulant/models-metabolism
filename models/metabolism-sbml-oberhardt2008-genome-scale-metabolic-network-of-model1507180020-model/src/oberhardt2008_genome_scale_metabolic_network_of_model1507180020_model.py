...
"""Auto-generated SBML BioModule wrapper for Oberhardt2008 - Genome-scale metabolic network of Pseudomonas aeruginosa (iMO1056).

Source: biomodels_ebi:MODEL1507180020
Original: https://www.ebi.ac.uk/biomodels/MODEL1507180020
"""
...
class SbmlOberhardt2008GenomeScaleMetabolicNetworkOfPseudomonas(biosim.BioModule):
    """BioModule wrapper for SBML model: Oberhardt2008 - Genome-scale metabolic network of Pseudomonas aeruginosa (iMO1056)."""

    def __init__(self, model_path: str = "data/MODEL1507180020.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Oberhardt2008GenomeScaleMetabolicNetworkOfModel1507180020Model = SbmlOberhardt2008GenomeScaleMetabolicNetworkOfPseudomonas
