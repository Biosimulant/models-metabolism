...
"""Auto-generated SBML BioModule wrapper for Swainston2016 - Reconstruction of human metabolic network (Recon 2.2).

Source: biomodels_ebi:MODEL1603150001
Original: https://www.ebi.ac.uk/biomodels/MODEL1603150001
"""
...
class SbmlSwainston2016ReconstructionOfHumanMetabolicNetwork(biosim.BioModule):
    """BioModule wrapper for SBML model: Swainston2016 - Reconstruction of human metabolic network (Recon 2.2)."""

    def __init__(self, model_path: str = "data/MODEL1603150001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Swainston2016ReconstructionOfHumanMetabolicModel1603150001Model = SbmlSwainston2016ReconstructionOfHumanMetabolicNetwork
