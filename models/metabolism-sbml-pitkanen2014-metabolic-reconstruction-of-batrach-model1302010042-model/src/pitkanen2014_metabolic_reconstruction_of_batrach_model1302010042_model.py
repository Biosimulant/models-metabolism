...
"""Auto-generated SBML BioModule wrapper for Pitkanen2014 - Metabolic reconstruction of Batrachochytrium dendrobatidis using CoReCo.

Source: biomodels_ebi:MODEL1302010042
Original: https://www.ebi.ac.uk/biomodels/MODEL1302010042
"""
...
class SbmlPitkanen2014MetabolicReconstructionOfBatrachochytrium(biosim.BioModule):
    """BioModule wrapper for SBML model: Pitkanen2014 - Metabolic reconstruction of Batrachochytrium dendrobatidis using CoReCo."""

    def __init__(self, model_path: str = "data/MODEL1302010042.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Pitkanen2014MetabolicReconstructionOfBatrachModel1302010042Model = SbmlPitkanen2014MetabolicReconstructionOfBatrachochytrium
