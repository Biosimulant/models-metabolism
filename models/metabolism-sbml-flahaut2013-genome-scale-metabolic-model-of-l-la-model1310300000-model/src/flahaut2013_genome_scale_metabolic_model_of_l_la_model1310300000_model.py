...
"""Auto-generated SBML BioModule wrapper for Flahaut2013 - Genome-scale metabolic model of L.lactis (MG1363).

Source: biomodels_ebi:MODEL1310300000
Original: https://www.ebi.ac.uk/biomodels/MODEL1310300000
"""
...
class SbmlFlahaut2013GenomeScaleMetabolicModelOfLLactisMg1363(biosim.BioModule):
    """BioModule wrapper for SBML model: Flahaut2013 - Genome-scale metabolic model of L.lactis (MG1363)."""

    def __init__(self, model_path: str = "data/MODEL1310300000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Flahaut2013GenomeScaleMetabolicModelOfLLaModel1310300000Model = SbmlFlahaut2013GenomeScaleMetabolicModelOfLLactisMg1363
