...
"""Auto-generated SBML BioModule wrapper for Thiele2013 - Lymph node germinal center cells.

Source: biomodels_ebi:MODEL1310110036
Original: https://www.ebi.ac.uk/biomodels/MODEL1310110036
"""
...
class SbmlThiele2013LymphNodeGerminalCenterCells(biosim.BioModule):
    """BioModule wrapper for SBML model: Thiele2013 - Lymph node germinal center cells."""

    def __init__(self, model_path: str = "data/MODEL1310110036.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Thiele2013LymphNodeGerminalCenterCellsModel1310110036Model = SbmlThiele2013LymphNodeGerminalCenterCells
