...
"""Auto-generated SBML BioModule wrapper for Bekaert2010_rat_inferred_metabolic_network.

Source: biomodels_ebi:MODEL1008120003
Original: https://www.ebi.ac.uk/biomodels/MODEL1008120003
"""
...
class SbmlBekaert2010RatInferredMetabolicNetwork(biosim.BioModule):
    """BioModule wrapper for SBML model: Bekaert2010_rat_inferred_metabolic_network."""

    def __init__(self, model_path: str = "data/MODEL1008120003.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Bekaert2010RatInferredMetabolicNetworkModel1008120003Model = SbmlBekaert2010RatInferredMetabolicNetwork
