...
"""Auto-generated SBML BioModule wrapper for Guo2016 - Bacillus licheniformis (iWX1009).

Source: biomodels_ebi:MODEL2408030002
Original: https://www.ebi.ac.uk/biomodels/MODEL2408030002
"""
...
class SbmlGuo2016BacillusLicheniformisIwx1009(biosim.BioModule):
    """BioModule wrapper for SBML model: Guo2016 - Bacillus licheniformis (iWX1009)."""

    def __init__(self, model_path: str = "data/MODEL2408030002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Guo2016BacillusLicheniformisIwx1009Model2408030002Model = SbmlGuo2016BacillusLicheniformisIwx1009
