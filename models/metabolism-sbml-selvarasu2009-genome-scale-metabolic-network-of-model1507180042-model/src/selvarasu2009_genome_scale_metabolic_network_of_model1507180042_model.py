...
"""Auto-generated SBML BioModule wrapper for Selvarasu2009 - Genome-scale metabolic network of Mus Musculus (iSS724).

Source: biomodels_ebi:MODEL1507180042
Original: https://www.ebi.ac.uk/biomodels/MODEL1507180042
"""
...
class SbmlSelvarasu2009GenomeScaleMetabolicNetworkOfMus(biosim.BioModule):
    """BioModule wrapper for SBML model: Selvarasu2009 - Genome-scale metabolic network of Mus Musculus (iSS724)."""

    def __init__(self, model_path: str = "data/MODEL1507180042.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Selvarasu2009GenomeScaleMetabolicNetworkOfModel1507180042Model = SbmlSelvarasu2009GenomeScaleMetabolicNetworkOfMus
