...
"""Auto-generated SBML BioModule wrapper for Thiele2013 - Human metabolism global reconstruction (Recon 2).

Source: biomodels_ebi:MODEL1109130000
Original: https://www.ebi.ac.uk/biomodels/MODEL1109130000
"""
...
class SbmlThiele2013HumanMetabolismGlobalReconstructionRecon2(biosim.BioModule):
    """BioModule wrapper for SBML model: Thiele2013 - Human metabolism global reconstruction (Recon 2)."""

    def __init__(self, model_path: str = "data/MODEL1109130000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Thiele2013HumanMetabolismGlobalReconstructioModel1109130000Model = SbmlThiele2013HumanMetabolismGlobalReconstructionRecon2
