...
"""Auto-generated SBML BioModule wrapper for Senger2008 - Genome-scale metabolic network of Clostridium acetobutylicum (iCac802).

Source: biomodels_ebi:MODEL1507180027
Original: https://www.ebi.ac.uk/biomodels/MODEL1507180027
"""
...
class SbmlSenger2008GenomeScaleMetabolicNetworkOfClostridium(biosim.BioModule):
    """BioModule wrapper for SBML model: Senger2008 - Genome-scale metabolic network of Clostridium acetobutylicum (iCac802)."""

    def __init__(self, model_path: str = "data/MODEL1507180027.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Senger2008GenomeScaleMetabolicNetworkOfCloModel1507180027Model = SbmlSenger2008GenomeScaleMetabolicNetworkOfClostridium
