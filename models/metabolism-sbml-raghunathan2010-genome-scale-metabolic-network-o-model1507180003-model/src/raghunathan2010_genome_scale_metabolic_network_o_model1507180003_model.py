...
"""Auto-generated SBML BioModule wrapper for Raghunathan2010 - Genome-scale metabolic network of Francisella tularensis (iRS605).

Source: biomodels_ebi:MODEL1507180003
Original: https://www.ebi.ac.uk/biomodels/MODEL1507180003
"""
...
class SbmlRaghunathan2010GenomeScaleMetabolicNetworkOf(biosim.BioModule):
    """BioModule wrapper for SBML model: Raghunathan2010 - Genome-scale metabolic network of Francisella tularensis (iRS605)."""

    def __init__(self, model_path: str = "data/MODEL1507180003.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Raghunathan2010GenomeScaleMetabolicNetworkOModel1507180003Model = SbmlRaghunathan2010GenomeScaleMetabolicNetworkOf
