...
"""Auto-generated SBML BioModule wrapper for Lu2021-Genome scale metabolic model for yeast species of clade CUG-Ala.

Source: biomodels_ebi:MODEL2109130004
Original: https://www.ebi.ac.uk/biomodels/MODEL2109130004
"""
...
class SbmlLu2021GenomeScaleMetabolicModelForYeastSpeciesOf(biosim.BioModule):
    """BioModule wrapper for SBML model: Lu2021-Genome scale metabolic model for yeast species of clade CUG-Ala."""

    def __init__(self, model_path: str = "data/MODEL2109130004.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Lu2021GenomeScaleMetabolicModelForYeastSpModel2109130004Model = SbmlLu2021GenomeScaleMetabolicModelForYeastSpeciesOf
