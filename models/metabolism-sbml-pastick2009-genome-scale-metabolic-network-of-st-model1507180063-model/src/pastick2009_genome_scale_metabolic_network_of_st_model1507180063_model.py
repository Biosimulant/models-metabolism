...
"""Auto-generated SBML BioModule wrapper for Pastick2009 - Genome-scale metabolic network of Streptococcus thermophilus (iMP429).

Source: biomodels_ebi:MODEL1507180063
Original: https://www.ebi.ac.uk/biomodels/MODEL1507180063
"""
...
class SbmlPastick2009GenomeScaleMetabolicNetworkOfStreptococcus(biosim.BioModule):
    """BioModule wrapper for SBML model: Pastick2009 - Genome-scale metabolic network of Streptococcus thermophilus (iMP429)."""

    def __init__(self, model_path: str = "data/MODEL1507180063.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Pastick2009GenomeScaleMetabolicNetworkOfStModel1507180063Model = SbmlPastick2009GenomeScaleMetabolicNetworkOfStreptococcus
