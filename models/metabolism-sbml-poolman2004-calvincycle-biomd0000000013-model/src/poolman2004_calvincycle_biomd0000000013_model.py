...
"""Auto-generated SBML BioModule wrapper for Poolman2004_CalvinCycle.

Source: biomodels_ebi:BIOMD0000000013
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000013
"""
...
class SbmlPoolman2004Calvincycle(biosim.BioModule):
    """BioModule wrapper for SBML model: Poolman2004_CalvinCycle."""

    def __init__(self, model_path: str = "data/BIOMD0000000013.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Poolman2004CalvincycleBiomd0000000013Model = SbmlPoolman2004Calvincycle
