...
"""Auto-generated SBML BioModule wrapper for Zhang2009 - Genome-scale metabolic network of Thermotoga maritima.

Source: biomodels_ebi:MODEL1507180048
Original: https://www.ebi.ac.uk/biomodels/MODEL1507180048
"""
...
class SbmlZhang2009GenomeScaleMetabolicNetworkOfThermotoga(biosim.BioModule):
    """BioModule wrapper for SBML model: Zhang2009 - Genome-scale metabolic network of Thermotoga maritima."""

    def __init__(self, model_path: str = "data/MODEL1507180048.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Zhang2009GenomeScaleMetabolicNetworkOfTherModel1507180048Model = SbmlZhang2009GenomeScaleMetabolicNetworkOfThermotoga
