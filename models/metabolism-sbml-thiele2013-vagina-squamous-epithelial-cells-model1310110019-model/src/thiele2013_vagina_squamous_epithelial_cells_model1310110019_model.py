...
"""Auto-generated SBML BioModule wrapper for Thiele2013 - Vagina squamous epithelial cells.

Source: biomodels_ebi:MODEL1310110019
Original: https://www.ebi.ac.uk/biomodels/MODEL1310110019
"""
...
class SbmlThiele2013VaginaSquamousEpithelialCells(biosim.BioModule):
    """BioModule wrapper for SBML model: Thiele2013 - Vagina squamous epithelial cells."""

    def __init__(self, model_path: str = "data/MODEL1310110019.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Thiele2013VaginaSquamousEpithelialCellsModel1310110019Model = SbmlThiele2013VaginaSquamousEpithelialCells
