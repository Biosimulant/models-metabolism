...
"""Auto-generated SBML BioModule wrapper for Thiele2013 - Kidney cells in tubules.

Source: biomodels_ebi:MODEL1310110047
Original: https://www.ebi.ac.uk/biomodels/MODEL1310110047
"""
...
class SbmlThiele2013KidneyCellsInTubules(biosim.BioModule):
    """BioModule wrapper for SBML model: Thiele2013 - Kidney cells in tubules."""

    def __init__(self, model_path: str = "data/MODEL1310110047.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Thiele2013KidneyCellsInTubulesModel1310110047Model = SbmlThiele2013KidneyCellsInTubules
