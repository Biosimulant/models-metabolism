...
"""Auto-generated SBML BioModule wrapper for Pitkanen2014 - Metabolic reconstruction of Nectria haematococca using CoReCo.

Source: biomodels_ebi:MODEL1302010020
Original: https://www.ebi.ac.uk/biomodels/MODEL1302010020
"""
...
class SbmlPitkanen2014MetabolicReconstructionOfNectria(biosim.BioModule):
    """BioModule wrapper for SBML model: Pitkanen2014 - Metabolic reconstruction of Nectria haematococca using CoReCo."""

    def __init__(self, model_path: str = "data/MODEL1302010020.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Pitkanen2014MetabolicReconstructionOfNectriaModel1302010020Model = SbmlPitkanen2014MetabolicReconstructionOfNectria
