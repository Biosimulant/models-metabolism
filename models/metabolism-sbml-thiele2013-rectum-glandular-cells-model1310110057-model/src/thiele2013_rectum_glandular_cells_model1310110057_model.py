...
"""Auto-generated SBML BioModule wrapper for Thiele2013 - Rectum glandular cells.

Source: biomodels_ebi:MODEL1310110057
Original: https://www.ebi.ac.uk/biomodels/MODEL1310110057
"""
...
class SbmlThiele2013RectumGlandularCells(biosim.BioModule):
    """BioModule wrapper for SBML model: Thiele2013 - Rectum glandular cells."""

    def __init__(self, model_path: str = "data/MODEL1310110057.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Thiele2013RectumGlandularCellsModel1310110057Model = SbmlThiele2013RectumGlandularCells
