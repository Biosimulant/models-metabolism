...
"""Auto-generated SBML BioModule wrapper for González-Domenech2012_MetabolicNetwork_iCG230.

Source: biomodels_ebi:MODEL1110130001
Original: https://www.ebi.ac.uk/biomodels/MODEL1110130001
"""
...
class SbmlGonzalezDomenech2012MetabolicnetworkIcg230(biosim.BioModule):
    """BioModule wrapper for SBML model: González-Domenech2012_MetabolicNetwork_iCG230."""

    def __init__(self, model_path: str = "data/MODEL1110130001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
GonzLezDomenech2012MetabolicnetworkIcg230Model1110130001Model = SbmlGonzalezDomenech2012MetabolicnetworkIcg230
