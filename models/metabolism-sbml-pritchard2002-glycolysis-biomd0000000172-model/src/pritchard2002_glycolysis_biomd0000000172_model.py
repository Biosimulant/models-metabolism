...
"""Auto-generated SBML BioModule wrapper for Pritchard2002_glycolysis.

Source: biomodels_ebi:BIOMD0000000172
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000172
"""
...
class SbmlPritchard2002Glycolysis(biosim.BioModule):
    """BioModule wrapper for SBML model: Pritchard2002_glycolysis."""

    def __init__(self, model_path: str = "data/BIOMD0000000172.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Pritchard2002GlycolysisBiomd0000000172Model = SbmlPritchard2002Glycolysis
