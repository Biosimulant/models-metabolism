...
"""Auto-generated SBML BioModule wrapper for Castillo2016 - Whole-genome metabolic model of M.grisea using CoReCo.

Source: biomodels_ebi:MODEL1604280013
Original: https://www.ebi.ac.uk/biomodels/MODEL1604280013
"""
...
class SbmlCastillo2016WholeGenomeMetabolicModelOfMGriseaUsing(biosim.BioModule):
    """BioModule wrapper for SBML model: Castillo2016 - Whole-genome metabolic model of M.grisea using CoReCo."""

    def __init__(self, model_path: str = "data/MODEL1604280013.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Castillo2016WholeGenomeMetabolicModelOfMGModel1604280013Model = SbmlCastillo2016WholeGenomeMetabolicModelOfMGriseaUsing
