...
"""Auto-generated SBML BioModule wrapper for Thiele2013 - Seminal vesicle glandular cells.

Source: biomodels_ebi:MODEL1310110031
Original: https://www.ebi.ac.uk/biomodels/MODEL1310110031
"""
...
class SbmlThiele2013SeminalVesicleGlandularCells(biosim.BioModule):
    """BioModule wrapper for SBML model: Thiele2013 - Seminal vesicle glandular cells."""

    def __init__(self, model_path: str = "data/MODEL1310110031.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Thiele2013SeminalVesicleGlandularCellsModel1310110031Model = SbmlThiele2013SeminalVesicleGlandularCells
