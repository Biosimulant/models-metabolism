...
"""Auto-generated SBML BioModule wrapper for Castillo2016 - Whole-genome metabolic model of P.nodorum using CoReCo.

Source: biomodels_ebi:MODEL1604280002
Original: https://www.ebi.ac.uk/biomodels/MODEL1604280002
"""
...
class SbmlCastillo2016WholeGenomeMetabolicModelOfPNodorum(biosim.BioModule):
    """BioModule wrapper for SBML model: Castillo2016 - Whole-genome metabolic model of P.nodorum using CoReCo."""

    def __init__(self, model_path: str = "data/MODEL1604280002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Castillo2016WholeGenomeMetabolicModelOfPNModel1604280002Model = SbmlCastillo2016WholeGenomeMetabolicModelOfPNodorum
