...
"""Auto-generated SBML BioModule wrapper for Thiele2013 - Testis Leydig cells.

Source: biomodels_ebi:MODEL1310110008
Original: https://www.ebi.ac.uk/biomodels/MODEL1310110008
"""
...
class SbmlThiele2013TestisLeydigCells(biosim.BioModule):
    """BioModule wrapper for SBML model: Thiele2013 - Testis Leydig cells."""

    def __init__(self, model_path: str = "data/MODEL1310110008.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Thiele2013TestisLeydigCellsModel1310110008Model = SbmlThiele2013TestisLeydigCells
