...
"""Auto-generated SBML BioModule wrapper for Castillo2016 - Whole-genome metabolic model of P.blakesleeanus using CoReCo.

Source: biomodels_ebi:MODEL1604280014
Original: https://www.ebi.ac.uk/biomodels/MODEL1604280014
"""
...
class SbmlCastillo2016WholeGenomeMetabolicModelOfP2(biosim.BioModule):
    """BioModule wrapper for SBML model: Castillo2016 - Whole-genome metabolic model of P.blakesleeanus using CoReCo."""

    def __init__(self, model_path: str = "data/MODEL1604280014.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Castillo2016WholeGenomeMetabolicModelOfPBModel1604280014Model = SbmlCastillo2016WholeGenomeMetabolicModelOfP2
