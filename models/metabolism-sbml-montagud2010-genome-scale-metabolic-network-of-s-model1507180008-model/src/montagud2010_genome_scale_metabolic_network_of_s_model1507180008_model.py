...
"""Auto-generated SBML BioModule wrapper for Montagud2010 - Genome-scale metabolic network of Synechocystis sp. PCC6803 (iSyn669).

Source: biomodels_ebi:MODEL1507180008
Original: https://www.ebi.ac.uk/biomodels/MODEL1507180008
"""
...
class SbmlMontagud2010GenomeScaleMetabolicNetworkOf(biosim.BioModule):
    """BioModule wrapper for SBML model: Montagud2010 - Genome-scale metabolic network of Synechocystis sp. PCC6803 (iSyn669)."""

    def __init__(self, model_path: str = "data/MODEL1507180008.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Montagud2010GenomeScaleMetabolicNetworkOfSModel1507180008Model = SbmlMontagud2010GenomeScaleMetabolicNetworkOf
