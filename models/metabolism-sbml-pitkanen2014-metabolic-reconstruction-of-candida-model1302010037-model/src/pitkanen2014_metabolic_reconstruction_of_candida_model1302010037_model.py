...
"""Auto-generated SBML BioModule wrapper for Pitkanen2014 - Metabolic reconstruction of Candida lusitaniae using CoReCo.

Source: biomodels_ebi:MODEL1302010037
Original: https://www.ebi.ac.uk/biomodels/MODEL1302010037
"""
...
class SbmlPitkanen2014MetabolicReconstructionOfCandidaLusitaniae(biosim.BioModule):
    """BioModule wrapper for SBML model: Pitkanen2014 - Metabolic reconstruction of Candida lusitaniae using CoReCo."""

    def __init__(self, model_path: str = "data/MODEL1302010037.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Pitkanen2014MetabolicReconstructionOfCandidaModel1302010037Model = SbmlPitkanen2014MetabolicReconstructionOfCandidaLusitaniae
