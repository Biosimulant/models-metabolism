...
"""Auto-generated SBML BioModule wrapper for Cifelli2008 - whole-body vitamin A metabolism in humans.

Source: biomodels_ebi:MODEL2403080002
Original: https://www.ebi.ac.uk/biomodels/MODEL2403080002
"""
...
class SbmlCifelli2008WholeBodyVitaminAMetabolismInHumans(biosim.BioModule):
    """BioModule wrapper for SBML model: Cifelli2008 - whole-body vitamin A metabolism in humans."""

    def __init__(self, model_path: str = "data/MODEL2403080002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Cifelli2008WholeBodyVitaminAMetabolismInHModel2403080002Model = SbmlCifelli2008WholeBodyVitaminAMetabolismInHumans
