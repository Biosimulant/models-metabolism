...
"""Auto-generated SBML BioModule wrapper for Lesiczka2024 - Genome-scale Metabolic Model Midichloria mitochondrii.

Source: biomodels_ebi:MODEL2404170001
Original: https://www.ebi.ac.uk/biomodels/MODEL2404170001
"""
...
class SbmlLesiczka2024GenomeScaleMetabolicModelMidichloria(biosim.BioModule):
    """BioModule wrapper for SBML model: Lesiczka2024 - Genome-scale Metabolic Model Midichloria mitochondrii."""

    def __init__(self, model_path: str = "data/MODEL2404170001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Lesiczka2024GenomeScaleMetabolicModelMidichModel2404170001Model = SbmlLesiczka2024GenomeScaleMetabolicModelMidichloria
