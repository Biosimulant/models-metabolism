...
"""Auto-generated SBML BioModule wrapper for Mardinoglu2015 - Curated tissue-specific genome-scale metabolic network - Adipose.

Source: biomodels_ebi:MODEL1509220031
Original: https://www.ebi.ac.uk/biomodels/MODEL1509220031
"""
...
class SbmlMardinoglu2015CuratedTissueSpecificGenomeScale3(biosim.BioModule):
    """BioModule wrapper for SBML model: Mardinoglu2015 - Curated tissue-specific genome-scale metabolic network - Adipose."""

    def __init__(self, model_path: str = "data/MODEL1509220031.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Mardinoglu2015CuratedTissueSpecificGenomeScModel1509220031Model = SbmlMardinoglu2015CuratedTissueSpecificGenomeScale3
