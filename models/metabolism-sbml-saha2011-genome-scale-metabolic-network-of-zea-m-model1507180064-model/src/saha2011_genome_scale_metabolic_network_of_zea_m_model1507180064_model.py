...
"""Auto-generated SBML BioModule wrapper for Saha2011- Genome-scale metabolic network of Zea mays (iRS1563).

Source: biomodels_ebi:MODEL1507180064
Original: https://www.ebi.ac.uk/biomodels/MODEL1507180064
"""
...
class SbmlSaha2011GenomeScaleMetabolicNetworkOfZeaMaysIrs1563(biosim.BioModule):
    """BioModule wrapper for SBML model: Saha2011- Genome-scale metabolic network of Zea mays (iRS1563)."""

    def __init__(self, model_path: str = "data/MODEL1507180064.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Saha2011GenomeScaleMetabolicNetworkOfZeaMModel1507180064Model = SbmlSaha2011GenomeScaleMetabolicNetworkOfZeaMaysIrs1563
