...
"""Auto-generated SBML BioModule wrapper for Yilmaz2020 - iCEL1314 (Tissue relevant C.Elegans metabolism model).

Source: biomodels_ebi:MODEL2007280001
Original: https://www.ebi.ac.uk/biomodels/MODEL2007280001
"""
...
class SbmlYilmaz2020Icel1314TissueRelevantCElegansMetabolism(biosim.BioModule):
    """BioModule wrapper for SBML model: Yilmaz2020 - iCEL1314 (Tissue relevant C.Elegans metabolism model)."""

    def __init__(self, model_path: str = "data/MODEL2007280001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Yilmaz2020Icel1314TissueRelevantCElegansMeModel2007280001Model = SbmlYilmaz2020Icel1314TissueRelevantCElegansMetabolism
