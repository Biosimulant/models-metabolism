...
"""Auto-generated SBML BioModule wrapper for Raghunathan2009 - Genome-scale metabolic network of Salmonella typhimurium (iRR1083).

Source: biomodels_ebi:MODEL1507180058
Original: https://www.ebi.ac.uk/biomodels/MODEL1507180058
"""
...
class SbmlRaghunathan2009GenomeScaleMetabolicNetworkOf(biosim.BioModule):
    """BioModule wrapper for SBML model: Raghunathan2009 - Genome-scale metabolic network of Salmonella typhimurium (iRR1083)."""

    def __init__(self, model_path: str = "data/MODEL1507180058.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Raghunathan2009GenomeScaleMetabolicNetworkOModel1507180058Model = SbmlRaghunathan2009GenomeScaleMetabolicNetworkOf
