...
"""Auto-generated SBML BioModule wrapper for Thiele2013 - Uterus pre menopause cells in endometrial stroma.

Source: biomodels_ebi:MODEL1310110022
Original: https://www.ebi.ac.uk/biomodels/MODEL1310110022
"""
...
class SbmlThiele2013UterusPreMenopauseCellsInEndometrialStroma(biosim.BioModule):
    """BioModule wrapper for SBML model: Thiele2013 - Uterus pre menopause cells in endometrial stroma."""

    def __init__(self, model_path: str = "data/MODEL1310110022.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Thiele2013UterusPreMenopauseCellsInEndometModel1310110022Model = SbmlThiele2013UterusPreMenopauseCellsInEndometrialStroma
