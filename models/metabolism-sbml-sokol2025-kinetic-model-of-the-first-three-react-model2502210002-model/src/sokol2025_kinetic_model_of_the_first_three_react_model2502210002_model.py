...
"""Auto-generated SBML BioModule wrapper for Sokol2025 - Kinetic model of the first three reactions of glycolysis.

Source: biomodels_ebi:MODEL2502210002
Original: https://www.ebi.ac.uk/biomodels/MODEL2502210002
"""
...
class SbmlSokol2025KineticModelOfTheFirstThreeReactionsOf(biosim.BioModule):
    """BioModule wrapper for SBML model: Sokol2025 - Kinetic model of the first three reactions of glycolysis."""

    def __init__(self, model_path: str = "data/MODEL2502210002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Sokol2025KineticModelOfTheFirstThreeReactModel2502210002Model = SbmlSokol2025KineticModelOfTheFirstThreeReactionsOf
