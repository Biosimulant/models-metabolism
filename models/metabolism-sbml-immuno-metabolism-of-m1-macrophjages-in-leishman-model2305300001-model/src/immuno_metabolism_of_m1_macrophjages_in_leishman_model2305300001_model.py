...
"""Auto-generated SBML BioModule wrapper for Immuno-metabolism of M1 macrophjages in leishmaniasis.

Source: biomodels_ebi:MODEL2305300001
Original: https://www.ebi.ac.uk/biomodels/MODEL2305300001
"""
...
class SbmlImmunoMetabolismOfM1MacrophjagesInLeishmaniasis(biosim.BioModule):
    """BioModule wrapper for SBML model: Immuno-metabolism of M1 macrophjages in leishmaniasis."""

    def __init__(self, model_path: str = "data/MODEL2305300001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
ImmunoMetabolismOfM1MacrophjagesInLeishmanModel2305300001Model = SbmlImmunoMetabolismOfM1MacrophjagesInLeishmaniasis
