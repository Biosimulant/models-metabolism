...
"""Auto-generated SBML BioModule wrapper for Smallbone2009 - FBA model-Geometric Perspective.

Source: biomodels_ebi:MODEL1105180000
Original: https://www.ebi.ac.uk/biomodels/MODEL1105180000
"""
...
class SbmlSmallbone2009FbaModelGeometricPerspective(biosim.BioModule):
    """BioModule wrapper for SBML model: Smallbone2009 - FBA model-Geometric Perspective."""

    def __init__(self, model_path: str = "data/MODEL1105180000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Smallbone2009FbaModelGeometricPerspectiveModel1105180000Model = SbmlSmallbone2009FbaModelGeometricPerspective
