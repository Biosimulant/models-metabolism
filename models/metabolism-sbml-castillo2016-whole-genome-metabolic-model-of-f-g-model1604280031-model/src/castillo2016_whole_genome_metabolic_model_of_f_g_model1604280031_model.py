...
"""Auto-generated SBML BioModule wrapper for Castillo2016 - Whole-genome metabolic model of F.graminearum using CoReCo.

Source: biomodels_ebi:MODEL1604280031
Original: https://www.ebi.ac.uk/biomodels/MODEL1604280031
"""
...
class SbmlCastillo2016WholeGenomeMetabolicModelOfFGraminearum(biosim.BioModule):
    """BioModule wrapper for SBML model: Castillo2016 - Whole-genome metabolic model of F.graminearum using CoReCo."""

    def __init__(self, model_path: str = "data/MODEL1604280031.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Castillo2016WholeGenomeMetabolicModelOfFGModel1604280031Model = SbmlCastillo2016WholeGenomeMetabolicModelOfFGraminearum
