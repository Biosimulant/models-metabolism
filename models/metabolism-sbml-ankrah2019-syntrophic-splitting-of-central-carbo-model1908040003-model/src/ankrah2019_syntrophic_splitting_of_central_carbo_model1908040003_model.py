...
"""Auto-generated SBML BioModule wrapper for Ankrah2019 Syntrophic splitting of central carbon metabolism in host cells bearing functionally-different symbiotic bacteria_SulciaClastoptera.

Source: biomodels_ebi:MODEL1908040003
Original: https://www.ebi.ac.uk/biomodels/MODEL1908040003
"""
...
class SbmlAnkrah2019SyntrophicSplittingOfCentralCarbon2(biosim.BioModule):
    """BioModule wrapper for SBML model: Ankrah2019 Syntrophic splitting of central carbon metabolism in host cells bearing functionally-different symbiotic bacteria_SulciaClastoptera."""

    def __init__(self, model_path: str = "data/MODEL1908040003.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Ankrah2019SyntrophicSplittingOfCentralCarboModel1908040003Model = SbmlAnkrah2019SyntrophicSplittingOfCentralCarbon2
