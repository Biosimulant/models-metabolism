...
"""Auto-generated SBML BioModule wrapper for Kim2021 - Development of a Genome-Scale Metabolic Model and Phenome Analysis of the Probiotic Escherichia coli Strain Nissle 1917.

Source: biomodels_ebi:BIOMD0000001062
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000001062
"""
...
class SbmlKim2021DevelopmentOfAGenomeScaleMetabolicModelAnd(biosim.BioModule):
    """BioModule wrapper for SBML model: Kim2021 - Development of a Genome-Scale Metabolic Model and Phenome Analysis of the Probiotic Escherichia coli Strain Nissle 1917."""

    def __init__(self, model_path: str = "data/BIOMD0000001062.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Kim2021DevelopmentOfAGenomeScaleMetabolicBiomd0000001062Model = SbmlKim2021DevelopmentOfAGenomeScaleMetabolicModelAnd
