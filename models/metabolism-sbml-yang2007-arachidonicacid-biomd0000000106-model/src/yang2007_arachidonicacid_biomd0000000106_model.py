...
"""Auto-generated SBML BioModule wrapper for Yang2007_ArachidonicAcid.

Source: biomodels_ebi:BIOMD0000000106
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000106
"""
...
class SbmlYang2007Arachidonicacid(biosim.BioModule):
    """BioModule wrapper for SBML model: Yang2007_ArachidonicAcid."""

    def __init__(self, model_path: str = "data/BIOMD0000000106.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Yang2007ArachidonicacidBiomd0000000106Model = SbmlYang2007Arachidonicacid
