...
"""Auto-generated SBML BioModule wrapper for Shiratsubaki2020 - T. cruzi (iIS312).

Source: biomodels_ebi:MODEL2408050002
Original: https://www.ebi.ac.uk/biomodels/MODEL2408050002
"""
...
class SbmlShiratsubaki2020TCruziIis312(biosim.BioModule):
    """BioModule wrapper for SBML model: Shiratsubaki2020 - T. cruzi (iIS312)."""

    def __init__(self, model_path: str = "data/MODEL2408050002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Shiratsubaki2020TCruziIis312Model2408050002Model = SbmlShiratsubaki2020TCruziIis312
