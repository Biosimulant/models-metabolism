...
"""Auto-generated SBML BioModule wrapper for Pitkanen2014 - Metabolic reconstruction of Candida glabrata using CoReCo.

Source: biomodels_ebi:MODEL1302010028
Original: https://www.ebi.ac.uk/biomodels/MODEL1302010028
"""
...
class SbmlPitkanen2014MetabolicReconstructionOfCandidaGlabrata(biosim.BioModule):
    """BioModule wrapper for SBML model: Pitkanen2014 - Metabolic reconstruction of Candida glabrata using CoReCo."""

    def __init__(self, model_path: str = "data/MODEL1302010028.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Pitkanen2014MetabolicReconstructionOfCandidaModel1302010028Model = SbmlPitkanen2014MetabolicReconstructionOfCandidaGlabrata
