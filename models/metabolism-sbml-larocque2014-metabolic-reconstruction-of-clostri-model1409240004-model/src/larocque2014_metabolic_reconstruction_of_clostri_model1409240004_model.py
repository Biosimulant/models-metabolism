...
"""Auto-generated SBML BioModule wrapper for Larocque2014 - Metabolic reconstruction of Clostridium difficile pathogenic strain 630 (iMLTC806cdf).

Source: biomodels_ebi:MODEL1409240004
Original: https://www.ebi.ac.uk/biomodels/MODEL1409240004
"""
...
class SbmlLarocque2014MetabolicReconstructionOfClostridium(biosim.BioModule):
    """BioModule wrapper for SBML model: Larocque2014 - Metabolic reconstruction of Clostridium difficile pathogenic strain 630 (iMLTC806cdf)."""

    def __init__(self, model_path: str = "data/MODEL1409240004.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Larocque2014MetabolicReconstructionOfClostriModel1409240004Model = SbmlLarocque2014MetabolicReconstructionOfClostridium
