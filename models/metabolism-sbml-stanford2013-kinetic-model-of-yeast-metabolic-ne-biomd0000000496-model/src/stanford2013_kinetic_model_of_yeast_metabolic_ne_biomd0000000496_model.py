...
"""Auto-generated SBML BioModule wrapper for Stanford2013 - Kinetic model of yeast metabolic network (standard).

Source: biomodels_ebi:BIOMD0000000496
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000496
"""
...
class SbmlStanford2013KineticModelOfYeastMetabolicNetwork2(biosim.BioModule):
    """BioModule wrapper for SBML model: Stanford2013 - Kinetic model of yeast metabolic network (standard)."""

    def __init__(self, model_path: str = "data/BIOMD0000000496.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Stanford2013KineticModelOfYeastMetabolicNeBiomd0000000496Model = SbmlStanford2013KineticModelOfYeastMetabolicNetwork2
