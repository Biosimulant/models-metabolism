...
"""Auto-generated SBML BioModule wrapper for Castillo2016 - Whole-genome metabolic model of S.sclerotiorum using CoReCo.

Source: biomodels_ebi:MODEL1604280040
Original: https://www.ebi.ac.uk/biomodels/MODEL1604280040
"""
...
class SbmlCastillo2016WholeGenomeMetabolicModelOfSSclerotiorum(biosim.BioModule):
    """BioModule wrapper for SBML model: Castillo2016 - Whole-genome metabolic model of S.sclerotiorum using CoReCo."""

    def __init__(self, model_path: str = "data/MODEL1604280040.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Castillo2016WholeGenomeMetabolicModelOfSSModel1604280040Model = SbmlCastillo2016WholeGenomeMetabolicModelOfSSclerotiorum
