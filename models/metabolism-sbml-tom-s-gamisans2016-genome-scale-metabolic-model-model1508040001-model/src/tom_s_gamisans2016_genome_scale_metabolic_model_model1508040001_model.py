...
"""Auto-generated SBML BioModule wrapper for Tomàs-Gamisans2016 - Genome-Scale Metabolic Model of Pichia pastoris (version 2).

Source: biomodels_ebi:MODEL1508040001
Original: https://www.ebi.ac.uk/biomodels/MODEL1508040001
"""
...
class SbmlTomasGamisans2016GenomeScaleMetabolicModelOfPichia(biosim.BioModule):
    """BioModule wrapper for SBML model: Tomàs-Gamisans2016 - Genome-Scale Metabolic Model of Pichia pastoris (version 2)."""

    def __init__(self, model_path: str = "data/MODEL1508040001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
TomSGamisans2016GenomeScaleMetabolicModelModel1508040001Model = SbmlTomasGamisans2016GenomeScaleMetabolicModelOfPichia
