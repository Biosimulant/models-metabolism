...
"""Auto-generated SBML BioModule wrapper for Thiele2013 - Lung macrophages.

Source: biomodels_ebi:MODEL1310110051
Original: https://www.ebi.ac.uk/biomodels/MODEL1310110051
"""
...
class SbmlThiele2013LungMacrophages(biosim.BioModule):
    """BioModule wrapper for SBML model: Thiele2013 - Lung macrophages."""

    def __init__(self, model_path: str = "data/MODEL1310110051.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Thiele2013LungMacrophagesModel1310110051Model = SbmlThiele2013LungMacrophages
