...
"""Auto-generated SBML BioModule wrapper for Uhlén2015 - Human tissue-based proteome metabolic network - skin.

Source: biomodels_ebi:MODEL1411240022
Original: https://www.ebi.ac.uk/biomodels/MODEL1411240022
"""
...
class SbmlUhlen2015HumanTissueBasedProteomeMetabolicNetworkSkin(biosim.BioModule):
    """BioModule wrapper for SBML model: Uhlén2015 - Human tissue-based proteome metabolic network - skin."""

    def __init__(self, model_path: str = "data/MODEL1411240022.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
UhlN2015HumanTissueBasedProteomeMetabolicModel1411240022Model = SbmlUhlen2015HumanTissueBasedProteomeMetabolicNetworkSkin
