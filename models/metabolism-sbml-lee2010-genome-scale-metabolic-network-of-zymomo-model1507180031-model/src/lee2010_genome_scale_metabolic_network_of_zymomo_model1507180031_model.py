...
"""Auto-generated SBML BioModule wrapper for Lee2010 - Genome-scale metabolic network of Zymomonas mobilis (iZmobMBEL601).

Source: biomodels_ebi:MODEL1507180031
Original: https://www.ebi.ac.uk/biomodels/MODEL1507180031
"""
...
class SbmlLee2010GenomeScaleMetabolicNetworkOfZymomonasMobilis(biosim.BioModule):
    """BioModule wrapper for SBML model: Lee2010 - Genome-scale metabolic network of Zymomonas mobilis (iZmobMBEL601)."""

    def __init__(self, model_path: str = "data/MODEL1507180031.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Lee2010GenomeScaleMetabolicNetworkOfZymomoModel1507180031Model = SbmlLee2010GenomeScaleMetabolicNetworkOfZymomonasMobilis
