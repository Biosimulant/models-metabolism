...
"""Auto-generated SBML BioModule wrapper for Sohn2012 - Genome-scale metabolic network of Schizosaccharomyces pombe (SpoMBEL1693).

Source: biomodels_ebi:MODEL1507180061
Original: https://www.ebi.ac.uk/biomodels/MODEL1507180061
"""
...
class SbmlSohn2012GenomeScaleMetabolicNetworkOf(biosim.BioModule):
    """BioModule wrapper for SBML model: Sohn2012 - Genome-scale metabolic network of Schizosaccharomyces pombe (SpoMBEL1693)."""

    def __init__(self, model_path: str = "data/MODEL1507180061.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Sohn2012GenomeScaleMetabolicNetworkOfSchizModel1507180061Model = SbmlSohn2012GenomeScaleMetabolicNetworkOf
