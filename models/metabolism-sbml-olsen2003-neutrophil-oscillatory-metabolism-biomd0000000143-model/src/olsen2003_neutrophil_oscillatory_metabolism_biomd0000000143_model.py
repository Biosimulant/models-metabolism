...
"""Auto-generated SBML BioModule wrapper for Olsen2003_neutrophil_oscillatory_metabolism.

Source: biomodels_ebi:BIOMD0000000143
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000143
"""
...
class SbmlOlsen2003NeutrophilOscillatoryMetabolism(biosim.BioModule):
    """BioModule wrapper for SBML model: Olsen2003_neutrophil_oscillatory_metabolism."""

    def __init__(self, model_path: str = "data/BIOMD0000000143.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Olsen2003NeutrophilOscillatoryMetabolismBiomd0000000143Model = SbmlOlsen2003NeutrophilOscillatoryMetabolism
