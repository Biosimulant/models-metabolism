...
"""Auto-generated SBML BioModule wrapper for Pitkanen2014 - Metabolic reconstruction of Aspergillus fumigatus using CoReCo.

Source: biomodels_ebi:MODEL1302010024
Original: https://www.ebi.ac.uk/biomodels/MODEL1302010024
"""
...
class SbmlPitkanen2014MetabolicReconstructionOfAspergillus(biosim.BioModule):
    """BioModule wrapper for SBML model: Pitkanen2014 - Metabolic reconstruction of Aspergillus fumigatus using CoReCo."""

    def __init__(self, model_path: str = "data/MODEL1302010024.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Pitkanen2014MetabolicReconstructionOfAspergiModel1302010024Model = SbmlPitkanen2014MetabolicReconstructionOfAspergillus
