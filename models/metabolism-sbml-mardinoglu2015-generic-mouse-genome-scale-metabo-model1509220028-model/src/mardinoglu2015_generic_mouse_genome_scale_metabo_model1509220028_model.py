...
"""Auto-generated SBML BioModule wrapper for Mardinoglu2015 - Generic mouse genome-scale metabolic network (MMR).

Source: biomodels_ebi:MODEL1509220028
Original: https://www.ebi.ac.uk/biomodels/MODEL1509220028
"""
...
class SbmlMardinoglu2015GenericMouseGenomeScaleMetabolicNetwork(biosim.BioModule):
    """BioModule wrapper for SBML model: Mardinoglu2015 - Generic mouse genome-scale metabolic network (MMR)."""

    def __init__(self, model_path: str = "data/MODEL1509220028.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Mardinoglu2015GenericMouseGenomeScaleMetaboModel1509220028Model = SbmlMardinoglu2015GenericMouseGenomeScaleMetabolicNetwork
