...
"""Auto-generated SBML BioModule wrapper for Smallbone2013 - Glycolysis in S.cerevisiae - Iteration 13.

Source: biomodels_ebi:MODEL1303260013
Original: https://www.ebi.ac.uk/biomodels/MODEL1303260013
"""
...
class SbmlSmallbone2013GlycolysisInSCerevisiaeIteration13(biosim.BioModule):
    """BioModule wrapper for SBML model: Smallbone2013 - Glycolysis in S.cerevisiae - Iteration 13."""

    def __init__(self, model_path: str = "data/MODEL1303260013.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Smallbone2013GlycolysisInSCerevisiaeIteratiModel1303260013Model = SbmlSmallbone2013GlycolysisInSCerevisiaeIteration13
