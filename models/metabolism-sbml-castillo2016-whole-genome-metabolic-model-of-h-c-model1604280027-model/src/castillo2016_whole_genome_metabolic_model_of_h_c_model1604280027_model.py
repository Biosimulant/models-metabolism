...
"""Auto-generated SBML BioModule wrapper for Castillo2016 - Whole-genome metabolic model of H.capsulatum using CoReCo.

Source: biomodels_ebi:MODEL1604280027
Original: https://www.ebi.ac.uk/biomodels/MODEL1604280027
"""
...
class SbmlCastillo2016WholeGenomeMetabolicModelOfHCapsulatum(biosim.BioModule):
    """BioModule wrapper for SBML model: Castillo2016 - Whole-genome metabolic model of H.capsulatum using CoReCo."""

    def __init__(self, model_path: str = "data/MODEL1604280027.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Castillo2016WholeGenomeMetabolicModelOfHCModel1604280027Model = SbmlCastillo2016WholeGenomeMetabolicModelOfHCapsulatum
