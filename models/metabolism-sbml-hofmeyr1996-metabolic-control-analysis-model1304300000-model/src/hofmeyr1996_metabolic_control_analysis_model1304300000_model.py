...
"""Auto-generated SBML BioModule wrapper for Hofmeyr1996 - metabolic control analysis.

Source: biomodels_ebi:MODEL1304300000
Original: https://www.ebi.ac.uk/biomodels/MODEL1304300000
"""
...
class SbmlHofmeyr1996MetabolicControlAnalysis(biosim.BioModule):
    """BioModule wrapper for SBML model: Hofmeyr1996 - metabolic control analysis."""

    def __init__(self, model_path: str = "data/MODEL1304300000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Hofmeyr1996MetabolicControlAnalysisModel1304300000Model = SbmlHofmeyr1996MetabolicControlAnalysis
