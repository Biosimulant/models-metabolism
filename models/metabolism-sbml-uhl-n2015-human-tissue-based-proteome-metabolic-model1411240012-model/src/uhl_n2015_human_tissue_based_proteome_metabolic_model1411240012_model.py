...
"""Auto-generated SBML BioModule wrapper for Uhlén2015 - Human tissue-based proteome metabolic network - liver.

Source: biomodels_ebi:MODEL1411240012
Original: https://www.ebi.ac.uk/biomodels/MODEL1411240012
"""
...
class SbmlUhlen2015HumanTissueBasedProteomeMetabolicNetwork16(biosim.BioModule):
    """BioModule wrapper for SBML model: Uhlén2015 - Human tissue-based proteome metabolic network - liver."""

    def __init__(self, model_path: str = "data/MODEL1411240012.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
UhlN2015HumanTissueBasedProteomeMetabolicModel1411240012Model = SbmlUhlen2015HumanTissueBasedProteomeMetabolicNetwork16
