...
"""Auto-generated SBML BioModule wrapper for Noguchi2013 - Insulin dependent glucose metabolism.

Source: biomodels_ebi:BIOMD0000000482
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000482
"""
...
class SbmlNoguchi2013InsulinDependentGlucoseMetabolism(biosim.BioModule):
    """BioModule wrapper for SBML model: Noguchi2013 - Insulin dependent glucose metabolism."""

    def __init__(self, model_path: str = "data/BIOMD0000000482.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Noguchi2013InsulinDependentGlucoseMetabolismBiomd0000000482Model = SbmlNoguchi2013InsulinDependentGlucoseMetabolism
