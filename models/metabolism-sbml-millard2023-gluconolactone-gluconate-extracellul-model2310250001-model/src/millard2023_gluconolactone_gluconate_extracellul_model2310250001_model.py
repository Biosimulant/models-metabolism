...
"""Auto-generated SBML BioModule wrapper for Millard2023 - Gluconolactone-Gluconate extracellular bypass in Escherichia coli.

Source: biomodels_ebi:MODEL2310250001
Original: https://www.ebi.ac.uk/biomodels/MODEL2310250001
"""
...
class SbmlMillard2023GluconolactoneGluconateExtracellularBypass(biosim.BioModule):
    """BioModule wrapper for SBML model: Millard2023 - Gluconolactone-Gluconate extracellular bypass in Escherichia coli."""

    def __init__(self, model_path: str = "data/MODEL2310250001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Millard2023GluconolactoneGluconateExtracellulModel2310250001Model = SbmlMillard2023GluconolactoneGluconateExtracellularBypass
