...
"""Auto-generated SBML BioModule wrapper for Mirhakkak2023 - Aspergillus fumigatus metabolic models.

Source: biomodels_ebi:MODEL2211100001
Original: https://www.ebi.ac.uk/biomodels/MODEL2211100001
"""
...
class SbmlMirhakkak2023AspergillusFumigatusMetabolicModels(biosim.BioModule):
    """BioModule wrapper for SBML model: Mirhakkak2023 - Aspergillus fumigatus metabolic models."""

    def __init__(self, model_path: str = "data/MODEL2211100001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Mirhakkak2023AspergillusFumigatusMetabolicMoModel2211100001Model = SbmlMirhakkak2023AspergillusFumigatusMetabolicModels
