...
"""Auto-generated SBML BioModule wrapper for Cloutier2009_EnergyMetabolism_ModelE.

Source: biomodels_ebi:MODEL1006230059
Original: https://www.ebi.ac.uk/biomodels/MODEL1006230059
"""
...
class SbmlCloutier2009EnergymetabolismModele(biosim.BioModule):
    """BioModule wrapper for SBML model: Cloutier2009_EnergyMetabolism_ModelE."""

    def __init__(self, model_path: str = "data/MODEL1006230059.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Cloutier2009EnergymetabolismModeleModel1006230059Model = SbmlCloutier2009EnergymetabolismModele
