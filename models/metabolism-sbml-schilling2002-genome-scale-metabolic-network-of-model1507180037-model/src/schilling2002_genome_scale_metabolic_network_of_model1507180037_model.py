...
"""Auto-generated SBML BioModule wrapper for Schilling2002 - Genome-scale metabolic network of Helicobacter pylori (iCS291).

Source: biomodels_ebi:MODEL1507180037
Original: https://www.ebi.ac.uk/biomodels/MODEL1507180037
"""
...
class SbmlSchilling2002GenomeScaleMetabolicNetworkOf(biosim.BioModule):
    """BioModule wrapper for SBML model: Schilling2002 - Genome-scale metabolic network of Helicobacter pylori (iCS291)."""

    def __init__(self, model_path: str = "data/MODEL1507180037.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Schilling2002GenomeScaleMetabolicNetworkOfModel1507180037Model = SbmlSchilling2002GenomeScaleMetabolicNetworkOf
