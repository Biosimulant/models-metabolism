...
"""Auto-generated SBML BioModule wrapper for Cloutier2009 - Brain Energy Metabolism.

Source: biomodels_ebi:BIOMD0000000554
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000554
"""
...
class SbmlCloutier2009BrainEnergyMetabolism(biosim.BioModule):
    """BioModule wrapper for SBML model: Cloutier2009 - Brain Energy Metabolism."""

    def __init__(self, model_path: str = "data/BIOMD0000000554.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Cloutier2009BrainEnergyMetabolismBiomd0000000554Model = SbmlCloutier2009BrainEnergyMetabolism
