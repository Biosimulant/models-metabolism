...
"""Auto-generated SBML BioModule wrapper for Kerkhoven2013 - Glycolysis and Pentose Phosphate Pathway in T.brucei - MODEL B.

Source: biomodels_ebi:BIOMD0000000514
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000514
"""
...
class SbmlKerkhoven2013GlycolysisAndPentosePhosphatePathwayInT(biosim.BioModule):
    """BioModule wrapper for SBML model: Kerkhoven2013 - Glycolysis and Pentose Phosphate Pathway in T.brucei - MODEL B."""

    def __init__(self, model_path: str = "data/BIOMD0000000514.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Kerkhoven2013GlycolysisAndPentosePhosphatePBiomd0000000514Model = SbmlKerkhoven2013GlycolysisAndPentosePhosphatePathwayInT
