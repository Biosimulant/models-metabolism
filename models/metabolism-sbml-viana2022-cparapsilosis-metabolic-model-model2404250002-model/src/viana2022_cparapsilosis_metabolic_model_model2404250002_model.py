...
"""Auto-generated SBML BioModule wrapper for Viana2022 - Cparapsilosis metabolic model.

Source: biomodels_ebi:MODEL2404250002
Original: https://www.ebi.ac.uk/biomodels/MODEL2404250002
"""
...
class SbmlViana2022CparapsilosisMetabolicModel(biosim.BioModule):
    """BioModule wrapper for SBML model: Viana2022 - Cparapsilosis metabolic model."""

    def __init__(self, model_path: str = "data/MODEL2404250002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Viana2022CparapsilosisMetabolicModelModel2404250002Model = SbmlViana2022CparapsilosisMetabolicModel
