...
"""Auto-generated SBML BioModule wrapper for A genome scale metabolic model for Helicobacter pylori26695.

Source: biomodels_ebi:MODEL2404260001
Original: https://www.ebi.ac.uk/biomodels/MODEL2404260001
"""
...
class SbmlAGenomeScaleMetabolicModelForHelicobacterPylori26695(biosim.BioModule):
    """BioModule wrapper for SBML model: A genome scale metabolic model for Helicobacter pylori26695."""

    def __init__(self, model_path: str = "data/MODEL2404260001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
AGenomeScaleMetabolicModelForHelicobacterModel2404260001Model = SbmlAGenomeScaleMetabolicModelForHelicobacterPylori26695
