...
"""Auto-generated SBML BioModule wrapper for Mardinoglu2015 - Curated tissue-specific genome-scale metabolic model - Small intestine.

Source: biomodels_ebi:MODEL1509220032
Original: https://www.ebi.ac.uk/biomodels/MODEL1509220032
"""
...
class SbmlMardinoglu2015CuratedTissueSpecificGenomeScale4(biosim.BioModule):
    """BioModule wrapper for SBML model: Mardinoglu2015 - Curated tissue-specific genome-scale metabolic model - Small intestine."""

    def __init__(self, model_path: str = "data/MODEL1509220032.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Mardinoglu2015CuratedTissueSpecificGenomeScModel1509220032Model = SbmlMardinoglu2015CuratedTissueSpecificGenomeScale4
