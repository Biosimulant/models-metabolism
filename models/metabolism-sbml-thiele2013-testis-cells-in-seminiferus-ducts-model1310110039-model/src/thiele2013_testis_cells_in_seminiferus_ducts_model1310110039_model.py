...
"""Auto-generated SBML BioModule wrapper for Thiele2013 - Testis cells in seminiferus ducts.

Source: biomodels_ebi:MODEL1310110039
Original: https://www.ebi.ac.uk/biomodels/MODEL1310110039
"""
...
class SbmlThiele2013TestisCellsInSeminiferusDucts(biosim.BioModule):
    """BioModule wrapper for SBML model: Thiele2013 - Testis cells in seminiferus ducts."""

    def __init__(self, model_path: str = "data/MODEL1310110039.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Thiele2013TestisCellsInSeminiferusDuctsModel1310110039Model = SbmlThiele2013TestisCellsInSeminiferusDucts
