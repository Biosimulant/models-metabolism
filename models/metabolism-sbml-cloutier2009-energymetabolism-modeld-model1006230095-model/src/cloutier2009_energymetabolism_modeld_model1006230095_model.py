...
"""Auto-generated SBML BioModule wrapper for Cloutier2009_EnergyMetabolism_ModelD.

Source: biomodels_ebi:MODEL1006230095
Original: https://www.ebi.ac.uk/biomodels/MODEL1006230095
"""
...
class SbmlCloutier2009EnergymetabolismModeld(biosim.BioModule):
    """BioModule wrapper for SBML model: Cloutier2009_EnergyMetabolism_ModelD."""

    def __init__(self, model_path: str = "data/MODEL1006230095.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Cloutier2009EnergymetabolismModeldModel1006230095Model = SbmlCloutier2009EnergymetabolismModeld
