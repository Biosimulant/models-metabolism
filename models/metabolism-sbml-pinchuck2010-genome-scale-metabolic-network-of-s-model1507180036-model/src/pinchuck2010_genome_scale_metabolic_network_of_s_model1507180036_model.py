...
"""Auto-generated SBML BioModule wrapper for Pinchuck2010 - Genome-scale metabolic network of Shewanella oneidensis (iSO783).

Source: biomodels_ebi:MODEL1507180036
Original: https://www.ebi.ac.uk/biomodels/MODEL1507180036
"""
...
class SbmlPinchuck2010GenomeScaleMetabolicNetworkOfShewanella(biosim.BioModule):
    """BioModule wrapper for SBML model: Pinchuck2010 - Genome-scale metabolic network of Shewanella oneidensis (iSO783)."""

    def __init__(self, model_path: str = "data/MODEL1507180036.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Pinchuck2010GenomeScaleMetabolicNetworkOfSModel1507180036Model = SbmlPinchuck2010GenomeScaleMetabolicNetworkOfShewanella
