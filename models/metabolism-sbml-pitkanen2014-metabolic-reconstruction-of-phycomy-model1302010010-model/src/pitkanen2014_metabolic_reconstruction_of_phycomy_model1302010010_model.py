...
"""Auto-generated SBML BioModule wrapper for Pitkanen2014 - Metabolic reconstruction of Phycomyces blakesleeanus using CoReCo.

Source: biomodels_ebi:MODEL1302010010
Original: https://www.ebi.ac.uk/biomodels/MODEL1302010010
"""
...
class SbmlPitkanen2014MetabolicReconstructionOfPhycomyces(biosim.BioModule):
    """BioModule wrapper for SBML model: Pitkanen2014 - Metabolic reconstruction of Phycomyces blakesleeanus using CoReCo."""

    def __init__(self, model_path: str = "data/MODEL1302010010.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Pitkanen2014MetabolicReconstructionOfPhycomyModel1302010010Model = SbmlPitkanen2014MetabolicReconstructionOfPhycomyces
