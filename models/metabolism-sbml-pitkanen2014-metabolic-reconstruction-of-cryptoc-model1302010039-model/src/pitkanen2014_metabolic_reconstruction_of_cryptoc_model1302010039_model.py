...
"""Auto-generated SBML BioModule wrapper for Pitkanen2014 - Metabolic reconstruction of Cryptococcus neoformans using CoReCo.

Source: biomodels_ebi:MODEL1302010039
Original: https://www.ebi.ac.uk/biomodels/MODEL1302010039
"""
...
class SbmlPitkanen2014MetabolicReconstructionOfCryptococcus(biosim.BioModule):
    """BioModule wrapper for SBML model: Pitkanen2014 - Metabolic reconstruction of Cryptococcus neoformans using CoReCo."""

    def __init__(self, model_path: str = "data/MODEL1302010039.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Pitkanen2014MetabolicReconstructionOfCryptocModel1302010039Model = SbmlPitkanen2014MetabolicReconstructionOfCryptococcus
