...
"""Auto-generated SBML BioModule wrapper for Pitkanen2014 - Metabolic reconstruction of Phanerochaete chrysosporium using CoReCo.

Source: biomodels_ebi:MODEL1302010025
Original: https://www.ebi.ac.uk/biomodels/MODEL1302010025
"""
...
class SbmlPitkanen2014MetabolicReconstructionOfPhanerochaete(biosim.BioModule):
    """BioModule wrapper for SBML model: Pitkanen2014 - Metabolic reconstruction of Phanerochaete chrysosporium using CoReCo."""

    def __init__(self, model_path: str = "data/MODEL1302010025.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Pitkanen2014MetabolicReconstructionOfPhaneroModel1302010025Model = SbmlPitkanen2014MetabolicReconstructionOfPhanerochaete
