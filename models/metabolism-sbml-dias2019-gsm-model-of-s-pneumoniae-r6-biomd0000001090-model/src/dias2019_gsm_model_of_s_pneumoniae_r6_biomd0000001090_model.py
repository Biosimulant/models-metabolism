...
"""Auto-generated SBML BioModule wrapper for Dias2019 - GSM model of S. pneumoniae R6.

Source: biomodels_ebi:BIOMD0000001090
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000001090
"""
...
class SbmlDias2019GsmModelOfSPneumoniaeR6(biosim.BioModule):
    """BioModule wrapper for SBML model: Dias2019 - GSM model of S. pneumoniae R6."""

    def __init__(self, model_path: str = "data/BIOMD0000001090.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Dias2019GsmModelOfSPneumoniaeR6Biomd0000001090Model = SbmlDias2019GsmModelOfSPneumoniaeR6
