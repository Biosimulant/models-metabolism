...
"""Auto-generated SBML BioModule wrapper for Archer2011 - Genome-scale metabolic model of Escherichia coli (iCA1273).

Source: biomodels_ebi:MODEL1507180010
Original: https://www.ebi.ac.uk/biomodels/MODEL1507180010
"""
...
class SbmlArcher2011GenomeScaleMetabolicModelOfEscherichiaColi(biosim.BioModule):
    """BioModule wrapper for SBML model: Archer2011 - Genome-scale metabolic model of Escherichia coli (iCA1273)."""

    def __init__(self, model_path: str = "data/MODEL1507180010.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Archer2011GenomeScaleMetabolicModelOfEscheModel1507180010Model = SbmlArcher2011GenomeScaleMetabolicModelOfEscherichiaColi
