...
"""Auto-generated SBML BioModule wrapper for Dvarak2020 - PXR targeting using microbial metabolite mimicry.

Source: biomodels_ebi:MODEL2002050001
Original: https://www.ebi.ac.uk/biomodels/MODEL2002050001
"""
...
class SbmlDvarak2020PxrTargetingUsingMicrobialMetaboliteMimicry(biosim.BioModule):
    """BioModule wrapper for SBML model: Dvarak2020 - PXR targeting using microbial metabolite mimicry."""

    def __init__(self, model_path: str = "data/MODEL2002050001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Dvarak2020PxrTargetingUsingMicrobialMetabolModel2002050001Model = SbmlDvarak2020PxrTargetingUsingMicrobialMetaboliteMimicry
