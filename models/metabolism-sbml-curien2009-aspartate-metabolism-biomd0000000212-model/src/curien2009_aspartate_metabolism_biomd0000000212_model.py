...
"""Auto-generated SBML BioModule wrapper for Curien2009_Aspartate_Metabolism.

Source: biomodels_ebi:BIOMD0000000212
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000212
"""
...
class SbmlCurien2009AspartateMetabolism(biosim.BioModule):
    """BioModule wrapper for SBML model: Curien2009_Aspartate_Metabolism."""

    def __init__(self, model_path: str = "data/BIOMD0000000212.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Curien2009AspartateMetabolismBiomd0000000212Model = SbmlCurien2009AspartateMetabolism
