...
"""Auto-generated SBML BioModule wrapper for Caspeta2012 - Genome-scale metabolic network of Pichia stipitis (iSS884).

Source: biomodels_ebi:MODEL1507180022
Original: https://www.ebi.ac.uk/biomodels/MODEL1507180022
"""
...
class SbmlCaspeta2012GenomeScaleMetabolicNetworkOfPichia(biosim.BioModule):
    """BioModule wrapper for SBML model: Caspeta2012 - Genome-scale metabolic network of Pichia stipitis (iSS884)."""

    def __init__(self, model_path: str = "data/MODEL1507180022.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Caspeta2012GenomeScaleMetabolicNetworkOfPiModel1507180022Model = SbmlCaspeta2012GenomeScaleMetabolicNetworkOfPichia
