...
"""Auto-generated SBML BioModule wrapper for Thiele2013 - Hippocampus glial cells.

Source: biomodels_ebi:MODEL1310110005
Original: https://www.ebi.ac.uk/biomodels/MODEL1310110005
"""
...
class SbmlThiele2013HippocampusGlialCells(biosim.BioModule):
    """BioModule wrapper for SBML model: Thiele2013 - Hippocampus glial cells."""

    def __init__(self, model_path: str = "data/MODEL1310110005.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Thiele2013HippocampusGlialCellsModel1310110005Model = SbmlThiele2013HippocampusGlialCells
