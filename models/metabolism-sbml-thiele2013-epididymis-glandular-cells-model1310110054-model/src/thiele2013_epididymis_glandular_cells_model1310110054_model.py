...
"""Auto-generated SBML BioModule wrapper for Thiele2013 - Epididymis glandular cells.

Source: biomodels_ebi:MODEL1310110054
Original: https://www.ebi.ac.uk/biomodels/MODEL1310110054
"""
...
class SbmlThiele2013EpididymisGlandularCells(biosim.BioModule):
    """BioModule wrapper for SBML model: Thiele2013 - Epididymis glandular cells."""

    def __init__(self, model_path: str = "data/MODEL1310110054.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Thiele2013EpididymisGlandularCellsModel1310110054Model = SbmlThiele2013EpididymisGlandularCells
