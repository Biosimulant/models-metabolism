...
"""Auto-generated SBML BioModule wrapper for Smallbone2013 - Metabolic Control Analysis - Example 2.

Source: biomodels_ebi:BIOMD0000000455
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000455
"""
...
class SbmlSmallbone2013MetabolicControlAnalysisExample2(biosim.BioModule):
    """BioModule wrapper for SBML model: Smallbone2013 - Metabolic Control Analysis - Example 2."""

    def __init__(self, model_path: str = "data/BIOMD0000000455.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Smallbone2013MetabolicControlAnalysisExampleBiomd0000000455Model = SbmlSmallbone2013MetabolicControlAnalysisExample2
