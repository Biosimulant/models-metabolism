...
"""Auto-generated SBML BioModule wrapper for Ahmad2017 - Genome-scale metabolic model (iGT736) of Geobacillus thermoglucosidasius (C56-YS93).

Source: biomodels_ebi:MODEL1703060000
Original: https://www.ebi.ac.uk/biomodels/MODEL1703060000
"""
...
class SbmlAhmad2017GenomeScaleMetabolicModelIgt736Of(biosim.BioModule):
    """BioModule wrapper for SBML model: Ahmad2017 - Genome-scale metabolic model (iGT736) of Geobacillus thermoglucosidasius (C56-YS93)."""

    def __init__(self, model_path: str = "data/MODEL1703060000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Ahmad2017GenomeScaleMetabolicModelIgt736OfModel1703060000Model = SbmlAhmad2017GenomeScaleMetabolicModelIgt736Of
