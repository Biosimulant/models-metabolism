...
"""Auto-generated SBML BioModule wrapper for Thiele2013 - Colon glandular cells.

Source: biomodels_ebi:MODEL1310110043
Original: https://www.ebi.ac.uk/biomodels/MODEL1310110043
"""
...
class SbmlThiele2013ColonGlandularCells(biosim.BioModule):
    """BioModule wrapper for SBML model: Thiele2013 - Colon glandular cells."""

    def __init__(self, model_path: str = "data/MODEL1310110043.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Thiele2013ColonGlandularCellsModel1310110043Model = SbmlThiele2013ColonGlandularCells
