...
"""Auto-generated SBML BioModule wrapper for Mazumdar2008 - Genome-scale metabolic network of Porphyromonas gingivalis (iVM679).

Source: biomodels_ebi:MODEL1507180038
Original: https://www.ebi.ac.uk/biomodels/MODEL1507180038
"""
...
class SbmlMazumdar2008GenomeScaleMetabolicNetworkOf(biosim.BioModule):
    """BioModule wrapper for SBML model: Mazumdar2008 - Genome-scale metabolic network of Porphyromonas gingivalis (iVM679)."""

    def __init__(self, model_path: str = "data/MODEL1507180038.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Mazumdar2008GenomeScaleMetabolicNetworkOfPModel1507180038Model = SbmlMazumdar2008GenomeScaleMetabolicNetworkOf
