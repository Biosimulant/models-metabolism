...
"""Auto-generated SBML BioModule wrapper for Lu2021-Genome scale metabolic models for yeast species of clade Saccharomycetaceae.

Source: biomodels_ebi:MODEL2109130010
Original: https://www.ebi.ac.uk/biomodels/MODEL2109130010
"""
...
class SbmlLu2021GenomeScaleMetabolicModelsForYeastSpeciesOf8(biosim.BioModule):
    """BioModule wrapper for SBML model: Lu2021-Genome scale metabolic models for yeast species of clade Saccharomycetaceae."""

    def __init__(self, model_path: str = "data/MODEL2109130010.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Lu2021GenomeScaleMetabolicModelsForYeastSModel2109130010Model = SbmlLu2021GenomeScaleMetabolicModelsForYeastSpeciesOf8
