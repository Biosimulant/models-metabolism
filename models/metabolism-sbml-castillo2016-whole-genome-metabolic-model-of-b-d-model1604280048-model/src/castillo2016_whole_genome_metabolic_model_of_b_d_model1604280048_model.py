...
"""Auto-generated SBML BioModule wrapper for Castillo2016 - Whole-genome metabolic model of B.dendrobatidis using CoReCo.

Source: biomodels_ebi:MODEL1604280048
Original: https://www.ebi.ac.uk/biomodels/MODEL1604280048
"""
...
class SbmlCastillo2016WholeGenomeMetabolicModelOfB(biosim.BioModule):
    """BioModule wrapper for SBML model: Castillo2016 - Whole-genome metabolic model of B.dendrobatidis using CoReCo."""

    def __init__(self, model_path: str = "data/MODEL1604280048.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Castillo2016WholeGenomeMetabolicModelOfBDModel1604280048Model = SbmlCastillo2016WholeGenomeMetabolicModelOfB
