...
"""Auto-generated SBML BioModule wrapper for Blow2020 - Aphid Buchnera Hamiltonella multi-compartment metabolic model.

Source: biomodels_ebi:MODEL2001310002
Original: https://www.ebi.ac.uk/biomodels/MODEL2001310002
"""
...
class SbmlBlow2020AphidBuchneraHamiltonellaMultiCompartment(biosim.BioModule):
    """BioModule wrapper for SBML model: Blow2020 - Aphid Buchnera Hamiltonella multi-compartment metabolic model."""

    def __init__(self, model_path: str = "data/MODEL2001310002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Blow2020AphidBuchneraHamiltonellaMultiCompaModel2001310002Model = SbmlBlow2020AphidBuchneraHamiltonellaMultiCompartment
