...
"""Auto-generated SBML BioModule wrapper for Kolbe2019 - Spatio-temporal liver zonation.

Source: biomodels_ebi:MODEL2009110001
Original: https://www.ebi.ac.uk/biomodels/MODEL2009110001
"""
...
class SbmlKolbe2019SpatioTemporalLiverZonation(biosim.BioModule):
    """BioModule wrapper for SBML model: Kolbe2019 - Spatio-temporal liver zonation."""

    def __init__(self, model_path: str = "data/MODEL2009110001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Kolbe2019SpatioTemporalLiverZonationModel2009110001Model = SbmlKolbe2019SpatioTemporalLiverZonation
