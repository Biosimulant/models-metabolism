...
"""Auto-generated SBML BioModule wrapper for Zakhartsev2022 - Constraint-based model of metabolism of Atlantic salmon (Salmo salar).

Source: biomodels_ebi:MODEL2207070001
Original: https://www.ebi.ac.uk/biomodels/MODEL2207070001
"""
...
class SbmlZakhartsev2022ConstraintBasedModelOfMetabolismOf(biosim.BioModule):
    """BioModule wrapper for SBML model: Zakhartsev2022 - Constraint-based model of metabolism of Atlantic salmon (Salmo salar)."""

    def __init__(self, model_path: str = "data/MODEL2207070001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Zakhartsev2022ConstraintBasedModelOfMetabolModel2207070001Model = SbmlZakhartsev2022ConstraintBasedModelOfMetabolismOf
