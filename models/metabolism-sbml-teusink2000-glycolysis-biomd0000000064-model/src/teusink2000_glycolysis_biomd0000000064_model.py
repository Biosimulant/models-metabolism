...
"""Auto-generated SBML BioModule wrapper for Teusink2000_Glycolysis.

Source: biomodels_ebi:BIOMD0000000064
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000064
"""
...
class SbmlTeusink2000Glycolysis(biosim.BioModule):
    """BioModule wrapper for SBML model: Teusink2000_Glycolysis."""

    def __init__(self, model_path: str = "data/BIOMD0000000064.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Teusink2000GlycolysisBiomd0000000064Model = SbmlTeusink2000Glycolysis
