...
"""Auto-generated SBML BioModule wrapper for Thiele2013 - Lateral ventricle neuronal cells.

Source: biomodels_ebi:MODEL1310110040
Original: https://www.ebi.ac.uk/biomodels/MODEL1310110040
"""
...
class SbmlThiele2013LateralVentricleNeuronalCells(biosim.BioModule):
    """BioModule wrapper for SBML model: Thiele2013 - Lateral ventricle neuronal cells."""

    def __init__(self, model_path: str = "data/MODEL1310110040.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Thiele2013LateralVentricleNeuronalCellsModel1310110040Model = SbmlThiele2013LateralVentricleNeuronalCells
