...
"""Auto-generated SBML BioModule wrapper for Thiele2013 - Prostate glandular cells.

Source: biomodels_ebi:MODEL1310110018
Original: https://www.ebi.ac.uk/biomodels/MODEL1310110018
"""
...
class SbmlThiele2013ProstateGlandularCells(biosim.BioModule):
    """BioModule wrapper for SBML model: Thiele2013 - Prostate glandular cells."""

    def __init__(self, model_path: str = "data/MODEL1310110018.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Thiele2013ProstateGlandularCellsModel1310110018Model = SbmlThiele2013ProstateGlandularCells
