...
"""Auto-generated SBML BioModule wrapper for iCTUB2024RM - Genome-scale metabolic model of Corynebacterium tuberculostearicum strain DSM 44922.

Source: biomodels_ebi:MODEL2407310001
Original: https://www.ebi.ac.uk/biomodels/MODEL2407310001
"""
...
class SbmlIctub2024rmGenomeScaleMetabolicModelOfCorynebacterium(biosim.BioModule):
    """BioModule wrapper for SBML model: iCTUB2024RM - Genome-scale metabolic model of Corynebacterium tuberculostearicum strain DSM 44922."""

    def __init__(self, model_path: str = "data/MODEL2407310001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Ictub2024rmGenomeScaleMetabolicModelOfCoryModel2407310001Model = SbmlIctub2024rmGenomeScaleMetabolicModelOfCorynebacterium
