...
"""Auto-generated SBML BioModule wrapper for Pitkanen2014 - Metabolic reconstruction of Laccaria bicolor using CoReCo.

Source: biomodels_ebi:MODEL1302010041
Original: https://www.ebi.ac.uk/biomodels/MODEL1302010041
"""
...
class SbmlPitkanen2014MetabolicReconstructionOfLaccariaBicolor(biosim.BioModule):
    """BioModule wrapper for SBML model: Pitkanen2014 - Metabolic reconstruction of Laccaria bicolor using CoReCo."""

    def __init__(self, model_path: str = "data/MODEL1302010041.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Pitkanen2014MetabolicReconstructionOfLaccariModel1302010041Model = SbmlPitkanen2014MetabolicReconstructionOfLaccariaBicolor
