...
"""Auto-generated SBML BioModule wrapper for Oliveira2005 - Genome-scale metabolic network of Lactococcus lactis (iAO358).

Source: biomodels_ebi:MODEL1507180014
Original: https://www.ebi.ac.uk/biomodels/MODEL1507180014
"""
...
class SbmlOliveira2005GenomeScaleMetabolicNetworkOfLactococcus(biosim.BioModule):
    """BioModule wrapper for SBML model: Oliveira2005 - Genome-scale metabolic network of Lactococcus lactis (iAO358)."""

    def __init__(self, model_path: str = "data/MODEL1507180014.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Oliveira2005GenomeScaleMetabolicNetworkOfLModel1507180014Model = SbmlOliveira2005GenomeScaleMetabolicNetworkOfLactococcus
