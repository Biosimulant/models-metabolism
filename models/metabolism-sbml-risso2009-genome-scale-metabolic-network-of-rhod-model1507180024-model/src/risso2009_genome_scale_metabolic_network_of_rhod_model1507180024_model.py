...
"""Auto-generated SBML BioModule wrapper for Risso2009 - Genome-scale metabolic network of Rhodoferax ferrireducens (iCR744).

Source: biomodels_ebi:MODEL1507180024
Original: https://www.ebi.ac.uk/biomodels/MODEL1507180024
"""
...
class SbmlRisso2009GenomeScaleMetabolicNetworkOfRhodoferax(biosim.BioModule):
    """BioModule wrapper for SBML model: Risso2009 - Genome-scale metabolic network of Rhodoferax ferrireducens (iCR744)."""

    def __init__(self, model_path: str = "data/MODEL1507180024.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Risso2009GenomeScaleMetabolicNetworkOfRhodModel1507180024Model = SbmlRisso2009GenomeScaleMetabolicNetworkOfRhodoferax
