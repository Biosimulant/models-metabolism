...
"""Auto-generated SBML BioModule wrapper for Imam2013 - Metabolic network in Rhodobacter sphaeroides (iRsp1140).

Source: biomodels_ebi:MODEL1304240000
Original: https://www.ebi.ac.uk/biomodels/MODEL1304240000
"""
...
class SbmlImam2013MetabolicNetworkInRhodobacterSphaeroides(biosim.BioModule):
    """BioModule wrapper for SBML model: Imam2013 - Metabolic network in Rhodobacter sphaeroides (iRsp1140)."""

    def __init__(self, model_path: str = "data/MODEL1304240000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Imam2013MetabolicNetworkInRhodobacterSphaerModel1304240000Model = SbmlImam2013MetabolicNetworkInRhodobacterSphaeroides
