...
"""Auto-generated SBML BioModule wrapper for Tiago2010_FeMetabolism_FeDeficient.

Source: biomodels_ebi:BIOMD0000000259
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000259
"""
...
class SbmlTiago2010FemetabolismFedeficient(biosim.BioModule):
    """BioModule wrapper for SBML model: Tiago2010_FeMetabolism_FeDeficient."""

    def __init__(self, model_path: str = "data/BIOMD0000000259.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Tiago2010FemetabolismFedeficientBiomd0000000259Model = SbmlTiago2010FemetabolismFedeficient
