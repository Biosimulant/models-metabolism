...
"""Auto-generated SBML BioModule wrapper for Aubert2005 - Interaction between astrocytes and neurons on energy metabolism.

Source: biomodels_ebi:MODEL1411210000
Original: https://www.ebi.ac.uk/biomodels/MODEL1411210000
"""
...
class SbmlAubert2005InteractionBetweenAstrocytesAndNeuronsOn(biosim.BioModule):
    """BioModule wrapper for SBML model: Aubert2005 - Interaction between astrocytes and neurons on energy metabolism."""

    def __init__(self, model_path: str = "data/MODEL1411210000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Aubert2005InteractionBetweenAstrocytesAndNeModel1411210000Model = SbmlAubert2005InteractionBetweenAstrocytesAndNeuronsOn
