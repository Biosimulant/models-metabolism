...
"""Auto-generated SBML BioModule wrapper for Gaspari2019 - iEG158_mpn genome-scale metabolic model of Mycoplasma pneumoniae strain M129.

Source: biomodels_ebi:MODEL1912060001
Original: https://www.ebi.ac.uk/biomodels/MODEL1912060001
"""
...
class SbmlGaspari2019Ieg158MpnGenomeScaleMetabolicModelOf(biosim.BioModule):
    """BioModule wrapper for SBML model: Gaspari2019 - iEG158_mpn genome-scale metabolic model of Mycoplasma pneumoniae strain M129."""

    def __init__(self, model_path: str = "data/MODEL1912060001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Gaspari2019Ieg158MpnGenomeScaleMetabolicMoModel1912060001Model = SbmlGaspari2019Ieg158MpnGenomeScaleMetabolicModelOf
