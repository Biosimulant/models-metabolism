...
"""Auto-generated SBML BioModule wrapper for Klipp2002_MetabolicOptimization_linearPathway(n=2).

Source: biomodels_ebi:BIOMD0000000104
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000104
"""
...
class SbmlKlipp2002MetabolicoptimizationLinearpathwayN2(biosim.BioModule):
    """BioModule wrapper for SBML model: Klipp2002_MetabolicOptimization_linearPathway(n=2)."""

    def __init__(self, model_path: str = "data/BIOMD0000000104.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Klipp2002MetabolicoptimizationLinearpathwayNBiomd0000000104Model = SbmlKlipp2002MetabolicoptimizationLinearpathwayN2
