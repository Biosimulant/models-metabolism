...
"""Auto-generated SBML BioModule wrapper for Thomas2014 - The effect of aspirin resistance on platelet metabolism (constraint-based modelling).

Source: biomodels_ebi:MODEL1401290000
Original: https://www.ebi.ac.uk/biomodels/MODEL1401290000
"""
...
class SbmlThomas2014TheEffectOfAspirinResistanceOnPlatelet(biosim.BioModule):
    """BioModule wrapper for SBML model: Thomas2014 - The effect of aspirin resistance on platelet metabolism (constraint-based modelling)."""

    def __init__(self, model_path: str = "data/MODEL1401290000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Thomas2014TheEffectOfAspirinResistanceOnPModel1401290000Model = SbmlThomas2014TheEffectOfAspirinResistanceOnPlatelet
