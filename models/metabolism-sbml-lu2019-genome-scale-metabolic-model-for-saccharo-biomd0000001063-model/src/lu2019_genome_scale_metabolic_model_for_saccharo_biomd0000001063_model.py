...
"""Auto-generated SBML BioModule wrapper for Lu2019 - Genome scale metabolic model for Saccharomyces cerevisiae - yeastGEM8.5.0.

Source: biomodels_ebi:BIOMD0000001063
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000001063
"""
...
class SbmlLu2019GenomeScaleMetabolicModelForSaccharomyces(biosim.BioModule):
    """BioModule wrapper for SBML model: Lu2019 - Genome scale metabolic model for Saccharomyces cerevisiae - yeastGEM8.5.0."""

    def __init__(self, model_path: str = "data/BIOMD0000001063.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Lu2019GenomeScaleMetabolicModelForSaccharoBiomd0000001063Model = SbmlLu2019GenomeScaleMetabolicModelForSaccharomyces
