...
"""Auto-generated SBML BioModule wrapper for Castillo2016 - Whole-genome metabolic model of T.atroviride using CoReCo.

Source: biomodels_ebi:MODEL1604280054
Original: https://www.ebi.ac.uk/biomodels/MODEL1604280054
"""
...
class SbmlCastillo2016WholeGenomeMetabolicModelOfTAtroviride(biosim.BioModule):
    """BioModule wrapper for SBML model: Castillo2016 - Whole-genome metabolic model of T.atroviride using CoReCo."""

    def __init__(self, model_path: str = "data/MODEL1604280054.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Castillo2016WholeGenomeMetabolicModelOfTAModel1604280054Model = SbmlCastillo2016WholeGenomeMetabolicModelOfTAtroviride
