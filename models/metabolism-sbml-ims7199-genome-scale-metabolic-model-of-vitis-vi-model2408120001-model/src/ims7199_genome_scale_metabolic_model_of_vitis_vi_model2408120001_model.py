...
"""Auto-generated SBML BioModule wrapper for iMS7199 - genome-scale metabolic model of Vitis vinifera.

Source: biomodels_ebi:MODEL2408120001
Original: https://www.ebi.ac.uk/biomodels/MODEL2408120001
"""
...
class SbmlIms7199GenomeScaleMetabolicModelOfVitisVinifera(biosim.BioModule):
    """BioModule wrapper for SBML model: iMS7199 - genome-scale metabolic model of Vitis vinifera."""

    def __init__(self, model_path: str = "data/MODEL2408120001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Ims7199GenomeScaleMetabolicModelOfVitisViModel2408120001Model = SbmlIms7199GenomeScaleMetabolicModelOfVitisVinifera
