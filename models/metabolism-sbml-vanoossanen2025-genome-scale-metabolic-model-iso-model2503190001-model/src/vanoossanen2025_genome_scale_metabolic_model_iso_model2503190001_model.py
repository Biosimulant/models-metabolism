...
"""Auto-generated SBML BioModule wrapper for vanOossanen2025 - Genome-scale metabolic model iSO1949_N.oceanica for light-dependent modeling of central carbon, lipid, and pigment metabolism.

Source: biomodels_ebi:MODEL2503190001
Original: https://www.ebi.ac.uk/biomodels/MODEL2503190001
"""
...
class SbmlVanoossanen2025GenomeScaleMetabolicModelIso1949N(biosim.BioModule):
    """BioModule wrapper for SBML model: vanOossanen2025 - Genome-scale metabolic model iSO1949_N.oceanica for light-dependent modeling of central carbon, lipid, and pigment metabolism."""

    def __init__(self, model_path: str = "data/MODEL2503190001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Vanoossanen2025GenomeScaleMetabolicModelIsoModel2503190001Model = SbmlVanoossanen2025GenomeScaleMetabolicModelIso1949N
