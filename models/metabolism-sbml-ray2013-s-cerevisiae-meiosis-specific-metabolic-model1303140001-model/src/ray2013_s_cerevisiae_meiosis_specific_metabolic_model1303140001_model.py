...
"""Auto-generated SBML BioModule wrapper for Ray2013 - S.cerevisiae meiosis-specific metabolic network.

Source: biomodels_ebi:MODEL1303140001
Original: https://www.ebi.ac.uk/biomodels/MODEL1303140001
"""
...
class SbmlRay2013SCerevisiaeMeiosisSpecificMetabolicNetwork(biosim.BioModule):
    """BioModule wrapper for SBML model: Ray2013 - S.cerevisiae meiosis-specific metabolic network."""

    def __init__(self, model_path: str = "data/MODEL1303140001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Ray2013SCerevisiaeMeiosisSpecificMetabolicModel1303140001Model = SbmlRay2013SCerevisiaeMeiosisSpecificMetabolicNetwork
