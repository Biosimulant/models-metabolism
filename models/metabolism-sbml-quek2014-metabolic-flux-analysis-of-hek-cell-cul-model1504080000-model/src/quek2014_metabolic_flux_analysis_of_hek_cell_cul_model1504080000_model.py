...
"""Auto-generated SBML BioModule wrapper for Quek2014 - Metabolic flux analysis of HEK cell culture using Recon 2 (reduced version of Recon 2).

Source: biomodels_ebi:MODEL1504080000
Original: https://www.ebi.ac.uk/biomodels/MODEL1504080000
"""
...
class SbmlQuek2014MetabolicFluxAnalysisOfHekCellCultureUsing(biosim.BioModule):
    """BioModule wrapper for SBML model: Quek2014 - Metabolic flux analysis of HEK cell culture using Recon 2 (reduced version of Recon 2)."""

    def __init__(self, model_path: str = "data/MODEL1504080000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Quek2014MetabolicFluxAnalysisOfHekCellCulModel1504080000Model = SbmlQuek2014MetabolicFluxAnalysisOfHekCellCultureUsing
