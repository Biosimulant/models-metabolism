...
"""Auto-generated SBML BioModule wrapper for Messiha2013 - combined glycolysis and pentose phosphate pathway model.

Source: biomodels_ebi:BIOMD0000000503
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000503
"""
...
class SbmlMessiha2013CombinedGlycolysisAndPentosePhosphate(biosim.BioModule):
    """BioModule wrapper for SBML model: Messiha2013 - combined glycolysis and pentose phosphate pathway model."""

    def __init__(self, model_path: str = "data/BIOMD0000000503.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Messiha2013CombinedGlycolysisAndPentosePhosBiomd0000000503Model = SbmlMessiha2013CombinedGlycolysisAndPentosePhosphate
