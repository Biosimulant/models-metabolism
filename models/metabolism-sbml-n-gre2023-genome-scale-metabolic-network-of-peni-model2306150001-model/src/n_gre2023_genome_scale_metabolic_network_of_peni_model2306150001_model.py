...
"""Auto-generated SBML BioModule wrapper for Nègre2023 - Genome-Scale Metabolic Network of Penicillium rubens Wisconsin 54-1255.

Source: biomodels_ebi:MODEL2306150001
Original: https://www.ebi.ac.uk/biomodels/MODEL2306150001
"""
...
class SbmlNegre2023GenomeScaleMetabolicNetworkOfPenicillium(biosim.BioModule):
    """BioModule wrapper for SBML model: Nègre2023 - Genome-Scale Metabolic Network of Penicillium rubens Wisconsin 54-1255."""

    def __init__(self, model_path: str = "data/MODEL2306150001.sbml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
NGre2023GenomeScaleMetabolicNetworkOfPeniModel2306150001Model = SbmlNegre2023GenomeScaleMetabolicNetworkOfPenicillium
