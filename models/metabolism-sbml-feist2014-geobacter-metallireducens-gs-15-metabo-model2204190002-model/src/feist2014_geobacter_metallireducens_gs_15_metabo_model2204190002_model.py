...
"""Auto-generated SBML BioModule wrapper for Feist2014 - Geobacter metallireducens GS-15 metabolism.

Source: biomodels_ebi:MODEL2204190002
Original: https://www.ebi.ac.uk/biomodels/MODEL2204190002
"""
...
class SbmlFeist2014GeobacterMetallireducensGs15Metabolism(biosim.BioModule):
    """BioModule wrapper for SBML model: Feist2014 - Geobacter metallireducens GS-15 metabolism."""

    def __init__(self, model_path: str = "data/MODEL2204190002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Feist2014GeobacterMetallireducensGs15MetaboModel2204190002Model = SbmlFeist2014GeobacterMetallireducensGs15Metabolism
