...
"""Auto-generated SBML BioModule wrapper for Lee2008 - Genome-scale metabolic network of Clostridium acetobutylicum (iJL432).

Source: biomodels_ebi:MODEL1507180030
Original: https://www.ebi.ac.uk/biomodels/MODEL1507180030
"""
...
class SbmlLee2008GenomeScaleMetabolicNetworkOfClostridium(biosim.BioModule):
    """BioModule wrapper for SBML model: Lee2008 - Genome-scale metabolic network of Clostridium acetobutylicum (iJL432)."""

    def __init__(self, model_path: str = "data/MODEL1507180030.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Lee2008GenomeScaleMetabolicNetworkOfClostrModel1507180030Model = SbmlLee2008GenomeScaleMetabolicNetworkOfClostridium
