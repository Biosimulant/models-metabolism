...
"""Auto-generated SBML BioModule wrapper for Castillo2016 - Whole-genome metabolic model of D.hansenii using CoReCo.

Source: biomodels_ebi:MODEL1604280028
Original: https://www.ebi.ac.uk/biomodels/MODEL1604280028
"""
...
class SbmlCastillo2016WholeGenomeMetabolicModelOfDHansenii(biosim.BioModule):
    """BioModule wrapper for SBML model: Castillo2016 - Whole-genome metabolic model of D.hansenii using CoReCo."""

    def __init__(self, model_path: str = "data/MODEL1604280028.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Castillo2016WholeGenomeMetabolicModelOfDHModel1604280028Model = SbmlCastillo2016WholeGenomeMetabolicModelOfDHansenii
