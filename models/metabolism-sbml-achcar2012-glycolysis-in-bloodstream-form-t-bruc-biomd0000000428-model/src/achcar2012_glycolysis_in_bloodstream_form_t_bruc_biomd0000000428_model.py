...
"""Auto-generated SBML BioModule wrapper for Achcar2012 - Glycolysis in bloodstream form T. brucei.

Source: biomodels_ebi:BIOMD0000000428
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000428
"""
...
class SbmlAchcar2012GlycolysisInBloodstreamFormTBrucei(biosim.BioModule):
    """BioModule wrapper for SBML model: Achcar2012 - Glycolysis in bloodstream form T. brucei."""

    def __init__(self, model_path: str = "data/BIOMD0000000428.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Achcar2012GlycolysisInBloodstreamFormTBrucBiomd0000000428Model = SbmlAchcar2012GlycolysisInBloodstreamFormTBrucei
