...
"""Auto-generated SBML BioModule wrapper for Nazaret2009_TCA_RC_ATP.

Source: biomodels_ebi:BIOMD0000000232
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000232
"""
...
class SbmlNazaret2009TcaRcAtp(biosim.BioModule):
    """BioModule wrapper for SBML model: Nazaret2009_TCA_RC_ATP."""

    def __init__(self, model_path: str = "data/BIOMD0000000232.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Nazaret2009TcaRcAtpBiomd0000000232Model = SbmlNazaret2009TcaRcAtp
