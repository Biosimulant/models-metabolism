...
"""Auto-generated SBML BioModule wrapper for Canto-Encalada2022-FBA of simultaneous degradation of ammonia and pollutants.

Source: biomodels_ebi:BIOMD0000001061
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000001061
"""
...
class SbmlCantoEncalada2022FbaOfSimultaneousDegradationOf(biosim.BioModule):
    """BioModule wrapper for SBML model: Canto-Encalada2022-FBA of simultaneous degradation of ammonia and pollutants."""

    def __init__(self, model_path: str = "data/BIOMD0000001061.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
CantoEncalada2022FbaOfSimultaneousDegradatiBiomd0000001061Model = SbmlCantoEncalada2022FbaOfSimultaneousDegradationOf
