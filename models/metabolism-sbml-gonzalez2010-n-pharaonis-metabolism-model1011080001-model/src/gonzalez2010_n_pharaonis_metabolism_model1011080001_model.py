...
"""Auto-generated SBML BioModule wrapper for Gonzalez2010_N_pharaonis_metabolism.

Source: biomodels_ebi:MODEL1011080001
Original: https://www.ebi.ac.uk/biomodels/MODEL1011080001
"""
...
class SbmlGonzalez2010NPharaonisMetabolism(biosim.BioModule):
    """BioModule wrapper for SBML model: Gonzalez2010_N_pharaonis_metabolism."""

    def __init__(self, model_path: str = "data/MODEL1011080001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Gonzalez2010NPharaonisMetabolismModel1011080001Model = SbmlGonzalez2010NPharaonisMetabolism
