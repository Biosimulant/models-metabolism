...
"""Auto-generated SBML BioModule wrapper for Ankrah2018 - The cost of metabolic interactions in symbioses between insects and bacteria with reduced genomes  cicada symbiosis.

Source: biomodels_ebi:MODEL1806250005
Original: https://www.ebi.ac.uk/biomodels/MODEL1806250005
"""
...
class SbmlAnkrah2018TheCostOfMetabolicInteractionsInSymbioses3(biosim.BioModule):
    """BioModule wrapper for SBML model: Ankrah2018 - The cost of metabolic interactions in symbioses between insects and bacteria with reduced genomes  cicada symbiosis."""

    def __init__(self, model_path: str = "data/MODEL1806250005.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Ankrah2018TheCostOfMetabolicInteractionsInModel1806250005Model = SbmlAnkrah2018TheCostOfMetabolicInteractionsInSymbioses3
