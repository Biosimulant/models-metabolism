...
"""Auto-generated SBML BioModule wrapper for Pitkanen2014 - Metabolic reconstruction of Neurospora crassa using CoReCo.

Source: biomodels_ebi:MODEL1302010040
Original: https://www.ebi.ac.uk/biomodels/MODEL1302010040
"""
...
class SbmlPitkanen2014MetabolicReconstructionOfNeurosporaCrassa(biosim.BioModule):
    """BioModule wrapper for SBML model: Pitkanen2014 - Metabolic reconstruction of Neurospora crassa using CoReCo."""

    def __init__(self, model_path: str = "data/MODEL1302010040.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Pitkanen2014MetabolicReconstructionOfNeurospModel1302010040Model = SbmlPitkanen2014MetabolicReconstructionOfNeurosporaCrassa
