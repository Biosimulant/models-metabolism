...
"""Auto-generated SBML BioModule wrapper for iEM759.

Source: biomodels_ebi:MODEL2405070001
Original: https://www.ebi.ac.uk/biomodels/MODEL2405070001
"""
...
class SbmlIem759(biosim.BioModule):
    """BioModule wrapper for SBML model: iEM759."""

    def __init__(self, model_path: str = "data/MODEL2405070001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Iem759Model2405070001Model = SbmlIem759
