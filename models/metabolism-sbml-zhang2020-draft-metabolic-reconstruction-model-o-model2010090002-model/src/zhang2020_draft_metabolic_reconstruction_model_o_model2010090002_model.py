...
"""Auto-generated SBML BioModule wrapper for Zhang2020 - Draft metabolic reconstruction model of Atlantic cod liver generated from gadMorTrinity and iHepatocyte2322.

Source: biomodels_ebi:MODEL2010090002
Original: https://www.ebi.ac.uk/biomodels/MODEL2010090002
"""
...
class SbmlZhang2020DraftMetabolicReconstructionModelOfAtlantic(biosim.BioModule):
    """BioModule wrapper for SBML model: Zhang2020 - Draft metabolic reconstruction model of Atlantic cod liver generated from gadMorTrinity and iHepatocyte2322."""

    def __init__(self, model_path: str = "data/MODEL2010090002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Zhang2020DraftMetabolicReconstructionModelOModel2010090002Model = SbmlZhang2020DraftMetabolicReconstructionModelOfAtlantic
