...
"""Auto-generated SBML BioModule wrapper for Kongas2007 - Creatine Kinase in energy metabolic signaling in muscle.

Source: biomodels_ebi:BIOMD0000000041
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000041
"""
...
class SbmlKongas2007CreatineKinaseInEnergyMetabolicSignalingIn(biosim.BioModule):
    """BioModule wrapper for SBML model: Kongas2007 - Creatine Kinase in energy metabolic signaling in muscle."""

    def __init__(self, model_path: str = "data/BIOMD0000000041.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Kongas2007CreatineKinaseInEnergyMetabolicSBiomd0000000041Model = SbmlKongas2007CreatineKinaseInEnergyMetabolicSignalingIn
