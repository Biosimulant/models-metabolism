...
"""Auto-generated SBML BioModule wrapper for Aubert2002 - Coupling between Brain electrical activity, Metabolism and Hemodynamics.

Source: biomodels_ebi:BIOMD0000000570
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000570
"""
...
class SbmlAubert2002CouplingBetweenBrainElectricalActivity(biosim.BioModule):
    """BioModule wrapper for SBML model: Aubert2002 - Coupling between Brain electrical activity, Metabolism and Hemodynamics."""

    def __init__(self, model_path: str = "data/BIOMD0000000570.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Aubert2002CouplingBetweenBrainElectricalActBiomd0000000570Model = SbmlAubert2002CouplingBetweenBrainElectricalActivity
