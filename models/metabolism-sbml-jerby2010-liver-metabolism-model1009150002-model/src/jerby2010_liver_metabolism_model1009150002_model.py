...
"""Auto-generated SBML BioModule wrapper for Jerby2010_Liver_Metabolism.

Source: biomodels_ebi:MODEL1009150002
Original: https://www.ebi.ac.uk/biomodels/MODEL1009150002
"""
...
class SbmlJerby2010LiverMetabolism(biosim.BioModule):
    """BioModule wrapper for SBML model: Jerby2010_Liver_Metabolism."""

    def __init__(self, model_path: str = "data/MODEL1009150002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Jerby2010LiverMetabolismModel1009150002Model = SbmlJerby2010LiverMetabolism
