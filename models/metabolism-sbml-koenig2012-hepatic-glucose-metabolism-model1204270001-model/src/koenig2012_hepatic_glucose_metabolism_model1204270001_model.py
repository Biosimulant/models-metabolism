...
Source: biomodels_ebi:MODEL1204270001
Original: https://www.ebi.ac.uk/biomodels/MODEL1204270001
"""
...
class SbmlKoenig2012HepaticGlucoseMetabolism(biosim.BioModule):
    """BioModule wrapper for SBML model: Koenig2012 - Hepatic Glucose Metabolism."""

    def __init__(self, model_path: str = "data/MODEL1204270001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Koenig2012HepaticGlucoseMetabolismModel1204270001Model = SbmlKoenig2012HepaticGlucoseMetabolism
