...
"""Auto-generated SBML BioModule wrapper for Uhlén2015 - Human tissue-based proteome metabolic network - small intestine.

Source: biomodels_ebi:MODEL1411240024
Original: https://www.ebi.ac.uk/biomodels/MODEL1411240024
"""
...
class SbmlUhlen2015HumanTissueBasedProteomeMetabolicNetwork21(biosim.BioModule):
    """BioModule wrapper for SBML model: Uhlén2015 - Human tissue-based proteome metabolic network - small intestine."""

    def __init__(self, model_path: str = "data/MODEL1411240024.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
UhlN2015HumanTissueBasedProteomeMetabolicModel1411240024Model = SbmlUhlen2015HumanTissueBasedProteomeMetabolicNetwork21
