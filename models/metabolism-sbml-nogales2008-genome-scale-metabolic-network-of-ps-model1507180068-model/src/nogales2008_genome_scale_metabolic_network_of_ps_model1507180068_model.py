...
"""Auto-generated SBML BioModule wrapper for Nogales2008 - Genome-scale metabolic network of Pseudomonas putida (iJN746).

Source: biomodels_ebi:MODEL1507180068
Original: https://www.ebi.ac.uk/biomodels/MODEL1507180068
"""
...
class SbmlNogales2008GenomeScaleMetabolicNetworkOfPseudomonas(biosim.BioModule):
    """BioModule wrapper for SBML model: Nogales2008 - Genome-scale metabolic network of Pseudomonas putida (iJN746)."""

    def __init__(self, model_path: str = "data/MODEL1507180068.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Nogales2008GenomeScaleMetabolicNetworkOfPsModel1507180068Model = SbmlNogales2008GenomeScaleMetabolicNetworkOfPseudomonas
