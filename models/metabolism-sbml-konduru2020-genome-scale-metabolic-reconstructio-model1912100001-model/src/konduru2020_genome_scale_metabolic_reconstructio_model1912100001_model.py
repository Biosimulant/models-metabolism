...
"""Auto-generated SBML BioModule wrapper for Konduru2020 - Genome-scale metabolic reconstruction and in silico analysis of rice leaf blight pathogen, Xanthomonas oryzae.

Source: biomodels_ebi:MODEL1912100001
Original: https://www.ebi.ac.uk/biomodels/MODEL1912100001
"""
...
class SbmlKonduru2020GenomeScaleMetabolicReconstructionAndIn(biosim.BioModule):
    """BioModule wrapper for SBML model: Konduru2020 - Genome-scale metabolic reconstruction and in silico analysis of rice leaf blight pathogen, Xanthomonas oryzae."""

    def __init__(self, model_path: str = "data/MODEL1912100001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Konduru2020GenomeScaleMetabolicReconstructioModel1912100001Model = SbmlKonduru2020GenomeScaleMetabolicReconstructionAndIn
