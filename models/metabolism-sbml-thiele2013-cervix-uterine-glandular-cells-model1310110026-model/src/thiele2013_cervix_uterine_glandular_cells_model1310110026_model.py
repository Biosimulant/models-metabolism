...
"""Auto-generated SBML BioModule wrapper for Thiele2013 - Cervix uterine glandular cells.

Source: biomodels_ebi:MODEL1310110026
Original: https://www.ebi.ac.uk/biomodels/MODEL1310110026
"""
...
class SbmlThiele2013CervixUterineGlandularCells(biosim.BioModule):
    """BioModule wrapper for SBML model: Thiele2013 - Cervix uterine glandular cells."""

    def __init__(self, model_path: str = "data/MODEL1310110026.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Thiele2013CervixUterineGlandularCellsModel1310110026Model = SbmlThiele2013CervixUterineGlandularCells
