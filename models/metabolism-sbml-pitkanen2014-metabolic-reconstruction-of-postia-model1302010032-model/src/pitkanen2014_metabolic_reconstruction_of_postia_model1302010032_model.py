...
"""Auto-generated SBML BioModule wrapper for Pitkanen2014 - Metabolic reconstruction of Postia placenta using CoReCo.

Source: biomodels_ebi:MODEL1302010032
Original: https://www.ebi.ac.uk/biomodels/MODEL1302010032
"""
...
class SbmlPitkanen2014MetabolicReconstructionOfPostiaPlacenta(biosim.BioModule):
    """BioModule wrapper for SBML model: Pitkanen2014 - Metabolic reconstruction of Postia placenta using CoReCo."""

    def __init__(self, model_path: str = "data/MODEL1302010032.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Pitkanen2014MetabolicReconstructionOfPostiaModel1302010032Model = SbmlPitkanen2014MetabolicReconstructionOfPostiaPlacenta
