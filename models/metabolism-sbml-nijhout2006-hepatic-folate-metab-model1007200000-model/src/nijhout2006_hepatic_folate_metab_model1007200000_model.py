...
"""Auto-generated SBML BioModule wrapper for Nijhout2006_Hepatic_Folate_Metab.

Source: biomodels_ebi:MODEL1007200000
Original: https://www.ebi.ac.uk/biomodels/MODEL1007200000
"""
...
class SbmlNijhout2006HepaticFolateMetab(biosim.BioModule):
    """BioModule wrapper for SBML model: Nijhout2006_Hepatic_Folate_Metab."""

    def __init__(self, model_path: str = "data/MODEL1007200000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Nijhout2006HepaticFolateMetabModel1007200000Model = SbmlNijhout2006HepaticFolateMetab
