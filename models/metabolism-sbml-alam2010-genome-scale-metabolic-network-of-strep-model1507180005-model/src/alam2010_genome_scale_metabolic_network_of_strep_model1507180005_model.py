...
"""Auto-generated SBML BioModule wrapper for Alam2010 - Genome-scale metabolic network of Streptomyces coelicolor.

Source: biomodels_ebi:MODEL1507180005
Original: https://www.ebi.ac.uk/biomodels/MODEL1507180005
"""
...
class SbmlAlam2010GenomeScaleMetabolicNetworkOfStreptomyces(biosim.BioModule):
    """BioModule wrapper for SBML model: Alam2010 - Genome-scale metabolic network of Streptomyces coelicolor."""

    def __init__(self, model_path: str = "data/MODEL1507180005.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Alam2010GenomeScaleMetabolicNetworkOfStrepModel1507180005Model = SbmlAlam2010GenomeScaleMetabolicNetworkOfStreptomyces
