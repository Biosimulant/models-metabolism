...
"""Auto-generated SBML BioModule wrapper for Castillo2016 - Whole-genome metabolic model of C.lusitaniae using CoReCo.

Source: biomodels_ebi:MODEL1604280043
Original: https://www.ebi.ac.uk/biomodels/MODEL1604280043
"""
...
class SbmlCastillo2016WholeGenomeMetabolicModelOfCLusitaniae(biosim.BioModule):
    """BioModule wrapper for SBML model: Castillo2016 - Whole-genome metabolic model of C.lusitaniae using CoReCo."""

    def __init__(self, model_path: str = "data/MODEL1604280043.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Castillo2016WholeGenomeMetabolicModelOfCLModel1604280043Model = SbmlCastillo2016WholeGenomeMetabolicModelOfCLusitaniae
