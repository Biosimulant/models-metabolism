...
"""Auto-generated SBML BioModule wrapper for Pitkanen2014 - Metabolic reconstruction of Saccharomyces cerevisiae using CoReCo.

Source: biomodels_ebi:MODEL1302010029
Original: https://www.ebi.ac.uk/biomodels/MODEL1302010029
"""
...
class SbmlPitkanen2014MetabolicReconstructionOfSaccharomyces(biosim.BioModule):
    """BioModule wrapper for SBML model: Pitkanen2014 - Metabolic reconstruction of Saccharomyces cerevisiae using CoReCo."""

    def __init__(self, model_path: str = "data/MODEL1302010029.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Pitkanen2014MetabolicReconstructionOfSaccharModel1302010029Model = SbmlPitkanen2014MetabolicReconstructionOfSaccharomyces
