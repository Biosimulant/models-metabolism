...
"""Auto-generated SBML BioModule wrapper for Mardinoglu2014 - Genome-scale metabolic model (HMR version 2.0) - generic human cell.

Source: biomodels_ebi:MODEL1402200002
Original: https://www.ebi.ac.uk/biomodels/MODEL1402200002
"""
...
class SbmlMardinoglu2014GenomeScaleMetabolicModelHmrVersion20(biosim.BioModule):
    """BioModule wrapper for SBML model: Mardinoglu2014 - Genome-scale metabolic model (HMR version 2.0) - generic human cell."""

    def __init__(self, model_path: str = "data/MODEL1402200002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Mardinoglu2014GenomeScaleMetabolicModelHmrModel1402200002Model = SbmlMardinoglu2014GenomeScaleMetabolicModelHmrVersion20
