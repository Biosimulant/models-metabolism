...
"""Auto-generated SBML BioModule wrapper for Thiele2013 - Liver bile duct cells.

Source: biomodels_ebi:MODEL1310110041
Original: https://www.ebi.ac.uk/biomodels/MODEL1310110041
"""
...
class SbmlThiele2013LiverBileDuctCells(biosim.BioModule):
    """BioModule wrapper for SBML model: Thiele2013 - Liver bile duct cells."""

    def __init__(self, model_path: str = "data/MODEL1310110041.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Thiele2013LiverBileDuctCellsModel1310110041Model = SbmlThiele2013LiverBileDuctCells
