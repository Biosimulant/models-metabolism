...
"""Auto-generated SBML BioModule wrapper for Bertram2007_IsletCell_Oscillations.

Source: biomodels_ebi:BIOMD0000000376
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000376
"""
...
class SbmlBertram2007IsletcellOscillations(biosim.BioModule):
    """BioModule wrapper for SBML model: Bertram2007_IsletCell_Oscillations."""

    def __init__(self, model_path: str = "data/BIOMD0000000376.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Bertram2007IsletcellOscillationsBiomd0000000376Model = SbmlBertram2007IsletcellOscillations
