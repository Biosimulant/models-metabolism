...
"""Auto-generated SBML BioModule wrapper for Slaviero2021 - E. coli anaerobic central carbon and energy metabolism_Version1.

Source: biomodels_ebi:MODEL2202020001
Original: https://www.ebi.ac.uk/biomodels/MODEL2202020001
"""
...
class SbmlSlaviero2021EColiAnaerobicCentralCarbonAndEnergy(biosim.BioModule):
    """BioModule wrapper for SBML model: Slaviero2021 - E. coli anaerobic central carbon and energy metabolism_Version1."""

    def __init__(self, model_path: str = "data/MODEL2202020001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Slaviero2021EColiAnaerobicCentralCarbonAndModel2202020001Model = SbmlSlaviero2021EColiAnaerobicCentralCarbonAndEnergy
