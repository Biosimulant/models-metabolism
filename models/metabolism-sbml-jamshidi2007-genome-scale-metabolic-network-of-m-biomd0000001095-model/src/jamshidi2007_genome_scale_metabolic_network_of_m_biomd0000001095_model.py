...
"""Auto-generated SBML BioModule wrapper for Jamshidi2007 - Genome-scale metabolic network of Mycobacterium tuberculosis (iNJ661).

Source: biomodels_ebi:BIOMD0000001095
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000001095
"""
...
class SbmlJamshidi2007GenomeScaleMetabolicNetworkOf(biosim.BioModule):
    """BioModule wrapper for SBML model: Jamshidi2007 - Genome-scale metabolic network of Mycobacterium tuberculosis (iNJ661)."""

    def __init__(self, model_path: str = "data/BIOMD0000001095.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Jamshidi2007GenomeScaleMetabolicNetworkOfMBiomd0000001095Model = SbmlJamshidi2007GenomeScaleMetabolicNetworkOf
