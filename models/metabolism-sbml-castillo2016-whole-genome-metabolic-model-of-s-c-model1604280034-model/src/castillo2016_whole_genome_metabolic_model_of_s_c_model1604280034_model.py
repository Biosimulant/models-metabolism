...
"""Auto-generated SBML BioModule wrapper for Castillo2016 - Whole-genome metabolic model of S.cerevisiae using CoReCo.

Source: biomodels_ebi:MODEL1604280034
Original: https://www.ebi.ac.uk/biomodels/MODEL1604280034
"""
...
class SbmlCastillo2016WholeGenomeMetabolicModelOfSCerevisiae(biosim.BioModule):
    """BioModule wrapper for SBML model: Castillo2016 - Whole-genome metabolic model of S.cerevisiae using CoReCo."""

    def __init__(self, model_path: str = "data/MODEL1604280034.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Castillo2016WholeGenomeMetabolicModelOfSCModel1604280034Model = SbmlCastillo2016WholeGenomeMetabolicModelOfSCerevisiae
