...
"""Auto-generated SBML BioModule wrapper for Witting2018 - WormJam-GEM - Whole-genome metabolic reconstructions for Caenorhabditis elegans..

Source: biomodels_ebi:MODEL1807230002
Original: https://www.ebi.ac.uk/biomodels/MODEL1807230002
"""
...
class SbmlWitting2018WormjamGemWholeGenomeMetabolic(biosim.BioModule):
    """BioModule wrapper for SBML model: Witting2018 - WormJam-GEM - Whole-genome metabolic reconstructions for Caenorhabditis elegans.."""

    def __init__(self, model_path: str = "data/MODEL1807230002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Witting2018WormjamGemWholeGenomeMetabolicRModel1807230002Model = SbmlWitting2018WormjamGemWholeGenomeMetabolic
