...
"""Auto-generated SBML BioModule wrapper for Kerkhoven2013 - Glycolysis in T.brucei - MODEL A.

Source: biomodels_ebi:BIOMD0000000513
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000513
"""
...
class SbmlKerkhoven2013GlycolysisInTBruceiModelA(biosim.BioModule):
    """BioModule wrapper for SBML model: Kerkhoven2013 - Glycolysis in T.brucei - MODEL A."""

    def __init__(self, model_path: str = "data/BIOMD0000000513.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Kerkhoven2013GlycolysisInTBruceiModelABiomd0000000513Model = SbmlKerkhoven2013GlycolysisInTBruceiModelA
