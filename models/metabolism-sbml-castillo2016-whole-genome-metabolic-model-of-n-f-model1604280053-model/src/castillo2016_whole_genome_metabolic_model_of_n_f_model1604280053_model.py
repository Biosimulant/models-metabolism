...
"""Auto-generated SBML BioModule wrapper for Castillo2016 - Whole-genome metabolic model of N.fischeri using CoReCo.

Source: biomodels_ebi:MODEL1604280053
Original: https://www.ebi.ac.uk/biomodels/MODEL1604280053
"""
...
class SbmlCastillo2016WholeGenomeMetabolicModelOfNFischeri(biosim.BioModule):
    """BioModule wrapper for SBML model: Castillo2016 - Whole-genome metabolic model of N.fischeri using CoReCo."""

    def __init__(self, model_path: str = "data/MODEL1604280053.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Castillo2016WholeGenomeMetabolicModelOfNFModel1604280053Model = SbmlCastillo2016WholeGenomeMetabolicModelOfNFischeri
