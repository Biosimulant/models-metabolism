...
"""Auto-generated SBML BioModule wrapper for Oliveira2020 - E. coli Extended Central Carbon Metabolism from Glycerol.

Source: biomodels_ebi:MODEL2010160002
Original: https://www.ebi.ac.uk/biomodels/MODEL2010160002
"""
...
class SbmlOliveira2020EColiExtendedCentralCarbonMetabolismFrom(biosim.BioModule):
    """BioModule wrapper for SBML model: Oliveira2020 - E. coli Extended Central Carbon Metabolism from Glycerol."""

    def __init__(self, model_path: str = "data/MODEL2010160002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Oliveira2020EColiExtendedCentralCarbonMetaModel2010160002Model = SbmlOliveira2020EColiExtendedCentralCarbonMetabolismFrom
