...
"""Auto-generated SBML BioModule wrapper for Thiele2013 - Esophagus squamous epithelial cells.

Source: biomodels_ebi:MODEL1310110048
Original: https://www.ebi.ac.uk/biomodels/MODEL1310110048
"""
...
class SbmlThiele2013EsophagusSquamousEpithelialCells(biosim.BioModule):
    """BioModule wrapper for SBML model: Thiele2013 - Esophagus squamous epithelial cells."""

    def __init__(self, model_path: str = "data/MODEL1310110048.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Thiele2013EsophagusSquamousEpithelialCellsModel1310110048Model = SbmlThiele2013EsophagusSquamousEpithelialCells
