...
"""Auto-generated SBML BioModule wrapper for Pitkanen2014 - Metabolic reconstruction of Sclerotinia sclerotiorum using CoReCo.

Source: biomodels_ebi:MODEL1302010034
Original: https://www.ebi.ac.uk/biomodels/MODEL1302010034
"""
...
class SbmlPitkanen2014MetabolicReconstructionOfSclerotinia(biosim.BioModule):
    """BioModule wrapper for SBML model: Pitkanen2014 - Metabolic reconstruction of Sclerotinia sclerotiorum using CoReCo."""

    def __init__(self, model_path: str = "data/MODEL1302010034.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Pitkanen2014MetabolicReconstructionOfSclerotModel1302010034Model = SbmlPitkanen2014MetabolicReconstructionOfSclerotinia
