...
"""Auto-generated SBML BioModule wrapper for Thiele2013 - Gall bladder glandular cells.

Source: biomodels_ebi:MODEL1310110042
Original: https://www.ebi.ac.uk/biomodels/MODEL1310110042
"""
...
class SbmlThiele2013GallBladderGlandularCells(biosim.BioModule):
    """BioModule wrapper for SBML model: Thiele2013 - Gall bladder glandular cells."""

    def __init__(self, model_path: str = "data/MODEL1310110042.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Thiele2013GallBladderGlandularCellsModel1310110042Model = SbmlThiele2013GallBladderGlandularCells
