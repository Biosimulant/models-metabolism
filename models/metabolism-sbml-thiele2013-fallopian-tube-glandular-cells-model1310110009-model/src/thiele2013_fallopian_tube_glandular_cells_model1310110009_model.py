...
"""Auto-generated SBML BioModule wrapper for Thiele2013 - Fallopian tube glandular cells.

Source: biomodels_ebi:MODEL1310110009
Original: https://www.ebi.ac.uk/biomodels/MODEL1310110009
"""
...
class SbmlThiele2013FallopianTubeGlandularCells(biosim.BioModule):
    """BioModule wrapper for SBML model: Thiele2013 - Fallopian tube glandular cells."""

    def __init__(self, model_path: str = "data/MODEL1310110009.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Thiele2013FallopianTubeGlandularCellsModel1310110009Model = SbmlThiele2013FallopianTubeGlandularCells
