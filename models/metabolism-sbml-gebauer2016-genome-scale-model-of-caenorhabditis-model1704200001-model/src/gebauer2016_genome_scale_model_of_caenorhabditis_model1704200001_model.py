...
"""Auto-generated SBML BioModule wrapper for Gebauer2016 - Genome-scale model of Caenorhabditis elegans metabolism (with bacteria).

Source: biomodels_ebi:MODEL1704200001
Original: https://www.ebi.ac.uk/biomodels/MODEL1704200001
"""
...
class SbmlGebauer2016GenomeScaleModelOfCaenorhabditisElegans2(biosim.BioModule):
    """BioModule wrapper for SBML model: Gebauer2016 - Genome-scale model of Caenorhabditis elegans metabolism (with bacteria)."""

    def __init__(self, model_path: str = "data/MODEL1704200001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Gebauer2016GenomeScaleModelOfCaenorhabditisModel1704200001Model = SbmlGebauer2016GenomeScaleModelOfCaenorhabditisElegans2
