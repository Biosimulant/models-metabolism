...
"""Auto-generated SBML BioModule wrapper for Sigurdsson2010 - Genome-scale metabolic model of Mus Musculus (iMM1415).

Source: biomodels_ebi:MODEL1507180055
Original: https://www.ebi.ac.uk/biomodels/MODEL1507180055
"""
...
class SbmlSigurdsson2010GenomeScaleMetabolicModelOfMusMusculus(biosim.BioModule):
    """BioModule wrapper for SBML model: Sigurdsson2010 - Genome-scale metabolic model of Mus Musculus (iMM1415)."""

    def __init__(self, model_path: str = "data/MODEL1507180055.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Sigurdsson2010GenomeScaleMetabolicModelOfMModel1507180055Model = SbmlSigurdsson2010GenomeScaleMetabolicModelOfMusMusculus
