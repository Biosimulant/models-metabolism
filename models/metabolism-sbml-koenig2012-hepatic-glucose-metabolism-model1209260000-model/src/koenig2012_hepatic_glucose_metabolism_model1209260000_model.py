...
"""Auto-generated SBML BioModule wrapper for Koenig2012 - Hepatic Glucose Metabolism.

Source: biomodels_ebi:MODEL1209260000
Original: https://www.ebi.ac.uk/biomodels/MODEL1209260000
"""
...
class SbmlKoenig2012HepaticGlucoseMetabolism2(biosim.BioModule):
    """BioModule wrapper for SBML model: Koenig2012 - Hepatic Glucose Metabolism."""

    def __init__(self, model_path: str = "data/MODEL1209260000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Koenig2012HepaticGlucoseMetabolismModel1209260000Model = SbmlKoenig2012HepaticGlucoseMetabolism2
