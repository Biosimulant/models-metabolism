...
"""Auto-generated SBML BioModule wrapper for iLG335.

Source: biomodels_ebi:MODEL2507280001
Original: https://www.ebi.ac.uk/biomodels/MODEL2507280001
"""
...
class SbmlIlg335(biosim.BioModule):
    """BioModule wrapper for SBML model: iLG335."""

    def __init__(self, model_path: str = "data/MODEL2507280001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Ilg335Model2507280001Model = SbmlIlg335
