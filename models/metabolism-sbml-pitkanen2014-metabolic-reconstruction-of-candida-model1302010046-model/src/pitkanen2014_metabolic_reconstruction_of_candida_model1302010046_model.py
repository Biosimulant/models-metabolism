...
"""Auto-generated SBML BioModule wrapper for Pitkanen2014 - Metabolic reconstruction of Candida albicans using CoReCo.

Source: biomodels_ebi:MODEL1302010046
Original: https://www.ebi.ac.uk/biomodels/MODEL1302010046
"""
...
class SbmlPitkanen2014MetabolicReconstructionOfCandidaAlbicans(biosim.BioModule):
    """BioModule wrapper for SBML model: Pitkanen2014 - Metabolic reconstruction of Candida albicans using CoReCo."""

    def __init__(self, model_path: str = "data/MODEL1302010046.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Pitkanen2014MetabolicReconstructionOfCandidaModel1302010046Model = SbmlPitkanen2014MetabolicReconstructionOfCandidaAlbicans
