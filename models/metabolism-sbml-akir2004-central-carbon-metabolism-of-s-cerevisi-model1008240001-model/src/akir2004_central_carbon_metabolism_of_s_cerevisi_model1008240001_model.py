...
"""Auto-generated SBML BioModule wrapper for Çakir2004 - Central Carbon Metabolism of S.cerevisiae.

Source: biomodels_ebi:MODEL1008240001
Original: https://www.ebi.ac.uk/biomodels/MODEL1008240001
"""
...
class SbmlCakir2004CentralCarbonMetabolismOfSCerevisiae(biosim.BioModule):
    """BioModule wrapper for SBML model: Çakir2004 - Central Carbon Metabolism of S.cerevisiae."""

    def __init__(self, model_path: str = "data/MODEL1008240001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Akir2004CentralCarbonMetabolismOfSCerevisiModel1008240001Model = SbmlCakir2004CentralCarbonMetabolismOfSCerevisiae
