...
"""Auto-generated SBML BioModule wrapper for Hoefnagel2002_PyruvateBranches.

Source: biomodels_ebi:BIOMD0000000017
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000017
"""
...
class SbmlHoefnagel2002Pyruvatebranches(biosim.BioModule):
    """BioModule wrapper for SBML model: Hoefnagel2002_PyruvateBranches."""

    def __init__(self, model_path: str = "data/BIOMD0000000017.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Hoefnagel2002PyruvatebranchesBiomd0000000017Model = SbmlHoefnagel2002Pyruvatebranches
