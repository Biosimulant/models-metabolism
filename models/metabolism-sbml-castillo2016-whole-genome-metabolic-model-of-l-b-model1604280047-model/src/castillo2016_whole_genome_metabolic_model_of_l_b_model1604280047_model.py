...
"""Auto-generated SBML BioModule wrapper for Castillo2016 - Whole-genome metabolic model of L.bicolor using CoReCo.

Source: biomodels_ebi:MODEL1604280047
Original: https://www.ebi.ac.uk/biomodels/MODEL1604280047
"""
...
class SbmlCastillo2016WholeGenomeMetabolicModelOfLBicolor(biosim.BioModule):
    """BioModule wrapper for SBML model: Castillo2016 - Whole-genome metabolic model of L.bicolor using CoReCo."""

    def __init__(self, model_path: str = "data/MODEL1604280047.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Castillo2016WholeGenomeMetabolicModelOfLBModel1604280047Model = SbmlCastillo2016WholeGenomeMetabolicModelOfLBicolor
