...
"""Auto-generated SBML BioModule wrapper for Castillo2016 - Whole-genome metabolic model of S.roseus using CoReCo.

Source: biomodels_ebi:MODEL1604280042
Original: https://www.ebi.ac.uk/biomodels/MODEL1604280042
"""
...
class SbmlCastillo2016WholeGenomeMetabolicModelOfSRoseusUsing(biosim.BioModule):
    """BioModule wrapper for SBML model: Castillo2016 - Whole-genome metabolic model of S.roseus using CoReCo."""

    def __init__(self, model_path: str = "data/MODEL1604280042.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Castillo2016WholeGenomeMetabolicModelOfSRModel1604280042Model = SbmlCastillo2016WholeGenomeMetabolicModelOfSRoseusUsing
