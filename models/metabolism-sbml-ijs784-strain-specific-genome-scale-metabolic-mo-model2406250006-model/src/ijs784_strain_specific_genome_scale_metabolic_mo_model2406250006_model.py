...
"""Auto-generated SBML BioModule wrapper for iJS784 - Strain-specific genome-scale metabolic model of Acinetobacter baumannii ATCC 17978.

Source: biomodels_ebi:MODEL2406250006
Original: https://www.ebi.ac.uk/biomodels/MODEL2406250006
"""
...
class SbmlIjs784StrainSpecificGenomeScaleMetabolicModelOf(biosim.BioModule):
    """BioModule wrapper for SBML model: iJS784 - Strain-specific genome-scale metabolic model of Acinetobacter baumannii ATCC 17978."""

    def __init__(self, model_path: str = "data/MODEL2406250006.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Ijs784StrainSpecificGenomeScaleMetabolicMoModel2406250006Model = SbmlIjs784StrainSpecificGenomeScaleMetabolicModelOf
