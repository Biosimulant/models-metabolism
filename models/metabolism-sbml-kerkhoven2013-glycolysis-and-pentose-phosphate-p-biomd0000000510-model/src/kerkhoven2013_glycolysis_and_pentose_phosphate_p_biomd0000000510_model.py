...
"""Auto-generated SBML BioModule wrapper for Kerkhoven2013 - Glycolysis and Pentose Phosphate Pathway in T.brucei - MODEL C (with glucosomal ribokinase).

Source: biomodels_ebi:BIOMD0000000510
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000510
"""
...
class SbmlKerkhoven2013GlycolysisAndPentosePhosphatePathwayInT3(biosim.BioModule):
    """BioModule wrapper for SBML model: Kerkhoven2013 - Glycolysis and Pentose Phosphate Pathway in T.brucei - MODEL C (with glucosomal ribokinase)."""

    def __init__(self, model_path: str = "data/BIOMD0000000510.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Kerkhoven2013GlycolysisAndPentosePhosphatePBiomd0000000510Model = SbmlKerkhoven2013GlycolysisAndPentosePhosphatePathwayInT3
