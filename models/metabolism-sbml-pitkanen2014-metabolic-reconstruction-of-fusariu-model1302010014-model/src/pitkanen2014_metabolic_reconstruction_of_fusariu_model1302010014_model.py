...
"""Auto-generated SBML BioModule wrapper for Pitkanen2014 - Metabolic reconstruction of Fusarium oxysporum using CoReCo.

Source: biomodels_ebi:MODEL1302010014
Original: https://www.ebi.ac.uk/biomodels/MODEL1302010014
"""
...
class SbmlPitkanen2014MetabolicReconstructionOfFusariumOxysporum(biosim.BioModule):
    """BioModule wrapper for SBML model: Pitkanen2014 - Metabolic reconstruction of Fusarium oxysporum using CoReCo."""

    def __init__(self, model_path: str = "data/MODEL1302010014.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Pitkanen2014MetabolicReconstructionOfFusariuModel1302010014Model = SbmlPitkanen2014MetabolicReconstructionOfFusariumOxysporum
