...
"""Auto-generated SBML BioModule wrapper for Smallbone2013 - E.coli metabolic model with modular rate law.

Source: biomodels_ebi:BIOMD0000000470
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000470
"""
...
class SbmlSmallbone2013EColiMetabolicModelWithModularRateLaw(biosim.BioModule):
    """BioModule wrapper for SBML model: Smallbone2013 - E.coli metabolic model with modular rate law."""

    def __init__(self, model_path: str = "data/BIOMD0000000470.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Smallbone2013EColiMetabolicModelWithModulaBiomd0000000470Model = SbmlSmallbone2013EColiMetabolicModelWithModularRateLaw
