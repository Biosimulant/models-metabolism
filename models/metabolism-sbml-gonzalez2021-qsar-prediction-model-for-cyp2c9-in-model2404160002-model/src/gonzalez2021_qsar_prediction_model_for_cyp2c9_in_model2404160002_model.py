...
"""Auto-generated SBML BioModule wrapper for Gonzalez2021 - QSAR Prediction Model for CYP2C9 Inhibitor and Substrate.

Source: biomodels_ebi:MODEL2404160002
Original: https://www.ebi.ac.uk/biomodels/MODEL2404160002
"""
...
class SbmlGonzalez2021QsarPredictionModelForCyp2c9InhibitorAnd(biosim.BioModule):
    """BioModule wrapper for SBML model: Gonzalez2021 - QSAR Prediction Model for CYP2C9 Inhibitor and Substrate."""

    def __init__(self, model_path: str = "data/MODEL2404160002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Gonzalez2021QsarPredictionModelForCyp2c9InModel2404160002Model = SbmlGonzalez2021QsarPredictionModelForCyp2c9InhibitorAnd
