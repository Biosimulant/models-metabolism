...
"""Auto-generated SBML BioModule wrapper for Teusink2006 - Genome-scale metabolic network of Lactobacillus plantarum (iBT721).

Source: biomodels_ebi:MODEL1507180045
Original: https://www.ebi.ac.uk/biomodels/MODEL1507180045
"""
...
class SbmlTeusink2006GenomeScaleMetabolicNetworkOfLactobacillus(biosim.BioModule):
    """BioModule wrapper for SBML model: Teusink2006 - Genome-scale metabolic network of Lactobacillus plantarum (iBT721)."""

    def __init__(self, model_path: str = "data/MODEL1507180045.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Teusink2006GenomeScaleMetabolicNetworkOfLaModel1507180045Model = SbmlTeusink2006GenomeScaleMetabolicNetworkOfLactobacillus
