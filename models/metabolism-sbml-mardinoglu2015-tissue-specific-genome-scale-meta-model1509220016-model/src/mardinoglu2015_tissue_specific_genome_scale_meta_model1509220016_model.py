...
"""Auto-generated SBML BioModule wrapper for Mardinoglu2015 - Tissue-specific genome-scale metabolic network - Muscle.

Source: biomodels_ebi:MODEL1509220016
Original: https://www.ebi.ac.uk/biomodels/MODEL1509220016
"""
...
class SbmlMardinoglu2015TissueSpecificGenomeScaleMetabolic19(biosim.BioModule):
    """BioModule wrapper for SBML model: Mardinoglu2015 - Tissue-specific genome-scale metabolic network - Muscle."""

    def __init__(self, model_path: str = "data/MODEL1509220016.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Mardinoglu2015TissueSpecificGenomeScaleMetaModel1509220016Model = SbmlMardinoglu2015TissueSpecificGenomeScaleMetabolic19
