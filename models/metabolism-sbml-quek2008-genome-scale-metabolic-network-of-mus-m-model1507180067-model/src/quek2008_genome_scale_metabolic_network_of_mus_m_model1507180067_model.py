...
"""Auto-generated SBML BioModule wrapper for Quek2008 - Genome-scale metabolic network of Mus musculus.

Source: biomodels_ebi:MODEL1507180067
Original: https://www.ebi.ac.uk/biomodels/MODEL1507180067
"""
...
class SbmlQuek2008GenomeScaleMetabolicNetworkOfMusMusculus(biosim.BioModule):
    """BioModule wrapper for SBML model: Quek2008 - Genome-scale metabolic network of Mus musculus."""

    def __init__(self, model_path: str = "data/MODEL1507180067.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Quek2008GenomeScaleMetabolicNetworkOfMusMModel1507180067Model = SbmlQuek2008GenomeScaleMetabolicNetworkOfMusMusculus
