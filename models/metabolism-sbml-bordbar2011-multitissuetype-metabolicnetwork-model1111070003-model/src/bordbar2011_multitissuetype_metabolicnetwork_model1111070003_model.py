...
"""Auto-generated SBML BioModule wrapper for Bordbar2011_MultiTissueType_MetabolicNetwork.

Source: biomodels_ebi:MODEL1111070003
Original: https://www.ebi.ac.uk/biomodels/MODEL1111070003
"""
...
class SbmlBordbar2011MultitissuetypeMetabolicnetwork(biosim.BioModule):
    """BioModule wrapper for SBML model: Bordbar2011_MultiTissueType_MetabolicNetwork."""

    def __init__(self, model_path: str = "data/MODEL1111070003.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Bordbar2011MultitissuetypeMetabolicnetworkModel1111070003Model = SbmlBordbar2011MultitissuetypeMetabolicnetwork
