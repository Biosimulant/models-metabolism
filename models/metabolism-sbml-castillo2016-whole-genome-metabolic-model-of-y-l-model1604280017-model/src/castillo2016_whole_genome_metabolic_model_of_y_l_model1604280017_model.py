...
"""Auto-generated SBML BioModule wrapper for Castillo2016 - Whole-genome metabolic model of Y.lipolytica using CoReCo.

Source: biomodels_ebi:MODEL1604280017
Original: https://www.ebi.ac.uk/biomodels/MODEL1604280017
"""
...
class SbmlCastillo2016WholeGenomeMetabolicModelOfYLipolytica(biosim.BioModule):
    """BioModule wrapper for SBML model: Castillo2016 - Whole-genome metabolic model of Y.lipolytica using CoReCo."""

    def __init__(self, model_path: str = "data/MODEL1604280017.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Castillo2016WholeGenomeMetabolicModelOfYLModel1604280017Model = SbmlCastillo2016WholeGenomeMetabolicModelOfYLipolytica
