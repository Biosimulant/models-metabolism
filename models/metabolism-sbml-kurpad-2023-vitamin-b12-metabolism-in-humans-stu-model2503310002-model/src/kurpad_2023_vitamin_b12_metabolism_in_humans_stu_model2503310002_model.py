...
"""Auto-generated SBML BioModule wrapper for Kurpad 2023 - vitamin B12 metabolism in humans [study 1].

Source: biomodels_ebi:MODEL2503310002
Original: https://www.ebi.ac.uk/biomodels/MODEL2503310002
"""
...
class SbmlKurpad2023VitaminB12MetabolismInHumansStudy1(biosim.BioModule):
    """BioModule wrapper for SBML model: Kurpad 2023 - vitamin B12 metabolism in humans [study 1]."""

    def __init__(self, model_path: str = "data/MODEL2503310002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Kurpad2023VitaminB12MetabolismInHumansStuModel2503310002Model = SbmlKurpad2023VitaminB12MetabolismInHumansStudy1
