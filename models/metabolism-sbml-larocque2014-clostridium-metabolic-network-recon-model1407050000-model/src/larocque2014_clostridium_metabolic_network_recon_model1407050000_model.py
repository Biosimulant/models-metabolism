...
"""Auto-generated SBML BioModule wrapper for Larocque2014 - Clostridium metabolic network reconstruction.

Source: biomodels_ebi:MODEL1407050000
Original: https://www.ebi.ac.uk/biomodels/MODEL1407050000
"""
...
class SbmlLarocque2014ClostridiumMetabolicNetworkReconstruction(biosim.BioModule):
    """BioModule wrapper for SBML model: Larocque2014 - Clostridium metabolic network reconstruction."""

    def __init__(self, model_path: str = "data/MODEL1407050000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Larocque2014ClostridiumMetabolicNetworkReconModel1407050000Model = SbmlLarocque2014ClostridiumMetabolicNetworkReconstruction
