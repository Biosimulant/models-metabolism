...
"""Auto-generated SBML BioModule wrapper for Oliveira2020 - Extended E. coli  Central Carbon Metabolism from Glucose.

Source: biomodels_ebi:MODEL2010030001
Original: https://www.ebi.ac.uk/biomodels/MODEL2010030001
"""
...
class SbmlOliveira2020ExtendedEColiCentralCarbonMetabolismFrom(biosim.BioModule):
    """BioModule wrapper for SBML model: Oliveira2020 - Extended E. coli  Central Carbon Metabolism from Glucose."""

    def __init__(self, model_path: str = "data/MODEL2010030001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Oliveira2020ExtendedEColiCentralCarbonMetaModel2010030001Model = SbmlOliveira2020ExtendedEColiCentralCarbonMetabolismFrom
