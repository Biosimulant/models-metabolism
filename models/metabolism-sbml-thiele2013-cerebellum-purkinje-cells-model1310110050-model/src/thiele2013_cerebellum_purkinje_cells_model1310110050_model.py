...
"""Auto-generated SBML BioModule wrapper for Thiele2013 - Cerebellum Purkinje cells.

Source: biomodels_ebi:MODEL1310110050
Original: https://www.ebi.ac.uk/biomodels/MODEL1310110050
"""
...
class SbmlThiele2013CerebellumPurkinjeCells(biosim.BioModule):
    """BioModule wrapper for SBML model: Thiele2013 - Cerebellum Purkinje cells."""

    def __init__(self, model_path: str = "data/MODEL1310110050.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Thiele2013CerebellumPurkinjeCellsModel1310110050Model = SbmlThiele2013CerebellumPurkinjeCells
