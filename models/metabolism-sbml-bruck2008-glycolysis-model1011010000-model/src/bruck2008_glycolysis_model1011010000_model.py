...
"""Auto-generated SBML BioModule wrapper for Bruck2008_Glycolysis.

Source: biomodels_ebi:MODEL1011010000
Original: https://www.ebi.ac.uk/biomodels/MODEL1011010000
"""
...
class SbmlBruck2008Glycolysis(biosim.BioModule):
    """BioModule wrapper for SBML model: Bruck2008_Glycolysis."""

    def __init__(self, model_path: str = "data/MODEL1011010000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Bruck2008GlycolysisModel1011010000Model = SbmlBruck2008Glycolysis
