...
"""Auto-generated SBML BioModule wrapper for Thiele2013 - Oral mucosa squamous epithelial cells.

Source: biomodels_ebi:MODEL1310110027
Original: https://www.ebi.ac.uk/biomodels/MODEL1310110027
"""
...
class SbmlThiele2013OralMucosaSquamousEpithelialCells(biosim.BioModule):
    """BioModule wrapper for SBML model: Thiele2013 - Oral mucosa squamous epithelial cells."""

    def __init__(self, model_path: str = "data/MODEL1310110027.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Thiele2013OralMucosaSquamousEpithelialCellsModel1310110027Model = SbmlThiele2013OralMucosaSquamousEpithelialCells
