...
"""Auto-generated SBML BioModule wrapper for MartínJiménez2017 - Genome-scale reconstruction of the human astrocyte metabolic network.

Source: biomodels_ebi:MODEL1608180000
Original: https://www.ebi.ac.uk/biomodels/MODEL1608180000
"""
...
class SbmlMartinjimenez2017GenomeScaleReconstructionOfTheHuman(biosim.BioModule):
    """BioModule wrapper for SBML model: MartínJiménez2017 - Genome-scale reconstruction of the human astrocyte metabolic network."""

    def __init__(self, model_path: str = "data/MODEL1608180000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
MartNjimNez2017GenomeScaleReconstructionOfModel1608180000Model = SbmlMartinjimenez2017GenomeScaleReconstructionOfTheHuman
