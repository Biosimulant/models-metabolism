...
"""Auto-generated SBML BioModule wrapper for Czajka2024 - Lipomyces genome scale model.

Source: biomodels_ebi:MODEL2403190001
Original: https://www.ebi.ac.uk/biomodels/MODEL2403190001
"""
...
class SbmlCzajka2024LipomycesGenomeScaleModel(biosim.BioModule):
    """BioModule wrapper for SBML model: Czajka2024 - Lipomyces genome scale model."""

    def __init__(self, model_path: str = "data/MODEL2403190001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Czajka2024LipomycesGenomeScaleModelModel2403190001Model = SbmlCzajka2024LipomycesGenomeScaleModel
