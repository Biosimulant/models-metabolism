...
"""Auto-generated SBML BioModule wrapper for Villanova2017 - Mixotrophic metabolism in the model diatom Phaeodactylum tricornutum.

Source: biomodels_ebi:MODEL2102080001
Original: https://www.ebi.ac.uk/biomodels/MODEL2102080001
"""
...
class SbmlVillanova2017MixotrophicMetabolismInTheModelDiatom(biosim.BioModule):
    """BioModule wrapper for SBML model: Villanova2017 - Mixotrophic metabolism in the model diatom Phaeodactylum tricornutum."""

    def __init__(self, model_path: str = "data/MODEL2102080001.sbml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Villanova2017MixotrophicMetabolismInTheModeModel2102080001Model = SbmlVillanova2017MixotrophicMetabolismInTheModelDiatom
