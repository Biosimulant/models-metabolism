...
"""Auto-generated SBML BioModule wrapper for Cottret2010_S_muelleri_Met_Net.

Source: biomodels_ebi:MODEL1011080000
Original: https://www.ebi.ac.uk/biomodels/MODEL1011080000
"""
...
class SbmlCottret2010SMuelleriMetNet(biosim.BioModule):
    """BioModule wrapper for SBML model: Cottret2010_S_muelleri_Met_Net."""

    def __init__(self, model_path: str = "data/MODEL1011080000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Cottret2010SMuelleriMetNetModel1011080000Model = SbmlCottret2010SMuelleriMetNet
