...
"""Auto-generated SBML BioModule wrapper for Cloutier2009_EnergyMetabolism_ModelF.

Source: biomodels_ebi:MODEL1006230096
Original: https://www.ebi.ac.uk/biomodels/MODEL1006230096
"""
...
class SbmlCloutier2009EnergymetabolismModelf(biosim.BioModule):
    """BioModule wrapper for SBML model: Cloutier2009_EnergyMetabolism_ModelF."""

    def __init__(self, model_path: str = "data/MODEL1006230096.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Cloutier2009EnergymetabolismModelfModel1006230096Model = SbmlCloutier2009EnergymetabolismModelf
