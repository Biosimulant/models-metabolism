...
"""Auto-generated SBML BioModule wrapper for Castillo2016 - Whole-genome metabolic model of C.glabrata using CoReCo.

Source: biomodels_ebi:MODEL1604280033
Original: https://www.ebi.ac.uk/biomodels/MODEL1604280033
"""
...
class SbmlCastillo2016WholeGenomeMetabolicModelOfCGlabrata(biosim.BioModule):
    """BioModule wrapper for SBML model: Castillo2016 - Whole-genome metabolic model of C.glabrata using CoReCo."""

    def __init__(self, model_path: str = "data/MODEL1604280033.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Castillo2016WholeGenomeMetabolicModelOfCGModel1604280033Model = SbmlCastillo2016WholeGenomeMetabolicModelOfCGlabrata
