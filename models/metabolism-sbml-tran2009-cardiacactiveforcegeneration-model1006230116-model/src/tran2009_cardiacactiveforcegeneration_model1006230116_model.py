...
"""Auto-generated SBML BioModule wrapper for Tran2009_CardiacActiveForceGeneration.

Source: biomodels_ebi:MODEL1006230116
Original: https://www.ebi.ac.uk/biomodels/MODEL1006230116
"""
...
class SbmlTran2009Cardiacactiveforcegeneration(biosim.BioModule):
    """BioModule wrapper for SBML model: Tran2009_CardiacActiveForceGeneration."""

    def __init__(self, model_path: str = "data/MODEL1006230116.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Tran2009CardiacactiveforcegenerationModel1006230116Model = SbmlTran2009Cardiacactiveforcegeneration
