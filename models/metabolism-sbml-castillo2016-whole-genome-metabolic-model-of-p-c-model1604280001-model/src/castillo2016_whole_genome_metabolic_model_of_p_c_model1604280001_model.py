...
"""Auto-generated SBML BioModule wrapper for Castillo2016 - Whole-genome metabolic model of P.chrysogenum using CoReCo.

Source: biomodels_ebi:MODEL1604280001
Original: https://www.ebi.ac.uk/biomodels/MODEL1604280001
"""
...
class SbmlCastillo2016WholeGenomeMetabolicModelOfPChrysogenum(biosim.BioModule):
    """BioModule wrapper for SBML model: Castillo2016 - Whole-genome metabolic model of P.chrysogenum using CoReCo."""

    def __init__(self, model_path: str = "data/MODEL1604280001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Castillo2016WholeGenomeMetabolicModelOfPCModel1604280001Model = SbmlCastillo2016WholeGenomeMetabolicModelOfPChrysogenum
