...
"""Auto-generated SBML BioModule wrapper for Bulik2016 - Regulation of hepatic glucose metabolism.

Source: biomodels_ebi:BIOMD0000000633
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000633
"""
...
class SbmlBulik2016RegulationOfHepaticGlucoseMetabolism(biosim.BioModule):
    """BioModule wrapper for SBML model: Bulik2016 - Regulation of hepatic glucose metabolism."""

    def __init__(self, model_path: str = "data/BIOMD0000000633.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Bulik2016RegulationOfHepaticGlucoseMetaboliBiomd0000000633Model = SbmlBulik2016RegulationOfHepaticGlucoseMetabolism
