...
"""Auto-generated SBML BioModule wrapper for Pitkanen2014 - Metabolic reconstruction of Lodderomyces elongisporus using CoReCo.

Source: biomodels_ebi:MODEL1302010033
Original: https://www.ebi.ac.uk/biomodels/MODEL1302010033
"""
...
class SbmlPitkanen2014MetabolicReconstructionOfLodderomyces(biosim.BioModule):
    """BioModule wrapper for SBML model: Pitkanen2014 - Metabolic reconstruction of Lodderomyces elongisporus using CoReCo."""

    def __init__(self, model_path: str = "data/MODEL1302010033.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Pitkanen2014MetabolicReconstructionOfLodderoModel1302010033Model = SbmlPitkanen2014MetabolicReconstructionOfLodderomyces
