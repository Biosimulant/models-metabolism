...
"""Auto-generated SBML BioModule wrapper for Ankrah2019 Syntrophic splitting of central carbon metabolism in host cells bearing functionally-different symbiotic bacteria.

Source: biomodels_ebi:MODEL1908040002
Original: https://www.ebi.ac.uk/biomodels/MODEL1908040002
"""
...
class SbmlAnkrah2019SyntrophicSplittingOfCentralCarbon(biosim.BioModule):
    """BioModule wrapper for SBML model: Ankrah2019 Syntrophic splitting of central carbon metabolism in host cells bearing functionally-different symbiotic bacteria."""

    def __init__(self, model_path: str = "data/MODEL1908040002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Ankrah2019SyntrophicSplittingOfCentralCarboModel1908040002Model = SbmlAnkrah2019SyntrophicSplittingOfCentralCarbon
