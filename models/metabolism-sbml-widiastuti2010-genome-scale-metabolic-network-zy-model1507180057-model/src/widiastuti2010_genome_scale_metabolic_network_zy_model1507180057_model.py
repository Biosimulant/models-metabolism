...
"""Auto-generated SBML BioModule wrapper for Widiastuti2010 - Genome-scale metabolic network Zymomonas mobilis (iZM363).

Source: biomodels_ebi:MODEL1507180057
Original: https://www.ebi.ac.uk/biomodels/MODEL1507180057
"""
...
class SbmlWidiastuti2010GenomeScaleMetabolicNetworkZymomonas(biosim.BioModule):
    """BioModule wrapper for SBML model: Widiastuti2010 - Genome-scale metabolic network Zymomonas mobilis (iZM363)."""

    def __init__(self, model_path: str = "data/MODEL1507180057.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Widiastuti2010GenomeScaleMetabolicNetworkZyModel1507180057Model = SbmlWidiastuti2010GenomeScaleMetabolicNetworkZymomonas
