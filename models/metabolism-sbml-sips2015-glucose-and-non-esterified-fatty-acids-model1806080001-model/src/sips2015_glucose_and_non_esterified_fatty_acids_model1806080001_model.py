...
"""Auto-generated SBML BioModule wrapper for Sips2015 - Glucose and non-esterified fatty acids (NEFA) metabolism.

Source: biomodels_ebi:MODEL1806080001
Original: https://www.ebi.ac.uk/biomodels/MODEL1806080001
"""
...
class SbmlSips2015GlucoseAndNonEsterifiedFattyAcidsNefa(biosim.BioModule):
    """BioModule wrapper for SBML model: Sips2015 - Glucose and non-esterified fatty acids (NEFA) metabolism."""

    def __init__(self, model_path: str = "data/MODEL1806080001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Sips2015GlucoseAndNonEsterifiedFattyAcidsModel1806080001Model = SbmlSips2015GlucoseAndNonEsterifiedFattyAcidsNefa
