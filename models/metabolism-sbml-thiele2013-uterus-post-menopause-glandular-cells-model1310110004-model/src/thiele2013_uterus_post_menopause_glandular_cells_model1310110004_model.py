...
"""Auto-generated SBML BioModule wrapper for Thiele2013 - Uterus post menopause glandular cells.

Source: biomodels_ebi:MODEL1310110004
Original: https://www.ebi.ac.uk/biomodels/MODEL1310110004
"""
...
class SbmlThiele2013UterusPostMenopauseGlandularCells(biosim.BioModule):
    """BioModule wrapper for SBML model: Thiele2013 - Uterus post menopause glandular cells."""

    def __init__(self, model_path: str = "data/MODEL1310110004.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Thiele2013UterusPostMenopauseGlandularCellsModel1310110004Model = SbmlThiele2013UterusPostMenopauseGlandularCells
