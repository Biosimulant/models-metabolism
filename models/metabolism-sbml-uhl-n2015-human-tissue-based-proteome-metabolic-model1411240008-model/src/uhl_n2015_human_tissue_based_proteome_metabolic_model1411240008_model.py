...
"""Auto-generated SBML BioModule wrapper for Uhlén2015 - Human tissue-based proteome metabolic network - thyroid.

Source: biomodels_ebi:MODEL1411240008
Original: https://www.ebi.ac.uk/biomodels/MODEL1411240008
"""
...
class SbmlUhlen2015HumanTissueBasedProteomeMetabolicNetwork17(biosim.BioModule):
    """BioModule wrapper for SBML model: Uhlén2015 - Human tissue-based proteome metabolic network - thyroid."""

    def __init__(self, model_path: str = "data/MODEL1411240008.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
UhlN2015HumanTissueBasedProteomeMetabolicModel1411240008Model = SbmlUhlen2015HumanTissueBasedProteomeMetabolicNetwork17
