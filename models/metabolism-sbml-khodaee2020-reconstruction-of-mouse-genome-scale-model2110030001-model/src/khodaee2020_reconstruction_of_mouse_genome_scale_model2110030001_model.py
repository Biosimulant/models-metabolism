...
"""Auto-generated SBML BioModule wrapper for Khodaee2020 - Reconstruction of Mouse Genome-Scale Metabolic Model iMM1865.

Source: biomodels_ebi:MODEL2110030001
Original: https://www.ebi.ac.uk/biomodels/MODEL2110030001
"""
...
class SbmlKhodaee2020ReconstructionOfMouseGenomeScaleMetabolic(biosim.BioModule):
    """BioModule wrapper for SBML model: Khodaee2020 - Reconstruction of Mouse Genome-Scale Metabolic Model iMM1865."""

    def __init__(self, model_path: str = "data/MODEL2110030001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Khodaee2020ReconstructionOfMouseGenomeScaleModel2110030001Model = SbmlKhodaee2020ReconstructionOfMouseGenomeScaleMetabolic
