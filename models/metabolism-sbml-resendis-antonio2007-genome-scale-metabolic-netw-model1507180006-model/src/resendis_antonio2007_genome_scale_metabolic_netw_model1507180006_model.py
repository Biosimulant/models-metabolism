...
"""Auto-generated SBML BioModule wrapper for Resendis-Antonio2007 - Genome-scale metabolic network of Rhizobium etli (iOR363).

Source: biomodels_ebi:MODEL1507180006
Original: https://www.ebi.ac.uk/biomodels/MODEL1507180006
"""
...
class SbmlResendisAntonio2007GenomeScaleMetabolicNetworkOf(biosim.BioModule):
    """BioModule wrapper for SBML model: Resendis-Antonio2007 - Genome-scale metabolic network of Rhizobium etli (iOR363)."""

    def __init__(self, model_path: str = "data/MODEL1507180006.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
ResendisAntonio2007GenomeScaleMetabolicNetwModel1507180006Model = SbmlResendisAntonio2007GenomeScaleMetabolicNetworkOf
