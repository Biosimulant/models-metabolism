...
"""Auto-generated SBML BioModule wrapper for Green1985 - whole-body vitamin A metabolism in rats.

Source: biomodels_ebi:MODEL2311220001
Original: https://www.ebi.ac.uk/biomodels/MODEL2311220001
"""
...
class SbmlGreen1985WholeBodyVitaminAMetabolismInRats(biosim.BioModule):
    """BioModule wrapper for SBML model: Green1985 - whole-body vitamin A metabolism in rats."""

    def __init__(self, model_path: str = "data/MODEL2311220001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Green1985WholeBodyVitaminAMetabolismInRatModel2311220001Model = SbmlGreen1985WholeBodyVitaminAMetabolismInRats
