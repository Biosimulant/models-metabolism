...
"""Auto-generated SBML BioModule wrapper for Castillo2016 - Whole-genome metabolic model of P.guilliermondii using CoReCo.

Source: biomodels_ebi:MODEL1604280007
Original: https://www.ebi.ac.uk/biomodels/MODEL1604280007
"""
...
class SbmlCastillo2016WholeGenomeMetabolicModelOfP(biosim.BioModule):
    """BioModule wrapper for SBML model: Castillo2016 - Whole-genome metabolic model of P.guilliermondii using CoReCo."""

    def __init__(self, model_path: str = "data/MODEL1604280007.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Castillo2016WholeGenomeMetabolicModelOfPGModel1604280007Model = SbmlCastillo2016WholeGenomeMetabolicModelOfP
