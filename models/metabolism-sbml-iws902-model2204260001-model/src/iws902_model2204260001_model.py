...
"""Auto-generated SBML BioModule wrapper for iWS902.

Source: biomodels_ebi:MODEL2204260001
Original: https://www.ebi.ac.uk/biomodels/MODEL2204260001
"""
...
class SbmlIws902(biosim.BioModule):
    """BioModule wrapper for SBML model: iWS902."""

    def __init__(self, model_path: str = "data/MODEL2204260001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Iws902Model2204260001Model = SbmlIws902
