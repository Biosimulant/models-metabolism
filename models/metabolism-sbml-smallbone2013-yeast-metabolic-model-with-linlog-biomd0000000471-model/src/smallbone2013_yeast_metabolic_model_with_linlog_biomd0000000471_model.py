...
"""Auto-generated SBML BioModule wrapper for Smallbone2013 - Yeast metabolic model with linlog rate law.

Source: biomodels_ebi:BIOMD0000000471
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000471
"""
...
class SbmlSmallbone2013YeastMetabolicModelWithLinlogRateLaw(biosim.BioModule):
    """BioModule wrapper for SBML model: Smallbone2013 - Yeast metabolic model with linlog rate law."""

    def __init__(self, model_path: str = "data/BIOMD0000000471.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Smallbone2013YeastMetabolicModelWithLinlogBiomd0000000471Model = SbmlSmallbone2013YeastMetabolicModelWithLinlogRateLaw
