...
"""Auto-generated SBML BioModule wrapper for Saldivar2024 - iAS473 - Methylacidiphilum fumariolicum - GEM.

Source: biomodels_ebi:MODEL2308220001
Original: https://www.ebi.ac.uk/biomodels/MODEL2308220001
"""
...
class SbmlSaldivar2024Ias473MethylacidiphilumFumariolicumGem(biosim.BioModule):
    """BioModule wrapper for SBML model: Saldivar2024 - iAS473 - Methylacidiphilum fumariolicum - GEM."""

    def __init__(self, model_path: str = "data/MODEL2308220001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Saldivar2024Ias473MethylacidiphilumFumariolicModel2308220001Model = SbmlSaldivar2024Ias473MethylacidiphilumFumariolicumGem
