...
"""Auto-generated SBML BioModule wrapper for Nogales2020 - Genome-scale metabolic network of Pseudomonas putida (iJN1462).

Source: biomodels_ebi:BIOMD0000001093
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000001093
"""
...
class SbmlNogales2020GenomeScaleMetabolicNetworkOfPseudomonas(biosim.BioModule):
    """BioModule wrapper for SBML model: Nogales2020 - Genome-scale metabolic network of Pseudomonas putida (iJN1462)."""

    def __init__(self, model_path: str = "data/BIOMD0000001093.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Nogales2020GenomeScaleMetabolicNetworkOfPsBiomd0000001093Model = SbmlNogales2020GenomeScaleMetabolicNetworkOfPseudomonas
