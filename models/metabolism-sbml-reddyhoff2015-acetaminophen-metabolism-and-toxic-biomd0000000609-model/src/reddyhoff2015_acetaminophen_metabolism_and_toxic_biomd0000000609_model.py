...
"""Auto-generated SBML BioModule wrapper for Reddyhoff2015 - Acetaminophen metabolism and toxicity.

Source: biomodels_ebi:BIOMD0000000609
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000609
"""
...
class SbmlReddyhoff2015AcetaminophenMetabolismAndToxicity(biosim.BioModule):
    """BioModule wrapper for SBML model: Reddyhoff2015 - Acetaminophen metabolism and toxicity."""

    def __init__(self, model_path: str = "data/BIOMD0000000609.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Reddyhoff2015AcetaminophenMetabolismAndToxicBiomd0000000609Model = SbmlReddyhoff2015AcetaminophenMetabolismAndToxicity
