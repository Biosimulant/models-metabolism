...
"""Auto-generated SBML BioModule wrapper for Reyes-Palomares2012 - a combined model hepatic polyamine and sulfur aminoacid metabolism - version1.

Source: biomodels_ebi:BIOMD0000000674
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000674
"""
...
class SbmlReyesPalomares2012ACombinedModelHepaticPolyamineAnd(bsim.BioModule):
    ...
    def __init__(self, model_path: str = "data/BIOMD0000000674.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
ReyesPalomares2012ACombinedModelHepaticPolBiomd0000000674Model = SbmlReyesPalomares2012ACombinedModelHepaticPolyamineAnd
