...
"""Auto-generated SBML BioModule wrapper for Green2024 - whole-body vitamin A metabolism in humans.

Source: biomodels_ebi:MODEL2411290001
Original: https://www.ebi.ac.uk/biomodels/MODEL2411290001
"""
...
class SbmlGreen2024WholeBodyVitaminAMetabolismInHumans(biosim.BioModule):
    """BioModule wrapper for SBML model: Green2024 - whole-body vitamin A metabolism in humans."""

    def __init__(self, model_path: str = "data/MODEL2411290001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Green2024WholeBodyVitaminAMetabolismInHumModel2411290001Model = SbmlGreen2024WholeBodyVitaminAMetabolismInHumans
