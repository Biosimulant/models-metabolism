...
"""Auto-generated SBML BioModule wrapper for Zou2012 - Genome-scale metabolic network of Ketogulonicigenium vulgare (iWZ663).

Source: biomodels_ebi:MODEL1507180039
Original: https://www.ebi.ac.uk/biomodels/MODEL1507180039
"""
...
class SbmlZou2012GenomeScaleMetabolicNetworkOf(biosim.BioModule):
    """BioModule wrapper for SBML model: Zou2012 - Genome-scale metabolic network of Ketogulonicigenium vulgare (iWZ663)."""

    def __init__(self, model_path: str = "data/MODEL1507180039.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Zou2012GenomeScaleMetabolicNetworkOfKetoguModel1507180039Model = SbmlZou2012GenomeScaleMetabolicNetworkOf
