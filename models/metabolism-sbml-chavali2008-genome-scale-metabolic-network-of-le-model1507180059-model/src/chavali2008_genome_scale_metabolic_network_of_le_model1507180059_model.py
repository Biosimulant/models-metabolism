...
"""Auto-generated SBML BioModule wrapper for Chavali2008 - Genome-scale metabolic network of Leishmania major (iAC560).

Source: biomodels_ebi:MODEL1507180059
Original: https://www.ebi.ac.uk/biomodels/MODEL1507180059
"""
...
class SbmlChavali2008GenomeScaleMetabolicNetworkOfLeishmania(biosim.BioModule):
    """BioModule wrapper for SBML model: Chavali2008 - Genome-scale metabolic network of Leishmania major (iAC560)."""

    def __init__(self, model_path: str = "data/MODEL1507180059.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Chavali2008GenomeScaleMetabolicNetworkOfLeModel1507180059Model = SbmlChavali2008GenomeScaleMetabolicNetworkOfLeishmania
