...
"""Auto-generated SBML BioModule wrapper for Bekaert2012 - Reconstruction of D.rerio Metabolic Network.

Source: biomodels_ebi:MODEL1204120000
Original: https://www.ebi.ac.uk/biomodels/MODEL1204120000
"""
...
class SbmlBekaert2012ReconstructionOfDRerioMetabolicNetwork(biosim.BioModule):
    """BioModule wrapper for SBML model: Bekaert2012 - Reconstruction of D.rerio Metabolic Network."""

    def __init__(self, model_path: str = "data/MODEL1204120000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Bekaert2012ReconstructionOfDRerioMetabolicModel1204120000Model = SbmlBekaert2012ReconstructionOfDRerioMetabolicNetwork
