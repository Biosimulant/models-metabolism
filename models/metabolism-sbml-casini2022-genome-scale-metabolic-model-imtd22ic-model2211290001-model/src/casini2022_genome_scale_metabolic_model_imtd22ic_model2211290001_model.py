...
"""Auto-generated SBML BioModule wrapper for Casini2022 - genome scale metabolic model (iMTD22IC) of Methanothermobacter thermautotrophicus Delta H.

Source: biomodels_ebi:MODEL2211290001
Original: https://www.ebi.ac.uk/biomodels/MODEL2211290001
"""
...
class SbmlCasini2022GenomeScaleMetabolicModelImtd22icOf(biosim.BioModule):
    """BioModule wrapper for SBML model: Casini2022 - genome scale metabolic model (iMTD22IC) of Methanothermobacter thermautotrophicus Delta H."""

    def __init__(self, model_path: str = "data/MODEL2211290001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Casini2022GenomeScaleMetabolicModelImtd22icModel2211290001Model = SbmlCasini2022GenomeScaleMetabolicModelImtd22icOf
