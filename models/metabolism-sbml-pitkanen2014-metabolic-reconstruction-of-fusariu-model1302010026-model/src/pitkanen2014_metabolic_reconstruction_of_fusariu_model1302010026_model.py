...
"""Auto-generated SBML BioModule wrapper for Pitkanen2014 - Metabolic reconstruction of Fusarium graminearum using CoReCo.

Source: biomodels_ebi:MODEL1302010026
Original: https://www.ebi.ac.uk/biomodels/MODEL1302010026
"""
...
class SbmlPitkanen2014MetabolicReconstructionOfFusarium(biosim.BioModule):
    """BioModule wrapper for SBML model: Pitkanen2014 - Metabolic reconstruction of Fusarium graminearum using CoReCo."""

    def __init__(self, model_path: str = "data/MODEL1302010026.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Pitkanen2014MetabolicReconstructionOfFusariuModel1302010026Model = SbmlPitkanen2014MetabolicReconstructionOfFusarium
