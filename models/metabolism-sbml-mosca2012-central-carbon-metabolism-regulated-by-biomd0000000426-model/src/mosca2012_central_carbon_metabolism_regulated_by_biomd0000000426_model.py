...
"""Auto-generated SBML BioModule wrapper for Mosca2012 - Central Carbon Metabolism Regulated by AKT.

Source: biomodels_ebi:BIOMD0000000426
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000426
"""
...
class SbmlMosca2012CentralCarbonMetabolismRegulatedByAkt(biosim.BioModule):
    """BioModule wrapper for SBML model: Mosca2012 - Central Carbon Metabolism Regulated by AKT."""

    def __init__(self, model_path: str = "data/BIOMD0000000426.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Mosca2012CentralCarbonMetabolismRegulatedByBiomd0000000426Model = SbmlMosca2012CentralCarbonMetabolismRegulatedByAkt
