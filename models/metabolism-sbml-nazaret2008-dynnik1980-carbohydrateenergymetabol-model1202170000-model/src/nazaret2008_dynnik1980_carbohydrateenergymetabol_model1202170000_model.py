...
"""Auto-generated SBML BioModule wrapper for Nazaret2008_Dynnik1980_CarbohydrateEnergyMetabolism.

Source: biomodels_ebi:MODEL1202170000
Original: https://www.ebi.ac.uk/biomodels/MODEL1202170000
"""
...
class SbmlNazaret2008Dynnik1980Carbohydrateenergymetabolism(biosim.BioModule):
    """BioModule wrapper for SBML model: Nazaret2008_Dynnik1980_CarbohydrateEnergyMetabolism."""

    def __init__(self, model_path: str = "data/MODEL1202170000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Nazaret2008Dynnik1980CarbohydrateenergymetabolModel1202170000Model = SbmlNazaret2008Dynnik1980Carbohydrateenergymetabolism
