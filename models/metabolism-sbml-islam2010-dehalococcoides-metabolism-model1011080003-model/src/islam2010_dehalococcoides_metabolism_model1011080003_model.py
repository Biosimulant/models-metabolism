...
"""Auto-generated SBML BioModule wrapper for Islam2010_Dehalococcoides_Metabolism.

Source: biomodels_ebi:MODEL1011080003
Original: https://www.ebi.ac.uk/biomodels/MODEL1011080003
"""
...
class SbmlIslam2010DehalococcoidesMetabolism(biosim.BioModule):
    """BioModule wrapper for SBML model: Islam2010_Dehalococcoides_Metabolism."""

    def __init__(self, model_path: str = "data/MODEL1011080003.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Islam2010DehalococcoidesMetabolismModel1011080003Model = SbmlIslam2010DehalococcoidesMetabolism
