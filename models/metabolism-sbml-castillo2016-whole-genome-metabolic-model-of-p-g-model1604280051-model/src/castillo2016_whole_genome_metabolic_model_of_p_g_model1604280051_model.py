...
"""Auto-generated SBML BioModule wrapper for Castillo2016 - Whole-genome metabolic model of P.graminis using CoReCo.

Source: biomodels_ebi:MODEL1604280051
Original: https://www.ebi.ac.uk/biomodels/MODEL1604280051
"""
...
class SbmlCastillo2016WholeGenomeMetabolicModelOfPGraminis(biosim.BioModule):
    """BioModule wrapper for SBML model: Castillo2016 - Whole-genome metabolic model of P.graminis using CoReCo."""

    def __init__(self, model_path: str = "data/MODEL1604280051.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Castillo2016WholeGenomeMetabolicModelOfPGModel1604280051Model = SbmlCastillo2016WholeGenomeMetabolicModelOfPGraminis
