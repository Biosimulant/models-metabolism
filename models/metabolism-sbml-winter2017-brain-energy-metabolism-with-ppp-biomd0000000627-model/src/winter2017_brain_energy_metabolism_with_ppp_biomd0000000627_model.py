...
"""Auto-generated SBML BioModule wrapper for Winter2017 - Brain Energy Metabolism with PPP.

Source: biomodels_ebi:BIOMD0000000627
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000627
"""
...
class SbmlWinter2017BrainEnergyMetabolismWithPpp(biosim.BioModule):
    """BioModule wrapper for SBML model: Winter2017 - Brain Energy Metabolism with PPP."""

    def __init__(self, model_path: str = "data/BIOMD0000000627.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Winter2017BrainEnergyMetabolismWithPppBiomd0000000627Model = SbmlWinter2017BrainEnergyMetabolismWithPpp
