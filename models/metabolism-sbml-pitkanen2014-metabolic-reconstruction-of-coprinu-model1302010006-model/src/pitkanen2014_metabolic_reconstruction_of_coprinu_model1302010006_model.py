...
"""Auto-generated SBML BioModule wrapper for Pitkanen2014 - Metabolic reconstruction of Coprinus cinereus using CoReCo.

Source: biomodels_ebi:MODEL1302010006
Original: https://www.ebi.ac.uk/biomodels/MODEL1302010006
"""
...
class SbmlPitkanen2014MetabolicReconstructionOfCoprinusCinereus(biosim.BioModule):
    """BioModule wrapper for SBML model: Pitkanen2014 - Metabolic reconstruction of Coprinus cinereus using CoReCo."""

    def __init__(self, model_path: str = "data/MODEL1302010006.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Pitkanen2014MetabolicReconstructionOfCoprinuModel1302010006Model = SbmlPitkanen2014MetabolicReconstructionOfCoprinusCinereus
