...
"""Auto-generated SBML BioModule wrapper for Thomas2009_Buchnera_a_FBA.

Source: biomodels_ebi:MODEL7434234848
Original: https://www.ebi.ac.uk/biomodels/MODEL7434234848
"""
...
class SbmlThomas2009BuchneraAFba(biosim.BioModule):
    """BioModule wrapper for SBML model: Thomas2009_Buchnera_a_FBA."""

    def __init__(self, model_path: str = "data/MODEL7434234848.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Thomas2009BuchneraAFbaModel7434234848Model = SbmlThomas2009BuchneraAFba
