...
"""Auto-generated SBML BioModule wrapper for Ford2020 - whole-body vitamin A metabolism in humans.

Source: biomodels_ebi:MODEL2312190001
Original: https://www.ebi.ac.uk/biomodels/MODEL2312190001
"""
...
class SbmlFord2020WholeBodyVitaminAMetabolismInHumans(biosim.BioModule):
    """BioModule wrapper for SBML model: Ford2020 - whole-body vitamin A metabolism in humans."""

    def __init__(self, model_path: str = "data/MODEL2312190001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Ford2020WholeBodyVitaminAMetabolismInHumaModel2312190001Model = SbmlFord2020WholeBodyVitaminAMetabolismInHumans
