...
"""Auto-generated SBML BioModule wrapper for Thiele2013 - Pancreas islets of Langerhans.

Source: biomodels_ebi:MODEL1310110013
Original: https://www.ebi.ac.uk/biomodels/MODEL1310110013
"""
...
class SbmlThiele2013PancreasIsletsOfLangerhans(biosim.BioModule):
    """BioModule wrapper for SBML model: Thiele2013 - Pancreas islets of Langerhans."""

    def __init__(self, model_path: str = "data/MODEL1310110013.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Thiele2013PancreasIsletsOfLangerhansModel1310110013Model = SbmlThiele2013PancreasIsletsOfLangerhans
