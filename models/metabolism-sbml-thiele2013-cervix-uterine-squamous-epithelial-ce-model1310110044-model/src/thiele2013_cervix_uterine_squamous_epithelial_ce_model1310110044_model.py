...
"""Auto-generated SBML BioModule wrapper for Thiele2013 - Cervix uterine squamous epithelial cells.

Source: biomodels_ebi:MODEL1310110044
Original: https://www.ebi.ac.uk/biomodels/MODEL1310110044
"""
...
class SbmlThiele2013CervixUterineSquamousEpithelialCells(biosim.BioModule):
    """BioModule wrapper for SBML model: Thiele2013 - Cervix uterine squamous epithelial cells."""

    def __init__(self, model_path: str = "data/MODEL1310110044.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Thiele2013CervixUterineSquamousEpithelialCeModel1310110044Model = SbmlThiele2013CervixUterineSquamousEpithelialCells
