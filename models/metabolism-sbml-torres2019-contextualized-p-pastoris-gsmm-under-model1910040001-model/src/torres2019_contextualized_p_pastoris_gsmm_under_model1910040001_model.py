...
"""Auto-generated SBML BioModule wrapper for Torres2019 - Contextualized P. pastoris GSMM under glucose growth and various oxygenation levels.

Source: biomodels_ebi:MODEL1910040001
Original: https://www.ebi.ac.uk/biomodels/MODEL1910040001
"""
...
class SbmlTorres2019ContextualizedPPastorisGsmmUnderGlucose(biosim.BioModule):
    """BioModule wrapper for SBML model: Torres2019 - Contextualized P. pastoris GSMM under glucose growth and various oxygenation levels."""

    def __init__(self, model_path: str = "data/MODEL1910040001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Torres2019ContextualizedPPastorisGsmmUnderModel1910040001Model = SbmlTorres2019ContextualizedPPastorisGsmmUnderGlucose
