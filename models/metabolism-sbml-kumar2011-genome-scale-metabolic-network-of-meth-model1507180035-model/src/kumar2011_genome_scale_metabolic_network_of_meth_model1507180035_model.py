...
"""Auto-generated SBML BioModule wrapper for Kumar2011 - Genome-scale metabolic network of Methanosarcina acetivorans (iVS941).

Source: biomodels_ebi:MODEL1507180035
Original: https://www.ebi.ac.uk/biomodels/MODEL1507180035
"""
...
class SbmlKumar2011GenomeScaleMetabolicNetworkOfMethanosarcina(biosim.BioModule):
    """BioModule wrapper for SBML model: Kumar2011 - Genome-scale metabolic network of Methanosarcina acetivorans (iVS941)."""

    def __init__(self, model_path: str = "data/MODEL1507180035.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Kumar2011GenomeScaleMetabolicNetworkOfMethModel1507180035Model = SbmlKumar2011GenomeScaleMetabolicNetworkOfMethanosarcina
