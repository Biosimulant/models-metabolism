...
"""Auto-generated SBML BioModule wrapper for Sohn2010 - Genome-scale metabolic network of Pichia pastoris (PpaMBEL1254).

Source: biomodels_ebi:MODEL1507180050
Original: https://www.ebi.ac.uk/biomodels/MODEL1507180050
"""
...
class SbmlSohn2010GenomeScaleMetabolicNetworkOfPichiaPastoris(biosim.BioModule):
    """BioModule wrapper for SBML model: Sohn2010 - Genome-scale metabolic network of Pichia pastoris (PpaMBEL1254)."""

    def __init__(self, model_path: str = "data/MODEL1507180050.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Sohn2010GenomeScaleMetabolicNetworkOfPichiModel1507180050Model = SbmlSohn2010GenomeScaleMetabolicNetworkOfPichiaPastoris
