...
"""Auto-generated SBML BioModule wrapper for Mulquiney1999_BPG_metabolism.

Source: biomodels_ebi:MODEL5950552398
Original: https://www.ebi.ac.uk/biomodels/MODEL5950552398
"""
...
class SbmlMulquiney1999BpgMetabolism(biosim.BioModule):
    """BioModule wrapper for SBML model: Mulquiney1999_BPG_metabolism."""

    def __init__(self, model_path: str = "data/MODEL5950552398.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Mulquiney1999BpgMetabolismModel5950552398Model = SbmlMulquiney1999BpgMetabolism
