...
"""Auto-generated SBML BioModule wrapper for Wodke2013 - Genome-scale constraint-based model of M.pneumoniae energy metabolism (iJW145).

Source: biomodels_ebi:MODEL1301290000
Original: https://www.ebi.ac.uk/biomodels/MODEL1301290000
"""
...
class SbmlWodke2013GenomeScaleConstraintBasedModelOfM(biosim.BioModule):
    """BioModule wrapper for SBML model: Wodke2013 - Genome-scale constraint-based model of M.pneumoniae energy metabolism (iJW145)."""

    def __init__(self, model_path: str = "data/MODEL1301290000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Wodke2013GenomeScaleConstraintBasedModelOfModel1301290000Model = SbmlWodke2013GenomeScaleConstraintBasedModelOfM
