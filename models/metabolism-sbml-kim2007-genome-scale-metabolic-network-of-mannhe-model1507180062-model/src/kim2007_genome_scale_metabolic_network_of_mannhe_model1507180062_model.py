...
"""Auto-generated SBML BioModule wrapper for Kim2007 - Genome-scale metabolic network of Mannheimia succiniciproducens (iTY425).

Source: biomodels_ebi:MODEL1507180062
Original: https://www.ebi.ac.uk/biomodels/MODEL1507180062
"""
...
class SbmlKim2007GenomeScaleMetabolicNetworkOfMannheimia(biosim.BioModule):
    """BioModule wrapper for SBML model: Kim2007 - Genome-scale metabolic network of Mannheimia succiniciproducens (iTY425)."""

    def __init__(self, model_path: str = "data/MODEL1507180062.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Kim2007GenomeScaleMetabolicNetworkOfMannheModel1507180062Model = SbmlKim2007GenomeScaleMetabolicNetworkOfMannheimia
