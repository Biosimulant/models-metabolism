...
"""Auto-generated SBML BioModule wrapper for RaynaNolen_2024_PFOS_Zebrafish_GEMs.

Source: biomodels_ebi:MODEL2403010004
Original: https://www.ebi.ac.uk/biomodels/MODEL2403010004
"""
...
class SbmlRaynanolen2024PfosZebrafishGems(biosim.BioModule):
    """BioModule wrapper for SBML model: RaynaNolen_2024_PFOS_Zebrafish_GEMs."""

    def __init__(self, model_path: str = "data/MODEL2403010004.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Raynanolen2024PfosZebrafishGemsModel2403010004Model = SbmlRaynanolen2024PfosZebrafishGems
