...
"""Auto-generated SBML BioModule wrapper for Haiman2020 - Full Kinase Regulatory Model of Erythrocyte Glycolysis.

Source: biomodels_ebi:MODEL2012150001
Original: https://www.ebi.ac.uk/biomodels/MODEL2012150001
"""
...
class SbmlHaiman2020FullKinaseRegulatoryModelOfErythrocyte(biosim.BioModule):
    """BioModule wrapper for SBML model: Haiman2020 - Full Kinase Regulatory Model of Erythrocyte Glycolysis."""

    def __init__(self, model_path: str = "data/MODEL2012150001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Haiman2020FullKinaseRegulatoryModelOfErythModel2012150001Model = SbmlHaiman2020FullKinaseRegulatoryModelOfErythrocyte
