...
"""Auto-generated SBML BioModule wrapper for Garde2020 - metabolic oscillations in Bacillus subtilis biofilms.

Source: biomodels_ebi:BIOMD0000001053
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000001053
"""
...
class SbmlGarde2020MetabolicOscillationsInBacillusSubtilis(biosim.BioModule):
    """BioModule wrapper for SBML model: Garde2020 - metabolic oscillations in Bacillus subtilis biofilms."""

    def __init__(self, model_path: str = "data/BIOMD0000001053.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Garde2020MetabolicOscillationsInBacillusSubBiomd0000001053Model = SbmlGarde2020MetabolicOscillationsInBacillusSubtilis
