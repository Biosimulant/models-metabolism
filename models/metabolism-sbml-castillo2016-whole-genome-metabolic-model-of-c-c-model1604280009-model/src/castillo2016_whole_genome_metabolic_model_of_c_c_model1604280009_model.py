...
"""Auto-generated SBML BioModule wrapper for Castillo2016 - Whole-genome metabolic model of C.cinereus using CoReCo.

Source: biomodels_ebi:MODEL1604280009
Original: https://www.ebi.ac.uk/biomodels/MODEL1604280009
"""
...
class SbmlCastillo2016WholeGenomeMetabolicModelOfCCinereus(biosim.BioModule):
    """BioModule wrapper for SBML model: Castillo2016 - Whole-genome metabolic model of C.cinereus using CoReCo."""

    def __init__(self, model_path: str = "data/MODEL1604280009.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Castillo2016WholeGenomeMetabolicModelOfCCModel1604280009Model = SbmlCastillo2016WholeGenomeMetabolicModelOfCCinereus
