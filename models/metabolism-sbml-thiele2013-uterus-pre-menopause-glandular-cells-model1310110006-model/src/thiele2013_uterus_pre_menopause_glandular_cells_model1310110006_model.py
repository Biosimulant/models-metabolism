...
"""Auto-generated SBML BioModule wrapper for Thiele2013 - Uterus pre menopause glandular cells.

Source: biomodels_ebi:MODEL1310110006
Original: https://www.ebi.ac.uk/biomodels/MODEL1310110006
"""
...
class SbmlThiele2013UterusPreMenopauseGlandularCells(biosim.BioModule):
    """BioModule wrapper for SBML model: Thiele2013 - Uterus pre menopause glandular cells."""

    def __init__(self, model_path: str = "data/MODEL1310110006.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Thiele2013UterusPreMenopauseGlandularCellsModel1310110006Model = SbmlThiele2013UterusPreMenopauseGlandularCells
