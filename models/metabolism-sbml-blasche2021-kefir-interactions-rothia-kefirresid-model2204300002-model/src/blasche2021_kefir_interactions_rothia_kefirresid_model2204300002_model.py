...
"""Auto-generated SBML BioModule wrapper for Blasche2021 - Kefir interactions, Rothia kefirresidentii KRP.

Source: biomodels_ebi:MODEL2204300002
Original: https://www.ebi.ac.uk/biomodels/MODEL2204300002
"""
...
class SbmlBlasche2021KefirInteractionsRothiaKefirresidentiiKrp(biosim.BioModule):
    """BioModule wrapper for SBML model: Blasche2021 - Kefir interactions, Rothia kefirresidentii KRP."""

    def __init__(self, model_path: str = "data/MODEL2204300002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Blasche2021KefirInteractionsRothiaKefirresidModel2204300002Model = SbmlBlasche2021KefirInteractionsRothiaKefirresidentiiKrp
