...
"""Auto-generated SBML BioModule wrapper for Gautam2020-Metabolic network of Thermotoga sp. Strain RQ7.

Source: biomodels_ebi:BIOMD0000001092
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000001092
"""
...
class SbmlGautam2020MetabolicNetworkOfThermotogaSpStrainRq7(biosim.BioModule):
    """BioModule wrapper for SBML model: Gautam2020-Metabolic network of Thermotoga sp. Strain RQ7."""

    def __init__(self, model_path: str = "data/BIOMD0000001092.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Gautam2020MetabolicNetworkOfThermotogaSpStBiomd0000001092Model = SbmlGautam2020MetabolicNetworkOfThermotogaSpStrainRq7
