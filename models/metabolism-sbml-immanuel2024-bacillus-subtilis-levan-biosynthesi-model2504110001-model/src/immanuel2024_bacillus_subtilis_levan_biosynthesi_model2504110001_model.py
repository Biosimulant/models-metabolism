...
"""Auto-generated SBML BioModule wrapper for Immanuel2024 - Bacillus subtilis Levan Biosynthesis.

Source: biomodels_ebi:MODEL2504110001
Original: https://www.ebi.ac.uk/biomodels/MODEL2504110001
"""
...
class SbmlImmanuel2024BacillusSubtilisLevanBiosynthesis(biosim.BioModule):
    """BioModule wrapper for SBML model: Immanuel2024 - Bacillus subtilis Levan Biosynthesis."""

    def __init__(self, model_path: str = "data/MODEL2504110001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Immanuel2024BacillusSubtilisLevanBiosynthesiModel2504110001Model = SbmlImmanuel2024BacillusSubtilisLevanBiosynthesis
