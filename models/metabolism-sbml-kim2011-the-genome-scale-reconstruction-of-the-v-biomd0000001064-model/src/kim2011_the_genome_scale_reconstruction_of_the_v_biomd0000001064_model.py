...
"""Auto-generated SBML BioModule wrapper for Kim2011 - the genome scale reconstruction of the Vibrio vulnificus metabolic network - VvuMBEL943.

Source: biomodels_ebi:BIOMD0000001064
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000001064
"""
...
class SbmlKim2011TheGenomeScaleReconstructionOfTheVibrio(biosim.BioModule):
    """BioModule wrapper for SBML model: Kim2011 - the genome scale reconstruction of the Vibrio vulnificus metabolic network - VvuMBEL943."""

    def __init__(self, model_path: str = "data/BIOMD0000001064.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Kim2011TheGenomeScaleReconstructionOfTheVBiomd0000001064Model = SbmlKim2011TheGenomeScaleReconstructionOfTheVibrio
