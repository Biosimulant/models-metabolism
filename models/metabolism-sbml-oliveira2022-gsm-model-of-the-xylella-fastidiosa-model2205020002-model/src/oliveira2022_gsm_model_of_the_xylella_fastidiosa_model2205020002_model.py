...
"""Auto-generated SBML BioModule wrapper for Oliveira2022 - GSM Model of the Xylella fastidiosa’s_iMS508.

Source: biomodels_ebi:MODEL2205020002
Original: https://www.ebi.ac.uk/biomodels/MODEL2205020002
"""
...
class SbmlOliveira2022GsmModelOfTheXylellaFastidiosasIms508(biosim.BioModule):
    """BioModule wrapper for SBML model: Oliveira2022 - GSM Model of the Xylella fastidiosa’s_iMS508."""

    def __init__(self, model_path: str = "data/MODEL2205020002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Oliveira2022GsmModelOfTheXylellaFastidiosaModel2205020002Model = SbmlOliveira2022GsmModelOfTheXylellaFastidiosasIms508
