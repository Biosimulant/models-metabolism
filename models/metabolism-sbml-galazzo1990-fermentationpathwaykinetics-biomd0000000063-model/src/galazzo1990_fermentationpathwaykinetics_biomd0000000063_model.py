...
"""Auto-generated SBML BioModule wrapper for Galazzo1990_FermentationPathwayKinetics.

Source: biomodels_ebi:BIOMD0000000063
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000063
"""
...
class SbmlGalazzo1990Fermentationpathwaykinetics(biosim.BioModule):
    """BioModule wrapper for SBML model: Galazzo1990_FermentationPathwayKinetics."""

    def __init__(self, model_path: str = "data/BIOMD0000000063.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Galazzo1990FermentationpathwaykineticsBiomd0000000063Model = SbmlGalazzo1990Fermentationpathwaykinetics
