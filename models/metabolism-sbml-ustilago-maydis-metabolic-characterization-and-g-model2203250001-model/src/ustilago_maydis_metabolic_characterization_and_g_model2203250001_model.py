...
"""Auto-generated SBML BioModule wrapper for Ustilago maydis Metabolic Characterization and Growth Quantification with a Genome-Scale Metabolic Model.

Source: biomodels_ebi:MODEL2203250001
Original: https://www.ebi.ac.uk/biomodels/MODEL2203250001
"""
...
class SbmlUstilagoMaydisMetabolicCharacterizationAndGrowth(biosim.BioModule):
    """BioModule wrapper for SBML model: Ustilago maydis Metabolic Characterization and Growth Quantification with a Genome-Scale Metabolic Model."""

    def __init__(self, model_path: str = "data/MODEL2203250001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
UstilagoMaydisMetabolicCharacterizationAndGModel2203250001Model = SbmlUstilagoMaydisMetabolicCharacterizationAndGrowth
