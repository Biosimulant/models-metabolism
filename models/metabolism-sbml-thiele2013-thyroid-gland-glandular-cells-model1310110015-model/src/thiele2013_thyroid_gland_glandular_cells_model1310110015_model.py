...
"""Auto-generated SBML BioModule wrapper for Thiele2013 - Thyroid gland glandular cells.

Source: biomodels_ebi:MODEL1310110015
Original: https://www.ebi.ac.uk/biomodels/MODEL1310110015
"""
...
class SbmlThiele2013ThyroidGlandGlandularCells(biosim.BioModule):
    """BioModule wrapper for SBML model: Thiele2013 - Thyroid gland glandular cells."""

    def __init__(self, model_path: str = "data/MODEL1310110015.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Thiele2013ThyroidGlandGlandularCellsModel1310110015Model = SbmlThiele2013ThyroidGlandGlandularCells
