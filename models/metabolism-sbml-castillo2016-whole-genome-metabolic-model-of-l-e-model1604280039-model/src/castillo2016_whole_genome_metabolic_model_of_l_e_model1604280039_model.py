...
"""Auto-generated SBML BioModule wrapper for Castillo2016 - Whole-genome metabolic model of L.elongisporus using CoReCo.

Source: biomodels_ebi:MODEL1604280039
Original: https://www.ebi.ac.uk/biomodels/MODEL1604280039
"""
...
class SbmlCastillo2016WholeGenomeMetabolicModelOfLElongisporus(biosim.BioModule):
    """BioModule wrapper for SBML model: Castillo2016 - Whole-genome metabolic model of L.elongisporus using CoReCo."""

    def __init__(self, model_path: str = "data/MODEL1604280039.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Castillo2016WholeGenomeMetabolicModelOfLEModel1604280039Model = SbmlCastillo2016WholeGenomeMetabolicModelOfLElongisporus
