...
"""Auto-generated SBML BioModule wrapper for Ponce-de-Leon2015 - Genome-Scale Model of Bacterial Metabolism (MM130).

Source: biomodels_ebi:MODEL1601050000
Original: https://www.ebi.ac.uk/biomodels/MODEL1601050000
"""
...
class SbmlPonceDeLeon2015GenomeScaleModelOfBacterial(biosim.BioModule):
    """BioModule wrapper for SBML model: Ponce-de-Leon2015 - Genome-Scale Model of Bacterial Metabolism (MM130)."""

    def __init__(self, model_path: str = "data/MODEL1601050000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
PonceDeLeon2015GenomeScaleModelOfBacteriaModel1601050000Model = SbmlPonceDeLeon2015GenomeScaleModelOfBacterial
