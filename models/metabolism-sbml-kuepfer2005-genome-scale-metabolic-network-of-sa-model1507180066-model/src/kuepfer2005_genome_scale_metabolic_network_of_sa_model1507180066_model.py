...
"""Auto-generated SBML BioModule wrapper for Kuepfer2005 - Genome-scale metabolic network of Saccharomyces cerevisiae (iLL672).

Source: biomodels_ebi:MODEL1507180066
Original: https://www.ebi.ac.uk/biomodels/MODEL1507180066
"""
...
class SbmlKuepfer2005GenomeScaleMetabolicNetworkOfSaccharomyces(biosim.BioModule):
    """BioModule wrapper for SBML model: Kuepfer2005 - Genome-scale metabolic network of Saccharomyces cerevisiae (iLL672)."""

    def __init__(self, model_path: str = "data/MODEL1507180066.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Kuepfer2005GenomeScaleMetabolicNetworkOfSaModel1507180066Model = SbmlKuepfer2005GenomeScaleMetabolicNetworkOfSaccharomyces
