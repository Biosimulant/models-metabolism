...
"""Auto-generated SBML BioModule wrapper for Garde2020-Minimal model describing metabolic oscillations in Bacillus subtilis biofilms.

Source: biomodels_ebi:BIOMD0000000932
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000932
"""
...
class SbmlGarde2020MinimalModelDescribingMetabolicOscillations(biosim.BioModule):
    """BioModule wrapper for SBML model: Garde2020-Minimal model describing metabolic oscillations in Bacillus subtilis biofilms."""

    def __init__(self, model_path: str = "data/BIOMD0000000932.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Garde2020MinimalModelDescribingMetabolicOscBiomd0000000932Model = SbmlGarde2020MinimalModelDescribingMetabolicOscillations
