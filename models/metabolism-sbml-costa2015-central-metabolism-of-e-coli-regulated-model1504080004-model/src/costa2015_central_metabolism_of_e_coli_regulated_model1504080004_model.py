...
"""Auto-generated SBML BioModule wrapper for Costa2015 - Central metabolism of E. coli, regulated linlog model (with allosteric regulations).

Source: biomodels_ebi:MODEL1504080004
Original: https://www.ebi.ac.uk/biomodels/MODEL1504080004
"""
...
class SbmlCosta2015CentralMetabolismOfEColiRegulatedLinlog(biosim.BioModule):
    """BioModule wrapper for SBML model: Costa2015 - Central metabolism of E. coli, regulated linlog model (with allosteric regulations)."""

    def __init__(self, model_path: str = "data/MODEL1504080004.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Costa2015CentralMetabolismOfEColiRegulatedModel1504080004Model = SbmlCosta2015CentralMetabolismOfEColiRegulatedLinlog
