...
"""Auto-generated SBML BioModule wrapper for Mitchell2013 - Liver Iron Metabolism.

Source: biomodels_ebi:BIOMD0000000498
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000498
"""
...
class SbmlMitchell2013LiverIronMetabolism(biosim.BioModule):
    """BioModule wrapper for SBML model: Mitchell2013 - Liver Iron Metabolism."""

    def __init__(self, model_path: str = "data/BIOMD0000000498.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Mitchell2013LiverIronMetabolismBiomd0000000498Model = SbmlMitchell2013LiverIronMetabolism
