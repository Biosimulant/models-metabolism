...
"""Auto-generated SBML BioModule wrapper for Teusink1998_Glycolysis_TurboDesign.

Source: biomodels_ebi:BIOMD0000000253
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000253
"""
...
class SbmlTeusink1998GlycolysisTurbodesign(biosim.BioModule):
    """BioModule wrapper for SBML model: Teusink1998_Glycolysis_TurboDesign."""

    def __init__(self, model_path: str = "data/BIOMD0000000253.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Teusink1998GlycolysisTurbodesignBiomd0000000253Model = SbmlTeusink1998GlycolysisTurbodesign
