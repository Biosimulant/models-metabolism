...
"""Auto-generated SBML BioModule wrapper for Thiele2013 - Skin epidermal cells.

Source: biomodels_ebi:MODEL1310110003
Original: https://www.ebi.ac.uk/biomodels/MODEL1310110003
"""
...
class SbmlThiele2013SkinEpidermalCells(biosim.BioModule):
    """BioModule wrapper for SBML model: Thiele2013 - Skin epidermal cells."""

    def __init__(self, model_path: str = "data/MODEL1310110003.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Thiele2013SkinEpidermalCellsModel1310110003Model = SbmlThiele2013SkinEpidermalCells
