...
"""Auto-generated SBML BioModule wrapper for Zhuang2011 - Ecoli FBA with membrane economics.

Source: biomodels_ebi:MODEL1105030000
Original: https://www.ebi.ac.uk/biomodels/MODEL1105030000
"""
...
class SbmlZhuang2011EcoliFbaWithMembraneEconomics(biosim.BioModule):
    """BioModule wrapper for SBML model: Zhuang2011 - Ecoli FBA with membrane economics."""

    def __init__(self, model_path: str = "data/MODEL1105030000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Zhuang2011EcoliFbaWithMembraneEconomicsModel1105030000Model = SbmlZhuang2011EcoliFbaWithMembraneEconomics
