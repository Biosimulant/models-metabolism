...
"""Auto-generated SBML BioModule wrapper for Uhlén2015 - Human tissue-based proteome metabolic network - lung.

Source: biomodels_ebi:MODEL1411240011
Original: https://www.ebi.ac.uk/biomodels/MODEL1411240011
"""
...
class SbmlUhlen2015HumanTissueBasedProteomeMetabolicNetworkLung(biosim.BioModule):
    """BioModule wrapper for SBML model: Uhlén2015 - Human tissue-based proteome metabolic network - lung."""

    def __init__(self, model_path: str = "data/MODEL1411240011.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
UhlN2015HumanTissueBasedProteomeMetabolicModel1411240011Model = SbmlUhlen2015HumanTissueBasedProteomeMetabolicNetworkLung
