...
"""Auto-generated SBML BioModule wrapper for Hurbain2022 - Oxidative Stress Response model.

Source: biomodels_ebi:MODEL2204220001
Original: https://www.ebi.ac.uk/biomodels/MODEL2204220001
"""
...
class SbmlHurbain2022OxidativeStressResponseModel(biosim.BioModule):
    """BioModule wrapper for SBML model: Hurbain2022 - Oxidative Stress Response model."""

    def __init__(self, model_path: str = "data/MODEL2204220001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Hurbain2022OxidativeStressResponseModelModel2204220001Model = SbmlHurbain2022OxidativeStressResponseModel
