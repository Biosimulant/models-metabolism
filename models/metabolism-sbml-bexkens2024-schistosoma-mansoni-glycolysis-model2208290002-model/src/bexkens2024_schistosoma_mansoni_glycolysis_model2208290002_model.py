...
"""Auto-generated SBML BioModule wrapper for Bexkens2024 - Schistosoma mansoni glycolysis.

Source: biomodels_ebi:MODEL2208290002
Original: https://www.ebi.ac.uk/biomodels/MODEL2208290002
"""
...
class SbmlBexkens2024SchistosomaMansoniGlycolysis(biosim.BioModule):
    """BioModule wrapper for SBML model: Bexkens2024 - Schistosoma mansoni glycolysis."""

    def __init__(self, model_path: str = "data/MODEL2208290002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Bexkens2024SchistosomaMansoniGlycolysisModel2208290002Model = SbmlBexkens2024SchistosomaMansoniGlycolysis
