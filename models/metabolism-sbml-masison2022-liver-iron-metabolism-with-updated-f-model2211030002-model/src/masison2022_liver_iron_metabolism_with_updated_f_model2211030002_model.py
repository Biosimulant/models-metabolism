...
"""Auto-generated SBML BioModule wrapper for Masison2022 - Liver Iron Metabolism with updated ferritin.

Source: biomodels_ebi:MODEL2211030002
Original: https://www.ebi.ac.uk/biomodels/MODEL2211030002
"""
...
class SbmlMasison2022LiverIronMetabolismWithUpdatedFerritin(biosim.BioModule):
    """BioModule wrapper for SBML model: Masison2022 - Liver Iron Metabolism with updated ferritin."""

    def __init__(self, model_path: str = "data/MODEL2211030002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Masison2022LiverIronMetabolismWithUpdatedFModel2211030002Model = SbmlMasison2022LiverIronMetabolismWithUpdatedFerritin
