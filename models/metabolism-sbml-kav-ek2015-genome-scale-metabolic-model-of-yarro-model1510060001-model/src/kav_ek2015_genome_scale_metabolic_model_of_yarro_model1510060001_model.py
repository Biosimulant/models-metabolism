...
"""Auto-generated SBML BioModule wrapper for Kavšček2015 - Genome-scale metabolic model of Yarrowia lipolytica (iMK735).

Source: biomodels_ebi:MODEL1510060001
Original: https://www.ebi.ac.uk/biomodels/MODEL1510060001
"""
...
class SbmlKavscek2015GenomeScaleMetabolicModelOfYarrowia(biosim.BioModule):
    """BioModule wrapper for SBML model: Kavšček2015 - Genome-scale metabolic model of Yarrowia lipolytica (iMK735)."""

    def __init__(self, model_path: str = "data/MODEL1510060001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
KavEk2015GenomeScaleMetabolicModelOfYarroModel1510060001Model = SbmlKavscek2015GenomeScaleMetabolicModelOfYarrowia
