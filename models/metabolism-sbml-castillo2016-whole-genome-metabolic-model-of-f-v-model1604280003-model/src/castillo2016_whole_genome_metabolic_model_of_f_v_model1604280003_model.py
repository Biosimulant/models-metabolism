...
"""Auto-generated SBML BioModule wrapper for Castillo2016 - Whole-genome metabolic model of F.verticillioides using CoReCo.

Source: biomodels_ebi:MODEL1604280003
Original: https://www.ebi.ac.uk/biomodels/MODEL1604280003
"""
...
class SbmlCastillo2016WholeGenomeMetabolicModelOfF(biosim.BioModule):
    """BioModule wrapper for SBML model: Castillo2016 - Whole-genome metabolic model of F.verticillioides using CoReCo."""

    def __init__(self, model_path: str = "data/MODEL1604280003.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Castillo2016WholeGenomeMetabolicModelOfFVModel1604280003Model = SbmlCastillo2016WholeGenomeMetabolicModelOfF
