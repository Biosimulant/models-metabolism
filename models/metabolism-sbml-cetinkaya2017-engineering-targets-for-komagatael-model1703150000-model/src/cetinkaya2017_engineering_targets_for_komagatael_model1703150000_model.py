...
"""Auto-generated SBML BioModule wrapper for Cetinkaya2017 - Engineering targets for Komagataella phaffii.

Source: biomodels_ebi:MODEL1703150000
Original: https://www.ebi.ac.uk/biomodels/MODEL1703150000
"""
...
class SbmlCetinkaya2017EngineeringTargetsForKomagataellaPhaffii(biosim.BioModule):
    """BioModule wrapper for SBML model: Cetinkaya2017 - Engineering targets for Komagataella phaffii."""

    def __init__(self, model_path: str = "data/MODEL1703150000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Cetinkaya2017EngineeringTargetsForKomagataelModel1703150000Model = SbmlCetinkaya2017EngineeringTargetsForKomagataellaPhaffii
