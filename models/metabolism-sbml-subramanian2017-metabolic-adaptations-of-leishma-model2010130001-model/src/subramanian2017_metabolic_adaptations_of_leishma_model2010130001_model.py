...
"""Auto-generated SBML BioModule wrapper for Subramanian2017 - Metabolic adaptations of Leishmania parasite, Genome-scale constraint-based model of Leishmania infantum.

Source: biomodels_ebi:MODEL2010130001
Original: https://www.ebi.ac.uk/biomodels/MODEL2010130001
"""
...
class SbmlSubramanian2017MetabolicAdaptationsOfLeishmania(biosim.BioModule):
    """BioModule wrapper for SBML model: Subramanian2017 - Metabolic adaptations of Leishmania parasite, Genome-scale constraint-based model of Leishmania infantum."""

    def __init__(self, model_path: str = "data/MODEL2010130001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Subramanian2017MetabolicAdaptationsOfLeishmaModel2010130001Model = SbmlSubramanian2017MetabolicAdaptationsOfLeishmania
