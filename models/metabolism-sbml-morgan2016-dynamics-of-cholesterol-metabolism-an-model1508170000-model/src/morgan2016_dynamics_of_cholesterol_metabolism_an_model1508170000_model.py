...
"""Auto-generated SBML BioModule wrapper for Morgan2016 - Dynamics of cholesterol metabolism and ageing.

Source: biomodels_ebi:MODEL1508170000
Original: https://www.ebi.ac.uk/biomodels/MODEL1508170000
"""
...
class SbmlMorgan2016DynamicsOfCholesterolMetabolismAndAgeing(biosim.BioModule):
    """BioModule wrapper for SBML model: Morgan2016 - Dynamics of cholesterol metabolism and ageing."""

    def __init__(self, model_path: str = "data/MODEL1508170000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Morgan2016DynamicsOfCholesterolMetabolismAnModel1508170000Model = SbmlMorgan2016DynamicsOfCholesterolMetabolismAndAgeing
