...
"""Auto-generated SBML BioModule wrapper for Roberts2010 - Genome-scale metabolic network of Clostridium thermocellum (iSR432).

Source: biomodels_ebi:MODEL1507180004
Original: https://www.ebi.ac.uk/biomodels/MODEL1507180004
"""
...
class SbmlRoberts2010GenomeScaleMetabolicNetworkOfClostridium(biosim.BioModule):
    """BioModule wrapper for SBML model: Roberts2010 - Genome-scale metabolic network of Clostridium thermocellum (iSR432)."""

    def __init__(self, model_path: str = "data/MODEL1507180004.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Roberts2010GenomeScaleMetabolicNetworkOfClModel1507180004Model = SbmlRoberts2010GenomeScaleMetabolicNetworkOfClostridium
