...
"""Auto-generated SBML BioModule wrapper for Orth2011_E.coli_MetabolicNetwork.

Source: biomodels_ebi:MODEL1108160000
Original: https://www.ebi.ac.uk/biomodels/MODEL1108160000
"""
...
class SbmlOrth2011EColiMetabolicnetwork(biosim.BioModule):
    """BioModule wrapper for SBML model: Orth2011_E.coli_MetabolicNetwork."""

    def __init__(self, model_path: str = "data/MODEL1108160000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Orth2011EColiMetabolicnetworkModel1108160000Model = SbmlOrth2011EColiMetabolicnetwork
