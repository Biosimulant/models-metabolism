...
"""Auto-generated SBML BioModule wrapper for Thiele2013 - Appendix glandular cells.

Source: biomodels_ebi:MODEL1310110038
Original: https://www.ebi.ac.uk/biomodels/MODEL1310110038
"""
...
class SbmlThiele2013AppendixGlandularCells(biosim.BioModule):
    """BioModule wrapper for SBML model: Thiele2013 - Appendix glandular cells."""

    def __init__(self, model_path: str = "data/MODEL1310110038.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Thiele2013AppendixGlandularCellsModel1310110038Model = SbmlThiele2013AppendixGlandularCells
