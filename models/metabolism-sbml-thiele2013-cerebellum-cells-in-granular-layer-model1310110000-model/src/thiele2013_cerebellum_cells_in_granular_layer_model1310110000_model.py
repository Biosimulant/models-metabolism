...
"""Auto-generated SBML BioModule wrapper for Thiele2013 - Cerebellum cells in granular layer.

Source: biomodels_ebi:MODEL1310110000
Original: https://www.ebi.ac.uk/biomodels/MODEL1310110000
"""
...
class SbmlThiele2013CerebellumCellsInGranularLayer(biosim.BioModule):
    """BioModule wrapper for SBML model: Thiele2013 - Cerebellum cells in granular layer."""

    def __init__(self, model_path: str = "data/MODEL1310110000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Thiele2013CerebellumCellsInGranularLayerModel1310110000Model = SbmlThiele2013CerebellumCellsInGranularLayer
