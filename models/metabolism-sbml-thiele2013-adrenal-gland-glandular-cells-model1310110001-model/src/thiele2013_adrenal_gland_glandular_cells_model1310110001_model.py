...
"""Auto-generated SBML BioModule wrapper for Thiele2013 - Adrenal gland glandular cells.

Source: biomodels_ebi:MODEL1310110001
Original: https://www.ebi.ac.uk/biomodels/MODEL1310110001
"""
...
class SbmlThiele2013AdrenalGlandGlandularCells(biosim.BioModule):
    """BioModule wrapper for SBML model: Thiele2013 - Adrenal gland glandular cells."""

    def __init__(self, model_path: str = "data/MODEL1310110001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Thiele2013AdrenalGlandGlandularCellsModel1310110001Model = SbmlThiele2013AdrenalGlandGlandularCells
