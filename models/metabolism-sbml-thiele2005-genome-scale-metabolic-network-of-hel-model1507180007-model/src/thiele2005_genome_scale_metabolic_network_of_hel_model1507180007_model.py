...
"""Auto-generated SBML BioModule wrapper for Thiele2005 - Genome-scale metabolic network of Helicobacter pylori (iIT341).

Source: biomodels_ebi:MODEL1507180007
Original: https://www.ebi.ac.uk/biomodels/MODEL1507180007
"""
...
class SbmlThiele2005GenomeScaleMetabolicNetworkOfHelicobacter(biosim.BioModule):
    """BioModule wrapper for SBML model: Thiele2005 - Genome-scale metabolic network of Helicobacter pylori (iIT341)."""

    def __init__(self, model_path: str = "data/MODEL1507180007.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Thiele2005GenomeScaleMetabolicNetworkOfHelModel1507180007Model = SbmlThiele2005GenomeScaleMetabolicNetworkOfHelicobacter
