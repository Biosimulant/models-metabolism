...
"""Auto-generated SBML BioModule wrapper for Milne2011 - Genome-scale metabolic network of Clostridium beijerinckii (iCB925).

Source: biomodels_ebi:MODEL1507180034
Original: https://www.ebi.ac.uk/biomodels/MODEL1507180034
"""
...
class SbmlMilne2011GenomeScaleMetabolicNetworkOfClostridium(biosim.BioModule):
    """BioModule wrapper for SBML model: Milne2011 - Genome-scale metabolic network of Clostridium beijerinckii (iCB925)."""

    def __init__(self, model_path: str = "data/MODEL1507180034.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Milne2011GenomeScaleMetabolicNetworkOfClosModel1507180034Model = SbmlMilne2011GenomeScaleMetabolicNetworkOfClostridium
