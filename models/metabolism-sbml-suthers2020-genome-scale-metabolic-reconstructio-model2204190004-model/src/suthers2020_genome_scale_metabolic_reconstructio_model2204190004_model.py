...
"""Auto-generated SBML BioModule wrapper for Suthers2020 - Genome-scale metabolic reconstruction of the non-model yeast Issatchenkia orientalis SD108 - iIsor850.

Source: biomodels_ebi:MODEL2204190004
Original: https://www.ebi.ac.uk/biomodels/MODEL2204190004
"""
...
class SbmlSuthers2020GenomeScaleMetabolicReconstructionOfThe(biosim.BioModule):
    """BioModule wrapper for SBML model: Suthers2020 - Genome-scale metabolic reconstruction of the non-model yeast Issatchenkia orientalis SD108 - iIsor850."""

    def __init__(self, model_path: str = "data/MODEL2204190004.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Suthers2020GenomeScaleMetabolicReconstructioModel2204190004Model = SbmlSuthers2020GenomeScaleMetabolicReconstructionOfThe
