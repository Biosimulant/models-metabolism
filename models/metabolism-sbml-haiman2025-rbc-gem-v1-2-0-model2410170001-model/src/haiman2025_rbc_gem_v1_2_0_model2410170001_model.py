...
"""Auto-generated SBML BioModule wrapper for Haiman2025 - RBC-GEM v1.2.0.

Source: biomodels_ebi:MODEL2410170001
Original: https://www.ebi.ac.uk/biomodels/MODEL2410170001
"""
...
class SbmlHaiman2025RbcGemV120(biosim.BioModule):
    """BioModule wrapper for SBML model: Haiman2025 - RBC-GEM v1.2.0."""

    def __init__(self, model_path: str = "data/MODEL2410170001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Haiman2025RbcGemV120Model2410170001Model = SbmlHaiman2025RbcGemV120
