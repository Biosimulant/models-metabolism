...
"""Auto-generated SBML BioModule wrapper for Carter2023 - Genome-scale metabolic model of Photorhabdus asymbiotica..

Source: biomodels_ebi:MODEL2309110001
Original: https://www.ebi.ac.uk/biomodels/MODEL2309110001
"""
...
class SbmlCarter2023GenomeScaleMetabolicModelOfPhotorhabdus(biosim.BioModule):
    """BioModule wrapper for SBML model: Carter2023 - Genome-scale metabolic model of Photorhabdus asymbiotica.."""

    def __init__(self, model_path: str = "data/MODEL2309110001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Carter2023GenomeScaleMetabolicModelOfPhotoModel2309110001Model = SbmlCarter2023GenomeScaleMetabolicModelOfPhotorhabdus
