...
"""Auto-generated SBML BioModule wrapper for Mardinoglu2013 - Genome-scale metabolic model (HMR version 1.0) - human adipocytes (iAdipocytes1809).

Source: biomodels_ebi:MODEL1402200001
Original: https://www.ebi.ac.uk/biomodels/MODEL1402200001
"""
...
class SbmlMardinoglu2013GenomeScaleMetabolicModelHmrVersion102(biosim.BioModule):
    """BioModule wrapper for SBML model: Mardinoglu2013 - Genome-scale metabolic model (HMR version 1.0) - human adipocytes (iAdipocytes1809)."""

    def __init__(self, model_path: str = "data/MODEL1402200001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Mardinoglu2013GenomeScaleMetabolicModelHmrModel1402200001Model = SbmlMardinoglu2013GenomeScaleMetabolicModelHmrVersion102
