...
"""Auto-generated SBML BioModule wrapper for Adams2019 - The regulatory role of shikimate in plant phenylalanine metabolism.

Source: biomodels_ebi:BIOMD0000000847
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000847
"""
...
class SbmlAdams2019TheRegulatoryRoleOfShikimateInPlant(biosim.BioModule):
    """BioModule wrapper for SBML model: Adams2019 - The regulatory role of shikimate in plant phenylalanine metabolism."""

    def __init__(self, model_path: str = "data/BIOMD0000000847.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Adams2019TheRegulatoryRoleOfShikimateInPlBiomd0000000847Model = SbmlAdams2019TheRegulatoryRoleOfShikimateInPlant
