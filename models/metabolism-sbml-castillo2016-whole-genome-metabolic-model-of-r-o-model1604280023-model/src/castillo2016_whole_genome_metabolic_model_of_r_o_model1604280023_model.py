...
"""Auto-generated SBML BioModule wrapper for Castillo2016 - Whole-genome metabolic model of R.oryzae using CoReCo.

Source: biomodels_ebi:MODEL1604280023
Original: https://www.ebi.ac.uk/biomodels/MODEL1604280023
"""
...
class SbmlCastillo2016WholeGenomeMetabolicModelOfROryzaeUsing(biosim.BioModule):
    """BioModule wrapper for SBML model: Castillo2016 - Whole-genome metabolic model of R.oryzae using CoReCo."""

    def __init__(self, model_path: str = "data/MODEL1604280023.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Castillo2016WholeGenomeMetabolicModelOfROModel1604280023Model = SbmlCastillo2016WholeGenomeMetabolicModelOfROryzaeUsing
