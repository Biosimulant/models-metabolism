...
"""Auto-generated SBML BioModule wrapper for Mardinoglu2015 - Tissue-specific genome-scale metabolic network - Eye.

Source: biomodels_ebi:MODEL1509220004
Original: https://www.ebi.ac.uk/biomodels/MODEL1509220004
"""
...
class SbmlMardinoglu2015TissueSpecificGenomeScaleMetabolic26(biosim.BioModule):
    """BioModule wrapper for SBML model: Mardinoglu2015 - Tissue-specific genome-scale metabolic network - Eye."""

    def __init__(self, model_path: str = "data/MODEL1509220004.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Mardinoglu2015TissueSpecificGenomeScaleMetaModel1509220004Model = SbmlMardinoglu2015TissueSpecificGenomeScaleMetabolic26
