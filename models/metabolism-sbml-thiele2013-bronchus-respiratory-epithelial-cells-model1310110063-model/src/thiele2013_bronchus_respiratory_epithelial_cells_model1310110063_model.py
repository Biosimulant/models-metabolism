...
"""Auto-generated SBML BioModule wrapper for Thiele2013 - Bronchus respiratory epithelial cells.

Source: biomodels_ebi:MODEL1310110063
Original: https://www.ebi.ac.uk/biomodels/MODEL1310110063
"""
...
class SbmlThiele2013BronchusRespiratoryEpithelialCells(biosim.BioModule):
    """BioModule wrapper for SBML model: Thiele2013 - Bronchus respiratory epithelial cells."""

    def __init__(self, model_path: str = "data/MODEL1310110063.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Thiele2013BronchusRespiratoryEpithelialCellsModel1310110063Model = SbmlThiele2013BronchusRespiratoryEpithelialCells
