...
"""Auto-generated SBML BioModule wrapper for Haiman2020 Functional enzyme states in the E.coli glycolytic proteome metabolic model.

Source: biomodels_ebi:MODEL2012150003
Original: https://www.ebi.ac.uk/biomodels/MODEL2012150003
"""
...
class SbmlHaiman2020FunctionalEnzymeStatesInTheEColi(biosim.BioModule):
    """BioModule wrapper for SBML model: Haiman2020 Functional enzyme states in the E.coli glycolytic proteome metabolic model."""

    def __init__(self, model_path: str = "data/MODEL2012150003.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Haiman2020FunctionalEnzymeStatesInTheEColModel2012150003Model = SbmlHaiman2020FunctionalEnzymeStatesInTheEColi
