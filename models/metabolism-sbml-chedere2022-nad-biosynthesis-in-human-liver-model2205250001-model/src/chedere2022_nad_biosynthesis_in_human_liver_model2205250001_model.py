...
"""Auto-generated SBML BioModule wrapper for Chedere2022 - NAD Biosynthesis in Human Liver.

Source: biomodels_ebi:MODEL2205250001
Original: https://www.ebi.ac.uk/biomodels/MODEL2205250001
"""
...
class SbmlChedere2022NadBiosynthesisInHumanLiver(biosim.BioModule):
    """BioModule wrapper for SBML model: Chedere2022 - NAD Biosynthesis in Human Liver."""

    def __init__(self, model_path: str = "data/MODEL2205250001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Chedere2022NadBiosynthesisInHumanLiverModel2205250001Model = SbmlChedere2022NadBiosynthesisInHumanLiver
