...
"""Auto-generated SBML BioModule wrapper for Green1994 - whole-body vitamin A metabolism in humans.

Source: biomodels_ebi:MODEL2403010001
Original: https://www.ebi.ac.uk/biomodels/MODEL2403010001
"""
...
class SbmlGreen1994WholeBodyVitaminAMetabolismInHumans(biosim.BioModule):
    """BioModule wrapper for SBML model: Green1994 - whole-body vitamin A metabolism in humans."""

    def __init__(self, model_path: str = "data/MODEL2403010001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Green1994WholeBodyVitaminAMetabolismInHumModel2403010001Model = SbmlGreen1994WholeBodyVitaminAMetabolismInHumans
