...
"""Auto-generated SBML BioModule wrapper for Thiele2013 - Lymph node non germinal center cells.

Source: biomodels_ebi:MODEL1310110007
Original: https://www.ebi.ac.uk/biomodels/MODEL1310110007
"""
...
class SbmlThiele2013LymphNodeNonGerminalCenterCells(biosim.BioModule):
    """BioModule wrapper for SBML model: Thiele2013 - Lymph node non germinal center cells."""

    def __init__(self, model_path: str = "data/MODEL1310110007.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Thiele2013LymphNodeNonGerminalCenterCellsModel1310110007Model = SbmlThiele2013LymphNodeNonGerminalCenterCells
