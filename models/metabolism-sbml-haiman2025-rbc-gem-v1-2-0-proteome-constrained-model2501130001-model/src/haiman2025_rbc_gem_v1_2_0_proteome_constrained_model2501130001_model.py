...
"""Auto-generated SBML BioModule wrapper for Haiman2025 - RBC-GEM, v1.2.0, proteome-constrained.

Source: biomodels_ebi:MODEL2501130001
Original: https://www.ebi.ac.uk/biomodels/MODEL2501130001
"""
...
class SbmlHaiman2025RbcGemV120ProteomeConstrained(biosim.BioModule):
    """BioModule wrapper for SBML model: Haiman2025 - RBC-GEM, v1.2.0, proteome-constrained."""

    def __init__(self, model_path: str = "data/MODEL2501130001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Haiman2025RbcGemV120ProteomeConstrainedModel2501130001Model = SbmlHaiman2025RbcGemV120ProteomeConstrained
