...
"""Auto-generated SBML BioModule wrapper for Lavoie2020 - F.cylindrus_Genome_scale_model.

Source: biomodels_ebi:MODEL2001280001
Original: https://www.ebi.ac.uk/biomodels/MODEL2001280001
"""
...
class SbmlLavoie2020FCylindrusGenomeScaleModel(biosim.BioModule):
    """BioModule wrapper for SBML model: Lavoie2020 - F.cylindrus_Genome_scale_model."""

    def __init__(self, model_path: str = "data/MODEL2001280001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Lavoie2020FCylindrusGenomeScaleModelModel2001280001Model = SbmlLavoie2020FCylindrusGenomeScaleModel
