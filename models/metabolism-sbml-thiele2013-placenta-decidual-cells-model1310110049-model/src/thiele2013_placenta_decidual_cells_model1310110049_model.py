...
"""Auto-generated SBML BioModule wrapper for Thiele2013 - Placenta decidual cells.

Source: biomodels_ebi:MODEL1310110049
Original: https://www.ebi.ac.uk/biomodels/MODEL1310110049
"""
...
class SbmlThiele2013PlacentaDecidualCells(biosim.BioModule):
    """BioModule wrapper for SBML model: Thiele2013 - Placenta decidual cells."""

    def __init__(self, model_path: str = "data/MODEL1310110049.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Thiele2013PlacentaDecidualCellsModel1310110049Model = SbmlThiele2013PlacentaDecidualCells
