...
"""Auto-generated SBML BioModule wrapper for Castillo2016 - Whole-genome metabolic model of K.lactis using CoReCo.

Source: biomodels_ebi:MODEL1604280015
Original: https://www.ebi.ac.uk/biomodels/MODEL1604280015
"""
...
class SbmlCastillo2016WholeGenomeMetabolicModelOfKLactisUsing(biosim.BioModule):
    """BioModule wrapper for SBML model: Castillo2016 - Whole-genome metabolic model of K.lactis using CoReCo."""

    def __init__(self, model_path: str = "data/MODEL1604280015.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Castillo2016WholeGenomeMetabolicModelOfKLModel1604280015Model = SbmlCastillo2016WholeGenomeMetabolicModelOfKLactisUsing
