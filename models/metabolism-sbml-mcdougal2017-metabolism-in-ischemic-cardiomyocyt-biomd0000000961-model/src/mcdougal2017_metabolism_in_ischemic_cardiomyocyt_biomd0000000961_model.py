...
"""Auto-generated SBML BioModule wrapper for McDougal2017 - Metabolism in ischemic cardiomyocytes.

Source: biomodels_ebi:BIOMD0000000961
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000961
"""
...
class SbmlMcdougal2017MetabolismInIschemicCardiomyocytes(biosim.BioModule):
    """BioModule wrapper for SBML model: McDougal2017 - Metabolism in ischemic cardiomyocytes."""

    def __init__(self, model_path: str = "data/BIOMD0000000961.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Mcdougal2017MetabolismInIschemicCardiomyocytBiomd0000000961Model = SbmlMcdougal2017MetabolismInIschemicCardiomyocytes
