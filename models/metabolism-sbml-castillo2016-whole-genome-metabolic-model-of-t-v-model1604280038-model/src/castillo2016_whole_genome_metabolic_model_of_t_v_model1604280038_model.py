...
"""Auto-generated SBML BioModule wrapper for Castillo2016 - Whole-genome metabolic model of T.virens using CoReCo.

Source: biomodels_ebi:MODEL1604280038
Original: https://www.ebi.ac.uk/biomodels/MODEL1604280038
"""
...
class SbmlCastillo2016WholeGenomeMetabolicModelOfTVirensUsing(biosim.BioModule):
    """BioModule wrapper for SBML model: Castillo2016 - Whole-genome metabolic model of T.virens using CoReCo."""

    def __init__(self, model_path: str = "data/MODEL1604280038.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Castillo2016WholeGenomeMetabolicModelOfTVModel1604280038Model = SbmlCastillo2016WholeGenomeMetabolicModelOfTVirensUsing
