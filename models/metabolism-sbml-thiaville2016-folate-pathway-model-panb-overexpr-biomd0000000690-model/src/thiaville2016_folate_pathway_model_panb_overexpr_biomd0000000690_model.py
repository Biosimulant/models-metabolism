...
"""Auto-generated SBML BioModule wrapper for Thiaville2016 - Folate pathway model (PanB overexpression and THF regulation).

Source: biomodels_ebi:BIOMD0000000690
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000690
"""
...
class SbmlThiaville2016FolatePathwayModelPanbOverexpressionAnd(biosim.BioModule):
    """BioModule wrapper for SBML model: Thiaville2016 - Folate pathway model (PanB overexpression and THF regulation)."""

    def __init__(self, model_path: str = "data/BIOMD0000000690.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Thiaville2016FolatePathwayModelPanbOverexprBiomd0000000690Model = SbmlThiaville2016FolatePathwayModelPanbOverexpressionAnd
