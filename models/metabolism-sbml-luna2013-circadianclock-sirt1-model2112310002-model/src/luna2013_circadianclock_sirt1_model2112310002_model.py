...
"""Auto-generated SBML BioModule wrapper for Luna2013_CircadianClock_SIRT1.

Source: biomodels_ebi:MODEL2112310002
Original: https://www.ebi.ac.uk/biomodels/MODEL2112310002
"""
...
class SbmlLuna2013CircadianclockSirt1(biosim.BioModule):
    """BioModule wrapper for SBML model: Luna2013_CircadianClock_SIRT1."""

    def __init__(self, model_path: str = "data/MODEL2112310002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Luna2013CircadianclockSirt1Model2112310002Model = SbmlLuna2013CircadianclockSirt1
