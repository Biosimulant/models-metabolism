...
"""Auto-generated SBML BioModule wrapper for Hoppe2012 - Predicting changes in metabolic function using transcript profiles (HepatoNet1b_mouse).

Source: biomodels_ebi:MODEL1208060000
Original: https://www.ebi.ac.uk/biomodels/MODEL1208060000
"""
...
class SbmlHoppe2012PredictingChangesInMetabolicFunctionUsing(biosim.BioModule):
    """BioModule wrapper for SBML model: Hoppe2012 - Predicting changes in metabolic function using transcript profiles (HepatoNet1b_mouse)."""

    def __init__(self, model_path: str = "data/MODEL1208060000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Hoppe2012PredictingChangesInMetabolicFunctiModel1208060000Model = SbmlHoppe2012PredictingChangesInMetabolicFunctionUsing
