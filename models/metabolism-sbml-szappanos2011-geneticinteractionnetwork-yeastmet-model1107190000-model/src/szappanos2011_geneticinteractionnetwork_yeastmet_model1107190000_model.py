...
"""Auto-generated SBML BioModule wrapper for Szappanos2011_GeneticInteractionNetwork_YeastMetabolism.

Source: biomodels_ebi:MODEL1107190000
Original: https://www.ebi.ac.uk/biomodels/MODEL1107190000
"""
...
class SbmlSzappanos2011GeneticinteractionnetworkYeastmetabolism(biosim.BioModule):
    """BioModule wrapper for SBML model: Szappanos2011_GeneticInteractionNetwork_YeastMetabolism."""

    def __init__(self, model_path: str = "data/MODEL1107190000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Szappanos2011GeneticinteractionnetworkYeastmetModel1107190000Model = SbmlSzappanos2011GeneticinteractionnetworkYeastmetabolism
