...
"""Auto-generated SBML BioModule wrapper for Stavrum2013 - Tryptophan Metabolism in Liver.

Source: biomodels_ebi:BIOMD0000000602
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000602
"""
...
class SbmlStavrum2013TryptophanMetabolismInLiver(biosim.BioModule):
    """BioModule wrapper for SBML model: Stavrum2013 - Tryptophan Metabolism in Liver."""

    def __init__(self, model_path: str = "data/BIOMD0000000602.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Stavrum2013TryptophanMetabolismInLiverBiomd0000000602Model = SbmlStavrum2013TryptophanMetabolismInLiver
