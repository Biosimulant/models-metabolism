...
"""Auto-generated SBML BioModule wrapper for Mahadevan2006 - Genome-scale metabolic network of Geobacter sulfurreducens (iRM588).

Source: biomodels_ebi:MODEL1507180000
Original: https://www.ebi.ac.uk/biomodels/MODEL1507180000
"""
...
class SbmlMahadevan2006GenomeScaleMetabolicNetworkOfGeobacter(biosim.BioModule):
    """BioModule wrapper for SBML model: Mahadevan2006 - Genome-scale metabolic network of Geobacter sulfurreducens (iRM588)."""

    def __init__(self, model_path: str = "data/MODEL1507180000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Mahadevan2006GenomeScaleMetabolicNetworkOfModel1507180000Model = SbmlMahadevan2006GenomeScaleMetabolicNetworkOfGeobacter
