...
"""Auto-generated SBML BioModule wrapper for Fuentealb2016 - Genome-scale metabolic reconstruction (iPF215) of Piscirickettsia salmonis LF-89.

Source: biomodels_ebi:MODEL1610250000
Original: https://www.ebi.ac.uk/biomodels/MODEL1610250000
"""
...
class SbmlFuentealb2016GenomeScaleMetabolicReconstructionIpf215(biosim.BioModule):
    """BioModule wrapper for SBML model: Fuentealb2016 - Genome-scale metabolic reconstruction (iPF215) of Piscirickettsia salmonis LF-89."""

    def __init__(self, model_path: str = "data/MODEL1610250000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Fuentealb2016GenomeScaleMetabolicReconstructModel1610250000Model = SbmlFuentealb2016GenomeScaleMetabolicReconstructionIpf215
