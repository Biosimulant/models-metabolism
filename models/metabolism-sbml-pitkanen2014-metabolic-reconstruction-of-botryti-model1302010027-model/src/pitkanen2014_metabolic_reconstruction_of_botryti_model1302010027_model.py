...
"""Auto-generated SBML BioModule wrapper for Pitkanen2014 - Metabolic reconstruction of Botrytis cinerea using CoReCo.

Source: biomodels_ebi:MODEL1302010027
Original: https://www.ebi.ac.uk/biomodels/MODEL1302010027
"""
...
class SbmlPitkanen2014MetabolicReconstructionOfBotrytisCinerea(biosim.BioModule):
    """BioModule wrapper for SBML model: Pitkanen2014 - Metabolic reconstruction of Botrytis cinerea using CoReCo."""

    def __init__(self, model_path: str = "data/MODEL1302010027.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Pitkanen2014MetabolicReconstructionOfBotrytiModel1302010027Model = SbmlPitkanen2014MetabolicReconstructionOfBotrytisCinerea
