...
"""Auto-generated SBML BioModule wrapper for Thiele2013 - Ovary ovarian stroma cells.

Source: biomodels_ebi:MODEL1310110029
Original: https://www.ebi.ac.uk/biomodels/MODEL1310110029
"""
...
class SbmlThiele2013OvaryOvarianStromaCells(biosim.BioModule):
    """BioModule wrapper for SBML model: Thiele2013 - Ovary ovarian stroma cells."""

    def __init__(self, model_path: str = "data/MODEL1310110029.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Thiele2013OvaryOvarianStromaCellsModel1310110029Model = SbmlThiele2013OvaryOvarianStromaCells
