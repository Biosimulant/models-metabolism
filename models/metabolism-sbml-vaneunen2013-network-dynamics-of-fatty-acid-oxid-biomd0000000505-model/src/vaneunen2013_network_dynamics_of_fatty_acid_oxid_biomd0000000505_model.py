...
"""Auto-generated SBML BioModule wrapper for vanEunen2013 - Network dynamics of fatty acid β-oxidation (steady-state model).

Source: biomodels_ebi:BIOMD0000000505
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000505
"""
...
class SbmlVaneunen2013NetworkDynamicsOfFattyAcidOxidation(biosim.BioModule):
    """BioModule wrapper for SBML model: vanEunen2013 - Network dynamics of fatty acid β-oxidation (steady-state model)."""

    def __init__(self, model_path: str = "data/BIOMD0000000505.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Vaneunen2013NetworkDynamicsOfFattyAcidOxidBiomd0000000505Model = SbmlVaneunen2013NetworkDynamicsOfFattyAcidOxidation
