...
"""Auto-generated SBML BioModule wrapper for Uhlén2015 - Human tissue-based proteome metabolic network - skeletal.

Source: biomodels_ebi:MODEL1411240009
Original: https://www.ebi.ac.uk/biomodels/MODEL1411240009
"""
...
class SbmlUhlen2015HumanTissueBasedProteomeMetabolicNetwork9(biosim.BioModule):
    """BioModule wrapper for SBML model: Uhlén2015 - Human tissue-based proteome metabolic network - skeletal."""

    def __init__(self, model_path: str = "data/MODEL1411240009.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
UhlN2015HumanTissueBasedProteomeMetabolicModel1411240009Model = SbmlUhlen2015HumanTissueBasedProteomeMetabolicNetwork9
