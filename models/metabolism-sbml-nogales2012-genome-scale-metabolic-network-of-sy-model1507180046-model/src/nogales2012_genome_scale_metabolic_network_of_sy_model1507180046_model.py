...
"""Auto-generated SBML BioModule wrapper for Nogales2012 - Genome-scale metabolic network of Synechocystis sp. PCC6803 (iJN678).

Source: biomodels_ebi:MODEL1507180046
Original: https://www.ebi.ac.uk/biomodels/MODEL1507180046
"""
...
class SbmlNogales2012GenomeScaleMetabolicNetworkOfSynechocystis(biosim.BioModule):
    """BioModule wrapper for SBML model: Nogales2012 - Genome-scale metabolic network of Synechocystis sp. PCC6803 (iJN678)."""

    def __init__(self, model_path: str = "data/MODEL1507180046.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Nogales2012GenomeScaleMetabolicNetworkOfSyModel1507180046Model = SbmlNogales2012GenomeScaleMetabolicNetworkOfSynechocystis
