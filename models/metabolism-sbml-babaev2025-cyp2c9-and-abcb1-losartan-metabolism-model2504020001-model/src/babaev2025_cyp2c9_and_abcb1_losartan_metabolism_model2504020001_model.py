...
"""Auto-generated SBML BioModule wrapper for Babaev2025 - CYP2C9 and ABCB1 losartan metabolism model.

Source: biomodels_ebi:MODEL2504020001
Original: https://www.ebi.ac.uk/biomodels/MODEL2504020001
"""
...
class SbmlBabaev2025Cyp2c9AndAbcb1LosartanMetabolismModel(biosim.BioModule):
    """BioModule wrapper for SBML model: Babaev2025 - CYP2C9 and ABCB1 losartan metabolism model."""

    def __init__(self, model_path: str = "data/MODEL2504020001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Babaev2025Cyp2c9AndAbcb1LosartanMetabolismModel2504020001Model = SbmlBabaev2025Cyp2c9AndAbcb1LosartanMetabolismModel
