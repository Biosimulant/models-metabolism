...
"""Auto-generated SBML BioModule wrapper for Pitkanen2014 - Metabolic reconstruction of Debaryomyces hansenii using CoReCo.

Source: biomodels_ebi:MODEL1302010023
Original: https://www.ebi.ac.uk/biomodels/MODEL1302010023
"""
...
class SbmlPitkanen2014MetabolicReconstructionOfDebaryomyces(biosim.BioModule):
    """BioModule wrapper for SBML model: Pitkanen2014 - Metabolic reconstruction of Debaryomyces hansenii using CoReCo."""

    def __init__(self, model_path: str = "data/MODEL1302010023.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Pitkanen2014MetabolicReconstructionOfDebaryoModel1302010023Model = SbmlPitkanen2014MetabolicReconstructionOfDebaryomyces
