...
"""Auto-generated SBML BioModule wrapper for Lesiczka2024 - Genome-scale metabolic model of Rickettsia helvetica.

Source: biomodels_ebi:MODEL2404170002
Original: https://www.ebi.ac.uk/biomodels/MODEL2404170002
"""
...
class SbmlLesiczka2024GenomeScaleMetabolicModelOfRickettsia(biosim.BioModule):
    """BioModule wrapper for SBML model: Lesiczka2024 - Genome-scale metabolic model of Rickettsia helvetica."""

    def __init__(self, model_path: str = "data/MODEL2404170002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Lesiczka2024GenomeScaleMetabolicModelOfRicModel2404170002Model = SbmlLesiczka2024GenomeScaleMetabolicModelOfRickettsia
