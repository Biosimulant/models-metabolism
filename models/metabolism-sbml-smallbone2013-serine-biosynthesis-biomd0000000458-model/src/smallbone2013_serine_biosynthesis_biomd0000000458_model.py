...
"""Auto-generated SBML BioModule wrapper for Smallbone2013 - Serine biosynthesis.

Source: biomodels_ebi:BIOMD0000000458
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000458
"""
...
class SbmlSmallbone2013SerineBiosynthesis(biosim.BioModule):
    """BioModule wrapper for SBML model: Smallbone2013 - Serine biosynthesis."""

    def __init__(self, model_path: str = "data/BIOMD0000000458.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Smallbone2013SerineBiosynthesisBiomd0000000458Model = SbmlSmallbone2013SerineBiosynthesis
