...
"""Auto-generated SBML BioModule wrapper for Henry2009 - Genome-scale metabolic network of Bacillus subtilis (iBsu1103).

Source: biomodels_ebi:MODEL1507180015
Original: https://www.ebi.ac.uk/biomodels/MODEL1507180015
"""
...
class SbmlHenry2009GenomeScaleMetabolicNetworkOfBacillus(biosim.BioModule):
    """BioModule wrapper for SBML model: Henry2009 - Genome-scale metabolic network of Bacillus subtilis (iBsu1103)."""

    def __init__(self, model_path: str = "data/MODEL1507180015.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Henry2009GenomeScaleMetabolicNetworkOfBaciModel1507180015Model = SbmlHenry2009GenomeScaleMetabolicNetworkOfBacillus
