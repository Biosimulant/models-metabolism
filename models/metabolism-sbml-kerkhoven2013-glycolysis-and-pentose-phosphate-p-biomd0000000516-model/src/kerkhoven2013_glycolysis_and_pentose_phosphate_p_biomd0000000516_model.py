...
"""Auto-generated SBML BioModule wrapper for Kerkhoven2013 - Glycolysis and Pentose Phosphate Pathway in T.brucei - MODEL D in fructose medium (with ATP:ADP antiporter).

Source: biomodels_ebi:BIOMD0000000516
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000516
"""
...
class SbmlKerkhoven2013GlycolysisAndPentosePhosphatePathwayInT5(biosim.BioModule):
    """BioModule wrapper for SBML model: Kerkhoven2013 - Glycolysis and Pentose Phosphate Pathway in T.brucei - MODEL D in fructose medium (with ATP:ADP antiporter)."""

    def __init__(self, model_path: str = "data/BIOMD0000000516.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Kerkhoven2013GlycolysisAndPentosePhosphatePBiomd0000000516Model = SbmlKerkhoven2013GlycolysisAndPentosePhosphatePathwayInT5
