...
"""Auto-generated SBML BioModule wrapper for Castillo2016 - Whole-genome metabolic model of B.cinerea using CoReCo.

Source: biomodels_ebi:MODEL1604280032
Original: https://www.ebi.ac.uk/biomodels/MODEL1604280032
"""
...
class SbmlCastillo2016WholeGenomeMetabolicModelOfBCinerea(biosim.BioModule):
    """BioModule wrapper for SBML model: Castillo2016 - Whole-genome metabolic model of B.cinerea using CoReCo."""

    def __init__(self, model_path: str = "data/MODEL1604280032.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Castillo2016WholeGenomeMetabolicModelOfBCModel1604280032Model = SbmlCastillo2016WholeGenomeMetabolicModelOfBCinerea
