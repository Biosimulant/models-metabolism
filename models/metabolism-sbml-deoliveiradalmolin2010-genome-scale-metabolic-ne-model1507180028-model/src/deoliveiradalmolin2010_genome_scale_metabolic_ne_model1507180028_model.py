...
"""Auto-generated SBML BioModule wrapper for deOliveiraDalMolin2010 - Genome-scale metabolic network of Arabidopsis thaliana (AraGEM).

Source: biomodels_ebi:MODEL1507180028
Original: https://www.ebi.ac.uk/biomodels/MODEL1507180028
"""
...
class SbmlDeoliveiradalmolin2010GenomeScaleMetabolicNetworkOf(biosim.BioModule):
    """BioModule wrapper for SBML model: deOliveiraDalMolin2010 - Genome-scale metabolic network of Arabidopsis thaliana (AraGEM)."""

    def __init__(self, model_path: str = "data/MODEL1507180028.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Deoliveiradalmolin2010GenomeScaleMetabolicNeModel1507180028Model = SbmlDeoliveiradalmolin2010GenomeScaleMetabolicNetworkOf
