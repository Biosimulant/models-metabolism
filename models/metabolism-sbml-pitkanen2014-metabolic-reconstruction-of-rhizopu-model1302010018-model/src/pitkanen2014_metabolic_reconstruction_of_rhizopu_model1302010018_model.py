...
"""Auto-generated SBML BioModule wrapper for Pitkanen2014 - Metabolic reconstruction of Rhizopus oryzae using CoReCo.

Source: biomodels_ebi:MODEL1302010018
Original: https://www.ebi.ac.uk/biomodels/MODEL1302010018
"""
...
class SbmlPitkanen2014MetabolicReconstructionOfRhizopusOryzae(biosim.BioModule):
    """BioModule wrapper for SBML model: Pitkanen2014 - Metabolic reconstruction of Rhizopus oryzae using CoReCo."""

    def __init__(self, model_path: str = "data/MODEL1302010018.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Pitkanen2014MetabolicReconstructionOfRhizopuModel1302010018Model = SbmlPitkanen2014MetabolicReconstructionOfRhizopusOryzae
