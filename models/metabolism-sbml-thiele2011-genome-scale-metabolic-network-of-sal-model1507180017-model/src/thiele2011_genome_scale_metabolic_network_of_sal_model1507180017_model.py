...
"""Auto-generated SBML BioModule wrapper for Thiele2011 - Genome-scale metabolic network of Salmonella Typhimurium (STM_v1_0).

Source: biomodels_ebi:MODEL1507180017
Original: https://www.ebi.ac.uk/biomodels/MODEL1507180017
"""
...
class SbmlThiele2011GenomeScaleMetabolicNetworkOfSalmonella(biosim.BioModule):
    """BioModule wrapper for SBML model: Thiele2011 - Genome-scale metabolic network of Salmonella Typhimurium (STM_v1_0)."""

    def __init__(self, model_path: str = "data/MODEL1507180017.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Thiele2011GenomeScaleMetabolicNetworkOfSalModel1507180017Model = SbmlThiele2011GenomeScaleMetabolicNetworkOfSalmonella
