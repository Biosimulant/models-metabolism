...
"""Auto-generated SBML BioModule wrapper for Diel multi-tissue genome-scale metabolic models of Vitis vinifera.

Source: biomodels_ebi:MODEL2408160001
Original: https://www.ebi.ac.uk/biomodels/MODEL2408160001
"""
...
class SbmlDielMultiTissueGenomeScaleMetabolicModelsOfVitis(biosim.BioModule):
    """BioModule wrapper for SBML model: Diel multi-tissue genome-scale metabolic models of Vitis vinifera."""

    def __init__(self, model_path: str = "data/MODEL2408160001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
DielMultiTissueGenomeScaleMetabolicModelsModel2408160001Model = SbmlDielMultiTissueGenomeScaleMetabolicModelsOfVitis
