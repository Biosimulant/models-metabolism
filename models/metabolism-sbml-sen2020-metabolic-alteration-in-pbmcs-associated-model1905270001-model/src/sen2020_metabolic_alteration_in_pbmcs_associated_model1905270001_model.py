...
"""Auto-generated SBML BioModule wrapper for Sen2020 - Metabolic alteration in PBMCs associated with type 1 diabetes.

Source: biomodels_ebi:MODEL1905270001
Original: https://www.ebi.ac.uk/biomodels/MODEL1905270001
"""
...
class SbmlSen2020MetabolicAlterationInPbmcsAssociatedWithType(biosim.BioModule):
    """BioModule wrapper for SBML model: Sen2020 - Metabolic alteration in PBMCs associated with type 1 diabetes."""

    def __init__(self, model_path: str = "data/MODEL1905270001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Sen2020MetabolicAlterationInPbmcsAssociatedModel1905270001Model = SbmlSen2020MetabolicAlterationInPbmcsAssociatedWithType
