...
"""Auto-generated SBML BioModule wrapper for Ankrah2021 - Genome scale metabolic model of Drosophila gut microbe Lactobacillus brevis.

Source: biomodels_ebi:MODEL2002040005
Original: https://www.ebi.ac.uk/biomodels/MODEL2002040005
"""
...
class SbmlAnkrah2021GenomeScaleMetabolicModelOfDrosophilaGut(biosim.BioModule):
    """BioModule wrapper for SBML model: Ankrah2021 - Genome scale metabolic model of Drosophila gut microbe Lactobacillus brevis."""

    def __init__(self, model_path: str = "data/MODEL2002040005.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Ankrah2021GenomeScaleMetabolicModelOfDrosoModel2002040005Model = SbmlAnkrah2021GenomeScaleMetabolicModelOfDrosophilaGut
