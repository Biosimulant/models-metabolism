...
"""Auto-generated SBML BioModule wrapper for Gerlin2020 - Genome scale metabolic model of bacterial growth.

Source: biomodels_ebi:MODEL2003100001
Original: https://www.ebi.ac.uk/biomodels/MODEL2003100001
"""
...
class SbmlGerlin2020GenomeScaleMetabolicModelOfBacterialGrowth(biosim.BioModule):
    """BioModule wrapper for SBML model: Gerlin2020 - Genome scale metabolic model of bacterial growth."""

    def __init__(self, model_path: str = "data/MODEL2003100001.sbml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Gerlin2020GenomeScaleMetabolicModelOfBacteModel2003100001Model = SbmlGerlin2020GenomeScaleMetabolicModelOfBacterialGrowth
