...
"""Auto-generated SBML BioModule wrapper for vanBeek2007_OxPhos_HeartMuscleCells.

Source: biomodels_ebi:MODEL1006230027
Original: https://www.ebi.ac.uk/biomodels/MODEL1006230027
"""
...
class SbmlVanbeek2007OxphosHeartmusclecells(biosim.BioModule):
    """BioModule wrapper for SBML model: vanBeek2007_OxPhos_HeartMuscleCells."""

    def __init__(self, model_path: str = "data/MODEL1006230027.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Vanbeek2007OxphosHeartmusclecellsModel1006230027Model = SbmlVanbeek2007OxphosHeartmusclecells
