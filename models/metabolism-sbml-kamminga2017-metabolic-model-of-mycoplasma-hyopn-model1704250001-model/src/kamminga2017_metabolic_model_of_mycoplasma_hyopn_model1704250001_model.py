...
"""Auto-generated SBML BioModule wrapper for Kamminga2017 - Metabolic model of Mycoplasma hyopneumoniae growth.

Source: biomodels_ebi:MODEL1704250001
Original: https://www.ebi.ac.uk/biomodels/MODEL1704250001
"""
...
class SbmlKamminga2017MetabolicModelOfMycoplasmaHyopneumoniae(biosim.BioModule):
    """BioModule wrapper for SBML model: Kamminga2017 - Metabolic model of Mycoplasma hyopneumoniae growth."""

    def __init__(self, model_path: str = "data/MODEL1704250001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Kamminga2017MetabolicModelOfMycoplasmaHyopnModel1704250001Model = SbmlKamminga2017MetabolicModelOfMycoplasmaHyopneumoniae
