...
"""Auto-generated SBML BioModule wrapper for Feala2007_dros_mel_central_metabolism.

Source: biomodels_ebi:MODEL2784700357
Original: https://www.ebi.ac.uk/biomodels/MODEL2784700357
"""
...
class SbmlFeala2007DrosMelCentralMetabolism(biosim.BioModule):
    """BioModule wrapper for SBML model: Feala2007_dros_mel_central_metabolism."""

    def __init__(self, model_path: str = "data/MODEL2784700357.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Feala2007DrosMelCentralMetabolismModel2784700357Model = SbmlFeala2007DrosMelCentralMetabolism
