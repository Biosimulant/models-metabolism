...
"""Auto-generated SBML BioModule wrapper for Kulyashov2020 - Genome-Scale Metabolic Model for Geobacillus icigianus.

Source: biomodels_ebi:BIOMD0000001091
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000001091
"""
...
class SbmlKulyashov2020GenomeScaleMetabolicModelForGeobacillus(biosim.BioModule):
    """BioModule wrapper for SBML model: Kulyashov2020 - Genome-Scale Metabolic Model for Geobacillus icigianus."""

    def __init__(self, model_path: str = "data/BIOMD0000001091.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Kulyashov2020GenomeScaleMetabolicModelForGBiomd0000001091Model = SbmlKulyashov2020GenomeScaleMetabolicModelForGeobacillus
