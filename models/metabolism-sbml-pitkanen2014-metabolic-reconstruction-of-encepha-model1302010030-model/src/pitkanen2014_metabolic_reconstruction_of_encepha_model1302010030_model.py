...
"""Auto-generated SBML BioModule wrapper for Pitkanen2014 - Metabolic reconstruction of Encephalitozoon cuniculi using CoReCo.

Source: biomodels_ebi:MODEL1302010030
Original: https://www.ebi.ac.uk/biomodels/MODEL1302010030
"""
...
class SbmlPitkanen2014MetabolicReconstructionOfEncephalitozoon(biosim.BioModule):
    """BioModule wrapper for SBML model: Pitkanen2014 - Metabolic reconstruction of Encephalitozoon cuniculi using CoReCo."""

    def __init__(self, model_path: str = "data/MODEL1302010030.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Pitkanen2014MetabolicReconstructionOfEncephaModel1302010030Model = SbmlPitkanen2014MetabolicReconstructionOfEncephalitozoon
