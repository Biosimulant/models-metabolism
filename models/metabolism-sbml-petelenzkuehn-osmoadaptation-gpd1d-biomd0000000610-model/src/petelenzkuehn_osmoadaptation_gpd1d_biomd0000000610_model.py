...
"""Auto-generated SBML BioModule wrapper for PetelenzKuehn_osmoadaptation_gpd1D.

Source: biomodels_ebi:BIOMD0000000610
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000610
"""
...
class SbmlPetelenzkuehnOsmoadaptationGpd1d(biosim.BioModule):
    """BioModule wrapper for SBML model: PetelenzKuehn_osmoadaptation_gpd1D."""

    def __init__(self, model_path: str = "data/BIOMD0000000610.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
PetelenzkuehnOsmoadaptationGpd1dBiomd0000000610Model = SbmlPetelenzkuehnOsmoadaptationGpd1d
