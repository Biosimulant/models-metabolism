...
"""Auto-generated SBML BioModule wrapper for Blasche2021 - Metabolic cooperation and spatiotemporal niche partitioning in a kefir microbial community.

Source: biomodels_ebi:MODEL2204300001
Original: https://www.ebi.ac.uk/biomodels/MODEL2204300001
"""
...
class SbmlBlasche2021MetabolicCooperationAndSpatiotemporalNiche(biosim.BioModule):
    """BioModule wrapper for SBML model: Blasche2021 - Metabolic cooperation and spatiotemporal niche partitioning in a kefir microbial community."""

    def __init__(self, model_path: str = "data/MODEL2204300001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Blasche2021MetabolicCooperationAndSpatiotempModel2204300001Model = SbmlBlasche2021MetabolicCooperationAndSpatiotemporalNiche
