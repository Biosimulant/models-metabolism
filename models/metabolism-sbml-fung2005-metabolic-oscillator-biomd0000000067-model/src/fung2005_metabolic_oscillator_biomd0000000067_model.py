...
"""Auto-generated SBML BioModule wrapper for Fung2005_Metabolic_Oscillator.

Source: biomodels_ebi:BIOMD0000000067
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000067
"""
...
class SbmlFung2005MetabolicOscillator(biosim.BioModule):
    """BioModule wrapper for SBML model: Fung2005_Metabolic_Oscillator."""

    def __init__(self, model_path: str = "data/BIOMD0000000067.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Fung2005MetabolicOscillatorBiomd0000000067Model = SbmlFung2005MetabolicOscillator
