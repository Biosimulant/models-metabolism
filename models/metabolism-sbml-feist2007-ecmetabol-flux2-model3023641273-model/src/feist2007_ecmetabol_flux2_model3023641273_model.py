...
"""Auto-generated SBML BioModule wrapper for Feist2007_EcMetabol_flux2.

Source: biomodels_ebi:MODEL3023641273
Original: https://www.ebi.ac.uk/biomodels/MODEL3023641273
"""
...
class SbmlFeist2007EcmetabolFlux2(biosim.BioModule):
    """BioModule wrapper for SBML model: Feist2007_EcMetabol_flux2."""

    def __init__(self, model_path: str = "data/MODEL3023641273.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Feist2007EcmetabolFlux2Model3023641273Model = SbmlFeist2007EcmetabolFlux2
