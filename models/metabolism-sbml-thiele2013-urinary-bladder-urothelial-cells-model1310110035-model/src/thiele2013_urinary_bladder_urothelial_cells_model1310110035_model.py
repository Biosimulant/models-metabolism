...
"""Auto-generated SBML BioModule wrapper for Thiele2013 - Urinary bladder urothelial cells.

Source: biomodels_ebi:MODEL1310110035
Original: https://www.ebi.ac.uk/biomodels/MODEL1310110035
"""
...
class SbmlThiele2013UrinaryBladderUrothelialCells(biosim.BioModule):
    """BioModule wrapper for SBML model: Thiele2013 - Urinary bladder urothelial cells."""

    def __init__(self, model_path: str = "data/MODEL1310110035.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Thiele2013UrinaryBladderUrothelialCellsModel1310110035Model = SbmlThiele2013UrinaryBladderUrothelialCells
