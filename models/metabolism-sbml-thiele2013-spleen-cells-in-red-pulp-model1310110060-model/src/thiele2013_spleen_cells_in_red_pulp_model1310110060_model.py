...
"""Auto-generated SBML BioModule wrapper for Thiele2013 - Spleen cells in red pulp.

Source: biomodels_ebi:MODEL1310110060
Original: https://www.ebi.ac.uk/biomodels/MODEL1310110060
"""
...
class SbmlThiele2013SpleenCellsInRedPulp(biosim.BioModule):
    """BioModule wrapper for SBML model: Thiele2013 - Spleen cells in red pulp."""

    def __init__(self, model_path: str = "data/MODEL1310110060.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Thiele2013SpleenCellsInRedPulpModel1310110060Model = SbmlThiele2013SpleenCellsInRedPulp
