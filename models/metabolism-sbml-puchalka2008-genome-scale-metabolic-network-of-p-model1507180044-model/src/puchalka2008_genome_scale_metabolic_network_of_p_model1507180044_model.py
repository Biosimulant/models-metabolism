...
"""Auto-generated SBML BioModule wrapper for Puchalka2008 - Genome-scale metabolic network of Pseudomonas putida (iJP815).

Source: biomodels_ebi:MODEL1507180044
Original: https://www.ebi.ac.uk/biomodels/MODEL1507180044
"""
...
class SbmlPuchalka2008GenomeScaleMetabolicNetworkOfPseudomonas(biosim.BioModule):
    """BioModule wrapper for SBML model: Puchalka2008 - Genome-scale metabolic network of Pseudomonas putida (iJP815)."""

    def __init__(self, model_path: str = "data/MODEL1507180044.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Puchalka2008GenomeScaleMetabolicNetworkOfPModel1507180044Model = SbmlPuchalka2008GenomeScaleMetabolicNetworkOfPseudomonas
