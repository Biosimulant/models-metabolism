...
"""Auto-generated SBML BioModule wrapper for Burgos2025 - Genome-scale metabolic model for Ruminiclostridium cellulolyticum.

Source: biomodels_ebi:MODEL2503030001
Original: https://www.ebi.ac.uk/biomodels/MODEL2503030001
"""
...
class SbmlBurgos2025GenomeScaleMetabolicModelFor(biosim.BioModule):
    """BioModule wrapper for SBML model: Burgos2025 - Genome-scale metabolic model for Ruminiclostridium cellulolyticum."""

    def __init__(self, model_path: str = "data/MODEL2503030001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Burgos2025GenomeScaleMetabolicModelForRumiModel2503030001Model = SbmlBurgos2025GenomeScaleMetabolicModelFor
