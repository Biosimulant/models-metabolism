...
"""Auto-generated SBML BioModule wrapper for Thiaville2016 - Folate pathway model (PanB overexpression).

Source: biomodels_ebi:BIOMD0000000689
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000689
"""
...
class SbmlThiaville2016FolatePathwayModelPanbOverexpression(biosim.BioModule):
    """BioModule wrapper for SBML model: Thiaville2016 - Folate pathway model (PanB overexpression)."""

    def __init__(self, model_path: str = "data/BIOMD0000000689.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Thiaville2016FolatePathwayModelPanbOverexprBiomd0000000689Model = SbmlThiaville2016FolatePathwayModelPanbOverexpression
