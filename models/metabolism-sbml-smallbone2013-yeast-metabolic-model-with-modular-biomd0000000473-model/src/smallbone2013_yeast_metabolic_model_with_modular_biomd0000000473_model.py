...
"""Auto-generated SBML BioModule wrapper for Smallbone2013 - Yeast metabolic model with modular rate law, merged with Pritchard 2002.

Source: biomodels_ebi:BIOMD0000000473
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000473
"""
...
class SbmlSmallbone2013YeastMetabolicModelWithModularRateLaw2(biosim.BioModule):
    """BioModule wrapper for SBML model: Smallbone2013 - Yeast metabolic model with modular rate law, merged with Pritchard 2002."""

    def __init__(self, model_path: str = "data/BIOMD0000000473.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Smallbone2013YeastMetabolicModelWithModularBiomd0000000473Model = SbmlSmallbone2013YeastMetabolicModelWithModularRateLaw2
