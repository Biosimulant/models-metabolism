...
"""Auto-generated SBML BioModule wrapper for Pitkanen2014 - Metabolic reconstruction of Phaeosphaeria nodorum using CoReCo.

Source: biomodels_ebi:MODEL1302010000
Original: https://www.ebi.ac.uk/biomodels/MODEL1302010000
"""
...
class SbmlPitkanen2014MetabolicReconstructionOfPhaeosphaeria(biosim.BioModule):
    """BioModule wrapper for SBML model: Pitkanen2014 - Metabolic reconstruction of Phaeosphaeria nodorum using CoReCo."""

    def __init__(self, model_path: str = "data/MODEL1302010000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Pitkanen2014MetabolicReconstructionOfPhaeospModel1302010000Model = SbmlPitkanen2014MetabolicReconstructionOfPhaeosphaeria
