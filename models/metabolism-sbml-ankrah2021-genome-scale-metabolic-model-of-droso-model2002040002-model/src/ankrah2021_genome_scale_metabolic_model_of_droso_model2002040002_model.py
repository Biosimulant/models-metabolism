...
"""Auto-generated SBML BioModule wrapper for Ankrah2021 - Genome scale metabolic model of Drosophila gut microbe Acetobacter fabarum.

Source: biomodels_ebi:MODEL2002040002
Original: https://www.ebi.ac.uk/biomodels/MODEL2002040002
"""
...
class SbmlAnkrah2021GenomeScaleMetabolicModelOfDrosophilaGut(biosim.BioModule):
    """BioModule wrapper for SBML model: Ankrah2021 - Genome scale metabolic model of Drosophila gut microbe Acetobacter fabarum."""

    def __init__(self, model_path: str = "data/MODEL2002040002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Ankrah2021GenomeScaleMetabolicModelOfDrosoModel2002040002Model = SbmlAnkrah2021GenomeScaleMetabolicModelOfDrosophilaGut
