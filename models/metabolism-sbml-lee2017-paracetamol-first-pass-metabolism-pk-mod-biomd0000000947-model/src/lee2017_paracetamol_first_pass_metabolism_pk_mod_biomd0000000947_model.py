...
"""Auto-generated SBML BioModule wrapper for Lee2017 - Paracetamol first-pass metabolism PK model.

Source: biomodels_ebi:BIOMD0000000947
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000947
"""
...
class SbmlLee2017ParacetamolFirstPassMetabolismPkModel(biosim.BioModule):
    """BioModule wrapper for SBML model: Lee2017 - Paracetamol first-pass metabolism PK model."""

    def __init__(self, model_path: str = "data/BIOMD0000000947.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Lee2017ParacetamolFirstPassMetabolismPkModBiomd0000000947Model = SbmlLee2017ParacetamolFirstPassMetabolismPkModel
