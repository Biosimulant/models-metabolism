...
"""Auto-generated SBML BioModule wrapper for Castillo2016 - Whole-genome metabolic model of P.placenta using CoReCo.

Source: biomodels_ebi:MODEL1604280037
Original: https://www.ebi.ac.uk/biomodels/MODEL1604280037
"""
...
class SbmlCastillo2016WholeGenomeMetabolicModelOfPPlacenta(biosim.BioModule):
    """BioModule wrapper for SBML model: Castillo2016 - Whole-genome metabolic model of P.placenta using CoReCo."""

    def __init__(self, model_path: str = "data/MODEL1604280037.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Castillo2016WholeGenomeMetabolicModelOfPPModel1604280037Model = SbmlCastillo2016WholeGenomeMetabolicModelOfPPlacenta
