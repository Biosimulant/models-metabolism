...
"""Auto-generated SBML BioModule wrapper for MirhakkakSchaeuble2021 - a Candida albicans genome-scale metabolic model reconstruction.

Source: biomodels_ebi:MODEL2110210002
Original: https://www.ebi.ac.uk/biomodels/MODEL2110210002
"""
...
class SbmlMirhakkakschaeuble2021ACandidaAlbicansGenomeScale(biosim.BioModule):
    """BioModule wrapper for SBML model: MirhakkakSchaeuble2021 - a Candida albicans genome-scale metabolic model reconstruction."""

    def __init__(self, model_path: str = "data/MODEL2110210002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Mirhakkakschaeuble2021ACandidaAlbicansGenomeModel2110210002Model = SbmlMirhakkakschaeuble2021ACandidaAlbicansGenomeScale
