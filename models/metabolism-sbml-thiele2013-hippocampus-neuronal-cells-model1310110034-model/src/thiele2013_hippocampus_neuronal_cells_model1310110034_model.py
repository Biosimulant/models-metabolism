...
"""Auto-generated SBML BioModule wrapper for Thiele2013 - Hippocampus neuronal cells.

Source: biomodels_ebi:MODEL1310110034
Original: https://www.ebi.ac.uk/biomodels/MODEL1310110034
"""
...
class SbmlThiele2013HippocampusNeuronalCells(biosim.BioModule):
    """BioModule wrapper for SBML model: Thiele2013 - Hippocampus neuronal cells."""

    def __init__(self, model_path: str = "data/MODEL1310110034.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Thiele2013HippocampusNeuronalCellsModel1310110034Model = SbmlThiele2013HippocampusNeuronalCells
