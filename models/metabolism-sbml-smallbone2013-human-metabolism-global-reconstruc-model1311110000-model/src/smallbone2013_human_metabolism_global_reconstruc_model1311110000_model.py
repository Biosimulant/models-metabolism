...
"""Auto-generated SBML BioModule wrapper for Smallbone2013 - Human metabolism global reconstruction (recon 2.1).

Source: biomodels_ebi:MODEL1311110000
Original: https://www.ebi.ac.uk/biomodels/MODEL1311110000
"""
...
class SbmlSmallbone2013HumanMetabolismGlobalReconstructionRecon(biosim.BioModule):
    """BioModule wrapper for SBML model: Smallbone2013 - Human metabolism global reconstruction (recon 2.1)."""

    def __init__(self, model_path: str = "data/MODEL1311110000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Smallbone2013HumanMetabolismGlobalReconstrucModel1311110000Model = SbmlSmallbone2013HumanMetabolismGlobalReconstructionRecon
