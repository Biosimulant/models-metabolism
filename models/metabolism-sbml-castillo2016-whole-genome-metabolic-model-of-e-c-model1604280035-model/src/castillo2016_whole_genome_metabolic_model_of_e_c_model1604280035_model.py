...
"""Auto-generated SBML BioModule wrapper for Castillo2016 - Whole-genome metabolic model of E.cuniculi using CoReCo.

Source: biomodels_ebi:MODEL1604280035
Original: https://www.ebi.ac.uk/biomodels/MODEL1604280035
"""
...
class SbmlCastillo2016WholeGenomeMetabolicModelOfECuniculi(biosim.BioModule):
    """BioModule wrapper for SBML model: Castillo2016 - Whole-genome metabolic model of E.cuniculi using CoReCo."""

    def __init__(self, model_path: str = "data/MODEL1604280035.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Castillo2016WholeGenomeMetabolicModelOfECModel1604280035Model = SbmlCastillo2016WholeGenomeMetabolicModelOfECuniculi
