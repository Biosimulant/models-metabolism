...
"""Auto-generated SBML BioModule wrapper for Pitkanen2014 - Metabolic reconstruction of Ustilago maydis using CoReCo.

Source: biomodels_ebi:MODEL1302010016
Original: https://www.ebi.ac.uk/biomodels/MODEL1302010016
"""
...
class SbmlPitkanen2014MetabolicReconstructionOfUstilagoMaydis(biosim.BioModule):
    """BioModule wrapper for SBML model: Pitkanen2014 - Metabolic reconstruction of Ustilago maydis using CoReCo."""

    def __init__(self, model_path: str = "data/MODEL1302010016.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Pitkanen2014MetabolicReconstructionOfUstilagModel1302010016Model = SbmlPitkanen2014MetabolicReconstructionOfUstilagoMaydis
