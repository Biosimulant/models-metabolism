...
"""Auto-generated SBML BioModule wrapper for Saa2016 - Mammalian methionine cycle - approximate bayesian computation.

Source: biomodels_ebi:MODEL1603150000
Original: https://www.ebi.ac.uk/biomodels/MODEL1603150000
"""
...
class SbmlSaa2016MammalianMethionineCycleApproximateBayesian(biosim.BioModule):
    """BioModule wrapper for SBML model: Saa2016 - Mammalian methionine cycle - approximate bayesian computation."""

    def __init__(self, model_path: str = "data/MODEL1603150000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Saa2016MammalianMethionineCycleApproximateBModel1603150000Model = SbmlSaa2016MammalianMethionineCycleApproximateBayesian
