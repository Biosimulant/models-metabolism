...
"""Auto-generated SBML BioModule wrapper for Lu2021-Genome scale metabolic models for yeast species of clade Sporopachydermia.

Source: biomodels_ebi:MODEL2109240002
Original: https://www.ebi.ac.uk/biomodels/MODEL2109240002
"""
...
class SbmlLu2021GenomeScaleMetabolicModelsForYeastSpeciesOf6(biosim.BioModule):
    """BioModule wrapper for SBML model: Lu2021-Genome scale metabolic models for yeast species of clade Sporopachydermia."""

    def __init__(self, model_path: str = "data/MODEL2109240002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Lu2021GenomeScaleMetabolicModelsForYeastSModel2109240002Model = SbmlLu2021GenomeScaleMetabolicModelsForYeastSpeciesOf6
