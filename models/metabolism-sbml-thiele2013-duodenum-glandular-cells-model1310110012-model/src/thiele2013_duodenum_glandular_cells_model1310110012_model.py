...
"""Auto-generated SBML BioModule wrapper for Thiele2013 - Duodenum glandular cells.

Source: biomodels_ebi:MODEL1310110012
Original: https://www.ebi.ac.uk/biomodels/MODEL1310110012
"""
...
class SbmlThiele2013DuodenumGlandularCells(biosim.BioModule):
    """BioModule wrapper for SBML model: Thiele2013 - Duodenum glandular cells."""

    def __init__(self, model_path: str = "data/MODEL1310110012.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Thiele2013DuodenumGlandularCellsModel1310110012Model = SbmlThiele2013DuodenumGlandularCells
