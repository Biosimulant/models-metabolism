...
"""Auto-generated SBML BioModule wrapper for Uhlén2015 - Human tissue-based proteome metabolic network - spleen.

Source: biomodels_ebi:MODEL1411240014
Original: https://www.ebi.ac.uk/biomodels/MODEL1411240014
"""
...
class SbmlUhlen2015HumanTissueBasedProteomeMetabolicNetwork20(biosim.BioModule):
    """BioModule wrapper for SBML model: Uhlén2015 - Human tissue-based proteome metabolic network - spleen."""

    def __init__(self, model_path: str = "data/MODEL1411240014.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
UhlN2015HumanTissueBasedProteomeMetabolicModel1411240014Model = SbmlUhlen2015HumanTissueBasedProteomeMetabolicNetwork20
