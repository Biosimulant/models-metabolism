...
"""Auto-generated SBML BioModule wrapper for Thiele2013 - Stomach upper glandular cells.

Source: biomodels_ebi:MODEL1310110059
Original: https://www.ebi.ac.uk/biomodels/MODEL1310110059
"""
...
class SbmlThiele2013StomachUpperGlandularCells(biosim.BioModule):
    """BioModule wrapper for SBML model: Thiele2013 - Stomach upper glandular cells."""

    def __init__(self, model_path: str = "data/MODEL1310110059.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Thiele2013StomachUpperGlandularCellsModel1310110059Model = SbmlThiele2013StomachUpperGlandularCells
