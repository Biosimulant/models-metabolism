...
"""Auto-generated SBML BioModule wrapper for Castillo2016 - Whole-genome metabolic model of A.clavatus using CoReCo.

Source: biomodels_ebi:MODEL1604280016
Original: https://www.ebi.ac.uk/biomodels/MODEL1604280016
"""
...
class SbmlCastillo2016WholeGenomeMetabolicModelOfAClavatus(biosim.BioModule):
    """BioModule wrapper for SBML model: Castillo2016 - Whole-genome metabolic model of A.clavatus using CoReCo."""

    def __init__(self, model_path: str = "data/MODEL1604280016.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Castillo2016WholeGenomeMetabolicModelOfACModel1604280016Model = SbmlCastillo2016WholeGenomeMetabolicModelOfAClavatus
