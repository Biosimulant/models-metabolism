...
"""Auto-generated SBML BioModule wrapper for Lai2007_O2_Transport_Metabolism.

Source: biomodels_ebi:BIOMD0000000248
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000248
"""
...
class SbmlLai2007O2TransportMetabolism(biosim.BioModule):
    """BioModule wrapper for SBML model: Lai2007_O2_Transport_Metabolism."""

    def __init__(self, model_path: str = "data/BIOMD0000000248.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Lai2007O2TransportMetabolismBiomd0000000248Model = SbmlLai2007O2TransportMetabolism
