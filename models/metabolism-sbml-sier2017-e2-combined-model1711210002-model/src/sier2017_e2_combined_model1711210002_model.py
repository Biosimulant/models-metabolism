...
"""Auto-generated SBML BioModule wrapper for Sier2017_E2_combined.

Source: biomodels_ebi:MODEL1711210002
Original: https://www.ebi.ac.uk/biomodels/MODEL1711210002
"""
...
class SbmlSier2017E2Combined(biosim.BioModule):
    """BioModule wrapper for SBML model: Sier2017_E2_combined."""

    def __init__(self, model_path: str = "data/MODEL1711210002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Sier2017E2CombinedModel1711210002Model = SbmlSier2017E2Combined
