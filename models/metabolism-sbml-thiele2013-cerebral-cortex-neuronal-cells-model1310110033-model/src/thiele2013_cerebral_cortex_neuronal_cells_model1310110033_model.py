...
"""Auto-generated SBML BioModule wrapper for Thiele2013 - Cerebral cortex neuronal cells.

Source: biomodels_ebi:MODEL1310110033
Original: https://www.ebi.ac.uk/biomodels/MODEL1310110033
"""
...
class SbmlThiele2013CerebralCortexNeuronalCells(biosim.BioModule):
    """BioModule wrapper for SBML model: Thiele2013 - Cerebral cortex neuronal cells."""

    def __init__(self, model_path: str = "data/MODEL1310110033.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Thiele2013CerebralCortexNeuronalCellsModel1310110033Model = SbmlThiele2013CerebralCortexNeuronalCells
