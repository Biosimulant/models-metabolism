...
"""Auto-generated SBML BioModule wrapper for Rienksma2014 - Genome-scale constraint-based metabolic model of M.tuberculosis.

Source: biomodels_ebi:MODEL1411110000
Original: https://www.ebi.ac.uk/biomodels/MODEL1411110000
"""
...
class SbmlRienksma2014GenomeScaleConstraintBasedMetabolicModel(biosim.BioModule):
    """BioModule wrapper for SBML model: Rienksma2014 - Genome-scale constraint-based metabolic model of M.tuberculosis."""

    def __init__(self, model_path: str = "data/MODEL1411110000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Rienksma2014GenomeScaleConstraintBasedMetabModel1411110000Model = SbmlRienksma2014GenomeScaleConstraintBasedMetabolicModel
