...
"""Auto-generated SBML BioModule wrapper for Nouri2020 - Zymomonas mobilis  (iHN446).

Source: biomodels_ebi:BIOMD0000001088
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000001088
"""
...
class SbmlNouri2020ZymomonasMobilisIhn446(biosim.BioModule):
    """BioModule wrapper for SBML model: Nouri2020 - Zymomonas mobilis  (iHN446)."""

    def __init__(self, model_path: str = "data/BIOMD0000001088.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Nouri2020ZymomonasMobilisIhn446Biomd0000001088Model = SbmlNouri2020ZymomonasMobilisIhn446
