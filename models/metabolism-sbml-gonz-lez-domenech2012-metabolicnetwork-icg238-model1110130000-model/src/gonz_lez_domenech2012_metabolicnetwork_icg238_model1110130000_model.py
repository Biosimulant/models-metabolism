...
"""Auto-generated SBML BioModule wrapper for González-Domenech2012_MetabolicNetwork_iCG238.

Source: biomodels_ebi:MODEL1110130000
Original: https://www.ebi.ac.uk/biomodels/MODEL1110130000
"""
...
class SbmlGonzalezDomenech2012MetabolicnetworkIcg238(biosim.BioModule):
    """BioModule wrapper for SBML model: González-Domenech2012_MetabolicNetwork_iCG238."""

    def __init__(self, model_path: str = "data/MODEL1110130000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
GonzLezDomenech2012MetabolicnetworkIcg238Model1110130000Model = SbmlGonzalezDomenech2012MetabolicnetworkIcg238
