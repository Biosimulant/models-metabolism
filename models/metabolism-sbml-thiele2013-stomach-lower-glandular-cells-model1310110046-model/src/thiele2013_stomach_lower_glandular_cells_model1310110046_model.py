...
"""Auto-generated SBML BioModule wrapper for Thiele2013 - Stomach lower glandular cells.

Source: biomodels_ebi:MODEL1310110046
Original: https://www.ebi.ac.uk/biomodels/MODEL1310110046
"""
...
class SbmlThiele2013StomachLowerGlandularCells(biosim.BioModule):
    """BioModule wrapper for SBML model: Thiele2013 - Stomach lower glandular cells."""

    def __init__(self, model_path: str = "data/MODEL1310110046.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Thiele2013StomachLowerGlandularCellsModel1310110046Model = SbmlThiele2013StomachLowerGlandularCells
