...
"""Auto-generated SBML BioModule wrapper for Pitkanen2014 - Metabolic reconstruction of Aspergillus terreus using CoReCo.

Source: biomodels_ebi:MODEL1302010015
Original: https://www.ebi.ac.uk/biomodels/MODEL1302010015
"""
...
class SbmlPitkanen2014MetabolicReconstructionOfAspergillus3(biosim.BioModule):
    """BioModule wrapper for SBML model: Pitkanen2014 - Metabolic reconstruction of Aspergillus terreus using CoReCo."""

    def __init__(self, model_path: str = "data/MODEL1302010015.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Pitkanen2014MetabolicReconstructionOfAspergiModel1302010015Model = SbmlPitkanen2014MetabolicReconstructionOfAspergillus3
