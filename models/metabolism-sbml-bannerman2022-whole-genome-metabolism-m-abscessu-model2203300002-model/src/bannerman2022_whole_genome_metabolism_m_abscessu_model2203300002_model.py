...
"""Auto-generated SBML BioModule wrapper for Bannerman2022 Whole Genome Metabolism - M. abscessus (strain ATCC 19977 / DSM 44196).

Source: biomodels_ebi:MODEL2203300002
Original: https://www.ebi.ac.uk/biomodels/MODEL2203300002
"""
...
class SbmlBannerman2022WholeGenomeMetabolismMAbscessusStrain(biosim.BioModule):
    """BioModule wrapper for SBML model: Bannerman2022 Whole Genome Metabolism - M. abscessus (strain ATCC 19977 / DSM 44196)."""

    def __init__(self, model_path: str = "data/MODEL2203300002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Bannerman2022WholeGenomeMetabolismMAbscessuModel2203300002Model = SbmlBannerman2022WholeGenomeMetabolismMAbscessusStrain
