...
"""Auto-generated SBML BioModule wrapper for Baart2007 - Genome-scale metabolic network of Neisseria meningitidis (iGB555).

Source: biomodels_ebi:MODEL1507180069
Original: https://www.ebi.ac.uk/biomodels/MODEL1507180069
"""
...
class SbmlBaart2007GenomeScaleMetabolicNetworkOfNeisseria(biosim.BioModule):
    """BioModule wrapper for SBML model: Baart2007 - Genome-scale metabolic network of Neisseria meningitidis (iGB555)."""

    def __init__(self, model_path: str = "data/MODEL1507180069.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Baart2007GenomeScaleMetabolicNetworkOfNeisModel1507180069Model = SbmlBaart2007GenomeScaleMetabolicNetworkOfNeisseria
