...
"""Auto-generated SBML BioModule wrapper for Castillo2016 - Whole-genome metabolic model of C.albicans using CoReCo.

Source: biomodels_ebi:MODEL1604280052
Original: https://www.ebi.ac.uk/biomodels/MODEL1604280052
"""
...
class SbmlCastillo2016WholeGenomeMetabolicModelOfCAlbicans(biosim.BioModule):
    """BioModule wrapper for SBML model: Castillo2016 - Whole-genome metabolic model of C.albicans using CoReCo."""

    def __init__(self, model_path: str = "data/MODEL1604280052.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Castillo2016WholeGenomeMetabolicModelOfCAModel1604280052Model = SbmlCastillo2016WholeGenomeMetabolicModelOfCAlbicans
