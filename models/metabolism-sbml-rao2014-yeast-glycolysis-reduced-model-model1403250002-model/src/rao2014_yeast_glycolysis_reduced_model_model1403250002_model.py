...
"""Auto-generated SBML BioModule wrapper for Rao2014 - Yeast glycolysis (reduced model).

Source: biomodels_ebi:MODEL1403250002
Original: https://www.ebi.ac.uk/biomodels/MODEL1403250002
"""
...
class SbmlRao2014YeastGlycolysisReducedModel(biosim.BioModule):
    """BioModule wrapper for SBML model: Rao2014 - Yeast glycolysis (reduced model)."""

    def __init__(self, model_path: str = "data/MODEL1403250002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Rao2014YeastGlycolysisReducedModelModel1403250002Model = SbmlRao2014YeastGlycolysisReducedModel
