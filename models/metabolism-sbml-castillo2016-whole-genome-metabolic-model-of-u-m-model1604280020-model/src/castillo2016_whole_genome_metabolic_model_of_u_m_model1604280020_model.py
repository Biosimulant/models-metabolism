...
"""Auto-generated SBML BioModule wrapper for Castillo2016 - Whole-genome metabolic model of U.maydis using CoReCo.

Source: biomodels_ebi:MODEL1604280020
Original: https://www.ebi.ac.uk/biomodels/MODEL1604280020
"""
...
class SbmlCastillo2016WholeGenomeMetabolicModelOfUMaydisUsing(biosim.BioModule):
    """BioModule wrapper for SBML model: Castillo2016 - Whole-genome metabolic model of U.maydis using CoReCo."""

    def __init__(self, model_path: str = "data/MODEL1604280020.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Castillo2016WholeGenomeMetabolicModelOfUMModel1604280020Model = SbmlCastillo2016WholeGenomeMetabolicModelOfUMaydisUsing
