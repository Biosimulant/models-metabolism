...
"""Auto-generated SBML BioModule wrapper for Castillo2016 - Whole-genome metabolic model of T.citrinoviride using CoReCo.

Source: biomodels_ebi:MODEL1604280004
Original: https://www.ebi.ac.uk/biomodels/MODEL1604280004
"""
...
class SbmlCastillo2016WholeGenomeMetabolicModelOfT(biosim.BioModule):
    """BioModule wrapper for SBML model: Castillo2016 - Whole-genome metabolic model of T.citrinoviride using CoReCo."""

    def __init__(self, model_path: str = "data/MODEL1604280004.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Castillo2016WholeGenomeMetabolicModelOfTCModel1604280004Model = SbmlCastillo2016WholeGenomeMetabolicModelOfT
