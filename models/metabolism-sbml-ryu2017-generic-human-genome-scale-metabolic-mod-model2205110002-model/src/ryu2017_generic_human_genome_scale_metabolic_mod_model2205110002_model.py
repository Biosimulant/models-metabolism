...
"""Auto-generated SBML BioModule wrapper for Ryu2017 - Generic human genome-scale metabolic model (Recon 2M.2).

Source: biomodels_ebi:MODEL2205110002
Original: https://www.ebi.ac.uk/biomodels/MODEL2205110002
"""
...
class SbmlRyu2017GenericHumanGenomeScaleMetabolicModelRecon2m(biosim.BioModule):
    """BioModule wrapper for SBML model: Ryu2017 - Generic human genome-scale metabolic model (Recon 2M.2)."""

    def __init__(self, model_path: str = "data/MODEL2205110002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Ryu2017GenericHumanGenomeScaleMetabolicModModel2205110002Model = SbmlRyu2017GenericHumanGenomeScaleMetabolicModelRecon2m
