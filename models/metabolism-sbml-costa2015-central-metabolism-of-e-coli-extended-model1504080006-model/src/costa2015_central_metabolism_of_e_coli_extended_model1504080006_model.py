...
"""Auto-generated SBML BioModule wrapper for Costa2015 - Central metabolism of E. coli, extended regulated linlog model ( with additional allosteric regulations than the Model1).

Source: biomodels_ebi:MODEL1504080006
Original: https://www.ebi.ac.uk/biomodels/MODEL1504080006
"""
...
class SbmlCosta2015CentralMetabolismOfEColiExtendedRegulated(biosim.BioModule):
    """BioModule wrapper for SBML model: Costa2015 - Central metabolism of E. coli, extended regulated linlog model ( with additional allosteric regulations than the Model1)."""

    def __init__(self, model_path: str = "data/MODEL1504080006.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Costa2015CentralMetabolismOfEColiExtendedModel1504080006Model = SbmlCosta2015CentralMetabolismOfEColiExtendedRegulated
