...
"""Auto-generated SBML BioModule wrapper for Castillo2016 - Whole-genome metabolic model of S.japonicus using CoReCo.

Source: biomodels_ebi:MODEL1604280026
Original: https://www.ebi.ac.uk/biomodels/MODEL1604280026
"""
...
class SbmlCastillo2016WholeGenomeMetabolicModelOfSJaponicus(biosim.BioModule):
    """BioModule wrapper for SBML model: Castillo2016 - Whole-genome metabolic model of S.japonicus using CoReCo."""

    def __init__(self, model_path: str = "data/MODEL1604280026.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Castillo2016WholeGenomeMetabolicModelOfSJModel1604280026Model = SbmlCastillo2016WholeGenomeMetabolicModelOfSJaponicus
