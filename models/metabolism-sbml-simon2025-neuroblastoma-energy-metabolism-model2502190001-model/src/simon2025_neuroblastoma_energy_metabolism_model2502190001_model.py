...
"""Auto-generated SBML BioModule wrapper for Simon2025 - Neuroblastoma energy metabolism.

Source: biomodels_ebi:MODEL2502190001
Original: https://www.ebi.ac.uk/biomodels/MODEL2502190001
"""
...
class SbmlSimon2025NeuroblastomaEnergyMetabolism(biosim.BioModule):
    """BioModule wrapper for SBML model: Simon2025 - Neuroblastoma energy metabolism."""

    def __init__(self, model_path: str = "data/MODEL2502190001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Simon2025NeuroblastomaEnergyMetabolismModel2502190001Model = SbmlSimon2025NeuroblastomaEnergyMetabolism
