...
"""Auto-generated SBML BioModule wrapper for Castillo2016 - Whole-genome metabolic model of N.haematococca using CoReCo.

Source: biomodels_ebi:MODEL1604280025
Original: https://www.ebi.ac.uk/biomodels/MODEL1604280025
"""
...
class SbmlCastillo2016WholeGenomeMetabolicModelOfNHaematococca(biosim.BioModule):
    """BioModule wrapper for SBML model: Castillo2016 - Whole-genome metabolic model of N.haematococca using CoReCo."""

    def __init__(self, model_path: str = "data/MODEL1604280025.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Castillo2016WholeGenomeMetabolicModelOfNHModel1604280025Model = SbmlCastillo2016WholeGenomeMetabolicModelOfNHaematococca
