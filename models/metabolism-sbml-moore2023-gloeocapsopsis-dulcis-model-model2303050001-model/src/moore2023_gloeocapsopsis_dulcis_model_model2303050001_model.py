...
"""Auto-generated SBML BioModule wrapper for Moore2023 - Gloeocapsopsis dulcis model.

Source: biomodels_ebi:MODEL2303050001
Original: https://www.ebi.ac.uk/biomodels/MODEL2303050001
"""
...
class SbmlMoore2023GloeocapsopsisDulcisModel(biosim.BioModule):
    """BioModule wrapper for SBML model: Moore2023 - Gloeocapsopsis dulcis model."""

    def __init__(self, model_path: str = "data/MODEL2303050001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Moore2023GloeocapsopsisDulcisModelModel2303050001Model = SbmlMoore2023GloeocapsopsisDulcisModel
