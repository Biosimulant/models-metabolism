...
"""Auto-generated SBML BioModule wrapper for Mo2009 - Genome-scale metabolic network of Saccharomyces cerevisiae (iMM904).

Source: biomodels_ebi:MODEL1507180033
Original: https://www.ebi.ac.uk/biomodels/MODEL1507180033
"""
...
class SbmlMo2009GenomeScaleMetabolicNetworkOfSaccharomyces(biosim.BioModule):
    """BioModule wrapper for SBML model: Mo2009 - Genome-scale metabolic network of Saccharomyces cerevisiae (iMM904)."""

    def __init__(self, model_path: str = "data/MODEL1507180033.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Mo2009GenomeScaleMetabolicNetworkOfSaccharModel1507180033Model = SbmlMo2009GenomeScaleMetabolicNetworkOfSaccharomyces
