...
"""Auto-generated SBML BioModule wrapper for Pitkanen2014 - Metabolic reconstruction of Kluyveromyces lactis using CoReCo.

Source: biomodels_ebi:MODEL1302010011
Original: https://www.ebi.ac.uk/biomodels/MODEL1302010011
"""
...
class SbmlPitkanen2014MetabolicReconstructionOfKluyveromyces(biosim.BioModule):
    """BioModule wrapper for SBML model: Pitkanen2014 - Metabolic reconstruction of Kluyveromyces lactis using CoReCo."""

    def __init__(self, model_path: str = "data/MODEL1302010011.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Pitkanen2014MetabolicReconstructionOfKluyverModel1302010011Model = SbmlPitkanen2014MetabolicReconstructionOfKluyveromyces
