...
"""Auto-generated SBML BioModule wrapper for Uhlén2015 - Human tissue-based proteome metabolic network - testis.

Source: biomodels_ebi:MODEL1411240018
Original: https://www.ebi.ac.uk/biomodels/MODEL1411240018
"""
...
class SbmlUhlen2015HumanTissueBasedProteomeMetabolicNetwork5(biosim.BioModule):
    """BioModule wrapper for SBML model: Uhlén2015 - Human tissue-based proteome metabolic network - testis."""

    def __init__(self, model_path: str = "data/MODEL1411240018.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
UhlN2015HumanTissueBasedProteomeMetabolicModel1411240018Model = SbmlUhlen2015HumanTissueBasedProteomeMetabolicNetwork5
