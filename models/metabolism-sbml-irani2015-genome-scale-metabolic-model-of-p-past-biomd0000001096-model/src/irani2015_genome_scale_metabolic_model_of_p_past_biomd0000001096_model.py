...
"""Auto-generated SBML BioModule wrapper for Irani2015 - Genome-scale metabolic model of P.pastoris N-glycosylation.

Source: biomodels_ebi:BIOMD0000001096
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000001096
"""
...
class SbmlIrani2015GenomeScaleMetabolicModelOfPPastorisN(biosim.BioModule):
    """BioModule wrapper for SBML model: Irani2015 - Genome-scale metabolic model of P.pastoris N-glycosylation."""

    def __init__(self, model_path: str = "data/BIOMD0000001096.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Irani2015GenomeScaleMetabolicModelOfPPastBiomd0000001096Model = SbmlIrani2015GenomeScaleMetabolicModelOfPPastorisN
