...
"""Auto-generated SBML BioModule wrapper for Smallbone2013 - Glycolysis in S.cerevisiae - Iteration 05.

Source: biomodels_ebi:MODEL1303260005
Original: https://www.ebi.ac.uk/biomodels/MODEL1303260005
"""
...
class SbmlSmallbone2013GlycolysisInSCerevisiaeIteration05(biosim.BioModule):
    """BioModule wrapper for SBML model: Smallbone2013 - Glycolysis in S.cerevisiae - Iteration 05."""

    def __init__(self, model_path: str = "data/MODEL1303260005.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Smallbone2013GlycolysisInSCerevisiaeIteratiModel1303260005Model = SbmlSmallbone2013GlycolysisInSCerevisiaeIteration05
