...
"""Auto-generated SBML BioModule wrapper for Castillo2016 - Whole-genome metabolic model of A.niger using CoReCo.

Source: biomodels_ebi:MODEL1604280021
Original: https://www.ebi.ac.uk/biomodels/MODEL1604280021
"""
...
class SbmlCastillo2016WholeGenomeMetabolicModelOfANigerUsing(biosim.BioModule):
    """BioModule wrapper for SBML model: Castillo2016 - Whole-genome metabolic model of A.niger using CoReCo."""

    def __init__(self, model_path: str = "data/MODEL1604280021.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Castillo2016WholeGenomeMetabolicModelOfANModel1604280021Model = SbmlCastillo2016WholeGenomeMetabolicModelOfANigerUsing
