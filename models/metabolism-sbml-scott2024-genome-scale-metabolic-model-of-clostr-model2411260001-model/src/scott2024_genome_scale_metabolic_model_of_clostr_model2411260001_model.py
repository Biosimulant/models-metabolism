...
"""Auto-generated SBML BioModule wrapper for Scott2024 - Genome-scale metabolic model of Clostridium luticellarii.

Source: biomodels_ebi:MODEL2411260001
Original: https://www.ebi.ac.uk/biomodels/MODEL2411260001
"""
...
class SbmlScott2024GenomeScaleMetabolicModelOfClostridium(biosim.BioModule):
    """BioModule wrapper for SBML model: Scott2024 - Genome-scale metabolic model of Clostridium luticellarii."""

    def __init__(self, model_path: str = "data/MODEL2411260001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Scott2024GenomeScaleMetabolicModelOfClostrModel2411260001Model = SbmlScott2024GenomeScaleMetabolicModelOfClostridium
