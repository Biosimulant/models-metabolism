...
"""Auto-generated SBML BioModule wrapper for Costa2015 - Central metabolism of E. coli, non-regulated linlog model (without allosteric regulations).

Source: biomodels_ebi:MODEL1504080005
Original: https://www.ebi.ac.uk/biomodels/MODEL1504080005
"""
...
class SbmlCosta2015CentralMetabolismOfEColiNonRegulatedLinlog(biosim.BioModule):
    """BioModule wrapper for SBML model: Costa2015 - Central metabolism of E. coli, non-regulated linlog model (without allosteric regulations)."""

    def __init__(self, model_path: str = "data/MODEL1504080005.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Costa2015CentralMetabolismOfEColiNonRegulModel1504080005Model = SbmlCosta2015CentralMetabolismOfEColiNonRegulatedLinlog
