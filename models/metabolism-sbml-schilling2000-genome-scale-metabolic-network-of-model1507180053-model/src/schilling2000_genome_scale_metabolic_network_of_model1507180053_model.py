...
"""Auto-generated SBML BioModule wrapper for Schilling2000-  Genome-scale metabolic network of Haemophilus influenzae (iCS400).

Source: biomodels_ebi:MODEL1507180053
Original: https://www.ebi.ac.uk/biomodels/MODEL1507180053
"""
...
class SbmlSchilling2000GenomeScaleMetabolicNetworkOfHaemophilus(biosim.BioModule):
    """BioModule wrapper for SBML model: Schilling2000-  Genome-scale metabolic network of Haemophilus influenzae (iCS400)."""

    def __init__(self, model_path: str = "data/MODEL1507180053.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Schilling2000GenomeScaleMetabolicNetworkOfModel1507180053Model = SbmlSchilling2000GenomeScaleMetabolicNetworkOfHaemophilus
