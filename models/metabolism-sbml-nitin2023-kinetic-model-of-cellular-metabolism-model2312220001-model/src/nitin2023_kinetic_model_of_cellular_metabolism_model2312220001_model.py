...
"""Auto-generated SBML BioModule wrapper for Nitin2023- Kinetic model of cellular metabolism.

Source: biomodels_ebi:MODEL2312220001
Original: https://www.ebi.ac.uk/biomodels/MODEL2312220001
"""
...
class SbmlNitin2023KineticModelOfCellularMetabolism(biosim.BioModule):
    """BioModule wrapper for SBML model: Nitin2023- Kinetic model of cellular metabolism."""

    def __init__(self, model_path: str = "data/MODEL2312220001.sbml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Nitin2023KineticModelOfCellularMetabolismModel2312220001Model = SbmlNitin2023KineticModelOfCellularMetabolism
