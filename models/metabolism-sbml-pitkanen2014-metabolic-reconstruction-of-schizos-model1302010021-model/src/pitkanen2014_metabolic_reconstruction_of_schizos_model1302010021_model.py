...
"""Auto-generated SBML BioModule wrapper for Pitkanen2014 - Metabolic reconstruction of Schizosaccharomyces japonicus using CoReCo.

Source: biomodels_ebi:MODEL1302010021
Original: https://www.ebi.ac.uk/biomodels/MODEL1302010021
"""
...
class SbmlPitkanen2014MetabolicReconstructionOf(biosim.BioModule):
    """BioModule wrapper for SBML model: Pitkanen2014 - Metabolic reconstruction of Schizosaccharomyces japonicus using CoReCo."""

    def __init__(self, model_path: str = "data/MODEL1302010021.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Pitkanen2014MetabolicReconstructionOfSchizosModel1302010021Model = SbmlPitkanen2014MetabolicReconstructionOf
