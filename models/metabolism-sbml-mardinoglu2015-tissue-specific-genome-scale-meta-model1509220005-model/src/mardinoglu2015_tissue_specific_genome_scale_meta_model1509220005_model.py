...
"""Auto-generated SBML BioModule wrapper for Mardinoglu2015 - Tissue-specific genome-scale metabolic network - Diaphragm.

Source: biomodels_ebi:MODEL1509220005
Original: https://www.ebi.ac.uk/biomodels/MODEL1509220005
"""
...
class SbmlMardinoglu2015TissueSpecificGenomeScaleMetabolic3(biosim.BioModule):
    """BioModule wrapper for SBML model: Mardinoglu2015 - Tissue-specific genome-scale metabolic network - Diaphragm."""

    def __init__(self, model_path: str = "data/MODEL1509220005.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Mardinoglu2015TissueSpecificGenomeScaleMetaModel1509220005Model = SbmlMardinoglu2015TissueSpecificGenomeScaleMetabolic3
