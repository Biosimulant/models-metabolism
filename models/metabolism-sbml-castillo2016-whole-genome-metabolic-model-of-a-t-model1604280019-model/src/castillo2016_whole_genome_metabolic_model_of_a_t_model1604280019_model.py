...
"""Auto-generated SBML BioModule wrapper for Castillo2016 - Whole-genome metabolic model of A.terreus using CoReCo.

Source: biomodels_ebi:MODEL1604280019
Original: https://www.ebi.ac.uk/biomodels/MODEL1604280019
"""
...
class SbmlCastillo2016WholeGenomeMetabolicModelOfATerreus(biosim.BioModule):
    """BioModule wrapper for SBML model: Castillo2016 - Whole-genome metabolic model of A.terreus using CoReCo."""

    def __init__(self, model_path: str = "data/MODEL1604280019.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Castillo2016WholeGenomeMetabolicModelOfATModel1604280019Model = SbmlCastillo2016WholeGenomeMetabolicModelOfATerreus
