...
"""Auto-generated SBML BioModule wrapper for Viana2023 - Cauris metabolic model.

Source: biomodels_ebi:MODEL2404250001
Original: https://www.ebi.ac.uk/biomodels/MODEL2404250001
"""
...
class SbmlViana2023CaurisMetabolicModel(biosim.BioModule):
    """BioModule wrapper for SBML model: Viana2023 - Cauris metabolic model."""

    def __init__(self, model_path: str = "data/MODEL2404250001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Viana2023CaurisMetabolicModelModel2404250001Model = SbmlViana2023CaurisMetabolicModel
