...
"""Auto-generated SBML BioModule wrapper for Goyal2014 - Genome-scale metabolic model of M.maripaludis S2.

Source: biomodels_ebi:MODEL1304120000
Original: https://www.ebi.ac.uk/biomodels/MODEL1304120000
"""
...
class SbmlGoyal2014GenomeScaleMetabolicModelOfMMaripaludisS2(biosim.BioModule):
    """BioModule wrapper for SBML model: Goyal2014 - Genome-scale metabolic model of M.maripaludis S2."""

    def __init__(self, model_path: str = "data/MODEL1304120000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Goyal2014GenomeScaleMetabolicModelOfMMariModel1304120000Model = SbmlGoyal2014GenomeScaleMetabolicModelOfMMaripaludisS2
