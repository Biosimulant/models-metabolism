...
"""Auto-generated SBML BioModule wrapper for DeboraSoncini2024 - NAD_Biosynthesis_in Human_B_Lymphocytes,ODE model.

Source: biomodels_ebi:MODEL2311140001
Original: https://www.ebi.ac.uk/biomodels/MODEL2311140001
"""
...
class SbmlDeborasoncini2024NadBiosynthesisInHumanBLymphocytes(biosim.BioModule):
    """BioModule wrapper for SBML model: DeboraSoncini2024 - NAD_Biosynthesis_in Human_B_Lymphocytes,ODE model."""

    def __init__(self, model_path: str = "data/MODEL2311140001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Deborasoncini2024NadBiosynthesisInHumanBLyModel2311140001Model = SbmlDeborasoncini2024NadBiosynthesisInHumanBLymphocytes
