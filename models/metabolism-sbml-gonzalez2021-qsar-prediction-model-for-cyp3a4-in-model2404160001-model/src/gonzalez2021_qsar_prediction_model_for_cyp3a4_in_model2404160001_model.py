...
"""Auto-generated SBML BioModule wrapper for Gonzalez2021 - QSAR Prediction Model for CYP3A4 Inhibitor and Substrate.

Source: biomodels_ebi:MODEL2404160001
Original: https://www.ebi.ac.uk/biomodels/MODEL2404160001
"""
...
class SbmlGonzalez2021QsarPredictionModelForCyp3a4InhibitorAnd(biosim.BioModule):
    """BioModule wrapper for SBML model: Gonzalez2021 - QSAR Prediction Model for CYP3A4 Inhibitor and Substrate."""

    def __init__(self, model_path: str = "data/MODEL2404160001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Gonzalez2021QsarPredictionModelForCyp3a4InModel2404160001Model = SbmlGonzalez2021QsarPredictionModelForCyp3a4InhibitorAnd
