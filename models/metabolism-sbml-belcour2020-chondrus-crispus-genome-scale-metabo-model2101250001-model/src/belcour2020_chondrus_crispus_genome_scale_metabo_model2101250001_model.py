...
"""Auto-generated SBML BioModule wrapper for Belcour2020 - Chondrus crispus Genome-Scale Metabolic Network model, version 1.3.

Source: biomodels_ebi:MODEL2101250001
Original: https://www.ebi.ac.uk/biomodels/MODEL2101250001
"""
...
class SbmlBelcour2020ChondrusCrispusGenomeScaleMetabolicNetwork(biosim.BioModule):
    """BioModule wrapper for SBML model: Belcour2020 - Chondrus crispus Genome-Scale Metabolic Network model, version 1.3."""

    def __init__(self, model_path: str = "data/MODEL2101250001.sbml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Belcour2020ChondrusCrispusGenomeScaleMetaboModel2101250001Model = SbmlBelcour2020ChondrusCrispusGenomeScaleMetabolicNetwork
