...
"""Auto-generated SBML BioModule wrapper for Bertram2004_PancreaticBetaCell_modelB.

Source: biomodels_ebi:BIOMD0000000373
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000373
"""
...
class SbmlBertram2004PancreaticbetacellModelb(biosim.BioModule):
    """BioModule wrapper for SBML model: Bertram2004_PancreaticBetaCell_modelB."""

    def __init__(self, model_path: str = "data/BIOMD0000000373.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Bertram2004PancreaticbetacellModelbBiomd0000000373Model = SbmlBertram2004PancreaticbetacellModelb
