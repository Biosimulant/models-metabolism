...
"""Auto-generated SBML BioModule wrapper for Smallbone2013 - Yeast metabolic model with modular rate law.

Source: biomodels_ebi:BIOMD0000000472
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000472
"""
...
class SbmlSmallbone2013YeastMetabolicModelWithModularRateLaw(biosim.BioModule):
    """BioModule wrapper for SBML model: Smallbone2013 - Yeast metabolic model with modular rate law."""

    def __init__(self, model_path: str = "data/BIOMD0000000472.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Smallbone2013YeastMetabolicModelWithModularBiomd0000000472Model = SbmlSmallbone2013YeastMetabolicModelWithModularRateLaw
