...
"""Auto-generated SBML BioModule wrapper for Veith2015 - Genome-scale metabolic model of Enterococcus faecalis V583.

Source: biomodels_ebi:MODEL1510010000
Original: https://www.ebi.ac.uk/biomodels/MODEL1510010000
"""
...
class SbmlVeith2015GenomeScaleMetabolicModelOfEnterococcus(biosim.BioModule):
    """BioModule wrapper for SBML model: Veith2015 - Genome-scale metabolic model of Enterococcus faecalis V583."""

    def __init__(self, model_path: str = "data/MODEL1510010000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Veith2015GenomeScaleMetabolicModelOfEnteroModel1510010000Model = SbmlVeith2015GenomeScaleMetabolicModelOfEnterococcus
