...
"""Auto-generated SBML BioModule wrapper for Davies2023 - Cholesterol Metabolism and Atherosclerosis Model.

Source: biomodels_ebi:MODEL2306300001
Original: https://www.ebi.ac.uk/biomodels/MODEL2306300001
"""
...
class SbmlDavies2023CholesterolMetabolismAndAtherosclerosisModel(biosim.BioModule):
    """BioModule wrapper for SBML model: Davies2023 - Cholesterol Metabolism and Atherosclerosis Model."""

    def __init__(self, model_path: str = "data/MODEL2306300001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Davies2023CholesterolMetabolismAndAtheroscleModel2306300001Model = SbmlDavies2023CholesterolMetabolismAndAtherosclerosisModel
