...
"""Auto-generated SBML BioModule wrapper for Reed2008_Glutathione_Metabolism.

Source: biomodels_ebi:BIOMD0000000268
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000268
"""
...
class SbmlReed2008GlutathioneMetabolism(biosim.BioModule):
    """BioModule wrapper for SBML model: Reed2008_Glutathione_Metabolism."""

    def __init__(self, model_path: str = "data/BIOMD0000000268.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Reed2008GlutathioneMetabolismBiomd0000000268Model = SbmlReed2008GlutathioneMetabolism
