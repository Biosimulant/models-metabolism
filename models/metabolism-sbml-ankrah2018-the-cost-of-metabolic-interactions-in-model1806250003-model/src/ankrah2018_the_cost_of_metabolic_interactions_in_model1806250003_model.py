...
"""Auto-generated SBML BioModule wrapper for Ankrah2018 - The cost of metabolic interactions in symbioses between insects and bacteria with reduced genomes spittlebug symbiosis.

Source: biomodels_ebi:MODEL1806250003
Original: https://www.ebi.ac.uk/biomodels/MODEL1806250003
"""
...
class SbmlAnkrah2018TheCostOfMetabolicInteractionsInSymbioses(biosim.BioModule):
    """BioModule wrapper for SBML model: Ankrah2018 - The cost of metabolic interactions in symbioses between insects and bacteria with reduced genomes spittlebug symbiosis."""

    def __init__(self, model_path: str = "data/MODEL1806250003.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Ankrah2018TheCostOfMetabolicInteractionsInModel1806250003Model = SbmlAnkrah2018TheCostOfMetabolicInteractionsInSymbioses
