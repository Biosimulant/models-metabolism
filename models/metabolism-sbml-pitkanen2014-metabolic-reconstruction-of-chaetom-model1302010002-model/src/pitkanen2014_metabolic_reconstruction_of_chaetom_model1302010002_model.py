...
"""Auto-generated SBML BioModule wrapper for Pitkanen2014 - Metabolic reconstruction of Chaetomium globosum using CoReCo.

Source: biomodels_ebi:MODEL1302010002
Original: https://www.ebi.ac.uk/biomodels/MODEL1302010002
"""
...
class SbmlPitkanen2014MetabolicReconstructionOfChaetomium(biosim.BioModule):
    """BioModule wrapper for SBML model: Pitkanen2014 - Metabolic reconstruction of Chaetomium globosum using CoReCo."""

    def __init__(self, model_path: str = "data/MODEL1302010002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Pitkanen2014MetabolicReconstructionOfChaetomModel1302010002Model = SbmlPitkanen2014MetabolicReconstructionOfChaetomium
