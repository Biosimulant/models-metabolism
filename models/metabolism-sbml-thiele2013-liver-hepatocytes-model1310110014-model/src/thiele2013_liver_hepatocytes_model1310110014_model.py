...
"""Auto-generated SBML BioModule wrapper for Thiele2013 - Liver hepatocytes.

Source: biomodels_ebi:MODEL1310110014
Original: https://www.ebi.ac.uk/biomodels/MODEL1310110014
"""
...
class SbmlThiele2013LiverHepatocytes(biosim.BioModule):
    """BioModule wrapper for SBML model: Thiele2013 - Liver hepatocytes."""

    def __init__(self, model_path: str = "data/MODEL1310110014.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Thiele2013LiverHepatocytesModel1310110014Model = SbmlThiele2013LiverHepatocytes
