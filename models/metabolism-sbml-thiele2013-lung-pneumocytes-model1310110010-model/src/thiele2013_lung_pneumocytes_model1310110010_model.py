...
"""Auto-generated SBML BioModule wrapper for Thiele2013 - Lung pneumocytes.

Source: biomodels_ebi:MODEL1310110010
Original: https://www.ebi.ac.uk/biomodels/MODEL1310110010
"""
...
class SbmlThiele2013LungPneumocytes(biosim.BioModule):
    """BioModule wrapper for SBML model: Thiele2013 - Lung pneumocytes."""

    def __init__(self, model_path: str = "data/MODEL1310110010.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Thiele2013LungPneumocytesModel1310110010Model = SbmlThiele2013LungPneumocytes
