...
"""Auto-generated SBML BioModule wrapper for Castillo2016 - Whole-genome metabolic model of C.neoformans using CoReCo.

Source: biomodels_ebi:MODEL1604280045
Original: https://www.ebi.ac.uk/biomodels/MODEL1604280045
"""
...
class SbmlCastillo2016WholeGenomeMetabolicModelOfCNeoformans(biosim.BioModule):
    """BioModule wrapper for SBML model: Castillo2016 - Whole-genome metabolic model of C.neoformans using CoReCo."""

    def __init__(self, model_path: str = "data/MODEL1604280045.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Castillo2016WholeGenomeMetabolicModelOfCNModel1604280045Model = SbmlCastillo2016WholeGenomeMetabolicModelOfCNeoformans
