...
"""Auto-generated SBML BioModule wrapper for Thiele2013 - Uterus post menopause cells in endometrial stroma.

Source: biomodels_ebi:MODEL1310110017
Original: https://www.ebi.ac.uk/biomodels/MODEL1310110017
"""
...
class SbmlThiele2013UterusPostMenopauseCellsInEndometrialStroma(biosim.BioModule):
    """BioModule wrapper for SBML model: Thiele2013 - Uterus post menopause cells in endometrial stroma."""

    def __init__(self, model_path: str = "data/MODEL1310110017.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Thiele2013UterusPostMenopauseCellsInEndomeModel1310110017Model = SbmlThiele2013UterusPostMenopauseCellsInEndometrialStroma
