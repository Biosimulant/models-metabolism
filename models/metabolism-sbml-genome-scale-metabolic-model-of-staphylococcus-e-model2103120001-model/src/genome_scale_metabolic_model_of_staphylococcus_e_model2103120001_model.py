...
"""Auto-generated SBML BioModule wrapper for Genome scale metabolic Model of Staphylococcus epidermidis.

Source: biomodels_ebi:MODEL2103120001
Original: https://www.ebi.ac.uk/biomodels/MODEL2103120001
"""
...
class SbmlGenomeScaleMetabolicModelOfStaphylococcusEpidermidis(biosim.BioModule):
    """BioModule wrapper for SBML model: Genome scale metabolic Model of Staphylococcus epidermidis."""

    def __init__(self, model_path: str = "data/MODEL2103120001.sbml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
GenomeScaleMetabolicModelOfStaphylococcusEModel2103120001Model = SbmlGenomeScaleMetabolicModelOfStaphylococcusEpidermidis
