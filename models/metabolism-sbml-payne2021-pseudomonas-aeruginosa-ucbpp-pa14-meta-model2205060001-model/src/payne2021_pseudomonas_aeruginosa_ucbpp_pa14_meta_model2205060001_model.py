...
"""Auto-generated SBML BioModule wrapper for Payne2021 - Pseudomonas aeruginosa UCBPP-PA14 metabolic model.

Source: biomodels_ebi:MODEL2205060001
Original: https://www.ebi.ac.uk/biomodels/MODEL2205060001
"""
...
class SbmlPayne2021PseudomonasAeruginosaUcbppPa14MetabolicModel(biosim.BioModule):
    """BioModule wrapper for SBML model: Payne2021 - Pseudomonas aeruginosa UCBPP-PA14 metabolic model."""

    def __init__(self, model_path: str = "data/MODEL2205060001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Payne2021PseudomonasAeruginosaUcbppPa14MetaModel2205060001Model = SbmlPayne2021PseudomonasAeruginosaUcbppPa14MetabolicModel
