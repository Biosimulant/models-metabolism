...
"""Auto-generated SBML BioModule wrapper for ecModel of humanGEM.

Source: biomodels_ebi:MODEL2210090003
Original: https://www.ebi.ac.uk/biomodels/MODEL2210090003
"""
...
class SbmlEcmodelOfHumangem(biosim.BioModule):
    """BioModule wrapper for SBML model: ecModel of humanGEM."""

    def __init__(self, model_path: str = "data/MODEL2210090003.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
EcmodelOfHumangemModel2210090003Model = SbmlEcmodelOfHumangem
