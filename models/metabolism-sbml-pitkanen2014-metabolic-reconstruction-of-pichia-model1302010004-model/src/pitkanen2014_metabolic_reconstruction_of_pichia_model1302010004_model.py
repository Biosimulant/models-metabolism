...
"""Auto-generated SBML BioModule wrapper for Pitkanen2014 - Metabolic reconstruction of Pichia guilliermondii using CoReCo.

Source: biomodels_ebi:MODEL1302010004
Original: https://www.ebi.ac.uk/biomodels/MODEL1302010004
"""
...
class SbmlPitkanen2014MetabolicReconstructionOfPichia(biosim.BioModule):
    """BioModule wrapper for SBML model: Pitkanen2014 - Metabolic reconstruction of Pichia guilliermondii using CoReCo."""

    def __init__(self, model_path: str = "data/MODEL1302010004.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Pitkanen2014MetabolicReconstructionOfPichiaModel1302010004Model = SbmlPitkanen2014MetabolicReconstructionOfPichia
