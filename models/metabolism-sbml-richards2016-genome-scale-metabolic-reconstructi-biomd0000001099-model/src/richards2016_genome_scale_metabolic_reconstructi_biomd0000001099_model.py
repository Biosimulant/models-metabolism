...
"""Auto-generated SBML BioModule wrapper for Richards2016 - Genome-scale metabolic reconstruction of Methanococcus maripaludis (iMR539).

Source: biomodels_ebi:BIOMD0000001099
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000001099
"""
...
class SbmlRichards2016GenomeScaleMetabolicReconstructionOf(biosim.BioModule):
    """BioModule wrapper for SBML model: Richards2016 - Genome-scale metabolic reconstruction of Methanococcus maripaludis (iMR539)."""

    def __init__(self, model_path: str = "data/BIOMD0000001099.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Richards2016GenomeScaleMetabolicReconstructiBiomd0000001099Model = SbmlRichards2016GenomeScaleMetabolicReconstructionOf
