...
"""Auto-generated SBML BioModule wrapper for Uhlén2015 - Human tissue-based proteome metabolic network - colon.

Source: biomodels_ebi:MODEL1411240015
Original: https://www.ebi.ac.uk/biomodels/MODEL1411240015
"""
...
class SbmlUhlen2015HumanTissueBasedProteomeMetabolicNetwork23(biosim.BioModule):
    """BioModule wrapper for SBML model: Uhlén2015 - Human tissue-based proteome metabolic network - colon."""

    def __init__(self, model_path: str = "data/MODEL1411240015.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
UhlN2015HumanTissueBasedProteomeMetabolicModel1411240015Model = SbmlUhlen2015HumanTissueBasedProteomeMetabolicNetwork23
