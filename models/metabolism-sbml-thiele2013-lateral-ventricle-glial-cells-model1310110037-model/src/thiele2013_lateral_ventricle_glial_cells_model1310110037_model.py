...
"""Auto-generated SBML BioModule wrapper for Thiele2013 - Lateral ventricle glial cells.

Source: biomodels_ebi:MODEL1310110037
Original: https://www.ebi.ac.uk/biomodels/MODEL1310110037
"""
...
class SbmlThiele2013LateralVentricleGlialCells(biosim.BioModule):
    """BioModule wrapper for SBML model: Thiele2013 - Lateral ventricle glial cells."""

    def __init__(self, model_path: str = "data/MODEL1310110037.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Thiele2013LateralVentricleGlialCellsModel1310110037Model = SbmlThiele2013LateralVentricleGlialCells
