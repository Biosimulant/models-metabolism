...
"""Auto-generated SBML BioModule wrapper for Levering2016 - Phaeodactylum tricornutum metabolic model.

Source: biomodels_ebi:MODEL2204200002
Original: https://www.ebi.ac.uk/biomodels/MODEL2204200002
"""
...
class SbmlLevering2016PhaeodactylumTricornutumMetabolicModel(biosim.BioModule):
    """BioModule wrapper for SBML model: Levering2016 - Phaeodactylum tricornutum metabolic model."""

    def __init__(self, model_path: str = "data/MODEL2204200002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Levering2016PhaeodactylumTricornutumMetabolicModel2204200002Model = SbmlLevering2016PhaeodactylumTricornutumMetabolicModel
