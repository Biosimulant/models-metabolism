...
"""Auto-generated SBML BioModule wrapper for Sun2009 - Genome-scale metabolic network of Geobacter metallireducens (iJS747).

Source: biomodels_ebi:MODEL1507180002
Original: https://www.ebi.ac.uk/biomodels/MODEL1507180002
"""
...
class SbmlSun2009GenomeScaleMetabolicNetworkOfGeobacter(biosim.BioModule):
    """BioModule wrapper for SBML model: Sun2009 - Genome-scale metabolic network of Geobacter metallireducens (iJS747)."""

    def __init__(self, model_path: str = "data/MODEL1507180002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Sun2009GenomeScaleMetabolicNetworkOfGeobacModel1507180002Model = SbmlSun2009GenomeScaleMetabolicNetworkOfGeobacter
