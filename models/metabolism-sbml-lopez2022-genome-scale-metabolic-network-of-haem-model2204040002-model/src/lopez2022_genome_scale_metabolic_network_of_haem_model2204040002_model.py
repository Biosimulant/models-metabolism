...
"""Auto-generated SBML BioModule wrapper for Lopez2022 - Genome-scale metabolic network of Haemophilus influenzae RdKW20 (iNL638).

Source: biomodels_ebi:MODEL2204040002
Original: https://www.ebi.ac.uk/biomodels/MODEL2204040002
"""
...
class SbmlLopez2022GenomeScaleMetabolicNetworkOfHaemophilus(biosim.BioModule):
    """BioModule wrapper for SBML model: Lopez2022 - Genome-scale metabolic network of Haemophilus influenzae RdKW20 (iNL638)."""

    def __init__(self, model_path: str = "data/MODEL2204040002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Lopez2022GenomeScaleMetabolicNetworkOfHaemModel2204040002Model = SbmlLopez2022GenomeScaleMetabolicNetworkOfHaemophilus
