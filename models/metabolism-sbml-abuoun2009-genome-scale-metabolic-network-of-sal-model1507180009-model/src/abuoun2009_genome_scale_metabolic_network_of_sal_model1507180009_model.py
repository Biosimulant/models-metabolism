...
"""Auto-generated SBML BioModule wrapper for AbuOun2009 - Genome-scale metabolic network of Salmonella typhimurium (iMA945).

Source: biomodels_ebi:MODEL1507180009
Original: https://www.ebi.ac.uk/biomodels/MODEL1507180009
"""
...
class SbmlAbuoun2009GenomeScaleMetabolicNetworkOfSalmonella(biosim.BioModule):
    """BioModule wrapper for SBML model: AbuOun2009 - Genome-scale metabolic network of Salmonella typhimurium (iMA945)."""

    def __init__(self, model_path: str = "data/MODEL1507180009.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Abuoun2009GenomeScaleMetabolicNetworkOfSalModel1507180009Model = SbmlAbuoun2009GenomeScaleMetabolicNetworkOfSalmonella
