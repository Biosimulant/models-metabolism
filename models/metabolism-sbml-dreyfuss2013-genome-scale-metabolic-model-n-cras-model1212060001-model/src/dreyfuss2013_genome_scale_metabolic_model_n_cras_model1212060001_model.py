...
"""Auto-generated SBML BioModule wrapper for Dreyfuss2013 - Genome-Scale Metabolic Model - N.crassa iJDZ836.

Source: biomodels_ebi:MODEL1212060001
Original: https://www.ebi.ac.uk/biomodels/MODEL1212060001
"""
...
class SbmlDreyfuss2013GenomeScaleMetabolicModelNCrassaIjdz836(biosim.BioModule):
    """BioModule wrapper for SBML model: Dreyfuss2013 - Genome-Scale Metabolic Model - N.crassa iJDZ836."""

    def __init__(self, model_path: str = "data/MODEL1212060001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Dreyfuss2013GenomeScaleMetabolicModelNCrasModel1212060001Model = SbmlDreyfuss2013GenomeScaleMetabolicModelNCrassaIjdz836
