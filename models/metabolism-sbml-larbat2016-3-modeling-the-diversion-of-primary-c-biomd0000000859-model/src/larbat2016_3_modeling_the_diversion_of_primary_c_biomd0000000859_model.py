...
"""Auto-generated SBML BioModule wrapper for Larbat2016.3 - Modeling the diversion of primary carbon flux into secondary metabolism under variable nitrate and light or dark conditions (Light Dark Cycles with Minimum Starch Adaption).

Source: biomodels_ebi:BIOMD0000000859
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000859
"""
...
class SbmlLarbat20163ModelingTheDiversionOfPrimaryCarbonFlux(biosim.BioModule):
    """BioModule wrapper for SBML model: Larbat2016.3 - Modeling the diversion of primary carbon flux into secondary metabolism under variable nitrate and light or dark conditions (Light Dark Cycles with Minimum Starch Adaption)."""

    def __init__(self, model_path: str = "data/BIOMD0000000859.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Larbat20163ModelingTheDiversionOfPrimaryCBiomd0000000859Model = SbmlLarbat20163ModelingTheDiversionOfPrimaryCarbonFlux
