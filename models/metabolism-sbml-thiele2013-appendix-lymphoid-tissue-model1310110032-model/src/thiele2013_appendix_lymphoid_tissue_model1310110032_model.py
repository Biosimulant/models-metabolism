...
"""Auto-generated SBML BioModule wrapper for Thiele2013 - Appendix lymphoid tissue.

Source: biomodels_ebi:MODEL1310110032
Original: https://www.ebi.ac.uk/biomodels/MODEL1310110032
"""
...
class SbmlThiele2013AppendixLymphoidTissue(biosim.BioModule):
    """BioModule wrapper for SBML model: Thiele2013 - Appendix lymphoid tissue."""

    def __init__(self, model_path: str = "data/MODEL1310110032.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Thiele2013AppendixLymphoidTissueModel1310110032Model = SbmlThiele2013AppendixLymphoidTissue
