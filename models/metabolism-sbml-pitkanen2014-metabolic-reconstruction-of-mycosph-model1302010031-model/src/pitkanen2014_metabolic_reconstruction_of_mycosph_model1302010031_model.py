...
"""Auto-generated SBML BioModule wrapper for Pitkanen2014 - Metabolic reconstruction of Mycosphaerella graminicola using CoReCo.

Source: biomodels_ebi:MODEL1302010031
Original: https://www.ebi.ac.uk/biomodels/MODEL1302010031
"""
...
class SbmlPitkanen2014MetabolicReconstructionOfMycosphaerella(biosim.BioModule):
    """BioModule wrapper for SBML model: Pitkanen2014 - Metabolic reconstruction of Mycosphaerella graminicola using CoReCo."""

    def __init__(self, model_path: str = "data/MODEL1302010031.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Pitkanen2014MetabolicReconstructionOfMycosphModel1302010031Model = SbmlPitkanen2014MetabolicReconstructionOfMycosphaerella
