...
"""Auto-generated SBML BioModule wrapper for Fang2010 - Genome-scale metabolic network of Mycobacterium tuberculosis (iNJ661m).

Source: biomodels_ebi:MODEL1507180018
Original: https://www.ebi.ac.uk/biomodels/MODEL1507180018
"""
...
class SbmlFang2010GenomeScaleMetabolicNetworkOfMycobacterium(biosim.BioModule):
    """BioModule wrapper for SBML model: Fang2010 - Genome-scale metabolic network of Mycobacterium tuberculosis (iNJ661m)."""

    def __init__(self, model_path: str = "data/MODEL1507180018.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Fang2010GenomeScaleMetabolicNetworkOfMycobModel1507180018Model = SbmlFang2010GenomeScaleMetabolicNetworkOfMycobacterium
