...
"""Auto-generated SBML BioModule wrapper for ODea2007_IkappaB.

Source: biomodels_ebi:BIOMD0000000147
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000147
"""
...
class SbmlOdea2007Ikappab(biosim.BioModule):
    """BioModule wrapper for SBML model: ODea2007_IkappaB."""

    def __init__(self, model_path: str = "data/BIOMD0000000147.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Odea2007IkappabBiomd0000000147Model = SbmlOdea2007Ikappab
