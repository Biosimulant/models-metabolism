...
"""Auto-generated SBML BioModule wrapper for Väremo2015 - Human myocyte metabolic model.

Source: biomodels_ebi:MODEL1503240000
Original: https://www.ebi.ac.uk/biomodels/MODEL1503240000
"""
...
class SbmlVaremo2015HumanMyocyteMetabolicModel(biosim.BioModule):
    """BioModule wrapper for SBML model: Väremo2015 - Human myocyte metabolic model."""

    def __init__(self, model_path: str = "data/MODEL1503240000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
VRemo2015HumanMyocyteMetabolicModelModel1503240000Model = SbmlVaremo2015HumanMyocyteMetabolicModel
