...
"""Auto-generated SBML BioModule wrapper for Sl2183 - Tomato metabolic model.

Source: biomodels_ebi:MODEL2111120001
Original: https://www.ebi.ac.uk/biomodels/MODEL2111120001
"""
...
class SbmlSl2183TomatoMetabolicModel(biosim.BioModule):
    """BioModule wrapper for SBML model: Sl2183 - Tomato metabolic model."""

    def __init__(self, model_path: str = "data/MODEL2111120001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Sl2183TomatoMetabolicModelModel2111120001Model = SbmlSl2183TomatoMetabolicModel
