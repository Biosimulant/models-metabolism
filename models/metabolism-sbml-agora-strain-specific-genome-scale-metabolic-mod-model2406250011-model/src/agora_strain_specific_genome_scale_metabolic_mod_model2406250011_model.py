...
"""Auto-generated SBML BioModule wrapper for AGORA - Strain-specific genome-scale metabolic model of Acinetobacter baumannii AB0057.

Source: biomodels_ebi:MODEL2406250011
Original: https://www.ebi.ac.uk/biomodels/MODEL2406250011
"""
...
class SbmlAgoraStrainSpecificGenomeScaleMetabolicModelOf(biosim.BioModule):
    """BioModule wrapper for SBML model: AGORA - Strain-specific genome-scale metabolic model of Acinetobacter baumannii AB0057."""

    def __init__(self, model_path: str = "data/MODEL2406250011.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
AgoraStrainSpecificGenomeScaleMetabolicModModel2406250011Model = SbmlAgoraStrainSpecificGenomeScaleMetabolicModelOf
