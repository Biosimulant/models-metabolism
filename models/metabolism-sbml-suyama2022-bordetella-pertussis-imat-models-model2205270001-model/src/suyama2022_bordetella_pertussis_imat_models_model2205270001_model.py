...
"""Auto-generated SBML BioModule wrapper for Suyama2022 - Bordetella pertussis iMAT models.

Source: biomodels_ebi:MODEL2205270001
Original: https://www.ebi.ac.uk/biomodels/MODEL2205270001
"""
...
class SbmlSuyama2022BordetellaPertussisImatModels(biosim.BioModule):
    """BioModule wrapper for SBML model: Suyama2022 - Bordetella pertussis iMAT models."""

    def __init__(self, model_path: str = "data/MODEL2205270001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Suyama2022BordetellaPertussisImatModelsModel2205270001Model = SbmlSuyama2022BordetellaPertussisImatModels
