...
"""Auto-generated SBML BioModule wrapper for Rex2013 - Genome scale metabolic model of D.shibae (iDsh827).

Source: biomodels_ebi:MODEL1308180000
Original: https://www.ebi.ac.uk/biomodels/MODEL1308180000
"""
...
class SbmlRex2013GenomeScaleMetabolicModelOfDShibaeIdsh827(biosim.BioModule):
    """BioModule wrapper for SBML model: Rex2013 - Genome scale metabolic model of D.shibae (iDsh827)."""

    def __init__(self, model_path: str = "data/MODEL1308180000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Rex2013GenomeScaleMetabolicModelOfDShibaeModel1308180000Model = SbmlRex2013GenomeScaleMetabolicModelOfDShibaeIdsh827
