...
"""Auto-generated SBML BioModule wrapper for Pitkanen2014 - Metabolic reconstruction of Neosartorya fischeri using CoReCo.

Source: biomodels_ebi:MODEL1302010047
Original: https://www.ebi.ac.uk/biomodels/MODEL1302010047
"""
...
class SbmlPitkanen2014MetabolicReconstructionOfNeosartorya(biosim.BioModule):
    """BioModule wrapper for SBML model: Pitkanen2014 - Metabolic reconstruction of Neosartorya fischeri using CoReCo."""

    def __init__(self, model_path: str = "data/MODEL1302010047.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Pitkanen2014MetabolicReconstructionOfNeosartModel1302010047Model = SbmlPitkanen2014MetabolicReconstructionOfNeosartorya
