...
"""Auto-generated SBML BioModule wrapper for Caspeta2012 - Genome-scale metabolic network of Pichia pastoris (iLC915).

Source: biomodels_ebi:MODEL1507180065
Original: https://www.ebi.ac.uk/biomodels/MODEL1507180065
"""
...
class SbmlCaspeta2012GenomeScaleMetabolicNetworkOfPichia(biosim.BioModule):
    """BioModule wrapper for SBML model: Caspeta2012 - Genome-scale metabolic network of Pichia pastoris (iLC915)."""

    def __init__(self, model_path: str = "data/MODEL1507180065.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Caspeta2012GenomeScaleMetabolicNetworkOfPiModel1507180065Model = SbmlCaspeta2012GenomeScaleMetabolicNetworkOfPichia
