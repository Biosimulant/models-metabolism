...
"""Auto-generated SBML BioModule wrapper for vanEunen2012 - Yeast Glycolysis (glucose upshift).

Source: biomodels_ebi:MODEL1403250001
Original: https://www.ebi.ac.uk/biomodels/MODEL1403250001
"""
...
class SbmlVaneunen2012YeastGlycolysisGlucoseUpshift(biosim.BioModule):
    """BioModule wrapper for SBML model: vanEunen2012 - Yeast Glycolysis (glucose upshift)."""

    def __init__(self, model_path: str = "data/MODEL1403250001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Vaneunen2012YeastGlycolysisGlucoseUpshiftModel1403250001Model = SbmlVaneunen2012YeastGlycolysisGlucoseUpshift
