...
"""Auto-generated SBML BioModule wrapper for Reed2003 - Genome-scale metabolic network of Escherichia coli (iJR904).

Source: biomodels_ebi:MODEL1507180060
Original: https://www.ebi.ac.uk/biomodels/MODEL1507180060
"""
...
class SbmlReed2003GenomeScaleMetabolicNetworkOfEscherichiaColi(biosim.BioModule):
    """BioModule wrapper for SBML model: Reed2003 - Genome-scale metabolic network of Escherichia coli (iJR904)."""

    def __init__(self, model_path: str = "data/MODEL1507180060.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Reed2003GenomeScaleMetabolicNetworkOfEscheModel1507180060Model = SbmlReed2003GenomeScaleMetabolicNetworkOfEscherichiaColi
