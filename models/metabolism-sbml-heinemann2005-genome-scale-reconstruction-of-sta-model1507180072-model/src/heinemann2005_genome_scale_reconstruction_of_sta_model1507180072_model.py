...
"""Auto-generated SBML BioModule wrapper for Heinemann2005 - Genome-scale reconstruction of Staphylococcus aureus (iMH551).

Source: biomodels_ebi:MODEL1507180072
Original: https://www.ebi.ac.uk/biomodels/MODEL1507180072
"""
...
class SbmlHeinemann2005GenomeScaleReconstructionOfStaphylococcus(biosim.BioModule):
    """BioModule wrapper for SBML model: Heinemann2005 - Genome-scale reconstruction of Staphylococcus aureus (iMH551)."""

    def __init__(self, model_path: str = "data/MODEL1507180072.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Heinemann2005GenomeScaleReconstructionOfStaModel1507180072Model = SbmlHeinemann2005GenomeScaleReconstructionOfStaphylococcus
