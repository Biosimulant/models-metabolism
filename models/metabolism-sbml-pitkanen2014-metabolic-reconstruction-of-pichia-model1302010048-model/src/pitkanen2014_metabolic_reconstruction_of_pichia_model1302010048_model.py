...
"""Auto-generated SBML BioModule wrapper for Pitkanen2014 - Metabolic reconstruction of Pichia pastoris using CoReCo.

Source: biomodels_ebi:MODEL1302010048
Original: https://www.ebi.ac.uk/biomodels/MODEL1302010048
"""
...
class SbmlPitkanen2014MetabolicReconstructionOfPichiaPastoris(biosim.BioModule):
    """BioModule wrapper for SBML model: Pitkanen2014 - Metabolic reconstruction of Pichia pastoris using CoReCo."""

    def __init__(self, model_path: str = "data/MODEL1302010048.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Pitkanen2014MetabolicReconstructionOfPichiaModel1302010048Model = SbmlPitkanen2014MetabolicReconstructionOfPichiaPastoris
