...
"""Auto-generated SBML BioModule wrapper for Ankrah2021 - Genome scale metabolic model of Drosophila gut microbe Acetobacter tropicalis.

Source: biomodels_ebi:MODEL2002040004
Original: https://www.ebi.ac.uk/biomodels/MODEL2002040004
"""
...
class SbmlAnkrah2021GenomeScaleMetabolicModelOfDrosophilaGut3(biosim.BioModule):
    """BioModule wrapper for SBML model: Ankrah2021 - Genome scale metabolic model of Drosophila gut microbe Acetobacter tropicalis."""

    def __init__(self, model_path: str = "data/MODEL2002040004.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Ankrah2021GenomeScaleMetabolicModelOfDrosoModel2002040004Model = SbmlAnkrah2021GenomeScaleMetabolicModelOfDrosophilaGut3
