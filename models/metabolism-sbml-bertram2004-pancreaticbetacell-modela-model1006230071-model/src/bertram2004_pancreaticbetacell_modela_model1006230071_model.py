...
"""Auto-generated SBML BioModule wrapper for Bertram2004_PancreaticBetaCell_modelA.

Source: biomodels_ebi:MODEL1006230071
Original: https://www.ebi.ac.uk/biomodels/MODEL1006230071
"""
...
class SbmlBertram2004PancreaticbetacellModela(biosim.BioModule):
    """BioModule wrapper for SBML model: Bertram2004_PancreaticBetaCell_modelA."""

    def __init__(self, model_path: str = "data/MODEL1006230071.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Bertram2004PancreaticbetacellModelaModel1006230071Model = SbmlBertram2004PancreaticbetacellModela
