...
"""Auto-generated SBML BioModule wrapper for Castillo2016 - Whole-genome metabolic model of T.reesei using CoReCo.

Source: biomodels_ebi:MODEL1604280024
Original: https://www.ebi.ac.uk/biomodels/MODEL1604280024
"""
...
class SbmlCastillo2016WholeGenomeMetabolicModelOfTReeseiUsing(biosim.BioModule):
    """BioModule wrapper for SBML model: Castillo2016 - Whole-genome metabolic model of T.reesei using CoReCo."""

    def __init__(self, model_path: str = "data/MODEL1604280024.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Castillo2016WholeGenomeMetabolicModelOfTRModel1604280024Model = SbmlCastillo2016WholeGenomeMetabolicModelOfTReeseiUsing
