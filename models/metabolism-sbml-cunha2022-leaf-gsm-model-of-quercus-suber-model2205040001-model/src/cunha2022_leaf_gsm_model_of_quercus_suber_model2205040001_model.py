...
"""Auto-generated SBML BioModule wrapper for Cunha2022 - Leaf GSM model of Quercus suber.

Source: biomodels_ebi:MODEL2205040001
Original: https://www.ebi.ac.uk/biomodels/MODEL2205040001
"""
...
class SbmlCunha2022LeafGsmModelOfQuercusSuber(biosim.BioModule):
    """BioModule wrapper for SBML model: Cunha2022 - Leaf GSM model of Quercus suber."""

    def __init__(self, model_path: str = "data/MODEL2205040001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Cunha2022LeafGsmModelOfQuercusSuberModel2205040001Model = SbmlCunha2022LeafGsmModelOfQuercusSuber
