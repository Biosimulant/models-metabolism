...
"""Auto-generated SBML BioModule wrapper for Tymoshenko2015 - Genome scale metabolic model - ToxoNet1.

Source: biomodels_ebi:MODEL1504280000
Original: https://www.ebi.ac.uk/biomodels/MODEL1504280000
"""
...
class SbmlTymoshenko2015GenomeScaleMetabolicModelToxonet1(biosim.BioModule):
    """BioModule wrapper for SBML model: Tymoshenko2015 - Genome scale metabolic model - ToxoNet1."""

    def __init__(self, model_path: str = "data/MODEL1504280000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Tymoshenko2015GenomeScaleMetabolicModelToxoModel1504280000Model = SbmlTymoshenko2015GenomeScaleMetabolicModelToxonet1
