...
"""Auto-generated SBML BioModule wrapper for Pitkanen2014 - Metabolic reconstruction of Puccinia graminis using CoReCo.

Source: biomodels_ebi:MODEL1302010045
Original: https://www.ebi.ac.uk/biomodels/MODEL1302010045
"""
...
class SbmlPitkanen2014MetabolicReconstructionOfPucciniaGraminis(biosim.BioModule):
    """BioModule wrapper for SBML model: Pitkanen2014 - Metabolic reconstruction of Puccinia graminis using CoReCo."""

    def __init__(self, model_path: str = "data/MODEL1302010045.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Pitkanen2014MetabolicReconstructionOfPucciniModel1302010045Model = SbmlPitkanen2014MetabolicReconstructionOfPucciniaGraminis
