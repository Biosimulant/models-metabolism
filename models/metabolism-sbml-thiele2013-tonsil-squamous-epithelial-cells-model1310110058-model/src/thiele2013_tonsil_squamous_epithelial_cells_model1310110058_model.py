...
"""Auto-generated SBML BioModule wrapper for Thiele2013 - Tonsil squamous epithelial cells.

Source: biomodels_ebi:MODEL1310110058
Original: https://www.ebi.ac.uk/biomodels/MODEL1310110058
"""
...
class SbmlThiele2013TonsilSquamousEpithelialCells(biosim.BioModule):
    """BioModule wrapper for SBML model: Thiele2013 - Tonsil squamous epithelial cells."""

    def __init__(self, model_path: str = "data/MODEL1310110058.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Thiele2013TonsilSquamousEpithelialCellsModel1310110058Model = SbmlThiele2013TonsilSquamousEpithelialCells
