...
"""Auto-generated SBML BioModule wrapper for Beste2007 - Genome-scale metabolic network of Mycobacterium tuberculosis (GSMN_TB).

Source: biomodels_ebi:MODEL1507180021
Original: https://www.ebi.ac.uk/biomodels/MODEL1507180021
"""
...
class SbmlBeste2007GenomeScaleMetabolicNetworkOfMycobacterium(biosim.BioModule):
    """BioModule wrapper for SBML model: Beste2007 - Genome-scale metabolic network of Mycobacterium tuberculosis (GSMN_TB)."""

    def __init__(self, model_path: str = "data/MODEL1507180021.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Beste2007GenomeScaleMetabolicNetworkOfMycoModel1507180021Model = SbmlBeste2007GenomeScaleMetabolicNetworkOfMycobacterium
