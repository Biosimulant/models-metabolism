...
"""Auto-generated SBML BioModule wrapper for Liao2011 - Genome-scale metabolic reconstruction of Klebsiella pneumoniae (iYL1228).

Source: biomodels_ebi:BIOMD0000001094
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000001094
"""
...
class SbmlLiao2011GenomeScaleMetabolicReconstructionOf(biosim.BioModule):
    """BioModule wrapper for SBML model: Liao2011 - Genome-scale metabolic reconstruction of Klebsiella pneumoniae (iYL1228)."""

    def __init__(self, model_path: str = "data/BIOMD0000001094.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Liao2011GenomeScaleMetabolicReconstructionOBiomd0000001094Model = SbmlLiao2011GenomeScaleMetabolicReconstructionOf
