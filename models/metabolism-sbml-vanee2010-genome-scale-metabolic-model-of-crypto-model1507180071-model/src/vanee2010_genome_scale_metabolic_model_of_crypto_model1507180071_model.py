...
"""Auto-generated SBML BioModule wrapper for Vanee2010 - Genome-scale metabolic model of Cryptosporidium hominis (iNV213).

Source: biomodels_ebi:MODEL1507180071
Original: https://www.ebi.ac.uk/biomodels/MODEL1507180071
"""
...
class SbmlVanee2010GenomeScaleMetabolicModelOfCryptosporidium(biosim.BioModule):
    """BioModule wrapper for SBML model: Vanee2010 - Genome-scale metabolic model of Cryptosporidium hominis (iNV213)."""

    def __init__(self, model_path: str = "data/MODEL1507180071.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Vanee2010GenomeScaleMetabolicModelOfCryptoModel1507180071Model = SbmlVanee2010GenomeScaleMetabolicModelOfCryptosporidium
