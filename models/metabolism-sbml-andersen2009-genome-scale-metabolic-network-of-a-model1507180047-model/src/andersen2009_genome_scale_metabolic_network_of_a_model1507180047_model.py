...
"""Auto-generated SBML BioModule wrapper for Andersen2009 - Genome-scale metabolic network of Aspergillus niger (iMA871).

Source: biomodels_ebi:MODEL1507180047
Original: https://www.ebi.ac.uk/biomodels/MODEL1507180047
"""
...
class SbmlAndersen2009GenomeScaleMetabolicNetworkOfAspergillus(biosim.BioModule):
    """BioModule wrapper for SBML model: Andersen2009 - Genome-scale metabolic network of Aspergillus niger (iMA871)."""

    def __init__(self, model_path: str = "data/MODEL1507180047.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Andersen2009GenomeScaleMetabolicNetworkOfAModel1507180047Model = SbmlAndersen2009GenomeScaleMetabolicNetworkOfAspergillus
