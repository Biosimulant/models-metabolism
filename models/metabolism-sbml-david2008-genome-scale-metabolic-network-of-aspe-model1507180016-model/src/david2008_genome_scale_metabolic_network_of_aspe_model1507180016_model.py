...
"""Auto-generated SBML BioModule wrapper for David2008 - Genome-scale metabolic network of Aspergillus nidulans (iHD666).

Source: biomodels_ebi:MODEL1507180016
Original: https://www.ebi.ac.uk/biomodels/MODEL1507180016
"""
...
class SbmlDavid2008GenomeScaleMetabolicNetworkOfAspergillus(biosim.BioModule):
    """BioModule wrapper for SBML model: David2008 - Genome-scale metabolic network of Aspergillus nidulans (iHD666)."""

    def __init__(self, model_path: str = "data/MODEL1507180016.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
David2008GenomeScaleMetabolicNetworkOfAspeModel1507180016Model = SbmlDavid2008GenomeScaleMetabolicNetworkOfAspergillus
