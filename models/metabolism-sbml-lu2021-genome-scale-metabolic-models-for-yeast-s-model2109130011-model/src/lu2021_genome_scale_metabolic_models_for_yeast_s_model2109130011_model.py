...
"""Auto-generated SBML BioModule wrapper for Lu2021-Genome scale metabolic models for yeast species in clade Trigonopsidaceae.

Source: biomodels_ebi:MODEL2109130011
Original: https://www.ebi.ac.uk/biomodels/MODEL2109130011
"""
...
class SbmlLu2021GenomeScaleMetabolicModelsForYeastSpeciesIn(biosim.BioModule):
    """BioModule wrapper for SBML model: Lu2021-Genome scale metabolic models for yeast species in clade Trigonopsidaceae."""

    def __init__(self, model_path: str = "data/MODEL2109130011.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Lu2021GenomeScaleMetabolicModelsForYeastSModel2109130011Model = SbmlLu2021GenomeScaleMetabolicModelsForYeastSpeciesIn
