...
"""Auto-generated SBML BioModule wrapper for Subrmanian2015 - Energy metabolism of Leishmania infantum, constrain-based metabolic model.

Source: biomodels_ebi:MODEL2010130002
Original: https://www.ebi.ac.uk/biomodels/MODEL2010130002
"""
...
class SbmlSubrmanian2015EnergyMetabolismOfLeishmaniaInfantum(biosim.BioModule):
    """BioModule wrapper for SBML model: Subrmanian2015 - Energy metabolism of Leishmania infantum, constrain-based metabolic model."""

    def __init__(self, model_path: str = "data/MODEL2010130002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Subrmanian2015EnergyMetabolismOfLeishmaniaIModel2010130002Model = SbmlSubrmanian2015EnergyMetabolismOfLeishmaniaInfantum
