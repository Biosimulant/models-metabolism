...
"""Auto-generated SBML BioModule wrapper for Thiele2013 - Tonsil germinal center cells.

Source: biomodels_ebi:MODEL1310110021
Original: https://www.ebi.ac.uk/biomodels/MODEL1310110021
"""
...
class SbmlThiele2013TonsilGerminalCenterCells(biosim.BioModule):
    """BioModule wrapper for SBML model: Thiele2013 - Tonsil germinal center cells."""

    def __init__(self, model_path: str = "data/MODEL1310110021.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Thiele2013TonsilGerminalCenterCellsModel1310110021Model = SbmlThiele2013TonsilGerminalCenterCells
