...
"""Auto-generated SBML BioModule wrapper for Tiago2010_FeMetabolism_FeLoaded.

Source: biomodels_ebi:BIOMD0000000261
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000261
"""
...
class SbmlTiago2010FemetabolismFeloaded(biosim.BioModule):
    """BioModule wrapper for SBML model: Tiago2010_FeMetabolism_FeLoaded."""

    def __init__(self, model_path: str = "data/BIOMD0000000261.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Tiago2010FemetabolismFeloadedBiomd0000000261Model = SbmlTiago2010FemetabolismFeloaded
