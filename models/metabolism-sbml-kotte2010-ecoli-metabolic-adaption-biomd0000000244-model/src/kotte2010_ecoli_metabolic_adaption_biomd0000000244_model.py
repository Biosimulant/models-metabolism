...
"""Auto-generated SBML BioModule wrapper for Kotte2010_Ecoli_Metabolic_Adaption.

Source: biomodels_ebi:BIOMD0000000244
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000244
"""
...
class SbmlKotte2010EcoliMetabolicAdaption(biosim.BioModule):
    """BioModule wrapper for SBML model: Kotte2010_Ecoli_Metabolic_Adaption."""

    def __init__(self, model_path: str = "data/BIOMD0000000244.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Kotte2010EcoliMetabolicAdaptionBiomd0000000244Model = SbmlKotte2010EcoliMetabolicAdaption
