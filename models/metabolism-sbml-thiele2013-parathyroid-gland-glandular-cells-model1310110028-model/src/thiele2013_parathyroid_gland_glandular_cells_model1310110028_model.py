...
"""Auto-generated SBML BioModule wrapper for Thiele2013 - Parathyroid gland glandular cells.

Source: biomodels_ebi:MODEL1310110028
Original: https://www.ebi.ac.uk/biomodels/MODEL1310110028
"""
...
class SbmlThiele2013ParathyroidGlandGlandularCells(biosim.BioModule):
    """BioModule wrapper for SBML model: Thiele2013 - Parathyroid gland glandular cells."""

    def __init__(self, model_path: str = "data/MODEL1310110028.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Thiele2013ParathyroidGlandGlandularCellsModel1310110028Model = SbmlThiele2013ParathyroidGlandGlandularCells
