...
"""Auto-generated SBML BioModule wrapper for Castillo2016 - Whole-genome metabolic model of P.stipitis using CoReCo.

Source: biomodels_ebi:MODEL1604280049
Original: https://www.ebi.ac.uk/biomodels/MODEL1604280049
"""
...
class SbmlCastillo2016WholeGenomeMetabolicModelOfPStipitis(biosim.BioModule):
    """BioModule wrapper for SBML model: Castillo2016 - Whole-genome metabolic model of P.stipitis using CoReCo."""

    def __init__(self, model_path: str = "data/MODEL1604280049.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Castillo2016WholeGenomeMetabolicModelOfPSModel1604280049Model = SbmlCastillo2016WholeGenomeMetabolicModelOfPStipitis
