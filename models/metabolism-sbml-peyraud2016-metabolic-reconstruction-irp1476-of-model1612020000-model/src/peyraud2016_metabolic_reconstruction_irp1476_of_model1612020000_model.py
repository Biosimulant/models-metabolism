...
"""Auto-generated SBML BioModule wrapper for Peyraud2016 - Metabolic reconstruction (iRP1476) of Ralstonia solanacearum GMI1000.

Source: biomodels_ebi:MODEL1612020000
Original: https://www.ebi.ac.uk/biomodels/MODEL1612020000
"""
...
class SbmlPeyraud2016MetabolicReconstructionIrp1476OfRalstonia(biosim.BioModule):
    """BioModule wrapper for SBML model: Peyraud2016 - Metabolic reconstruction (iRP1476) of Ralstonia solanacearum GMI1000."""

    def __init__(self, model_path: str = "data/MODEL1612020000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Peyraud2016MetabolicReconstructionIrp1476OfModel1612020000Model = SbmlPeyraud2016MetabolicReconstructionIrp1476OfRalstonia
