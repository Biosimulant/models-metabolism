...
"""Auto-generated SBML BioModule wrapper for Pitkanen2014 - Metabolic reconstruction of Histoplasma capsulatum using CoReCo.

Source: biomodels_ebi:MODEL1302010022
Original: https://www.ebi.ac.uk/biomodels/MODEL1302010022
"""
...
class SbmlPitkanen2014MetabolicReconstructionOfHistoplasma(biosim.BioModule):
    """BioModule wrapper for SBML model: Pitkanen2014 - Metabolic reconstruction of Histoplasma capsulatum using CoReCo."""

    def __init__(self, model_path: str = "data/MODEL1302010022.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Pitkanen2014MetabolicReconstructionOfHistoplModel1302010022Model = SbmlPitkanen2014MetabolicReconstructionOfHistoplasma
