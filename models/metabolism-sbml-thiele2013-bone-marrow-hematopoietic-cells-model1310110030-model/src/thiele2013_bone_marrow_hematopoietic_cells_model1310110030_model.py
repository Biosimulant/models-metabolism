...
"""Auto-generated SBML BioModule wrapper for Thiele2013 - Bone marrow hematopoietic cells.

Source: biomodels_ebi:MODEL1310110030
Original: https://www.ebi.ac.uk/biomodels/MODEL1310110030
"""
...
class SbmlThiele2013BoneMarrowHematopoieticCells(biosim.BioModule):
    """BioModule wrapper for SBML model: Thiele2013 - Bone marrow hematopoietic cells."""

    def __init__(self, model_path: str = "data/MODEL1310110030.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Thiele2013BoneMarrowHematopoieticCellsModel1310110030Model = SbmlThiele2013BoneMarrowHematopoieticCells
