...
"""Auto-generated SBML BioModule wrapper for Yang2008_AAnetwork_PLT.

Source: biomodels_ebi:MODEL8236520494
Original: https://www.ebi.ac.uk/biomodels/MODEL8236520494
"""
...
class SbmlYang2008AanetworkPlt(biosim.BioModule):
    """BioModule wrapper for SBML model: Yang2008_AAnetwork_PLT."""

    def __init__(self, model_path: str = "data/MODEL8236520494.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Yang2008AanetworkPltModel8236520494Model = SbmlYang2008AanetworkPlt
