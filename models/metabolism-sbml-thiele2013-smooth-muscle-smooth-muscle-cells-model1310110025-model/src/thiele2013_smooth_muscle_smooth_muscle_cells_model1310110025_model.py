...
"""Auto-generated SBML BioModule wrapper for Thiele2013 - Smooth muscle smooth muscle cells.

Source: biomodels_ebi:MODEL1310110025
Original: https://www.ebi.ac.uk/biomodels/MODEL1310110025
"""
...
class SbmlThiele2013SmoothMuscleSmoothMuscleCells(biosim.BioModule):
    """BioModule wrapper for SBML model: Thiele2013 - Smooth muscle smooth muscle cells."""

    def __init__(self, model_path: str = "data/MODEL1310110025.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Thiele2013SmoothMuscleSmoothMuscleCellsModel1310110025Model = SbmlThiele2013SmoothMuscleSmoothMuscleCells
