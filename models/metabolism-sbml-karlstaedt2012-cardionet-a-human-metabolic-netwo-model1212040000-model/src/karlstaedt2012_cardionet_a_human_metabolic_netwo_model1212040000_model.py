...
"""Auto-generated SBML BioModule wrapper for Karlstaedt2012 - CardioNet, A Human Metabolic Network.

Source: biomodels_ebi:MODEL1212040000
Original: https://www.ebi.ac.uk/biomodels/MODEL1212040000
"""
...
class SbmlKarlstaedt2012CardionetAHumanMetabolicNetwork(biosim.BioModule):
    """BioModule wrapper for SBML model: Karlstaedt2012 - CardioNet, A Human Metabolic Network."""

    def __init__(self, model_path: str = "data/MODEL1212040000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Karlstaedt2012CardionetAHumanMetabolicNetwoModel1212040000Model = SbmlKarlstaedt2012CardionetAHumanMetabolicNetwork
