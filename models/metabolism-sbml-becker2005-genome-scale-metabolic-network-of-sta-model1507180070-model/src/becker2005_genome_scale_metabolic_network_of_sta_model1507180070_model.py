...
"""Auto-generated SBML BioModule wrapper for Becker2005 - Genome-scale metabolic network of Staphylococcus aureus (iSB619).

Source: biomodels_ebi:MODEL1507180070
Original: https://www.ebi.ac.uk/biomodels/MODEL1507180070
"""
...
class SbmlBecker2005GenomeScaleMetabolicNetworkOfStaphylococcus(biosim.BioModule):
    """BioModule wrapper for SBML model: Becker2005 - Genome-scale metabolic network of Staphylococcus aureus (iSB619)."""

    def __init__(self, model_path: str = "data/MODEL1507180070.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Becker2005GenomeScaleMetabolicNetworkOfStaModel1507180070Model = SbmlBecker2005GenomeScaleMetabolicNetworkOfStaphylococcus
