...
"""Auto-generated SBML BioModule wrapper for Cottret2010_B_cicadellinicola_Met_Net.

Source: biomodels_ebi:MODEL1011080002
Original: https://www.ebi.ac.uk/biomodels/MODEL1011080002
"""
...
class SbmlCottret2010BCicadellinicolaMetNet(biosim.BioModule):
    """BioModule wrapper for SBML model: Cottret2010_B_cicadellinicola_Met_Net."""

    def __init__(self, model_path: str = "data/MODEL1011080002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Cottret2010BCicadellinicolaMetNetModel1011080002Model = SbmlCottret2010BCicadellinicolaMetNet
