...
"""Auto-generated SBML BioModule wrapper for Zhang2020 - Draft metabolic reconstruction model of Atlantic cod liver generated from gadMor3 and iHepatocyte2322.

Source: biomodels_ebi:MODEL2010090001
Original: https://www.ebi.ac.uk/biomodels/MODEL2010090001
"""
...
class SbmlZhang2020DraftMetabolicReconstructionModelOfAtlantic(biosim.BioModule):
    """BioModule wrapper for SBML model: Zhang2020 - Draft metabolic reconstruction model of Atlantic cod liver generated from gadMor3 and iHepatocyte2322."""

    def __init__(self, model_path: str = "data/MODEL2010090001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Zhang2020DraftMetabolicReconstructionModelOModel2010090001Model = SbmlZhang2020DraftMetabolicReconstructionModelOfAtlantic
