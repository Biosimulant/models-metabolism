...
"""Auto-generated SBML BioModule wrapper for Thiele2013 - Cerebellum cells in molecular layer.

Source: biomodels_ebi:MODEL1310110016
Original: https://www.ebi.ac.uk/biomodels/MODEL1310110016
"""
...
class SbmlThiele2013CerebellumCellsInMolecularLayer(biosim.BioModule):
    """BioModule wrapper for SBML model: Thiele2013 - Cerebellum cells in molecular layer."""

    def __init__(self, model_path: str = "data/MODEL1310110016.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Thiele2013CerebellumCellsInMolecularLayerModel1310110016Model = SbmlThiele2013CerebellumCellsInMolecularLayer
