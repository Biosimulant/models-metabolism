...
"""Auto-generated SBML BioModule wrapper for Pitkanen2014 - Metabolic reconstruction of Sporobolomyces roseus using CoReCo.

Source: biomodels_ebi:MODEL1302010036
Original: https://www.ebi.ac.uk/biomodels/MODEL1302010036
"""
...
class SbmlPitkanen2014MetabolicReconstructionOfSporobolomyces(biosim.BioModule):
    """BioModule wrapper for SBML model: Pitkanen2014 - Metabolic reconstruction of Sporobolomyces roseus using CoReCo."""

    def __init__(self, model_path: str = "data/MODEL1302010036.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Pitkanen2014MetabolicReconstructionOfSporoboModel1302010036Model = SbmlPitkanen2014MetabolicReconstructionOfSporobolomyces
