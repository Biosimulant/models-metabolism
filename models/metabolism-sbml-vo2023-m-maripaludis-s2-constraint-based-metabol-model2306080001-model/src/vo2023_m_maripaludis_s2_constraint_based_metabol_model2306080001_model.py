...
"""Auto-generated SBML BioModule wrapper for Vo2023 - M. maripaludis S2 constraint-based metabolic model.

Source: biomodels_ebi:MODEL2306080001
Original: https://www.ebi.ac.uk/biomodels/MODEL2306080001
"""
...
class SbmlVo2023MMaripaludisS2ConstraintBasedMetabolicModel(biosim.BioModule):
    """BioModule wrapper for SBML model: Vo2023 - M. maripaludis S2 constraint-based metabolic model."""

    def __init__(self, model_path: str = "data/MODEL2306080001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Vo2023MMaripaludisS2ConstraintBasedMetabolModel2306080001Model = SbmlVo2023MMaripaludisS2ConstraintBasedMetabolicModel
