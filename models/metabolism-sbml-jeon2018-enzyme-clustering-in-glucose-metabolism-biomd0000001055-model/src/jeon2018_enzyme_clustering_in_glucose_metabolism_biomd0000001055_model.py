...
"""Auto-generated SBML BioModule wrapper for Jeon2018 - Enzyme clustering in Glucose metabolism.

Source: biomodels_ebi:BIOMD0000001055
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000001055
"""
...
class SbmlJeon2018EnzymeClusteringInGlucoseMetabolism(biosim.BioModule):
    """BioModule wrapper for SBML model: Jeon2018 - Enzyme clustering in Glucose metabolism."""

    def __init__(self, model_path: str = "data/BIOMD0000001055.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Jeon2018EnzymeClusteringInGlucoseMetabolismBiomd0000001055Model = SbmlJeon2018EnzymeClusteringInGlucoseMetabolism
