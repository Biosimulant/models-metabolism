...
"""Auto-generated SBML BioModule wrapper for Mardinoglu2015 - Curated tissue-specific genome-scale metabolic network - Liver.

Source: biomodels_ebi:MODEL1509220029
Original: https://www.ebi.ac.uk/biomodels/MODEL1509220029
"""
...
class SbmlMardinoglu2015CuratedTissueSpecificGenomeScale(biosim.BioModule):
    """BioModule wrapper for SBML model: Mardinoglu2015 - Curated tissue-specific genome-scale metabolic network - Liver."""

    def __init__(self, model_path: str = "data/MODEL1509220029.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Mardinoglu2015CuratedTissueSpecificGenomeScModel1509220029Model = SbmlMardinoglu2015CuratedTissueSpecificGenomeScale
