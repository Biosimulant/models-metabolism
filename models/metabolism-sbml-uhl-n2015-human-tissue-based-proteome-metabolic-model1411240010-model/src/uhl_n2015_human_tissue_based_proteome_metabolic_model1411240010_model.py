...
"""Auto-generated SBML BioModule wrapper for Uhlén2015 - Human tissue-based proteome metabolic network - endometrium.

Source: biomodels_ebi:MODEL1411240010
Original: https://www.ebi.ac.uk/biomodels/MODEL1411240010
"""
...
class SbmlUhlen2015HumanTissueBasedProteomeMetabolicNetwork12(biosim.BioModule):
    """BioModule wrapper for SBML model: Uhlén2015 - Human tissue-based proteome metabolic network - endometrium."""

    def __init__(self, model_path: str = "data/MODEL1411240010.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
UhlN2015HumanTissueBasedProteomeMetabolicModel1411240010Model = SbmlUhlen2015HumanTissueBasedProteomeMetabolicNetwork12
