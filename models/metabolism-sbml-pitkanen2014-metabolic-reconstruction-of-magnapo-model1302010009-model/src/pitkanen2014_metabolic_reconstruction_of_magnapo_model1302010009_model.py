...
"""Auto-generated SBML BioModule wrapper for Pitkanen2014 - Metabolic reconstruction of Magnaporthe grisea using CoReCo.

Source: biomodels_ebi:MODEL1302010009
Original: https://www.ebi.ac.uk/biomodels/MODEL1302010009
"""
...
class SbmlPitkanen2014MetabolicReconstructionOfMagnaportheGrisea(biosim.BioModule):
    """BioModule wrapper for SBML model: Pitkanen2014 - Metabolic reconstruction of Magnaporthe grisea using CoReCo."""

    def __init__(self, model_path: str = "data/MODEL1302010009.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Pitkanen2014MetabolicReconstructionOfMagnapoModel1302010009Model = SbmlPitkanen2014MetabolicReconstructionOfMagnaportheGrisea
