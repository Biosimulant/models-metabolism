...
"""Auto-generated SBML BioModule wrapper for Castillo2016 - Whole-genome metabolic model of T.longibrachiatum using CoReCo.

Source: biomodels_ebi:MODEL1604280010
Original: https://www.ebi.ac.uk/biomodels/MODEL1604280010
"""
...
class SbmlCastillo2016WholeGenomeMetabolicModelOfT2(biosim.BioModule):
    """BioModule wrapper for SBML model: Castillo2016 - Whole-genome metabolic model of T.longibrachiatum using CoReCo."""

    def __init__(self, model_path: str = "data/MODEL1604280010.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Castillo2016WholeGenomeMetabolicModelOfTLModel1604280010Model = SbmlCastillo2016WholeGenomeMetabolicModelOfT2
