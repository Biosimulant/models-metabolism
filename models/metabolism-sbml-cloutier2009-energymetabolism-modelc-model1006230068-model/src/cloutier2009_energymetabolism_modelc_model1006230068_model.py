...
"""Auto-generated SBML BioModule wrapper for Cloutier2009_EnergyMetabolism_ModelC.

Source: biomodels_ebi:MODEL1006230068
Original: https://www.ebi.ac.uk/biomodels/MODEL1006230068
"""
...
class SbmlCloutier2009EnergymetabolismModelc(biosim.BioModule):
    """BioModule wrapper for SBML model: Cloutier2009_EnergyMetabolism_ModelC."""

    def __init__(self, model_path: str = "data/MODEL1006230068.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Cloutier2009EnergymetabolismModelcModel1006230068Model = SbmlCloutier2009EnergymetabolismModelc
