...
"""Auto-generated SBML BioModule wrapper for Castillo2016 - Whole-genome metabolic model of C.globosum using CoReCo.

Source: biomodels_ebi:MODEL1604280005
Original: https://www.ebi.ac.uk/biomodels/MODEL1604280005
"""
...
class SbmlCastillo2016WholeGenomeMetabolicModelOfCGlobosum(biosim.BioModule):
    """BioModule wrapper for SBML model: Castillo2016 - Whole-genome metabolic model of C.globosum using CoReCo."""

    def __init__(self, model_path: str = "data/MODEL1604280005.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Castillo2016WholeGenomeMetabolicModelOfCGModel1604280005Model = SbmlCastillo2016WholeGenomeMetabolicModelOfCGlobosum
