...
"""Auto-generated SBML BioModule wrapper for Best et al. 2024 - Metabolic metaorganism model of mice and their microbiota.

Source: biomodels_ebi:MODEL2310020001
Original: https://www.ebi.ac.uk/biomodels/MODEL2310020001
"""
...
class SbmlBestEtAl2024MetabolicMetaorganismModelOfMiceAnd(biosim.BioModule):
    """BioModule wrapper for SBML model: Best et al. 2024 - Metabolic metaorganism model of mice and their microbiota."""

    def __init__(self, model_path: str = "data/MODEL2310020001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
BestEtAl2024MetabolicMetaorganismModelOfModel2310020001Model = SbmlBestEtAl2024MetabolicMetaorganismModelOfMiceAnd
