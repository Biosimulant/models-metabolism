...
"""Auto-generated SBML BioModule wrapper for ODea2007 - A homeostatic model of IκB metabolism to control constitutive NF-κB activity.

Source: biomodels_ebi:MODEL1908270002
Original: https://www.ebi.ac.uk/biomodels/MODEL1908270002
"""
...
class SbmlOdea2007AHomeostaticModelOfIbMetabolismToControl(biosim.BioModule):
    """BioModule wrapper for SBML model: ODea2007 - A homeostatic model of IκB metabolism to control constitutive NF-κB activity."""

    def __init__(self, model_path: str = "data/MODEL1908270002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Odea2007AHomeostaticModelOfIBMetabolismTModel1908270002Model = SbmlOdea2007AHomeostaticModelOfIbMetabolismToControl
