...
"""Auto-generated SBML BioModule wrapper for Sertbaş2014 - Brain specific metabolic network (iMS570).

Source: biomodels_ebi:MODEL1401240000
Original: https://www.ebi.ac.uk/biomodels/MODEL1401240000
"""
...
class SbmlSertbas2014BrainSpecificMetabolicNetworkIms570(biosim.BioModule):
    """BioModule wrapper for SBML model: Sertbaş2014 - Brain specific metabolic network (iMS570)."""

    def __init__(self, model_path: str = "data/MODEL1401240000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Sertba2014BrainSpecificMetabolicNetworkImsModel1401240000Model = SbmlSertbas2014BrainSpecificMetabolicNetworkIms570
