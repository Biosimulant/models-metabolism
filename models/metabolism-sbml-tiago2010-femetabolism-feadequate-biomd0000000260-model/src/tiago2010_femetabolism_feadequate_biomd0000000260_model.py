...
"""Auto-generated SBML BioModule wrapper for Tiago2010_FeMetabolism_FeAdequate.

Source: biomodels_ebi:BIOMD0000000260
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000260
"""
...
class SbmlTiago2010FemetabolismFeadequate(biosim.BioModule):
    """BioModule wrapper for SBML model: Tiago2010_FeMetabolism_FeAdequate."""

    def __init__(self, model_path: str = "data/BIOMD0000000260.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Tiago2010FemetabolismFeadequateBiomd0000000260Model = SbmlTiago2010FemetabolismFeadequate
