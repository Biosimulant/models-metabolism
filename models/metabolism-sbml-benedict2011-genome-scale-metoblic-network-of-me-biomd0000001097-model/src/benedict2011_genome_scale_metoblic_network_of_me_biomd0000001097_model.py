...
"""Auto-generated SBML BioModule wrapper for Benedict2011 - Genome-scale metoblic network of Methanosarcina acetivorans (iMB745).

Source: biomodels_ebi:BIOMD0000001097
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000001097
"""
...
class SbmlBenedict2011GenomeScaleMetoblicNetworkOf(biosim.BioModule):
    """BioModule wrapper for SBML model: Benedict2011 - Genome-scale metoblic network of Methanosarcina acetivorans (iMB745)."""

    def __init__(self, model_path: str = "data/BIOMD0000001097.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Benedict2011GenomeScaleMetoblicNetworkOfMeBiomd0000001097Model = SbmlBenedict2011GenomeScaleMetoblicNetworkOf
