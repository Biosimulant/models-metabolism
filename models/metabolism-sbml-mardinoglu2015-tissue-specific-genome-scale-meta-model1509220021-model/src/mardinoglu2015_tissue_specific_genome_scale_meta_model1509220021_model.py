...
"""Auto-generated SBML BioModule wrapper for Mardinoglu2015 - Tissue-specific genome-scale metabolic network - Stomach.

Source: biomodels_ebi:MODEL1509220021
Original: https://www.ebi.ac.uk/biomodels/MODEL1509220021
"""
...
class SbmlMardinoglu2015TissueSpecificGenomeScaleMetabolic8(biosim.BioModule):
    """BioModule wrapper for SBML model: Mardinoglu2015 - Tissue-specific genome-scale metabolic network - Stomach."""

    def __init__(self, model_path: str = "data/MODEL1509220021.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Mardinoglu2015TissueSpecificGenomeScaleMetaModel1509220021Model = SbmlMardinoglu2015TissueSpecificGenomeScaleMetabolic8
