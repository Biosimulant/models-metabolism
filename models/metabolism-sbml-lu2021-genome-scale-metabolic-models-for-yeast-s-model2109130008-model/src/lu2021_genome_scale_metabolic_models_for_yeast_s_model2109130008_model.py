...
"""Auto-generated SBML BioModule wrapper for Lu2021-Genome scale metabolic models for yeast species of clade Phaffomycetaceae.

Source: biomodels_ebi:MODEL2109130008
Original: https://www.ebi.ac.uk/biomodels/MODEL2109130008
"""
...
class SbmlLu2021GenomeScaleMetabolicModelsForYeastSpeciesOf5(biosim.BioModule):
    """BioModule wrapper for SBML model: Lu2021-Genome scale metabolic models for yeast species of clade Phaffomycetaceae."""

    def __init__(self, model_path: str = "data/MODEL2109130008.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Lu2021GenomeScaleMetabolicModelsForYeastSModel2109130008Model = SbmlLu2021GenomeScaleMetabolicModelsForYeastSpeciesOf5
