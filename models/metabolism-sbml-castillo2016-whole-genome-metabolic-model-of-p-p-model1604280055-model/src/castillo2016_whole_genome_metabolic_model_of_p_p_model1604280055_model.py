...
"""Auto-generated SBML BioModule wrapper for Castillo2016 - Whole-genome metabolic model of P.pastoris using CoReCo.

Source: biomodels_ebi:MODEL1604280055
Original: https://www.ebi.ac.uk/biomodels/MODEL1604280055
"""
...
class SbmlCastillo2016WholeGenomeMetabolicModelOfPPastoris(biosim.BioModule):
    """BioModule wrapper for SBML model: Castillo2016 - Whole-genome metabolic model of P.pastoris using CoReCo."""

    def __init__(self, model_path: str = "data/MODEL1604280055.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Castillo2016WholeGenomeMetabolicModelOfPPModel1604280055Model = SbmlCastillo2016WholeGenomeMetabolicModelOfPPastoris
