...
"""Auto-generated SBML BioModule wrapper for Yilmaz2016 - Genome scale metabolic model - Caenorhabditis elegans (iCEL1273).

Source: biomodels_ebi:MODEL1604210000
Original: https://www.ebi.ac.uk/biomodels/MODEL1604210000
"""
...
class SbmlYilmaz2016GenomeScaleMetabolicModelCaenorhabditis(biosim.BioModule):
    """BioModule wrapper for SBML model: Yilmaz2016 - Genome scale metabolic model - Caenorhabditis elegans (iCEL1273)."""

    def __init__(self, model_path: str = "data/MODEL1604210000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Yilmaz2016GenomeScaleMetabolicModelCaenorhaModel1604210000Model = SbmlYilmaz2016GenomeScaleMetabolicModelCaenorhabditis
