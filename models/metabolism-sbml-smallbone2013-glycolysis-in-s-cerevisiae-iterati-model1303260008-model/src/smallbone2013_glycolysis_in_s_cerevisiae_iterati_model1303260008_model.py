...
"""Auto-generated SBML BioModule wrapper for Smallbone2013 - Glycolysis in S.cerevisiae - Iteration 08.

Source: biomodels_ebi:MODEL1303260008
Original: https://www.ebi.ac.uk/biomodels/MODEL1303260008
"""
...
class SbmlSmallbone2013GlycolysisInSCerevisiaeIteration08(biosim.BioModule):
    """BioModule wrapper for SBML model: Smallbone2013 - Glycolysis in S.cerevisiae - Iteration 08."""

    def __init__(self, model_path: str = "data/MODEL1303260008.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Smallbone2013GlycolysisInSCerevisiaeIteratiModel1303260008Model = SbmlSmallbone2013GlycolysisInSCerevisiaeIteration08
