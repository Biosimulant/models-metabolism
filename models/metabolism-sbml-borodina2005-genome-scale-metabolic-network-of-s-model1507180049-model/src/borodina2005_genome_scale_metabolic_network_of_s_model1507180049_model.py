...
"""Auto-generated SBML BioModule wrapper for Borodina2005 - Genome-scale metabolic network of Streptomyces coelicolor (iIB711).

Source: biomodels_ebi:MODEL1507180049
Original: https://www.ebi.ac.uk/biomodels/MODEL1507180049
"""
...
class SbmlBorodina2005GenomeScaleMetabolicNetworkOfStreptomyces(biosim.BioModule):
    """BioModule wrapper for SBML model: Borodina2005 - Genome-scale metabolic network of Streptomyces coelicolor (iIB711)."""

    def __init__(self, model_path: str = "data/MODEL1507180049.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Borodina2005GenomeScaleMetabolicNetworkOfSModel1507180049Model = SbmlBorodina2005GenomeScaleMetabolicNetworkOfStreptomyces
