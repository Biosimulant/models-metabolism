...
"""Auto-generated SBML BioModule wrapper for Thiele2013 - Pancreas exocrine glandular cells.

Source: biomodels_ebi:MODEL1310110024
Original: https://www.ebi.ac.uk/biomodels/MODEL1310110024
"""
...
class SbmlThiele2013PancreasExocrineGlandularCells(biosim.BioModule):
    """BioModule wrapper for SBML model: Thiele2013 - Pancreas exocrine glandular cells."""

    def __init__(self, model_path: str = "data/MODEL1310110024.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Thiele2013PancreasExocrineGlandularCellsModel1310110024Model = SbmlThiele2013PancreasExocrineGlandularCells
