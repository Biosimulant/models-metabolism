...
"""Auto-generated SBML BioModule wrapper for Duarte2004 - Genome-scale metabolic network of Saccharomyces cerevisiae (iND750).

Source: biomodels_ebi:MODEL1507180019
Original: https://www.ebi.ac.uk/biomodels/MODEL1507180019
"""
...
class SbmlDuarte2004GenomeScaleMetabolicNetworkOfSaccharomyces(biosim.BioModule):
    """BioModule wrapper for SBML model: Duarte2004 - Genome-scale metabolic network of Saccharomyces cerevisiae (iND750)."""

    def __init__(self, model_path: str = "data/MODEL1507180019.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Duarte2004GenomeScaleMetabolicNetworkOfSacModel1507180019Model = SbmlDuarte2004GenomeScaleMetabolicNetworkOfSaccharomyces
