...
"""Auto-generated SBML BioModule wrapper for Reyes-Palomares2012 -  a combined model hepatic polyamine and sulfur aminoacid metabolism - version2.

Source: biomodels_ebi:BIOMD0000000450
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000450
"""
...
class SbmlReyesPalomares2012ACombinedModelHepaticPolyamineAnd2(biosim.BioModule):
    """BioModule wrapper for SBML model: Reyes-Palomares2012 -  a combined model hepatic polyamine and sulfur aminoacid metabolism - version2."""

    def __init__(self, model_path: str = "data/BIOMD0000000450.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
ReyesPalomares2012ACombinedModelHepaticPolBiomd0000000450Model = SbmlReyesPalomares2012ACombinedModelHepaticPolyamineAnd2
