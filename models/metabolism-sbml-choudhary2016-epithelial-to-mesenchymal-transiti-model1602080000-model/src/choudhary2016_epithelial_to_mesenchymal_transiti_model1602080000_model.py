...
"""Auto-generated SBML BioModule wrapper for Choudhary2016 - Epithelial to  mesenchymal transition (EMT) metabolic network.

Source: biomodels_ebi:MODEL1602080000
Original: https://www.ebi.ac.uk/biomodels/MODEL1602080000
"""
...
class SbmlChoudhary2016EpithelialToMesenchymalTransitionEmt(biosim.BioModule):
    """BioModule wrapper for SBML model: Choudhary2016 - Epithelial to  mesenchymal transition (EMT) metabolic network."""

    def __init__(self, model_path: str = "data/MODEL1602080000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Choudhary2016EpithelialToMesenchymalTransitiModel1602080000Model = SbmlChoudhary2016EpithelialToMesenchymalTransitionEmt
