...
"""Auto-generated SBML BioModule wrapper for Liu2019 - Clostridium ljungdahlii metabolism model.

Source: biomodels_ebi:MODEL2204200003
Original: https://www.ebi.ac.uk/biomodels/MODEL2204200003
"""
...
class SbmlLiu2019ClostridiumLjungdahliiMetabolismModel(biosim.BioModule):
    """BioModule wrapper for SBML model: Liu2019 - Clostridium ljungdahlii metabolism model."""

    def __init__(self, model_path: str = "data/MODEL2204200003.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Liu2019ClostridiumLjungdahliiMetabolismModelModel2204200003Model = SbmlLiu2019ClostridiumLjungdahliiMetabolismModel
