...
"""Auto-generated SBML BioModule wrapper for Castillo2016 - Whole-genome metabolic model of C.tropicalis using CoReCo.

Source: biomodels_ebi:MODEL1604280006
Original: https://www.ebi.ac.uk/biomodels/MODEL1604280006
"""
...
class SbmlCastillo2016WholeGenomeMetabolicModelOfCTropicalis(biosim.BioModule):
    """BioModule wrapper for SBML model: Castillo2016 - Whole-genome metabolic model of C.tropicalis using CoReCo."""

    def __init__(self, model_path: str = "data/MODEL1604280006.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Castillo2016WholeGenomeMetabolicModelOfCTModel1604280006Model = SbmlCastillo2016WholeGenomeMetabolicModelOfCTropicalis
