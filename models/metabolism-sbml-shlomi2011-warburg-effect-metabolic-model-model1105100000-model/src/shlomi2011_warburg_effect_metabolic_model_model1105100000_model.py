...
"""Auto-generated SBML BioModule wrapper for Shlomi2011 - Warburg effect, metabolic model.

Source: biomodels_ebi:MODEL1105100000
Original: https://www.ebi.ac.uk/biomodels/MODEL1105100000
"""
...
class SbmlShlomi2011WarburgEffectMetabolicModel(biosim.BioModule):
    """BioModule wrapper for SBML model: Shlomi2011 - Warburg effect, metabolic model."""

    def __init__(self, model_path: str = "data/MODEL1105100000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Shlomi2011WarburgEffectMetabolicModelModel1105100000Model = SbmlShlomi2011WarburgEffectMetabolicModel
