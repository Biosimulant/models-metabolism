...
"""Auto-generated SBML BioModule wrapper for Stucki2005 - caspase-3 metabolism.

Source: biomodels_ebi:BIOMD0000001059
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000001059
"""
...
class SbmlStucki2005Caspase3Metabolism(biosim.BioModule):
    """BioModule wrapper for SBML model: Stucki2005 - caspase-3 metabolism."""

    def __init__(self, model_path: str = "data/BIOMD0000001059.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Stucki2005Caspase3MetabolismBiomd0000001059Model = SbmlStucki2005Caspase3Metabolism
