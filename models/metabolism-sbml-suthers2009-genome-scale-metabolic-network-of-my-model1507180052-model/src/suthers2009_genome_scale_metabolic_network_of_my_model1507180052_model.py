...
"""Auto-generated SBML BioModule wrapper for Suthers2009 - Genome-scale metabolic network of Mycoplasma genitalium (iPS189).

Source: biomodels_ebi:MODEL1507180052
Original: https://www.ebi.ac.uk/biomodels/MODEL1507180052
"""
...
class SbmlSuthers2009GenomeScaleMetabolicNetworkOfMycoplasma(biosim.BioModule):
    """BioModule wrapper for SBML model: Suthers2009 - Genome-scale metabolic network of Mycoplasma genitalium (iPS189)."""

    def __init__(self, model_path: str = "data/MODEL1507180052.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Suthers2009GenomeScaleMetabolicNetworkOfMyModel1507180052Model = SbmlSuthers2009GenomeScaleMetabolicNetworkOfMycoplasma
