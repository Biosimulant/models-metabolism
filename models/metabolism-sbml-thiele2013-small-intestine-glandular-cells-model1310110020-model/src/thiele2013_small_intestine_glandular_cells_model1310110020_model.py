...
"""Auto-generated SBML BioModule wrapper for Thiele2013 - Small intestine glandular cells.

Source: biomodels_ebi:MODEL1310110020
Original: https://www.ebi.ac.uk/biomodels/MODEL1310110020
"""
...
class SbmlThiele2013SmallIntestineGlandularCells(biosim.BioModule):
    """BioModule wrapper for SBML model: Thiele2013 - Small intestine glandular cells."""

    def __init__(self, model_path: str = "data/MODEL1310110020.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Thiele2013SmallIntestineGlandularCellsModel1310110020Model = SbmlThiele2013SmallIntestineGlandularCells
