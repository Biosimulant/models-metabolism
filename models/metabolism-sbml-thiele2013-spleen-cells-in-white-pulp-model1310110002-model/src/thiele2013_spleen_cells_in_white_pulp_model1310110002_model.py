...
"""Auto-generated SBML BioModule wrapper for Thiele2013 - Spleen cells in white pulp.

Source: biomodels_ebi:MODEL1310110002
Original: https://www.ebi.ac.uk/biomodels/MODEL1310110002
"""
...
class SbmlThiele2013SpleenCellsInWhitePulp(biosim.BioModule):
    """BioModule wrapper for SBML model: Thiele2013 - Spleen cells in white pulp."""

    def __init__(self, model_path: str = "data/MODEL1310110002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Thiele2013SpleenCellsInWhitePulpModel1310110002Model = SbmlThiele2013SpleenCellsInWhitePulp
