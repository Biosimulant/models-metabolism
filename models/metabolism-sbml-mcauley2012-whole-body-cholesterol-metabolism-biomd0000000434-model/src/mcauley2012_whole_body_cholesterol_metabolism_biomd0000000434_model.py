...
"""Auto-generated SBML BioModule wrapper for McAuley2012 - Whole-body Cholesterol Metabolism.

Source: biomodels_ebi:BIOMD0000000434
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000434
"""
...
class SbmlMcauley2012WholeBodyCholesterolMetabolism(biosim.BioModule):
    """BioModule wrapper for SBML model: McAuley2012 - Whole-body Cholesterol Metabolism."""

    def __init__(self, model_path: str = "data/BIOMD0000000434.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Mcauley2012WholeBodyCholesterolMetabolismBiomd0000000434Model = SbmlMcauley2012WholeBodyCholesterolMetabolism
