...
"""Auto-generated SBML BioModule wrapper for Stanford2013 - Kinetic model of yeast metabolic network (regulation).

Source: biomodels_ebi:BIOMD0000000497
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000497
"""
...
class SbmlStanford2013KineticModelOfYeastMetabolicNetwork(biosim.BioModule):
    """BioModule wrapper for SBML model: Stanford2013 - Kinetic model of yeast metabolic network (regulation)."""

    def __init__(self, model_path: str = "data/BIOMD0000000497.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Stanford2013KineticModelOfYeastMetabolicNeBiomd0000000497Model = SbmlStanford2013KineticModelOfYeastMetabolicNetwork
