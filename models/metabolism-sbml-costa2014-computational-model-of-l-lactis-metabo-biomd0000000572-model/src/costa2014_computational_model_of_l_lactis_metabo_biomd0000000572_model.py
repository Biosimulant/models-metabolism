...
"""Auto-generated SBML BioModule wrapper for Costa2014 - Computational Model of L. lactis Metabolism.

Source: biomodels_ebi:BIOMD0000000572
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000572
"""
...
class SbmlCosta2014ComputationalModelOfLLactisMetabolism(biosim.BioModule):
    """BioModule wrapper for SBML model: Costa2014 - Computational Model of L. lactis Metabolism."""

    def __init__(self, model_path: str = "data/BIOMD0000000572.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Costa2014ComputationalModelOfLLactisMetaboBiomd0000000572Model = SbmlCosta2014ComputationalModelOfLLactisMetabolism
