...
"""Auto-generated SBML BioModule wrapper for Pitkanen2014 - Metabolic reconstruction of Aspergillus clavatus using CoReCo.

Source: biomodels_ebi:MODEL1302010012
Original: https://www.ebi.ac.uk/biomodels/MODEL1302010012
"""
...
class SbmlPitkanen2014MetabolicReconstructionOfAspergillus4(biosim.BioModule):
    """BioModule wrapper for SBML model: Pitkanen2014 - Metabolic reconstruction of Aspergillus clavatus using CoReCo."""

    def __init__(self, model_path: str = "data/MODEL1302010012.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Pitkanen2014MetabolicReconstructionOfAspergiModel1302010012Model = SbmlPitkanen2014MetabolicReconstructionOfAspergillus4
