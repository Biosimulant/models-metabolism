...
"""Auto-generated SBML BioModule wrapper for Mardinoglu2015 - Tissue-specific genome-scale metabolic network - Duodenum.

Source: biomodels_ebi:MODEL1509220010
Original: https://www.ebi.ac.uk/biomodels/MODEL1509220010
"""
...
class SbmlMardinoglu2015TissueSpecificGenomeScaleMetabolic9(biosim.BioModule):
    """BioModule wrapper for SBML model: Mardinoglu2015 - Tissue-specific genome-scale metabolic network - Duodenum."""

    def __init__(self, model_path: str = "data/MODEL1509220010.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Mardinoglu2015TissueSpecificGenomeScaleMetaModel1509220010Model = SbmlMardinoglu2015TissueSpecificGenomeScaleMetabolic9
