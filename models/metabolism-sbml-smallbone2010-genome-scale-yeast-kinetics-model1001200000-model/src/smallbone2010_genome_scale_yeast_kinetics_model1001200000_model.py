...
"""Auto-generated SBML BioModule wrapper for Smallbone2010_Genome_Scale_Yeast_Kinetics.

Source: biomodels_ebi:MODEL1001200000
Original: https://www.ebi.ac.uk/biomodels/MODEL1001200000
"""
...
class SbmlSmallbone2010GenomeScaleYeastKinetics(biosim.BioModule):
    """BioModule wrapper for SBML model: Smallbone2010_Genome_Scale_Yeast_Kinetics."""

    def __init__(self, model_path: str = "data/MODEL1001200000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Smallbone2010GenomeScaleYeastKineticsModel1001200000Model = SbmlSmallbone2010GenomeScaleYeastKinetics
