...
"""Auto-generated SBML BioModule wrapper for Castillo2016 - Whole-genome metabolic model of A.fumigatus using CoReCo.

Source: biomodels_ebi:MODEL1604280029
Original: https://www.ebi.ac.uk/biomodels/MODEL1604280029
"""
...
class SbmlCastillo2016WholeGenomeMetabolicModelOfAFumigatus(biosim.BioModule):
    """BioModule wrapper for SBML model: Castillo2016 - Whole-genome metabolic model of A.fumigatus using CoReCo."""

    def __init__(self, model_path: str = "data/MODEL1604280029.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Castillo2016WholeGenomeMetabolicModelOfAFModel1604280029Model = SbmlCastillo2016WholeGenomeMetabolicModelOfAFumigatus
