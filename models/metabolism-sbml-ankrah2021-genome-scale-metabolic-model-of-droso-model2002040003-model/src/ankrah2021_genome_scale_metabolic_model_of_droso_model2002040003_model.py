...
"""Auto-generated SBML BioModule wrapper for Ankrah2021 - Genome scale metabolic model of Drosophila gut microbe Acetobacter pomorum.

Source: biomodels_ebi:MODEL2002040003
Original: https://www.ebi.ac.uk/biomodels/MODEL2002040003
"""
...
class SbmlAnkrah2021GenomeScaleMetabolicModelOfDrosophilaGut2(biosim.BioModule):
    """BioModule wrapper for SBML model: Ankrah2021 - Genome scale metabolic model of Drosophila gut microbe Acetobacter pomorum."""

    def __init__(self, model_path: str = "data/MODEL2002040003.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Ankrah2021GenomeScaleMetabolicModelOfDrosoModel2002040003Model = SbmlAnkrah2021GenomeScaleMetabolicModelOfDrosophilaGut2
