...
"""Auto-generated SBML BioModule wrapper for Luo2022 - iLJ1162-genome-scale metabolic network Shewanella oneidensis MR-1.

Source: biomodels_ebi:MODEL2205050001
Original: https://www.ebi.ac.uk/biomodels/MODEL2205050001
"""
...
class SbmlLuo2022Ilj1162GenomeScaleMetabolicNetworkShewanella(biosim.BioModule):
    """BioModule wrapper for SBML model: Luo2022 - iLJ1162-genome-scale metabolic network Shewanella oneidensis MR-1."""

    def __init__(self, model_path: str = "data/MODEL2205050001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Luo2022Ilj1162GenomeScaleMetabolicNetworkSModel2205050001Model = SbmlLuo2022Ilj1162GenomeScaleMetabolicNetworkShewanella
