...
"""Auto-generated SBML BioModule wrapper for Uhlén2015 - Human tissue-based proteome metabolic network - appendix.

Source: biomodels_ebi:MODEL1411240004
Original: https://www.ebi.ac.uk/biomodels/MODEL1411240004
"""
...
class SbmlUhlen2015HumanTissueBasedProteomeMetabolicNetwork7(biosim.BioModule):
    """BioModule wrapper for SBML model: Uhlén2015 - Human tissue-based proteome metabolic network - appendix."""

    def __init__(self, model_path: str = "data/MODEL1411240004.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
UhlN2015HumanTissueBasedProteomeMetabolicModel1411240004Model = SbmlUhlen2015HumanTissueBasedProteomeMetabolicNetwork7
