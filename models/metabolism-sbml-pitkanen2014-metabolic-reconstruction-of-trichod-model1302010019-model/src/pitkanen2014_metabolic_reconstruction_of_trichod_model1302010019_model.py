...
"""Auto-generated SBML BioModule wrapper for Pitkanen2014 - Metabolic reconstruction of Trichoderma reesei using CoReCo.

Source: biomodels_ebi:MODEL1302010019
Original: https://www.ebi.ac.uk/biomodels/MODEL1302010019
"""
...
class SbmlPitkanen2014MetabolicReconstructionOfTrichodermaReesei(biosim.BioModule):
    """BioModule wrapper for SBML model: Pitkanen2014 - Metabolic reconstruction of Trichoderma reesei using CoReCo."""

    def __init__(self, model_path: str = "data/MODEL1302010019.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Pitkanen2014MetabolicReconstructionOfTrichodModel1302010019Model = SbmlPitkanen2014MetabolicReconstructionOfTrichodermaReesei
