...
"""Auto-generated SBML BioModule wrapper for Jamshidi01_RBC_MetabolicNetwork.

Source: biomodels_ebi:MODEL1103210001
Original: https://www.ebi.ac.uk/biomodels/MODEL1103210001
"""
...
class SbmlJamshidi01RbcMetabolicnetwork(biosim.BioModule):
    """BioModule wrapper for SBML model: Jamshidi01_RBC_MetabolicNetwork."""

    def __init__(self, model_path: str = "data/MODEL1103210001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Jamshidi01RbcMetabolicnetworkModel1103210001Model = SbmlJamshidi01RbcMetabolicnetwork
