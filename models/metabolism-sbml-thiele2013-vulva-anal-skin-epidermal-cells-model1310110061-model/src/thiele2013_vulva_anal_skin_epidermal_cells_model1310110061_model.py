...
"""Auto-generated SBML BioModule wrapper for Thiele2013 - Vulva anal skin epidermal cells.

Source: biomodels_ebi:MODEL1310110061
Original: https://www.ebi.ac.uk/biomodels/MODEL1310110061
"""
...
class SbmlThiele2013VulvaAnalSkinEpidermalCells(biosim.BioModule):
    """BioModule wrapper for SBML model: Thiele2013 - Vulva anal skin epidermal cells."""

    def __init__(self, model_path: str = "data/MODEL1310110061.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Thiele2013VulvaAnalSkinEpidermalCellsModel1310110061Model = SbmlThiele2013VulvaAnalSkinEpidermalCells
