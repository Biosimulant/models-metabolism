...
"""Auto-generated SBML BioModule wrapper for Pitkanen2014 - Metabolic reconstruction of Uncinocarpus reesii using CoReCo.

Source: biomodels_ebi:MODEL1302010044
Original: https://www.ebi.ac.uk/biomodels/MODEL1302010044
"""
...
class SbmlPitkanen2014MetabolicReconstructionOfUncinocarpus(biosim.BioModule):
    """BioModule wrapper for SBML model: Pitkanen2014 - Metabolic reconstruction of Uncinocarpus reesii using CoReCo."""

    def __init__(self, model_path: str = "data/MODEL1302010044.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Pitkanen2014MetabolicReconstructionOfUncinocModel1302010044Model = SbmlPitkanen2014MetabolicReconstructionOfUncinocarpus
