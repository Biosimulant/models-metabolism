...
"""Auto-generated SBML BioModule wrapper for Furr2005 - whole-body vitamin A metabolism in humans.

Source: biomodels_ebi:MODEL2405200001
Original: https://www.ebi.ac.uk/biomodels/MODEL2405200001
"""
...
class SbmlFurr2005WholeBodyVitaminAMetabolismInHumans(biosim.BioModule):
    """BioModule wrapper for SBML model: Furr2005 - whole-body vitamin A metabolism in humans."""

    def __init__(self, model_path: str = "data/MODEL2405200001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Furr2005WholeBodyVitaminAMetabolismInHumaModel2405200001Model = SbmlFurr2005WholeBodyVitaminAMetabolismInHumans
