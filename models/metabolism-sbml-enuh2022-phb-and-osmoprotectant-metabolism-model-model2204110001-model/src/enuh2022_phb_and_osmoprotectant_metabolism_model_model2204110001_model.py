...
"""Auto-generated SBML BioModule wrapper for Enuh2022-PHB and Osmoprotectant metabolism model of Chromohalobacter canadensis.

Source: biomodels_ebi:MODEL2204110001
Original: https://www.ebi.ac.uk/biomodels/MODEL2204110001
"""
...
class SbmlEnuh2022PhbAndOsmoprotectantMetabolismModelOf(biosim.BioModule):
    """BioModule wrapper for SBML model: Enuh2022-PHB and Osmoprotectant metabolism model of Chromohalobacter canadensis."""

    def __init__(self, model_path: str = "data/MODEL2204110001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Enuh2022PhbAndOsmoprotectantMetabolismModelModel2204110001Model = SbmlEnuh2022PhbAndOsmoprotectantMetabolismModelOf
