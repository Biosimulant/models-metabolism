...
"""Auto-generated SBML BioModule wrapper for Mardinoglu2014 - Genome-scale metabolic model (HMR version 2.0) - human hepatocytes (iHepatocytes2322).

Source: biomodels_ebi:MODEL1402200003
Original: https://www.ebi.ac.uk/biomodels/MODEL1402200003
"""
...
class SbmlMardinoglu2014GenomeScaleMetabolicModelHmrVersion202(biosim.BioModule):
    """BioModule wrapper for SBML model: Mardinoglu2014 - Genome-scale metabolic model (HMR version 2.0) - human hepatocytes (iHepatocytes2322)."""

    def __init__(self, model_path: str = "data/MODEL1402200003.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Mardinoglu2014GenomeScaleMetabolicModelHmrModel1402200003Model = SbmlMardinoglu2014GenomeScaleMetabolicModelHmrVersion202
