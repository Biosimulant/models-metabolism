...
"""Auto-generated SBML BioModule wrapper for Lu2021-Genome scale metabolic models for yeast species of clade CUG-Ser2.

Source: biomodels_ebi:MODEL2109130005
Original: https://www.ebi.ac.uk/biomodels/MODEL2109130005
"""
...
class SbmlLu2021GenomeScaleMetabolicModelsForYeastSpeciesOf2(biosim.BioModule):
    """BioModule wrapper for SBML model: Lu2021-Genome scale metabolic models for yeast species of clade CUG-Ser2."""

    def __init__(self, model_path: str = "data/MODEL2109130005.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Lu2021GenomeScaleMetabolicModelsForYeastSModel2109130005Model = SbmlLu2021GenomeScaleMetabolicModelsForYeastSpeciesOf2
