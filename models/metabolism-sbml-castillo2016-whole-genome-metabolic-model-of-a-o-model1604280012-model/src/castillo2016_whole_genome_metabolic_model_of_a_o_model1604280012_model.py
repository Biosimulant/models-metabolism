...
"""Auto-generated SBML BioModule wrapper for Castillo2016 - Whole-genome metabolic model of A.oryzae using CoReCo.

Source: biomodels_ebi:MODEL1604280012
Original: https://www.ebi.ac.uk/biomodels/MODEL1604280012
"""
...
class SbmlCastillo2016WholeGenomeMetabolicModelOfAOryzaeUsing(biosim.BioModule):
    """BioModule wrapper for SBML model: Castillo2016 - Whole-genome metabolic model of A.oryzae using CoReCo."""

    def __init__(self, model_path: str = "data/MODEL1604280012.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Castillo2016WholeGenomeMetabolicModelOfAOModel1604280012Model = SbmlCastillo2016WholeGenomeMetabolicModelOfAOryzaeUsing
