...
"""Auto-generated SBML BioModule wrapper for Jallet2024 - Isotopic model of ethanolamine metabolism in E. coli.

Source: biomodels_ebi:MODEL2403010002
Original: https://www.ebi.ac.uk/biomodels/MODEL2403010002
"""
...
class SbmlJallet2024IsotopicModelOfEthanolamineMetabolismInE(biosim.BioModule):
    """BioModule wrapper for SBML model: Jallet2024 - Isotopic model of ethanolamine metabolism in E. coli."""

    def __init__(self, model_path: str = "data/MODEL2403010002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Jallet2024IsotopicModelOfEthanolamineMetaboModel2403010002Model = SbmlJallet2024IsotopicModelOfEthanolamineMetabolismInE
