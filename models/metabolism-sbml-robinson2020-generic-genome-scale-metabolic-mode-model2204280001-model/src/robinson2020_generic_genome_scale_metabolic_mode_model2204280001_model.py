...
"""Auto-generated SBML BioModule wrapper for Robinson2020 - generic genome-scale metabolic model of Homo sapiens - Human1.

Source: biomodels_ebi:MODEL2204280001
Original: https://www.ebi.ac.uk/biomodels/MODEL2204280001
"""
...
class SbmlRobinson2020GenericGenomeScaleMetabolicModelOfHomo(biosim.BioModule):
    """BioModule wrapper for SBML model: Robinson2020 - generic genome-scale metabolic model of Homo sapiens - Human1."""

    def __init__(self, model_path: str = "data/MODEL2204280001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Robinson2020GenericGenomeScaleMetabolicModeModel2204280001Model = SbmlRobinson2020GenericGenomeScaleMetabolicModelOfHomo
