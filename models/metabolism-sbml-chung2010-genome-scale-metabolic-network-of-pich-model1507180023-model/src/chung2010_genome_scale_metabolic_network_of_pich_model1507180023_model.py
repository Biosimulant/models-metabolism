...
"""Auto-generated SBML BioModule wrapper for Chung2010 - Genome-scale metabolic network of Pichia pastoris (iPP668).

Source: biomodels_ebi:MODEL1507180023
Original: https://www.ebi.ac.uk/biomodels/MODEL1507180023
"""
...
class SbmlChung2010GenomeScaleMetabolicNetworkOfPichiaPastoris(biosim.BioModule):
    """BioModule wrapper for SBML model: Chung2010 - Genome-scale metabolic network of Pichia pastoris (iPP668)."""

    def __init__(self, model_path: str = "data/MODEL1507180023.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Chung2010GenomeScaleMetabolicNetworkOfPichModel1507180023Model = SbmlChung2010GenomeScaleMetabolicNetworkOfPichiaPastoris
