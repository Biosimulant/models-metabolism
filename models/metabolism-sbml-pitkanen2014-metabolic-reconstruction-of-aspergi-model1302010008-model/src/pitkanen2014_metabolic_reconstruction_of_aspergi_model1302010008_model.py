...
"""Auto-generated SBML BioModule wrapper for Pitkanen2014 - Metabolic reconstruction of Aspergillus oryzae using CoReCo.

Source: biomodels_ebi:MODEL1302010008
Original: https://www.ebi.ac.uk/biomodels/MODEL1302010008
"""
...
class SbmlPitkanen2014MetabolicReconstructionOfAspergillusOryzae(biosim.BioModule):
    """BioModule wrapper for SBML model: Pitkanen2014 - Metabolic reconstruction of Aspergillus oryzae using CoReCo."""

    def __init__(self, model_path: str = "data/MODEL1302010008.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Pitkanen2014MetabolicReconstructionOfAspergiModel1302010008Model = SbmlPitkanen2014MetabolicReconstructionOfAspergillusOryzae
