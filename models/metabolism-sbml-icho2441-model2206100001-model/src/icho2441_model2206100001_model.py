...
"""Auto-generated SBML BioModule wrapper for iCHO2441.

Source: biomodels_ebi:MODEL2206100001
Original: https://www.ebi.ac.uk/biomodels/MODEL2206100001
"""
...
class SbmlIcho2441(biosim.BioModule):
    """BioModule wrapper for SBML model: iCHO2441."""

    def __init__(self, model_path: str = "data/MODEL2206100001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Icho2441Model2206100001Model = SbmlIcho2441
