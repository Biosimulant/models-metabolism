...
"""Auto-generated SBML BioModule wrapper for Sohn2010 - Genome-scale metabolic network of Pseudomonas putida (PpuMBEL1071).

Source: biomodels_ebi:MODEL1507180043
Original: https://www.ebi.ac.uk/biomodels/MODEL1507180043
"""
...
class SbmlSohn2010GenomeScaleMetabolicNetworkOfPseudomonas(biosim.BioModule):
    """BioModule wrapper for SBML model: Sohn2010 - Genome-scale metabolic network of Pseudomonas putida (PpuMBEL1071)."""

    def __init__(self, model_path: str = "data/MODEL1507180043.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Sohn2010GenomeScaleMetabolicNetworkOfPseudModel1507180043Model = SbmlSohn2010GenomeScaleMetabolicNetworkOfPseudomonas
