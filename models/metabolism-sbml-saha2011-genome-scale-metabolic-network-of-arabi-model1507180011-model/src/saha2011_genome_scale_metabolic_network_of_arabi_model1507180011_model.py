...
"""Auto-generated SBML BioModule wrapper for Saha2011 - Genome-scale metabolic network of Arabidopsis thaliana (iRS1597).

Source: biomodels_ebi:MODEL1507180011
Original: https://www.ebi.ac.uk/biomodels/MODEL1507180011
"""
...
class SbmlSaha2011GenomeScaleMetabolicNetworkOfArabidopsis(biosim.BioModule):
    """BioModule wrapper for SBML model: Saha2011 - Genome-scale metabolic network of Arabidopsis thaliana (iRS1597)."""

    def __init__(self, model_path: str = "data/MODEL1507180011.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Saha2011GenomeScaleMetabolicNetworkOfArabiModel1507180011Model = SbmlSaha2011GenomeScaleMetabolicNetworkOfArabidopsis
