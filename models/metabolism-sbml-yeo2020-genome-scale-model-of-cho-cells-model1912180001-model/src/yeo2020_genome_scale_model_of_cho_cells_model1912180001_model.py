...
"""Auto-generated SBML BioModule wrapper for Yeo2020 - Genome-scale model of CHO cells.

Source: biomodels_ebi:MODEL1912180001
Original: https://www.ebi.ac.uk/biomodels/MODEL1912180001
"""
...
class SbmlYeo2020GenomeScaleModelOfChoCells(biosim.BioModule):
    """BioModule wrapper for SBML model: Yeo2020 - Genome-scale model of CHO cells."""

    def __init__(self, model_path: str = "data/MODEL1912180001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Yeo2020GenomeScaleModelOfChoCellsModel1912180001Model = SbmlYeo2020GenomeScaleModelOfChoCells
