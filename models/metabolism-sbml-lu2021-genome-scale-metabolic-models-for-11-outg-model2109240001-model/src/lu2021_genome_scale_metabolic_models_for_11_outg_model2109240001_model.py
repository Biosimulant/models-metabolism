...
"""Auto-generated SBML BioModule wrapper for Lu2021-Genome scale metabolic models for 11 outgroup fungi species.

Source: biomodels_ebi:MODEL2109240001
Original: https://www.ebi.ac.uk/biomodels/MODEL2109240001
"""
...
class SbmlLu2021GenomeScaleMetabolicModelsFor11OutgroupFungi(biosim.BioModule):
    """BioModule wrapper for SBML model: Lu2021-Genome scale metabolic models for 11 outgroup fungi species."""

    def __init__(self, model_path: str = "data/MODEL2109240001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Lu2021GenomeScaleMetabolicModelsFor11OutgModel2109240001Model = SbmlLu2021GenomeScaleMetabolicModelsFor11OutgroupFungi
