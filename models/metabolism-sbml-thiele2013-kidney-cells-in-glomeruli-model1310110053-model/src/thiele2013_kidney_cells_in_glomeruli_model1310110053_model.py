...
"""Auto-generated SBML BioModule wrapper for Thiele2013 - Kidney cells in glomeruli.

Source: biomodels_ebi:MODEL1310110053
Original: https://www.ebi.ac.uk/biomodels/MODEL1310110053
"""
...
class SbmlThiele2013KidneyCellsInGlomeruli(biosim.BioModule):
    """BioModule wrapper for SBML model: Thiele2013 - Kidney cells in glomeruli."""

    def __init__(self, model_path: str = "data/MODEL1310110053.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Thiele2013KidneyCellsInGlomeruliModel1310110053Model = SbmlThiele2013KidneyCellsInGlomeruli
