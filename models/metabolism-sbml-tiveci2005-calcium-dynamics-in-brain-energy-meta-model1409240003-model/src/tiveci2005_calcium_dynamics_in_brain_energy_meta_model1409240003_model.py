...
"""Auto-generated SBML BioModule wrapper for Tiveci2005 - Calcium dynamics in brain energy metabolism and Alzheimer's disease.

Source: biomodels_ebi:MODEL1409240003
Original: https://www.ebi.ac.uk/biomodels/MODEL1409240003
"""
...
class SbmlTiveci2005CalciumDynamicsInBrainEnergyMetabolismAnd(biosim.BioModule):
    """BioModule wrapper for SBML model: Tiveci2005 - Calcium dynamics in brain energy metabolism and Alzheimer's disease."""

    def __init__(self, model_path: str = "data/MODEL1409240003.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Tiveci2005CalciumDynamicsInBrainEnergyMetaModel1409240003Model = SbmlTiveci2005CalciumDynamicsInBrainEnergyMetabolismAnd
