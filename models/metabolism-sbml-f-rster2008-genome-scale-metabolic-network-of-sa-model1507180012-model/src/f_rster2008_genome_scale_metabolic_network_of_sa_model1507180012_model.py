...
"""Auto-generated SBML BioModule wrapper for Förster2008 - Genome-scale metabolic network of Saccharamyces cerevisiae (iFF708).

Source: biomodels_ebi:MODEL1507180012
Original: https://www.ebi.ac.uk/biomodels/MODEL1507180012
"""
...
class SbmlForster2008GenomeScaleMetabolicNetworkOfSaccharamyces(biosim.BioModule):
    """BioModule wrapper for SBML model: Förster2008 - Genome-scale metabolic network of Saccharamyces cerevisiae (iFF708)."""

    def __init__(self, model_path: str = "data/MODEL1507180012.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
FRster2008GenomeScaleMetabolicNetworkOfSaModel1507180012Model = SbmlForster2008GenomeScaleMetabolicNetworkOfSaccharamyces
