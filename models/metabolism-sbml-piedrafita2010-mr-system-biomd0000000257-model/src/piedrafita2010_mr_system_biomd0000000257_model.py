...
"""Auto-generated SBML BioModule wrapper for Piedrafita2010_MR_System.

Source: biomodels_ebi:BIOMD0000000257
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000257
"""
...
class SbmlPiedrafita2010MrSystem(biosim.BioModule):
    """BioModule wrapper for SBML model: Piedrafita2010_MR_System."""

    def __init__(self, model_path: str = "data/BIOMD0000000257.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Piedrafita2010MrSystemBiomd0000000257Model = SbmlPiedrafita2010MrSystem
