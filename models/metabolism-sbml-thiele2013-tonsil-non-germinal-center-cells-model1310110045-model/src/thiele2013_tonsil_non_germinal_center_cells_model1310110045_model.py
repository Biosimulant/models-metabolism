...
"""Auto-generated SBML BioModule wrapper for Thiele2013 - Tonsil non germinal center cells.

Source: biomodels_ebi:MODEL1310110045
Original: https://www.ebi.ac.uk/biomodels/MODEL1310110045
"""
...
class SbmlThiele2013TonsilNonGerminalCenterCells(biosim.BioModule):
    """BioModule wrapper for SBML model: Thiele2013 - Tonsil non germinal center cells."""

    def __init__(self, model_path: str = "data/MODEL1310110045.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Thiele2013TonsilNonGerminalCenterCellsModel1310110045Model = SbmlThiele2013TonsilNonGerminalCenterCells
