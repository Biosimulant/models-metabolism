...
"""Auto-generated SBML BioModule wrapper for Feist2007_EcMetabol_flux1.

Source: biomodels_ebi:MODEL3023609334
Original: https://www.ebi.ac.uk/biomodels/MODEL3023609334
"""
...
class SbmlFeist2007EcmetabolFlux1(biosim.BioModule):
    """BioModule wrapper for SBML model: Feist2007_EcMetabol_flux1."""

    def __init__(self, model_path: str = "data/MODEL3023609334.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Feist2007EcmetabolFlux1Model3023609334Model = SbmlFeist2007EcmetabolFlux1
