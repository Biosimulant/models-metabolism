...
"""Auto-generated SBML BioModule wrapper for Pitkanen2014 - Metabolic reconstruction of Yarrowia lipolytica using CoReCo.

Source: biomodels_ebi:MODEL1302010013
Original: https://www.ebi.ac.uk/biomodels/MODEL1302010013
"""
...
class SbmlPitkanen2014MetabolicReconstructionOfYarrowia(biosim.BioModule):
    """BioModule wrapper for SBML model: Pitkanen2014 - Metabolic reconstruction of Yarrowia lipolytica using CoReCo."""

    def __init__(self, model_path: str = "data/MODEL1302010013.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Pitkanen2014MetabolicReconstructionOfYarrowiModel1302010013Model = SbmlPitkanen2014MetabolicReconstructionOfYarrowia
