...
"""Auto-generated SBML BioModule wrapper for Thiele2013 - Breast glandular cells.

Source: biomodels_ebi:MODEL1310110023
Original: https://www.ebi.ac.uk/biomodels/MODEL1310110023
"""
...
class SbmlThiele2013BreastGlandularCells(biosim.BioModule):
    """BioModule wrapper for SBML model: Thiele2013 - Breast glandular cells."""

    def __init__(self, model_path: str = "data/MODEL1310110023.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Thiele2013BreastGlandularCellsModel1310110023Model = SbmlThiele2013BreastGlandularCells
