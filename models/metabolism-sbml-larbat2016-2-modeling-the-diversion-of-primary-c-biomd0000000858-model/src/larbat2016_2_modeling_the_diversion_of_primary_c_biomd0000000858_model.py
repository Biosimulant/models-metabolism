...
"""Auto-generated SBML BioModule wrapper for Larbat2016.2 - Modeling the diversion of primary carbon flux into secondary metabolism under variable nitrate and light or dark conditions (Light Dark Cycles).

Source: biomodels_ebi:BIOMD0000000858
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000858
"""
...
class SbmlLarbat20162ModelingTheDiversionOfPrimaryCarbonFlux(biosim.BioModule):
    """BioModule wrapper for SBML model: Larbat2016.2 - Modeling the diversion of primary carbon flux into secondary metabolism under variable nitrate and light or dark conditions (Light Dark Cycles)."""

    def __init__(self, model_path: str = "data/BIOMD0000000858.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Larbat20162ModelingTheDiversionOfPrimaryCBiomd0000000858Model = SbmlLarbat20162ModelingTheDiversionOfPrimaryCarbonFlux
