...
"""Auto-generated SBML BioModule wrapper for Yang2008_AAnetwork_EC.

Source: biomodels_ebi:MODEL8236480549
Original: https://www.ebi.ac.uk/biomodels/MODEL8236480549
"""
...
class SbmlYang2008AanetworkEc(biosim.BioModule):
    """BioModule wrapper for SBML model: Yang2008_AAnetwork_EC."""

    def __init__(self, model_path: str = "data/MODEL8236480549.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Yang2008AanetworkEcModel8236480549Model = SbmlYang2008AanetworkEc
