#!/usr/bin/env python3
"""Run generated space: metabolism-central-carbon-combo-0029."""
...
def main() -> None:
    ...
    print(f"Completed {space.get('title', 'metabolism-central-carbon-combo-0029')} duration={duration} tick_dt={tick_dt}")
