#!/usr/bin/env python3
"""Run generated space: metabolism-lipid-metabolism-combo-0070."""
...
def _repo_root_map(current_repo_root: Path) -> dict[str, Path]:
    ...
    return {
        "Biosimulant/models-metabolism": current_repo_root.resolve(),
...
def main() -> None:
    ...
    print(f"Completed {space.get('title', 'metabolism-lipid-metabolism-combo-0070')} duration={duration} tick_dt={tick_dt}")
